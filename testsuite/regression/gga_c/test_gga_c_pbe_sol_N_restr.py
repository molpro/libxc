...
def test_gga_c_pbe_sol_N_restr_1_zk():
    # Prepare the input
...
def test_gga_c_pbe_sol_N_restr_1_vsigma():
    # Prepare the input
    inp = test_data["N_restr"]
    ...
    ref_tgt = ns.full_like(tgt, ns.asarray([6.727654515795143e-07, 7.191482749733584e-07, 7.913238982046248e-07, 9.074973382140916e-07, 1.103662614781730e-06, 1.457942349871168e-06, 2.160132370770127e-06, 3.736627279343838e-06, 7.880298687604031e-06, 2.141211669042137e-05, 1.216656579566311e-04, 2.943357132565547e-03, 7.250189187935950e-03, 1.264217598270968e-02, 3.760738519773288e-02, 1.370475946150112e-01, 2.267775783881135e-01, 1.014791853087659e-01, 1.269158971407812e-02, 3.166392589500310e-04]))
    error = ns.max(ns.abs(tgt-ref_tgt))/(1.0+ns.max(ns.asarray([ns.abs(tgt), ns.abs(ref_tgt)])))
    assert error < 5e-05


def test_gga_c_pbe_sol_N_restr_1_v2rho2():
    # Prepare the input
    inp = test_data["N_restr"]
...
def test_gga_c_pbe_sol_N_restr_1_v2rhosigma():
    # Prepare the input
    inp = test_data["N_restr"]
...
def test_gga_c_pbe_sol_N_restr_1_v2sigma2():
    ...
    ref_tgt = ns.full_like(tgt, ns.asarray([-8.438906604593425e-14, -1.027744087932888e-13, -1.364148523741280e-13, -2.048426104429827e-13, -3.669867790476229e-13, -8.458894911964486e-13, -2.790594619662762e-12, -1.531163584243654e-11, -1.723574630976632e-10, -5.284466556416764e-09, -7.983265696653352e-07, -5.076848419942160e-04, -4.309054095191505e-03, -2.880006446828376e-02, -1.212516175461109e+00, -2.780593320585133e+02, -1.093724428176208e+05, -5.595844265695358e+07, -9.670690284629982e+10, -1.387231921489522e+15]))
    err = ns.abs(tgt-ref_tgt)/(1.0+ns.max(ns.asarray([ns.abs(tgt), ns.abs(ref_tgt)])))
    tol = ns.full_like(tgt, ns.asarray([5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 5.000000000000000e-05, 1.000000000000000e+30]))
    assert bool(ns.all(err < tol))
