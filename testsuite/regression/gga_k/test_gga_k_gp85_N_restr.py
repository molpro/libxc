...
def test_gga_k_gp85_N_restr_1_zk():
    # Prepare the input
    inp = test_data["N_restr"]

    # Get the functional
    feval = pylibxc.LibXCFunctional("gga_k_gp85", 1)
...
def test_gga_k_gp85_N_restr_1_vrho():
    # Prepare the input
    inp = test_data["N_restr"]
...
def test_gga_k_gp85_N_restr_1_vsigma():
    # Prepare the input
    inp = test_data["N_restr"]
...
def test_gga_k_gp85_N_restr_1_v2rho2():
    # Prepare the input
    inp = test_data["N_restr"]
...
def test_gga_k_gp85_N_restr_1_v2rhosigma():
    # Prepare the input
    inp = test_data["N_restr"]
...
def test_gga_k_gp85_N_restr_1_v2sigma2():
    # Prepare the input
    inp = test_data["N_restr"]
