/*
  Generated from python/gga_exc/gga_c_sg4.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_c_sg4
*/

#ifndef _GGA_C_SG4_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_C_SG4_KERNEL_BODY
#define _KMAX 0
#define _GGA_C_SG4_HELPER_BODIES
#include "gga_c_sg4.c"
#undef _GGA_C_SG4_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_C_SG4_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_C_SG4_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(mbeta_k, _KMAX)(const xc_func_type *p, double rs, double t, double *out) {
  ...
  const double _t2 = xc_expm1(-_t1);
  const double _t3 = 0.070000000000000007*_t2;
#if _KMAX >= 1
  const double _t4 = _t2 + 0.1e1;
  const double _t5 = 0.14000000000000001*_t4*rs;
#endif
#if _KMAX >= 2
  const double _t6 = 0.28000000000000003*_t1*_t4;
#endif
#if _KMAX >= 3
  const double _t7 = 0.84000000000000008*_t4;
  const double _t8 = _t7*rs;
  const double _t9 = 0.56000000000000005*_t4*(rs * rs * rs);
#endif

  const double f = -_t3*t + 0.78000000000000003/(M_PI * M_PI);
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = -_t3;
  out[1] = df_dt;
  const double df_drs = _t5*t;
  out[2] = df_drs;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = 0;
  out[3] = d2f_dt2;
  const double d2f_drs_dt = _t5;
  out[4] = d2f_drs_dt;
  const double d2f_drs2 = 0.14000000000000001*_t4*t - _t6*t;
  out[5] = d2f_drs2;
#endif
#if _KMAX >= 3
  ...
  out[7] = d3f_drs_dt2;
  const double d3f_drs2_dt = 0.14000000000000001*_t2 - _t6 + 0.14000000000000001;
  out[8] = d3f_drs2_dt;
  const double d3f_drs3 = -_t8*t + _t9*t;
  out[9] = d3f_drs3;
#endif
#if _KMAX >= 4
  ...
  out[12] = d4f_drs2_dt2;
  const double d4f_drs3_dt = -_t8 + _t9;
  out[13] = d4f_drs3_dt;
  const double d4f_drs4 = 3.3600000000000003*_t1*_t4*t - 1.1200000000000001*_t4*(rs * rs * rs * rs)*t - _t7*t;
  out[14] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(A_k, _KMAX)(const xc_func_type *p, double rs, double z, double t, double *out) {
  ...
  const double _t100 = _t24*_t47;
  const double _t101 = _hc2[2]*_t47;
  const double _t102 = _t27*_t59;
  const double _t103 = _t102*_t48;
  const double _t104 = _hc2[7]*_t50;
  const double _t105 = _t35*_t52;
  const double _t106 = _t105*_t22;
  const double _t107 = _t38*_t52;
  const double _t108 = _hc2[4]*_t21;
  const double _t109 = _t23*_t94;
  const double _t110 = _hc3[2]*_t26;
  const double _t111 = _t29*_t59;
  const double _t112 = _t111*_t6;
  const double _t113 = _hc3[2]*_t112;
  const double _t114 = 0.2e1*_t18;
  const double _t115 = 0.4e1*_t58;
  const double _t116 = _hc3[0]*_t115;
  const double _t117 = _hc2[4]*_t24;
  const double _t118 = _t117*_t18;
  const double _t119 = _t111*_t57;
  const double _t120 = _t29*_t78;
  const double _t121 = _t120*_t57;
  const double _t122 = _t22*_t52;
  const double _t123 = _hc3[0]*_t18;
  const double _t124 = 0.4e1*_t13;
  const double _t125 = _hc2[2]*_t52*_t58;
  const double _t126 = _t124*_t125;
  const double _t127 = _t45*_t59;
  const double _t128 = _hc3[4]*_t64;
  const double _t129 = _hc3[1]*_t73;
  const double _t130 = _hc2[8]*_t50;
  const double _t131 = _hc3[2]*_t11;
  const double _t132 = 0.2e1*_t117;
  const double _t133 = _hc2[4]*_t70;
  const double _t134 = 0.2e1*_t133;
  const double _t135 = _hc2[2]*_t133;
  const double _t136 = _hc2[5]*_t53;
  const double _t137 = _hc2[2]*_t107;
  const double _t138 = xc_powi(_t1, -7);
  const double _t139 = -0.3e1*_hc0[2] + 0.3e1*_hc1[2];
  const double _t140 = _t138*_t139;
  const double _t141 = _t140*_t69;
  const double _t142 = _t141*_t67;
  const double _t143 = _t141*_t66;
  const double _t144 = _t143*_t59;
  const double _t145 = _t18*_t48;
  const double _t146 = _t115*_t145;
  const double _t147 = _hc3[2]*_t146;
  const double _t148 = _hc2[5]*_t24;
  const double _t149 = _hc3[0]*_t148;
  const double _t150 = _t149*_t60;
  const double _t151 = _t18*_t74;
  const double _t152 = _t72*_t78;
  const double _t153 = _t123*_t152;
  const double _t154 = _hc2[9]*_t50;
  const double _t155 = 0.3e1*_t63;
  const double _t156 = _hc3[5]*_t155;
  const double _t157 = 0.3e1*_t131;
  const double _t158 = _t148*_t157;
  const double _t159 = ((_hc2[2]) * (_hc2[2]) * (_hc2[2]));
  const double _t160 = xc_powi(M_PI, 8);
  const double _t161 = (0.1e1 / (_t4 * _t4 * _t4 * _t4));
  const double _t162 = _t160*_t161/xc_powi(_t1, 9);
  const double _t163 = _t159*_t162;
  const double _t164 = _t163*_t21;
  const double _t165 = _hc2[5]*_t70;
  const double _t166 = 0.3e1*_t165;
  const double _t167 = _t166*_t22;
  const double _t168 = _t157*_t72;
  const double _t169 = 0.6e1*_t58;
  const double _t170 = _hc3[0]*_t169;
  const double _t171 = _hc2[2]*_t165;
  const double _t172 = _t170*_t171;
  const double _t173 = _t169*_t72;
  const double _t174 = _hc3[2]*_t173;
  const double _t175 = _hc3[0]*_t163;
  const double _t176 = _t169*_t175;
  const double _t177 = _t175*_t78;
#endif
#if _KMAX >= 4
  const double _t178 = (_t18 * _t18 * _t18 * _t18);
  const double _t179 = xc_powi(_t8, -5);
  const double _t180 = (_t10 * _t10 * _t10 * _t10);
  const double _t181 = -0.3e1*_t12 - 0.3e1*_t17;
  const double _t182 = (_t80 * _t80);
  const double _t183 = (_t45 * _t45);
  const double _t184 = 0.6e1*_t13;
  const double _t185 = -_t184*_t37 - 0.3e1*_t34 - 0.3e1*_t36 - 0.3e1*_t44;
  const double _t186 = _t19*_t29*_t78;
  const double _t187 = 0.6e1*_t88;
  const double _t188 = _t42*_t90;
  const double _t189 = _t188*_t38;
  const double _t190 = 0.6e1*_t94;
  const double _t191 = _t43*_t97;
  const double _t192 = -_t13*_t187 - _t189*_t39 - _t190*_t93 - _t191*_t38 - 0.4e1*_t35*_t82 - 0.2e1*_t84 - 0.2e1*_t86 - 0.6e1*_t87;
  const double _t193 = _t35*_t39;
  const double _t194 = _t41*_t93;
  const double _t195 = _t40*_t90;
  const double _t196 = _hc3[4]*_t26;
  const double _t197 = _t11*_t27;
  const double _t198 = _hc3[1]*_t48;
  const double _t199 = _t105*_t21;
  const double _t200 = 0.3e1*_hc2[4];
  const double _t201 = _t52*_t89;
  const double _t202 = _t22*_t23;
  const double _t203 = _t202*_t41;
  const double _t204 = _hc3[2]*_t6;
  const double _t205 = _t204*_t59;
  const double _t206 = _t76*_t78;
  const double _t207 = 0.3e1*_t18;
  const double _t208 = 0.3e1*_t51;
  const double _t209 = _t170*_t18;
  const double _t210 = _t57*_t76;
  const double _t211 = 0.24e2*_t179*_t180;
  const double _t212 = _t117*_t170;
  const double _t213 = _hc3[0]*_t29;
  const double _t214 = 0.18e2*_t77;
  const double _t215 = _t213*_t214;
  const double _t216 = _t122*_t89;
  const double _t217 = 0.12e2*_t58;
  const double _t218 = _t125*_t184;
  const double _t219 = _hc2[2]*_t53;
  const double _t220 = _t123*_t58;
  const double _t221 = _hc2[2]*_t23;
  const double _t222 = _hc3[0]*_t45;
  const double _t223 = _t18*_t205;
  const double _t224 = _t45*_t48;
  const double _t225 = _t116*_t80;
  const double _t226 = _t18*_t57;
  const double _t227 = _t226*_t78;
  const double _t228 = _hc3[4]*_t11;
  const double _t229 = _t131*_t24;
  const double _t230 = 0.2e1*_hc2[7];
  const double _t231 = _t22*_t70;
  const double _t232 = ((_hc2[4]) * (_hc2[4]))*_t70;
  const double _t233 = _hc2[2]*_t70;
  const double _t234 = _t131*_t52;
  const double _t235 = _hc2[2]*_t234;
  const double _t236 = _t107*_t21;
  const double _t237 = 0.4e1*_t22;
  const double _t238 = _t67*_t69;
  const double _t239 = _t138*(-0.3e1*_hc0[5] - 0.3e1*_hc1[5]);
  const double _t240 = _hc2[4]*_t58;
  const double _t241 = _hc2[2]*_t141;
  const double _t242 = _hc3[0]*_t66;
  const double _t243 = _t242*_t59*_t69;
  const double _t244 = _t139*(-0.7e1 / 0.2e1*_hc0[2] + (0.7e1 / 0.2e1)*_hc1[2])/xc_powi(_t1, 8);
  const double _t245 = _hc3[5]*_t26;
  const double _t246 = 0.4e1*_t131;
  const double _t247 = _hc3[2]*_t58;
  const double _t248 = 0.8e1*_t247;
  const double _t249 = _hc2[8]*_t24;
  const double _t250 = _t116*_t18;
  const double _t251 = 0.8e1*_t58;
  const double _t252 = _t135*_t251;
  const double _t253 = _t123*_t77;
  const double _t254 = _t29*_t48;
  const double _t255 = _hc3[2]*_t115;
  const double _t256 = _hc3[2]*_t77;
  const double _t257 = _hc3[0]*_t72;
  const double _t258 = 0.3e1*_t228;
  const double _t259 = _hc3[1]*_t163;
  const double _t260 = _hc3[5]*_t11;
  const double _t261 = 0.3e1*_t21;
  const double _t262 = _hc2[5]*_t133;
  const double _t263 = _t162*_t67;
  const double _t264 = _t162*_t242;
  const double _t265 = _t159*_t160*_t161*(-0.9e1 / 0.2e1*_hc0[2] + (0.9e1 / 0.2e1)*_hc1[2])/xc_powi(_t1, 10);
  const double _t266 = _hc3[2]*_t169;
  const double _t267 = _hc2[9]*_hc3[0];
  const double _t268 = _t175*_t18;
  const double _t269 = 0.6e1*_t260;
  const double _t270 = 0.4e1*_hc2[9];
  const double _t271 = ((_hc2[5]) * (_hc2[5]))*_t70;
  const double _t272 = xc_powi(M_PI, 10)*((_hc2[2]) * (_hc2[2]) * (_hc2[2]) * (_hc2[2]))/(xc_powi(_t1, 12)*xc_powi(_t4, 5));
  const double _t273 = 0.24e2*_t163;
  const double _t274 = _hc3[0]*_t272;
  const double _t275 = 0.36e2*_t77;
  const double _t276 = _hc2[5]*_t264;
#endif
  ...
  const double d3f_drs_dt2 = 0;
  out[14] = d3f_drs_dt2;
  const double d3f_drs_dz_dt = _hc2[4]*_t100 - _hc3[4]*_t54 + _t101*_t53 - _t103 + _t27*_t63;
  out[15] = d3f_drs_dz_dt;
  const double d3f_drs_dz2 = _t104 + _t106 + _t107*_t108 + _t109*_t22 - _t110*_t29 - _t110*_t45 + _t113 + _t114*_t51 - _t116*_t118 - _t119 + _t121 + _t122*_t18*_t38 - _t123*_t126 - _t127*_t57 + _t25*_t29 + _t25*_t45 - _t61*_t80;
  out[16] = d3f_drs_dz2;
  const double d3f_drs2_dt = _hc2[5]*_t100 + _hc3[8]*_t9 + _t128 + _t129 - _t47*_t72;
  out[17] = d3f_drs2_dt;
  const double d3f_drs2_dz = _hc3[0]*_t144 - _hc3[5]*_t54 + _t116*_t135 + _t130 + _t131*_t132 + _t131*_t137 - _t134*_t22 + _t136*_t21 - _t142 - _t147 - _t150 + _t151 - _t153 + _t18*_t62 + _t18*_t65 - _t18*_t71 + _t74*_t80;
  out[18] = d3f_drs2_dz;
  const double d3f_drs3 = _hc3[9]*_t9 + _t154 + _t156 + _t158 + _t164 - _t167 - _t168 + _t172 + _t174 - _t176 + _t177;
  out[19] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = 0;
  ...
  out[23] = d4f_dz3_dt;
  const double d4f_dz4 = 0.24e2*_hc3[0]*_t178*_t179*_t180*_t3*_t5 + 0.2e1*_hc3[0]*_t178*_t3*_t32*_t33*_t5 + 0.2e1*_hc3[0]*_t18*_t192*_t3*_t32*_t33*_t5 + 0.2e1*_hc3[0]*_t18*_t3*_t32*_t33*_t45*_t5*_t80 + 0.4e1*_hc3[0]*_t18*_t3*_t32*_t33*_t5*_t80*_t83 + 0.4e1*_hc3[0]*_t18*_t3*_t32*_t33*_t5*_t99 + 0.2e1*_hc3[0]*_t182*_t29*_t3*_t32*_t33*_t5 + 0.2e1*_hc3[0]*_t183*_t3*_t32*_t33*_t5 + 0.2e1*_hc3[0]*_t185*_t29*_t3*_t32*_t33*_t5 + 0.2e1*_hc3[0]*_t29*_t3*_t32*_t33*_t45*_t5 + 0.4e1*_hc3[0]*_t29*_t3*_t32*_t33*_t5*_t83 + 0.2e1*_hc3[0]*_t3*_t32*_t33*_t45*_t5*_t83 + 0.2e1*_hc3[0]*_t3*_t32*_t33*_t5*_t76*_t80 - _t178*_t19*_t78 - _t178*_t30 - _t181*_t79 - _t183*_t30 - _t185*_t186 - _t185*_t31 - _t186*_t45 - _t186*_t83 - _t192*_t20 - 0.2e1*_t20*_t99 - _t30*(-_hc2[10]*_t7 - _hc2[3]*_t190*_t6 - _hc2[6]*_t124*_t15 - _t124*_t194*_t97 - _t140*_t96*_t98 - _t16*(-0.3e1 / 0.2e1*_hc0[14] - 0.3e1 / 0.2e1*_hc1[14]) - _t187*_t35 - 0.3e1*_t188*_t193 - _t189*_t97 - 0.3e1*_t191*_t35 - 0.8e1*_t193*_t194 - 0.4e1*_t195*_t93 - _t68*_t98*(-0.5e1 / 0.2e1*_hc0[5] - 0.5e1 / 0.2e1*_hc1[5]) - _t81*_t85 - 0.3e1*_t82*_t85 - _t91*(-0.2e1*_hc0[9] + 0.2e1*_hc1[9])) - _t31*_t45 - _t31*_t83 - _t46*_t83 - _t79*_t80;
  out[24] = d4f_dz4;
  const double d4f_drs_dt3 = 0;
  out[25] = d4f_drs_dt3;
  const double d4f_drs_dz_dt2 = 0;
  out[26] = d4f_drs_dz_dt2;
  const double d4f_drs_dz2_dt = _hc2[4]*_t107*_t47 + _hc2[7]*_t100 + _hc3[4]*_t112 + _t101*_t105 + _t101*_t109 - _t103*_t80 - _t111*_t198 - _t115*_t117*_t27 + _t120*_t198 - _t126*_t27 - _t127*_t198 + _t132*_t197 + _t137*_t197 - _t196*_t29 - _t196*_t45 + _t29*_t49 + _t45*_t49;
  out[27] = d4f_drs_dz2_dt;
  const double d4f_drs_dz3 = _hc2[11]*_t50 - _hc2[2]*_t105*_t209 - _hc2[4]*_t123*_t217*_t53 + _hc2[7]*_t201*_t21 - _hc2[7]*_t209*_t24 + _t104*_t207 + _t106*_t207 + _t108*_t18*_t184*_t52 + _t108*_t23*_t95 - _t110*_t76 - _t110*_t99 + _t113*_t80 - _t115*_t226*_t83 + _t117*_t215 - _t118*_t170*_t80 - _t119*_t80 + _t121*_t181 + _t121*_t80 + _t122*_t85 - _t123*_t218*_t80 + _t13*_t203*_t97 + _t18*_t202*_t95 - _t182*_t61 - _t190*_t220*_t221 + _t195*_t202 + _t199*_t200 + _t203*_t39*_t92 - _t204*_t206 + _t205*_t76 + _t206*_t57 + _t208*_t29 + _t208*_t45 - _t210*_t211 - _t210*_t59 - _t212*_t29 - _t212*_t45 - _t213*_t218 + _t215*_t219 + _t216*_t29 + _t216*_t45 - _t218*_t222 + _t223*_t45 + _t223*_t83 - _t224*_t225 + _t227*_t45 + _t227*_t83 + _t25*_t76 + _t25*_t99 - _t45*_t55 + _t45*_t56 - _t45*_t61 - _t55*_t83 + _t56*_t83 - _t57*_t59*_t99;
  out[28] = d4f_drs_dz3;
  const double d4f_drs2_dt2 = 0;
  out[29] = d4f_drs2_dt2;
  const double d4f_drs2_dz_dt = _hc2[8]*_t100 + _hc3[1]*_t115*_t135 + _hc3[1]*_t144 - _hc3[4]*_t146 - _hc3[8]*_t54 - _t101*_t134 - _t102*_t148 + _t128*_t18 + _t129*_t80 + _t132*_t228 + _t136*_t47 + _t137*_t228 - _t143*_t47 + _t148*_t197 - _t152*_t27 - _t197*_t72 + _t27*_t73;
  out[30] = d4f_drs2_dz_dt;
  const double d4f_drs2_dz2 = _hc2[12]*_t50 + _hc2[4]*_t124*_t234 - _hc2[4]*_t141*_t237 + _hc2[5]*_t109*_t21 - _hc2[5]*_t124*_t220*_t52 + _hc2[5]*_t18*_t236 + _hc2[5]*_t199 + _hc2[7]*_t116*_t233 + _hc2[8]*_t236 + 0.8e1*_hc3[0]*_t240*_t241 + _hc3[0]*_t252*_t80 + _hc3[5]*_t112 - _t111*_t149 + _t111*_t257 + _t114*_t130 - _t114*_t142 + _t116*_t232 + _t118*_t246 - _t118*_t248 + _t120*_t149 - _t120*_t257 + _t123*_t252 + _t124*_t18*_t235 - _t127*_t149 + _t131*_t221*_t38*_t39*_t41 - _t133*_t18*_t237 - 0.24e2*_t135*_t253 + _t143*_t225 + _t143*_t250 - 0.12e2*_t143*_t253 - _t147*_t80 - _t150*_t80 + _t151*_t80 - _t152*_t222 - _t153*_t181 - _t153*_t80 - _t18*_t219*_t248 + _t182*_t74 - 0.2e1*_t21*_t232 + _t211*_t213*_t72 - _t224*_t255 + _t229*_t230 - _t230*_t231 + _t235*_t92 - _t238*_t239 - _t238*_t244 + _t239*_t243 + _t243*_t244 - _t245*_t29 - _t245*_t45 - _t249*_t250 - _t254*_t255 + 0.12e2*_t254*_t256 + _t29*_t62 + _t29*_t65 - _t29*_t71 + _t45*_t62 + _t45*_t65 - _t45*_t71 + _t45*_t74 + _t74*_t83;
  out[31] = d4f_drs2_dz2;
  const double d4f_drs3_dt = _hc2[9]*_t100 + _hc3[1]*_t169*_t171 + _hc3[13]*_t9 + _hc3[4]*_t173 + _hc3[8]*_t155 - _t101*_t166 + _t148*_t258 + _t163*_t47 - _t169*_t259 - _t258*_t72 + _t259*_t78;
  out[32] = d4f_drs3_dt;
  const double d4f_drs3_dz = _hc2[13]*_t50 + _hc2[2]*_t201*_t260 + _hc2[4]*_t214*_t264 + _hc2[5]*_t131*_t201 - 0.3e1*_hc2[5]*_t141*_t22 + _hc2[5]*_t170*_t241 + _hc2[8]*_t170*_t233 - 0.3e1*_hc2[8]*_t231 + _hc2[9]*_t21*_t53 + _hc3[0]*_t265*_t78 - _hc3[5]*_t145*_t169 - _hc3[9]*_t54 + 0.3e1*_t117*_t260 - _t123*_t171*_t214 - 0.6e1*_t131*_t135 + 0.12e2*_t135*_t247 - _t143*_t157 + _t143*_t266 - _t148*_t18*_t266 + _t154*_t18 + _t156*_t18 + _t157*_t249 + _t158*_t18 + _t164*_t18 - _t167*_t18 - _t168*_t18 + _t170*_t262 - _t170*_t265 + _t172*_t18 + _t172*_t80 + _t174*_t18 + _t174*_t80 - _t175*_t60 - _t176*_t80 + _t177*_t181 - 0.18e2*_t18*_t256*_t72 + _t200*_t263 + _t21*_t265 - _t211*_t268 + _t214*_t268 - _t24*_t267*_t60 - 0.18e2*_t240*_t264 - _t261*_t262;
  out[33] = d4f_drs3_dz;
  const double d4f_drs4 = _hc2[14]*_t50 + 0.6e1*_hc2[5]*_t263 + _hc3[14]*_t9 + _hc3[5]*_t217*_t72 + 0.4e1*_hc3[9]*_t63 - 0.12e2*_t131*_t171 + _t148*_t269 + _t163*_t246 + _t170*_t271 + 0.24e2*_t171*_t247 - _t21*_t272 + _t211*_t274 + _t229*_t270 - _t231*_t270 + _t233*_t251*_t267 - _t247*_t273 + _t256*_t273 - _t261*_t271 - _t269*_t72 - _t274*_t275 + 0.14e2*_t274*_t58 + _t275*_t276 - 0.36e2*_t276*_t58;
  out[34] = d4f_drs4;
#endif
}
...
#endif
#if _KMAX >= 3
  const double _t70 = 0.3e1*_t20;
  const double _t71 = _hc2[1]*_t6;
  const double _t72 = _t10*_t71;
  const double _t73 = 0.6e1*_hc1[1];
  const double _t74 = 0.3e1*_t23;
  const double _t75 = 0.3e1*_t21;
  const double _t76 = 0.3e1*_hc1[1];
  const double _t77 = _t27*_t32;
  const double _t78 = _hc0[0]*_hc1[10];
  const double _t79 = _hc0[10]*_hc1[0];
  const double _t80 = _hc0[1]*_hc1[4];
  const double _t81 = _hc0[4]*_hc1[1];
  const double _t82 = -_t78 - _t79 - 0.3e1*_t80 - 0.3e1*_t81;
  const double _t83 = _t10*_t30;
  const double _t84 = _hc2[1]*_t29;
  const double _t85 = 0.3e1*_t84;
  const double _t86 = _t28*_t31;
  const double _t87 = -0.2e1*_t24 - 0.2e1*_t25 - 0.4e1*_t26;
  const double _t88 = _t11*_t29;
  const double _t89 = _t30*_t39;
  const double _t90 = 0.2e1*_t89;
  const double _t91 = -0.3e1*_t8 - 0.3e1*_t9;
  const double _t92 = _t2/(_t1 * _t1 * _t1 * _t1);
  const double _t93 = _hc1[0]*_t92;
  const double _t94 = _t91*_t93;
  const double _t95 = 0.2e1*_t20;
  const double _t96 = _t14*_t71;
  const double _t97 = 0.2e1*_hc1[5];
  const double _t98 = _t32*_t38;
  const double _t99 = 0.2e1*_t84;
  const double _t100 = _hc2[0]*_t28;
  const double _t101 = _t100*_t40;
  const double _t102 = _t14*_t39;
  const double _t103 = _hc0[0]*_hc1[11];
  const double _t104 = _hc0[11]*_hc1[0];
  const double _t105 = _hc0[2]*_hc1[4];
  const double _t106 = _hc0[4]*_hc1[2];
  const double _t107 = 0.2e1*_hc0[1];
  const double _t108 = 0.2e1*_hc0[5];
  const double _t109 = -_hc1[1]*_t108 - _hc1[5]*_t107 - _t103 - _t104 - _t105 - _t106;
  const double _t110 = _hc2[0]*_t94;
  const double _t111 = _hc1[1]*_t32;
  const double _t112 = _t14*_t47;
  const double _t113 = _t100*_t47;
  const double _t114 = _hc0[0]*_hc1[12];
  const double _t115 = _hc0[1]*_hc1[6];
  const double _t116 = _hc0[12]*_hc1[0];
  const double _t117 = _hc0[6]*_hc1[1];
  const double _t118 = -_hc1[2]*_t108 - _hc1[5]*_t45 - _t114 - _t115 - _t116 - _t117;
  const double _t119 = -0.2e1*_t34 - 0.2e1*_t35 - 0.2e1*_t36 - 0.2e1*_t37;
  const double _t120 = 0.3e1*_t42;
  const double _t121 = 0.3e1*_hc1[2];
  const double _t122 = _t32*_t46;
  const double _t123 = _hc0[0]*_hc1[13];
  const double _t124 = _hc0[13]*_hc1[0];
  const double _t125 = 0.3e1*_hc0[2];
  const double _t126 = -_hc0[6]*_t121 - _hc1[6]*_t125 - _t123 - _t124;
  const double _t127 = _t100*_t112;
  const double _t128 = 0.4e1*_hc0[2];
  const double _t129 = -_hc1[2]*_t128 - 0.2e1*_t43 - 0.2e1*_t44;
  const double _t130 = 0.2e1*_t48;
  const double _t131 = -0.3e1*_t12 - 0.3e1*_t13;
  const double _t132 = _hc2[0]*_t93;
  const double _t133 = _t131*_t132;
  const double _t134 = _hc2[4]*_t3;
  const double _t135 = _hc2[4]*_t7;
  const double _t136 = 0.2e1*_t135;
  const double _t137 = _t18*_t71;
  const double _t138 = _hc2[2]*_t6;
  const double _t139 = _t10*_t138;
  const double _t140 = 0.2e1*_hc1[7];
  const double _t141 = _t32*_t56;
  const double _t142 = _hc2[2]*_t29;
  const double _t143 = _t18*_t84;
  const double _t144 = 0.2e1*_t30;
  const double _t145 = _t100*_t30;
  const double _t146 = _t145*_t18;
  const double _t147 = _hc0[0]*_hc1[14];
  const double _t148 = _hc0[14]*_hc1[0];
  const double _t149 = _hc0[3]*_hc1[4];
  const double _t150 = _hc0[4]*_hc1[3];
  const double _t151 = 0.2e1*_hc0[7];
  const double _t152 = -_hc1[1]*_t151 - _hc1[7]*_t107 - _t147 - _t148 - _t149 - _t150;
  const double _t153 = _t110*_t18;
  const double _t154 = _hc1[2]*_t3;
  const double _t155 = _t14*_t7;
  const double _t156 = _hc1[2]*_t18;
  const double _t157 = _hc1[2]*_t138;
  const double _t158 = _hc1[3]*_t71;
  const double _t159 = _hc1[2]*_t32;
  const double _t160 = _hc1[3]*_t32;
  const double _t161 = _hc1[1]*_t18;
  const double _t162 = _t100*_t156;
  const double _t163 = _hc1[3]*_t100;
  const double _t164 = _hc0[0]*_hc1[15];
  const double _t165 = _hc0[1]*_hc1[8];
  const double _t166 = _hc0[15]*_hc1[0];
  const double _t167 = _hc0[2]*_hc1[7];
  const double _t168 = _hc0[3]*_hc1[5];
  const double _t169 = _hc0[5]*_hc1[3];
  const double _t170 = _hc0[7]*_hc1[2];
  const double _t171 = _hc0[8]*_hc1[1];
  const double _t172 = -_t164 - _t165 - _t166 - _t167 - _t168 - _t169 - _t170 - _t171;
  const double _t173 = _t138*_t14;
  const double _t174 = 0.2e1*_hc1[8];
  const double _t175 = _t32*_t62;
  const double _t176 = _t113*_t18;
  const double _t177 = _hc0[0]*_hc1[16];
  const double _t178 = _hc0[16]*_hc1[0];
  const double _t179 = _hc0[3]*_hc1[6];
  const double _t180 = _hc0[6]*_hc1[3];
  const double _t181 = 0.2e1*_hc0[8];
  const double _t182 = -_hc1[2]*_t181 - _hc1[8]*_t45 - _t177 - _t178 - _t179 - _t180;
  const double _t183 = _t133*_t18;
  const double _t184 = _hc2[5]*_t3;
  const double _t185 = 0.2e1*_t49;
  const double _t186 = _hc2[5]*_t7;
  const double _t187 = _t138*_t18;
  const double _t188 = _t100*_t161;
  const double _t189 = _t142*_t18;
  const double _t190 = _hc0[0]*_hc1[17];
  const double _t191 = _hc0[1]*_hc1[9];
  const double _t192 = _hc0[17]*_hc1[0];
  const double _t193 = _hc0[9]*_hc1[1];
  const double _t194 = -_hc1[3]*_t151 - _hc1[7]*_t67 - _t190 - _t191 - _t192 - _t193;
  const double _t195 = _t39*_t69;
  const double _t196 = -0.2e1*_t52 - 0.2e1*_t53 - 0.2e1*_t54 - 0.2e1*_t55;
  const double _t197 = _t142*_t47;
  const double _t198 = 0.2e1*_t197;
  const double _t199 = _hc0[0]*_hc1[18];
  const double _t200 = _hc0[18]*_hc1[0];
  const double _t201 = _hc0[2]*_hc1[9];
  const double _t202 = _hc0[9]*_hc1[2];
  const double _t203 = -_hc1[3]*_t181 - _hc1[8]*_t67 - _t199 - _t200 - _t201 - _t202;
  const double _t204 = -0.2e1*_t58 - 0.2e1*_t59 - 0.2e1*_t60 - 0.2e1*_t61;
  const double _t205 = 0.3e1*_hc1[3];
  const double _t206 = 0.3e1*_t49;
  const double _t207 = 0.3e1*_t186;
  const double _t208 = 0.6e1*_hc1[3];
  const double _t209 = 0.3e1*_t51;
  const double _t210 = 0.3e1*_t50;
  const double _t211 = _t32*_t68;
  const double _t212 = _hc0[0]*_hc1[19];
  const double _t213 = _hc0[19]*_hc1[0];
  const double _t214 = 0.3e1*_hc0[3];
  const double _t215 = -_hc0[9]*_t205 - _hc1[9]*_t214 - _t212 - _t213;
  const double _t216 = 0.3e1*_t189;
  const double _t217 = _t100*_t69;
  const double _t218 = _t18*_t217;
  const double _t219 = 0.4e1*_hc0[3];
  const double _t220 = -_hc1[3]*_t219 - 0.2e1*_t65 - 0.2e1*_t66;
  const double _t221 = 0.2e1*_t195;
  const double _t222 = _t132*_t18;
  const double _t223 = -0.3e1*_t16 - 0.3e1*_t17;
  const double _t224 = _t223*_t69;
#endif
#if _KMAX >= 4
  const double _t225 = 0.4e1*_hc1[10];
  const double _t226 = _t27*_t71;
  const double _t227 = 0.12e2*_hc1[1];
  const double _t228 = 0.6e1*_hc1[4];
  const double _t229 = 0.4e1*_hc1[1];
  const double _t230 = _hc2[1]*_t28;
  const double _t231 = _t230*_t83;
  const double _t232 = 0.4e1*_hc0[1];
  const double _t233 = 0.8e1*_t27;
  const double _t234 = _t30*_t84;
  const double _t235 = _t11*_t87;
  const double _t236 = _t235*_t28;
  const double _t237 = -0.2e1*_t78 - 0.2e1*_t79 - 0.6e1*_t80 - 0.6e1*_t81;
  const double _t238 = 0.3e1*_t89;
  const double _t239 = _t39*_t87;
  const double _t240 = 0.3e1*_t27;
  const double _t241 = _hc2[1]*_t94;
  const double _t242 = _t91*_t92;
  const double _t243 = _t242*_t31;
  const double _t244 = -0.3e1*_t24 - 0.3e1*_t25 - 0.6e1*_t26;
  const double _t245 = _t110*_t30;
  const double _t246 = 0.2e1*_t94;
  const double _t247 = _hc1[0]*_t2/xc_powi(_t1, 5);
  const double _t248 = _t247*(-0.4e1*_t8 - 0.4e1*_t9);
  const double _t249 = _t248*_t91;
  const double _t250 = 0.3e1*_t96;
  const double _t251 = 0.6e1*_t72;
  const double _t252 = 0.3e1*_hc1[5];
  const double _t253 = _t38*_t71;
  const double _t254 = _hc1[4]*_t32;
  const double _t255 = 0.3e1*_t38;
  const double _t256 = _t230*_t30;
  const double _t257 = 0.3e1*_hc1[4];
  const double _t258 = _t14*_t87;
  const double _t259 = _t100*_t258;
  const double _t260 = _t145*_t27;
  const double _t261 = _t109*_t32;
  const double _t262 = 0.6e1*_t234;
  const double _t263 = _t145*_t38;
  const double _t264 = 0.3e1*_t241;
  const double _t265 = _hc2[0]*_t242;
  const double _t266 = _t265*_t40;
  const double _t267 = _t132*_t244;
  const double _t268 = 0.2e1*_t110;
  const double _t269 = 0.3e1*_hc0[1];
  const double _t270 = 0.3e1*_hc0[5];
  const double _t271 = _hc2[0]*_t249;
  const double _t272 = 0.2e1*_t42;
  const double _t273 = 0.2e1*_t23;
  const double _t274 = 0.4e1*_hc1[5];
  const double _t275 = 0.2e1*_t72;
  const double _t276 = _t46*_t71;
  const double _t277 = 0.4e1*_hc1[2];
  const double _t278 = _t112*_t230;
  const double _t279 = _t230*_t40;
  const double _t280 = _t30*_t46;
  const double _t281 = _t100*_t19;
  const double _t282 = _t118*_t32;
  const double _t283 = _t47*_t84;
  const double _t284 = 0.2e1*_t38;
  const double _t285 = _t119*_t14;
  const double _t286 = _t113*_t38;
  const double _t287 = _hc2[1]*_t246;
  const double _t288 = _t112*_t265;
  const double _t289 = -_hc0[5]*_t229 - _hc1[5]*_t232 - 0.2e1*_t103 - 0.2e1*_t104 - 0.2e1*_t105 - 0.2e1*_t106;
  const double _t290 = _t119*_t39;
  const double _t291 = _t110*_t47;
  const double _t292 = 0.4e1*_hc0[5];
  const double _t293 = _hc1[6]*_t32;
  const double _t294 = _t129*_t14;
  const double _t295 = _t100*_t129;
  const double _t296 = 0.2e1*_t46;
  const double _t297 = _t113*_t46;
  const double _t298 = _t100*_t121;
  const double _t299 = _hc2[1]*_t93;
  const double _t300 = _t112*_t131;
  const double _t301 = _t33*_t47;
  const double _t302 = _hc2[0]*_t92;
  const double _t303 = _t131*_t302;
  const double _t304 = _t129*_t39;
  const double _t305 = -_hc1[2]*_t292 - _hc1[5]*_t128 - 0.2e1*_t114 - 0.2e1*_t115 - 0.2e1*_t116 - 0.2e1*_t117;
  const double _t306 = _t133*_t47;
  const double _t307 = -0.3e1*_t34 - 0.3e1*_t35 - 0.3e1*_t36 - 0.3e1*_t37;
  const double _t308 = _t112*_t132;
  const double _t309 = _hc2[0]*_t300;
  const double _t310 = 0.6e1*_hc1[6];
  const double _t311 = 0.6e1*_hc1[2];
  const double _t312 = -_hc0[2]*_t310 - _hc0[6]*_t311 - 0.2e1*_t123 - 0.2e1*_t124;
  const double _t313 = 0.3e1*_t48;
  const double _t314 = 0.3e1*_t46;
  const double _t315 = -_hc0[2]*_t311 - 0.3e1*_t43 - 0.3e1*_t44;
  const double _t316 = 0.2e1*_t133;
  const double _t317 = _t247*(-0.4e1*_t12 - 0.4e1*_t13);
  const double _t318 = 0.3e1*_t134;
  const double _t319 = _hc2[4]*_t6;
  const double _t320 = _t10*_t319;
  const double _t321 = 0.3e1*_t135;
  const double _t322 = _t138*_t27;
  const double _t323 = 0.3e1*_hc1[7];
  const double _t324 = _t56*_t71;
  const double _t325 = 0.3e1*_t56;
  const double _t326 = _hc2[4]*_t29;
  const double _t327 = 0.3e1*_t326;
  const double _t328 = _t18*_t256;
  const double _t329 = _hc2[2]*_t28;
  const double _t330 = _t329*_t83;
  const double _t331 = _t142*_t87;
  const double _t332 = _t142*_t144;
  const double _t333 = _t100*_t18;
  const double _t334 = _t333*_t87;
  const double _t335 = _t152*_t32;
  const double _t336 = _t145*_t56;
  const double _t337 = _hc2[2]*_t94;
  const double _t338 = _t18*_t30;
  const double _t339 = _t265*_t338;
  const double _t340 = _t222*_t244;
  const double _t341 = 0.2e1*_t153;
  const double _t342 = 0.3e1*_hc0[7];
  const double _t343 = 0.2e1*_t134;
  const double _t344 = _t14*_t319;
  const double _t345 = _t62*_t71;
  const double _t346 = _t138*_t38;
  const double _t347 = _hc1[2]*_t10;
  const double _t348 = _t30*_t329;
  const double _t349 = _hc1[4]*_t18;
  const double _t350 = 0.2e1*_t326;
  const double _t351 = _t18*_t47;
  const double _t352 = _t230*_t351;
  const double _t353 = _t329*_t40;
  const double _t354 = _t14*_t163;
  const double _t355 = _t62*_t84;
  const double _t356 = 0.2e1*_t56;
  const double _t357 = 0.2e1*_t143;
  const double _t358 = _t19*_t62;
  const double _t359 = _t113*_t56;
  const double _t360 = _t18*_t281;
  const double _t361 = _t156*_t265;
  const double _t362 = _t265*_t351;
  const double _t363 = _t172*_t32;
  const double _t364 = _t138*_t46;
  const double _t365 = _t112*_t29;
  const double _t366 = _hc1[3]*_t112;
  const double _t367 = _hc1[6]*_t18;
  const double _t368 = 0.2e1*_t62;
  const double _t369 = _t145*_t62;
  const double _t370 = _t119*_t333;
  const double _t371 = _t131*_t299;
  const double _t372 = _t161*_t303;
  const double _t373 = _t222*_t47;
  const double _t374 = _t131*_t351;
  const double _t375 = _hc2[0]*_t248;
  const double _t376 = 0.3e1*_t173;
  const double _t377 = 0.3e1*_hc1[8];
  const double _t378 = 0.3e1*_t62;
  const double _t379 = _t112*_t329;
  const double _t380 = _t18*_t295;
  const double _t381 = _t182*_t32;
  const double _t382 = _t113*_t62;
  const double _t383 = _hc2[2]*_t93;
  const double _t384 = _t303*_t351;
  const double _t385 = 0.3e1*_hc0[8];
  const double _t386 = _hc2[0]*_t317;
  const double _t387 = _hc2[8]*_t3;
  const double _t388 = 0.4e1*_hc1[7];
  const double _t389 = _t10*_t7;
  const double _t390 = _t18*_t319;
  const double _t391 = _hc2[5]*_t6;
  const double _t392 = _t10*_t391;
  const double _t393 = 0.2e1*_t51;
  const double _t394 = 0.4e1*_hc1[3];
  const double _t395 = 0.2e1*_t187;
  const double _t396 = _t68*_t71;
  const double _t397 = 0.4e1*_t56;
  const double _t398 = _t138*_t56;
  const double _t399 = _hc2[5]*_t29;
  const double _t400 = _t230*_t69;
  const double _t401 = _t18*_t400;
  const double _t402 = _t18*_t348;
  const double _t403 = _t68*_t99;
  const double _t404 = 0.2e1*_t18;
  const double _t405 = _t145*_t68;
  const double _t406 = _t194*_t32;
  const double _t407 = _t56*_t69;
  const double _t408 = _t142*_t30;
  const double _t409 = _t217*_t56;
  const double _t410 = _t18*_t69;
  const double _t411 = _t265*_t410;
  const double _t412 = _t39*_t56;
  const double _t413 = 0.2e1*_t196;
  const double _t414 = _t110*_t69;
  const double _t415 = 0.4e1*_hc0[7];
  const double _t416 = _t138*_t62;
  const double _t417 = _t329*_t351;
  const double _t418 = _t113*_t68;
  const double _t419 = _t217*_t62;
  const double _t420 = 0.2e1*_t189;
  const double _t421 = _t39*_t62;
  const double _t422 = _t222*_t69;
  const double _t423 = _t131*_t410;
  const double _t424 = _t14*_t391;
  const double _t425 = 0.4e1*_hc1[8];
  const double _t426 = _t203*_t32;
  const double _t427 = _t204*_t333;
  const double _t428 = _t303*_t410;
  const double _t429 = 0.2e1*_t204;
  const double _t430 = 0.4e1*_hc0[8];
  const double _t431 = _hc2[9]*_t3;
  const double _t432 = _t18*_t7;
  const double _t433 = _t18*_t391;
  const double _t434 = 0.6e1*_t187;
  const double _t435 = 0.3e1*_hc1[9];
  const double _t436 = _t138*_t68;
  const double _t437 = 0.3e1*_t399;
  const double _t438 = _t329*_t410;
  const double _t439 = 0.3e1*_t68;
  const double _t440 = _t217*_t68;
  const double _t441 = _t142*_t69;
  const double _t442 = _t18*_t224;
  const double _t443 = _t224*_t302;
  const double _t444 = _t39*_t68;
  const double _t445 = _t132*_t224;
  const double _t446 = _t222*_t223;
  const double _t447 = 0.4e1*_hc1[19];
  const double _t448 = 0.6e1*_hc1[9];
  const double _t449 = 0.12e2*_hc1[3];
  const double _t450 = 0.8e1*_t68;
#endif
...
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _hc1[4]*_t5 + _t10*_t22 + _t15*_t27 + _t19*_t20 + _t19*_t23 + _t29*_t31;
  out[4] = d2f_dt2;
...
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _hc1[10]*_t5 + _hc1[4]*_t70 + _hc1[4]*_t74 + _t15*_t82 + _t27*_t75 + _t27*_t90 + _t31*_t94 + _t72*_t73 + _t76*_t77 + _t76*_t86 + _t83*_t85 + _t87*_t88;
  out[10] = d3f_dt3;
  const double d3f_dz_dt2 = _hc1[11]*_t5 + _hc1[2]*_t77 + _hc1[2]*_t86 + _hc1[4]*_t42 + _hc1[5]*_t95 + _t101*_t19 + _t102*_t87 + _t109*_t15 + _t110*_t40 + _t19*_t96 + _t19*_t98 + _t22*_t38 + _t23*_t97 + _t38*_t90 + _t40*_t99 + _t41*_t72;
  out[11] = d3f_dz_dt2;
  const double d3f_dz2_dt = _hc1[12]*_t5 + _hc1[6]*_t20 + _hc1[6]*_t23 + _t101*_t41 + _t102*_t119 + _t110*_t112 + _t111*_t46 + _t112*_t84 + _t113*_t33 + _t118*_t15 + _t21*_t46 + _t38*_t48 + _t41*_t96 + _t41*_t98 + _t42*_t97 + _t46*_t89;
  out[12] = d3f_dz2_dt;
  const double d3f_dz3 = _hc1[13]*_t5 + _hc1[6]*_t120 + _t102*_t129 + _t112*_t133 + _t121*_t122 + _t121*_t127 + _t126*_t15 + _t130*_t46;
  out[13] = d3f_dz3;
  const double d3f_drs_dt2 = _hc1[14]*_t5 + _hc1[3]*_t77 + _hc1[3]*_t86 + _hc1[4]*_t49 + _hc1[4]*_t51 + _hc1[7]*_t95 + _t10*_t136 + _t134*_t19 + _t137*_t19 + _t139*_t19 + _t140*_t23 + _t141*_t19 + _t142*_t83 + _t143*_t144 + _t146*_t19 + _t15*_t152 + _t153*_t30 + _t22*_t56 + _t27*_t50 + _t56*_t90 + _t57*_t87 + _t63*_t72;
  out[14] = d3f_drs_dt2;
  const double d3f_drs_dz_dt = _hc1[15]*_t5 + _hc1[5]*_t49 + _hc1[5]*_t51 + _hc1[7]*_t42 + _hc1[8]*_t20 + _hc1[8]*_t23 + _hc2[4]*_t154 + _hc2[4]*_t155 + _t10*_t157 + _t111*_t62 + _t113*_t161 + _t119*_t57 + _t138*_t33 + _t14*_t158 + _t142*_t40 + _t143*_t47 + _t15*_t172 + _t153*_t47 + _t156*_t71 + _t159*_t56 + _t160*_t38 + _t162*_t30 + _t163*_t40 + _t21*_t62 + _t38*_t50 + _t48*_t56 + _t62*_t89;
  out[15] = d3f_drs_dz_dt;
  const double d3f_drs_dz2 = _hc1[16]*_t5 + _hc1[6]*_t49 + _hc1[6]*_t51 + _t112*_t142 + _t112*_t163 + _t129*_t57 + _t130*_t62 + _t15*_t182 + _t160*_t46 + _t173*_t41 + _t174*_t42 + _t175*_t41 + _t176*_t41 + _t183*_t47 + _t46*_t50;
  out[16] = d3f_drs_dz2;
  const double d3f_drs2_dt = _hc1[1]*_t184 + _hc1[17]*_t5 + _hc1[7]*_t185 + _hc1[9]*_t20 + _hc1[9]*_t23 + _hc2[8]*_t4 + _t10*_t186 + _t111*_t68 + _t134*_t63 + _t136*_t18 + _t137*_t63 + _t139*_t63 + _t140*_t51 + _t141*_t63 + _t143*_t69 + _t144*_t189 + _t146*_t63 + _t15*_t194 + _t153*_t69 + _t187*_t19 + _t188*_t69 + _t195*_t56 + _t196*_t57 + _t21*_t68 + _t56*_t64 + _t68*_t89;
  out[17] = d3f_drs2_dt;
  const double d3f_drs2_dz = _hc1[18]*_t5 + _hc1[8]*_t185 + _hc1[9]*_t42 + _hc2[5]*_t154 + _hc2[5]*_t155 + _t15*_t203 + _t159*_t68 + _t162*_t69 + _t173*_t63 + _t174*_t51 + _t175*_t63 + _t176*_t63 + _t18*_t198 + _t183*_t69 + _t187*_t41 + _t195*_t62 + _t204*_t57 + _t48*_t68 + _t62*_t64;
  out[18] = d3f_drs2_dz;
  const double d3f_drs3 = _hc1[19]*_t5 + _hc1[9]*_t206 + _hc1[9]*_t209 + _hc2[9]*_t4 + _t15*_t215 + _t18*_t207 + _t184*_t205 + _t187*_t208 + _t205*_t211 + _t205*_t218 + _t210*_t68 + _t216*_t69 + _t220*_t57 + _t221*_t68 + _t222*_t224;
  out[19] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = _hc1[1]*_t145*_t233 + _hc1[20]*_t5 + 0.12e2*_hc1[4]*_t72 + 0.4e1*_t10*_t84*_t87 + _t15*(-_hc0[0]*_hc1[20] - _hc0[10]*_t229 - _hc0[20]*_hc1[0] - _hc0[4]*_t228 - _hc1[10]*_t232) + _t20*_t225 + 0.4e1*_t21*_t82 + _t225*_t23 + _t226*_t227 + _t227*_t231 + _t228*_t77 + _t228*_t86 + _t229*_t236 + _t229*_t243 + _t229*_t32*_t82 + _t233*_t234 + _t235*_t246 + _t237*_t88 + _t238*_t82 + _t239*_t240 + _t240*_t245 + 0.4e1*_t241*_t83 + _t244*_t31*_t93 + _t249*_t31;
  out[20] = d4f_dt4;
  const double d4f_dz_dt3 = _hc1[10]*_t42 + _hc1[11]*_t70 + _hc1[11]*_t74 + _hc1[2]*_t236 + _hc1[2]*_t243 + _hc1[21]*_t5 + _hc1[4]*_t250 + _hc1[5]*_t251 + _t101*_t257 + _t102*_t237 + _t109*_t238 + _t109*_t75 + _t121*_t226 + _t121*_t231 + _t15*(-_hc0[0]*_hc1[21] - _hc0[10]*_hc1[2] - _hc0[11]*_t76 - _hc0[2]*_hc1[10] - _hc0[21]*_hc1[0] - _hc0[4]*_t252 - _hc1[11]*_t269 - _hc1[4]*_t270) + _t159*_t82 + _t239*_t255 + _t245*_t255 + _t252*_t77 + _t252*_t86 + _t253*_t73 + _t254*_t255 + 0.6e1*_t256*_t33 + _t258*_t268 + _t258*_t85 + _t259*_t76 + _t260*_t41 + _t261*_t76 + _t262*_t38 + _t263*_t73 + _t264*_t40 + _t266*_t76 + _t267*_t40 + _t271*_t40;
  out[21] = d4f_dz_dt3;
  const double d4f_dz2_dt2 = _hc1[11]*_t272 + _hc1[12]*_t273 + _hc1[12]*_t95 + _hc1[22]*_t5 + _hc1[4]*_t127 + _hc1[6]*_t275 + _hc1[6]*_t77 + _hc1[6]*_t86 + _t101*_t274 + _t102*_t289 + _t109*_t48 + _t110*_t280 + _t112*_t267 + _t112*_t271 + _t112*_t287 + _t118*_t22 + _t118*_t90 + _t15*(-_hc0[0]*_hc1[22] - _hc0[11]*_t41 - _hc0[12]*_t19 - _hc0[22]*_hc1[0] - _hc0[4]*_hc1[6] - _hc0[6]*_hc1[4] - _hc1[11]*_t45 - _hc1[12]*_t107 - _hc1[5]*_t292) + _t19*_t276 + _t19*_t278 + _t19*_t282 + _t19*_t286 + _t19*_t288 + _t239*_t46 + _t253*_t277 + _t254*_t46 + _t259*_t41 + _t261*_t41 + _t263*_t277 + _t266*_t41 + _t268*_t285 + _t274*_t96 + _t274*_t98 + _t277*_t279 + _t280*_t281 + _t280*_t99 + _t281*_t285 + _t283*_t284 + _t284*_t290 + _t284*_t291 + _t285*_t99;
  out[22] = d4f_dz2_dt2;
  const double d4f_dz3_dt = _hc1[12]*_t120 + _hc1[13]*_t20 + _hc1[13]*_t23 + _hc1[23]*_t5 + 0.3e1*_hc1[6]*_t101 + _hc1[6]*_t250 + _t102*_t305 + _t110*_t294 + _t111*_t126 + _t118*_t130 + _t121*_t276 + _t121*_t278 + _t121*_t282 + _t121*_t286 + _t121*_t288 + _t122*_t252 + _t126*_t21 + _t126*_t89 + _t127*_t252 + _t133*_t285 + _t15*(-_hc0[0]*_hc1[23] - _hc0[1]*_hc1[13] - _hc0[12]*_t121 - _hc0[13]*_hc1[1] - _hc0[23]*_hc1[0] - _hc0[6]*_t252 - _hc1[12]*_t125 - _hc1[6]*_t270) + _t19*_t297 + _t248*_t309 + _t255*_t293 + _t280*_t298 + _t283*_t296 + _t285*_t298 + _t290*_t296 + _t291*_t296 + _t294*_t84 + _t295*_t33 + _t299*_t300 + _t301*_t303 + _t304*_t38 + _t306*_t38 + _t307*_t308;
  out[23] = d4f_dz3_dt;
  const double d4f_dz4 = 0.4e1*_hc1[13]*_t42 + 0.8e1*_hc1[2]*_t297 + _hc1[24]*_t5 + _t100*_t277*_t294 + _t102*_t312 + _t122*_t310 + _t126*_t277*_t32 + _t126*_t313 + _t127*_t310 + _t15*(-_hc0[0]*_hc1[24] - _hc0[13]*_t277 - _hc0[24]*_hc1[0] - _hc0[6]*_t310 - _hc1[13]*_t128) + _t277*_t300*_t302 + _t294*_t316 + _t304*_t314 + _t306*_t314 + _t308*_t315 + _t309*_t317;
  out[24] = d4f_dz4;
  const double d4f_drs_dt3 = _hc1[10]*_t49 + _hc1[10]*_t51 + _hc1[14]*_t70 + _hc1[14]*_t74 + _hc1[25]*_t5 + _hc1[3]*_t236 + _hc1[3]*_t243 + _hc1[4]*_t318 + _hc1[7]*_t251 + _t10*_t331 + _t137*_t257 + _t139*_t257 + 0.3e1*_t143*_t87 + _t146*_t257 + _t15*(-_hc0[0]*_hc1[25] - _hc0[10]*_hc1[3] - _hc0[14]*_t76 - _hc0[25]*_hc1[0] - _hc0[3]*_hc1[10] - _hc0[4]*_t323 - _hc1[14]*_t269 - _hc1[4]*_t342) + _t152*_t238 + _t152*_t75 + _t160*_t82 + _t205*_t226 + _t205*_t231 + _t237*_t57 + _t239*_t325 + _t245*_t325 + _t254*_t325 + _t260*_t63 + _t262*_t56 + _t264*_t338 + _t27*_t321 + _t27*_t332 + _t271*_t338 + _t30*_t340 + _t320*_t73 + _t322*_t76 + _t323*_t77 + _t323*_t86 + _t324*_t73 + _t327*_t83 + _t328*_t73 + _t330*_t76 + _t334*_t76 + _t335*_t76 + _t336*_t73 + _t337*_t83 + _t339*_t76 + _t341*_t87 + _t50*_t82;
  out[25] = d4f_drs_dt3;
  const double d4f_drs_dz_dt2 = _hc1[11]*_t49 + _hc1[11]*_t51 + _hc1[14]*_t42 + _hc1[15]*_t273 + _hc1[15]*_t95 + _hc1[26]*_t5 + _hc1[3]*_t266 + _hc1[4]*_t173 + _hc1[5]*_t343 + _hc1[8]*_t77 + _hc1[8]*_t86 + _t101*_t140 + _t109*_t160 + _t109*_t50 + _t113*_t349 + _t119*_t341 + _t119*_t357 + _t119*_t360 + _t136*_t38 + _t137*_t97 + _t139*_t97 + _t14*_t331 + _t140*_t96 + _t140*_t98 + _t141*_t97 + _t144*_t355 + _t145*_t358 + _t146*_t97 + _t15*(-_hc0[0]*_hc1[26] - _hc0[11]*_hc1[3] - _hc0[14]*_hc1[2] - _hc0[15]*_t19 - _hc0[2]*_hc1[14] - _hc0[26]*_hc1[0] - _hc0[3]*_hc1[11] - _hc0[4]*_hc1[8] - _hc0[8]*_hc1[4] - _hc1[15]*_t107 - _hc1[5]*_t151 - _hc1[7]*_t108) + _t152*_t159 + _t152*_t48 + _t157*_t27 + _t162*_t87 + _t172*_t22 + _t172*_t90 + _t174*_t72 + _t19*_t344 + _t19*_t345 + _t19*_t346 + _t19*_t352 + _t19*_t353 + _t19*_t359 + _t19*_t362 + _t19*_t363 + _t239*_t62 + _t245*_t62 + _t253*_t63 + _t254*_t62 + _t263*_t63 + _t271*_t351 + _t279*_t63 + _t283*_t356 + _t287*_t351 + _t289*_t57 + _t290*_t356 + _t291*_t356 + _t30*_t361 + _t320*_t41 + _t324*_t41 + _t328*_t41 + _t332*_t38 + _t336*_t41 + _t337*_t40 + _t340*_t47 + _t347*_t348 + _t350*_t40 + _t354*_t87;
  out[26] = d4f_drs_dz_dt2;
  const double d4f_drs_dz2_dt = _hc1[1]*_t364 + _hc1[12]*_t49 + _hc1[12]*_t51 + _hc1[15]*_t272 + _hc1[16]*_t20 + _hc1[16]*_t23 + _hc1[27]*_t5 + _hc1[3]*_t286 + _hc1[6]*_t134 + _hc1[6]*_t137 + _hc1[6]*_t139 + _hc1[7]*_t122 + _hc1[7]*_t127 + _hc2[4]*_t365 + _t101*_t174 + _t111*_t182 + _t112*_t337 + _t113*_t358 + _t118*_t160 + _t118*_t50 + _t119*_t183 + _t119*_t354 + _t129*_t143 + _t129*_t153 + _t129*_t188 + _t130*_t172 + _t135*_t46 + _t142*_t280 + _t142*_t285 + _t145*_t367 + _t15*(-_hc0[0]*_hc1[27] - _hc0[1]*_hc1[16] - _hc0[12]*_hc1[3] - _hc0[15]*_t41 - _hc0[16]*_hc1[1] - _hc0[27]*_hc1[0] - _hc0[3]*_hc1[12] - _hc0[6]*_hc1[7] - _hc0[7]*_hc1[6] - _hc1[15]*_t45 - _hc1[5]*_t181 - _hc1[8]*_t108) + _t158*_t46 + _t163*_t280 + _t173*_t97 + _t174*_t96 + _t174*_t98 + _t175*_t97 + _t176*_t97 + _t182*_t21 + _t182*_t89 + _t197*_t38 + _t230*_t366 + _t265*_t366 + _t283*_t368 + _t290*_t368 + _t291*_t368 + _t293*_t56 + _t301*_t329 + _t304*_t56 + _t305*_t57 + _t306*_t56 + _t307*_t373 + _t344*_t41 + _t345*_t41 + _t346*_t41 + _t351*_t371 + _t352*_t41 + _t353*_t41 + _t359*_t41 + _t362*_t41 + _t363*_t41 + _t369*_t41 + _t370*_t41 + _t372*_t47 + _t374*_t375;
  out[27] = d4f_drs_dz2_dt;
  const double d4f_drs_dz3 = _hc1[13]*_t49 + _hc1[13]*_t51 + _hc1[16]*_t120 + _hc1[28]*_t5 + _hc1[6]*_t376 + 0.3e1*_t113*_t367 + _t121*_t364 + _t121*_t379 + _t121*_t380 + _t121*_t381 + _t121*_t384 + _t122*_t377 + _t126*_t160 + _t126*_t50 + _t127*_t377 + 0.2e1*_t129*_t183 + _t142*_t294 + _t15*(-_hc0[0]*_hc1[28] - _hc0[13]*_hc1[3] - _hc0[16]*_t121 - _hc0[28]*_hc1[0] - _hc0[3]*_hc1[13] - _hc0[6]*_t377 - _hc1[16]*_t125 - _hc1[6]*_t385) + _t163*_t294 + _t182*_t313 + _t198*_t46 + _t293*_t378 + _t297*_t63 + _t300*_t383 + _t303*_t366 + _t304*_t378 + _t306*_t378 + _t311*_t382 + _t312*_t57 + _t315*_t373 + _t374*_t386;
  out[28] = d4f_drs_dz3;
  const double d4f_drs2_dt2 = _hc1[14]*_t185 + _hc1[14]*_t393 + _hc1[17]*_t273 + _hc1[17]*_t95 + _hc1[29]*_t5 + _hc1[4]*_t184 + _hc1[4]*_t395 + _hc1[9]*_t275 + _hc1[9]*_t77 + _hc1[9]*_t86 + 0.2e1*_hc2[8]*_t389 + _t134*_t388 + _t135*_t397 + _t137*_t388 + _t139*_t388 + _t141*_t388 + _t144*_t18*_t337 + _t146*_t388 + _t15*(-_hc0[0]*_hc1[29] - _hc0[14]*_t63 - _hc0[17]*_t19 - _hc0[29]*_hc1[0] - _hc0[4]*_hc1[9] - _hc0[9]*_hc1[4] - _hc1[14]*_t67 - _hc1[17]*_t107 - _hc1[7]*_t415) + _t152*_t195 + _t152*_t64 + _t153*_t413 + _t186*_t27 + _t19*_t387 + _t19*_t392 + _t19*_t396 + _t19*_t401 + _t19*_t405 + _t19*_t406 + _t19*_t409 + _t19*_t411 + _t194*_t22 + _t194*_t90 + _t196*_t357 + _t196*_t360 + _t217*_t349 + _t229*_t390 + _t229*_t398 + _t229*_t402 + _t239*_t68 + _t241*_t404*_t69 + _t245*_t68 + _t254*_t68 + _t271*_t410 + _t30*_t403 + _t320*_t394 + _t322*_t63 + _t324*_t394 + 0.4e1*_t326*_t338 + _t328*_t394 + _t330*_t63 + _t331*_t404 + _t334*_t63 + _t335*_t63 + _t336*_t394 + _t339*_t63 + _t340*_t69 + _t356*_t414 + _t397*_t408 + _t399*_t83 + _t407*_t99 + _t412*_t413 + _t57*(-_hc0[7]*_t229 - _hc1[7]*_t232 - 0.2e1*_t147 - 0.2e1*_t148 - 0.2e1*_t149 - 0.2e1*_t150);
  out[29] = d4f_drs2_dt2;
  const double d4f_drs2_dz_dt = _hc1[1]*_t418 + _hc1[1]*_t419 + _hc1[15]*_t185 + _hc1[15]*_t393 + _hc1[17]*_t42 + _hc1[18]*_t20 + _hc1[18]*_t23 + _hc1[2]*_t396 + _hc1[2]*_t405 + _hc1[2]*_t409 + _hc1[30]*_t5 + _hc1[5]*_t184 + _hc1[5]*_t211 + _hc1[5]*_t218 + _hc1[8]*_t343 + _hc1[9]*_t101 + _hc1[9]*_t96 + _hc1[9]*_t98 + _hc2[8]*_t154 + _hc2[8]*_t155 + _t111*_t203 + _t119*_t420 + _t133*_t407 + _t136*_t62 + _t137*_t174 + _t139*_t174 + _t140*_t173 + _t140*_t175 + _t140*_t176 + _t141*_t174 + _t143*_t204 + _t146*_t174 + _t15*(-_hc0[0]*_hc1[30] - _hc0[1]*_hc1[18] - _hc0[15]*_t63 - _hc0[17]*_hc1[2] - _hc0[18]*_hc1[1] - _hc0[2]*_hc1[17] - _hc0[30]*_hc1[0] - _hc0[5]*_hc1[9] - _hc0[9]*_hc1[5] - _hc1[15]*_t67 - _hc1[7]*_t181 - _hc1[8]*_t151) + _t153*_t204 + _t156*_t400 + _t159*_t194 + _t162*_t196 + _t172*_t195 + _t172*_t64 + _t183*_t196 + _t186*_t38 + _t187*_t97 + _t188*_t204 + _t19*_t416 + _t19*_t417 + _t194*_t48 + _t196*_t421 + _t198*_t56 + _t203*_t21 + _t203*_t89 + _t204*_t412 + _t283*_t68 + _t290*_t68 + _t291*_t68 + _t307*_t422 + _t33*_t391 + _t332*_t62 + 0.2e1*_t337*_t351 + _t344*_t63 + _t345*_t63 + _t346*_t63 + _t347*_t391 + _t350*_t351 + _t352*_t63 + _t353*_t63 + _t355*_t69 + _t359*_t63 + _t361*_t69 + _t362*_t63 + _t363*_t63 + _t369*_t63 + _t370*_t63 + _t371*_t410 + _t372*_t69 + _t375*_t423 + _t390*_t41 + _t398*_t41 + _t399*_t40 + _t402*_t41 + _t414*_t62 + _t57*(-0.2e1*_t164 - 0.2e1*_t165 - 0.2e1*_t166 - 0.2e1*_t167 - 0.2e1*_t168 - 0.2e1*_t169 - 0.2e1*_t170 - 0.2e1*_t171);
  out[30] = d4f_drs2_dz_dt;
  const double d4f_drs2_dz2 = _hc1[16]*_t185 + _hc1[16]*_t393 + _hc1[18]*_t272 + _hc1[31]*_t5 + _hc1[6]*_t184 + _hc1[6]*_t395 + _hc1[9]*_t122 + _hc1[9]*_t127 + _hc2[5]*_t365 + _t129*_t420 + _t130*_t203 + _t133*_t368*_t69 + _t15*(-_hc0[0]*_hc1[31] - _hc0[16]*_t63 - _hc0[18]*_t41 - _hc0[31]*_hc1[0] - _hc0[6]*_hc1[9] - _hc0[9]*_hc1[6] - _hc1[16]*_t67 - _hc1[18]*_t45 - _hc1[8]*_t430) + _t173*_t425 + _t175*_t425 + _t176*_t425 + _t182*_t195 + _t182*_t64 + _t183*_t429 + _t186*_t46 + 0.4e1*_t197*_t62 + _t217*_t367 + _t277*_t416 + _t277*_t417 + _t293*_t68 + _t304*_t68 + _t306*_t68 + _t315*_t422 + _t364*_t63 + 0.2e1*_t374*_t383 + _t379*_t63 + _t380*_t63 + _t381*_t63 + _t382*_t394 + _t384*_t63 + _t386*_t423 + _t41*_t418 + _t41*_t419 + _t41*_t424 + _t41*_t426 + _t41*_t427 + _t41*_t428 + _t421*_t429 + _t57*(-_hc0[8]*_t277 - _hc1[8]*_t128 - 0.2e1*_t177 - 0.2e1*_t178 - 0.2e1*_t179 - 0.2e1*_t180);
  out[31] = d4f_drs2_dz2;
  const double d4f_drs3_dt = _hc1[1]*_t431 + _hc1[17]*_t206 + _hc1[17]*_t209 + _hc1[19]*_t20 + _hc1[19]*_t23 + _hc1[32]*_t5 + _hc1[7]*_t434 + _hc1[9]*_t318 + _hc2[13]*_t4 + 0.3e1*_hc2[8]*_t432 + _hc2[9]*_t389 + _t111*_t215 + _t137*_t435 + _t139*_t435 + _t141*_t435 + _t143*_t220 + _t146*_t435 + _t15*(-_hc0[0]*_hc1[32] - _hc0[1]*_hc1[19] - _hc0[17]*_t205 - _hc0[19]*_hc1[1] - _hc0[32]*_hc1[0] - _hc0[9]*_t323 - _hc1[17]*_t214 - _hc1[9]*_t342) + _t153*_t220 + _t161*_t443 + _t184*_t323 + _t188*_t220 + _t19*_t440 + _t194*_t210 + _t194*_t221 + _t196*_t205*_t333 + _t196*_t216 + _t196*_t446 + _t205*_t387 + _t205*_t392 + _t205*_t396 + _t205*_t401 + _t205*_t405 + _t205*_t406 + _t205*_t409 + _t205*_t411 + _t207*_t56 + _t208*_t390 + _t208*_t398 + _t208*_t402 + _t21*_t215 + _t211*_t323 + _t215*_t89 + _t218*_t323 + _t220*_t412 + _t299*_t442 + _t321*_t68 + _t325*_t441 + _t327*_t410 + 0.3e1*_t337*_t410 + _t338*_t437 + _t375*_t442 + _t403*_t69 + _t408*_t439 + _t413*_t444 + 0.2e1*_t414*_t68 + _t422*(-0.3e1*_t52 - 0.3e1*_t53 - 0.3e1*_t54 - 0.3e1*_t55) + _t433*_t76 + _t436*_t76 + _t438*_t76 + _t445*_t56 + _t57*(-_hc1[3]*_t415 - _hc1[7]*_t219 - 0.2e1*_t190 - 0.2e1*_t191 - 0.2e1*_t192 - 0.2e1*_t193);
  out[32] = d4f_drs3_dt;
  const double d4f_drs3_dz = _hc1[18]*_t206 + _hc1[18]*_t209 + _hc1[19]*_t42 + _hc1[33]*_t5 + _hc1[8]*_t434 + _hc1[9]*_t376 + _hc2[9]*_t154 + _hc2[9]*_t155 + _t121*_t433 + _t121*_t436 + _t121*_t438 + _t15*(-_hc0[0]*_hc1[33] - _hc0[18]*_t205 - _hc0[19]*_hc1[2] - _hc0[2]*_hc1[19] - _hc0[33]*_hc1[0] - _hc0[9]*_t377 - _hc1[18]*_t214 - _hc1[9]*_t385) + _t156*_t443 + _t159*_t215 + _t162*_t220 + _t175*_t435 + _t176*_t435 + _t183*_t220 + _t184*_t377 + _t197*_t439 + _t203*_t210 + _t203*_t221 + _t204*_t216 + _t204*_t446 + _t205*_t418 + _t205*_t419 + _t205*_t424 + _t205*_t426 + _t205*_t427 + _t205*_t428 + _t207*_t62 + _t208*_t416 + _t208*_t417 + _t211*_t377 + _t215*_t48 + _t218*_t377 + _t220*_t421 + _t316*_t68*_t69 + _t351*_t437 + _t378*_t441 + 0.3e1*_t383*_t423 + _t386*_t442 + _t41*_t440 + _t422*(-0.3e1*_t58 - 0.3e1*_t59 - 0.3e1*_t60 - 0.3e1*_t61) + _t429*_t444 + _t445*_t62 + _t57*(-_hc1[3]*_t430 - _hc1[8]*_t219 - 0.2e1*_t199 - 0.2e1*_t200 - 0.2e1*_t201 - 0.2e1*_t202);
  out[33] = d4f_drs3_dz;
  const double d4f_drs4 = _hc1[34]*_t5 + 0.12e2*_hc1[9]*_t187 + _hc2[0]*_t247*_t442*(-0.4e1*_t16 - 0.4e1*_t17) + _hc2[14]*_t4 + 0.4e1*_hc2[9]*_t432 + _t15*(-_hc0[0]*_hc1[34] - _hc0[19]*_t394 - _hc0[34]*_hc1[0] - _hc0[9]*_t448 - _hc1[19]*_t219) + _t163*_t450*_t69 + _t184*_t448 + 0.6e1*_t186*_t68 + 0.4e1*_t189*_t220 + 0.3e1*_t195*_t215 + _t211*_t448 + _t215*_t32*_t394 + 0.4e1*_t215*_t50 + _t218*_t448 + _t220*_t333*_t394 + 0.3e1*_t220*_t444 + 0.2e1*_t220*_t446 + _t302*_t394*_t442 + 0.4e1*_t383*_t442 + _t394*_t431 + 0.6e1*_t399*_t410 + _t422*(-_hc0[3]*_t208 - 0.3e1*_t65 - 0.3e1*_t66) + _t433*_t449 + _t436*_t449 + _t438*_t449 + _t439*_t445 + _t441*_t450 + _t447*_t49 + _t447*_t51 + _t57*(-_hc0[3]*_t448 - _hc0[9]*_t208 - 0.2e1*_t212 - 0.2e1*_t213);
  out[34] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(ff_k, _KMAX)(const xc_func_type *p, double z, double t, double *out) {
  ...
  const double _t3 = 0.80000000000000004*_t2;
  const double _t4 = pow(_t1, _t3);
#if _KMAX >= 1
  const double _t5 = log(_t1);
  const double _t6 = _t4*_t5;
  const double _t7 = (t * t);
  const double _t8 = 2.4000000000000004*_t7;
  const double _t9 = (0.1e1 / 0.2e1)*_hc0[2] - 0.1e1 / 0.2e1*_hc1[2];
  const double _t10 = (0.1e1 / _t1);
  const double _t11 = _t10*_t4;
  const double _t12 = _t11*_t9;
#endif
#if _KMAX >= 2
  const double _t13 = 4.8000000000000007*_t6;
  const double _t14 = (t * t * t * t);
  const double _t15 = (_t5 * _t5);
  const double _t16 = _t15*_t4;
  const double _t17 = _t10*_t9;
  const double _t18 = _t17*_t6;
  const double _t19 = xc_powi(t, 5);
  const double _t20 = 1.9200000000000004*_t19;
  const double _t21 = (_t9 * _t9);
  const double _t22 = pow(_t1, _t3 - 0.2e1)*_t21;
  const double _t23 = xc_powi(t, 6);
  const double _t24 = 0.64000000000000012*_t23;
  const double _t25 = (0.1e1 / 0.2e1)*_hc0[5] + (0.1e1 / 0.2e1)*_hc1[5];
  const double _t26 = _t11*_t25;
  const double _t27 = -_t9;
...
#endif
#if _KMAX >= 3
  const double _t32 = _t4*(_t5 * _t5 * _t5);
  const double _t33 = 4.8000000000000007*_t12;
  const double _t34 = 15.360000000000003*_t14;
  const double _t35 = _t16*_t17;
  const double _t36 = xc_powi(t, 7);
  const double _t37 = 4.6080000000000014*_t36;
  const double _t38 = 3.8400000000000007*_t19;
  const double _t39 = _t22*_t5;
  const double _t40 = xc_powi(t, 8);
  const double _t41 = 1.5360000000000005*_t40;
  const double _t42 = _t10*_t25;
  const double _t43 = _t20*_t6;
  const double _t44 = _t27*_t9;
  const double _t45 = _t28*_t44;
  const double _t46 = (_t27 * _t27 * _t27);
  const double _t47 = pow(_t1, _t3 - 0.3e1);
  const double _t48 = _t46*_t47;
  const double _t49 = (_t9 * _t9 * _t9);
  const double _t50 = _t47*_t49;
  const double _t51 = xc_powi(t, 9);
  const double _t52 = 0.51200000000000012*_t51;
  const double _t53 = _t21*_t47;
  const double _t54 = _t23*(-0.64000000000000012*_hc0[2] + 0.64000000000000012*_hc1[2]);
  const double _t55 = (0.1e1 / 0.2e1)*_hc0[9] - 0.1e1 / 0.2e1*_hc1[9];
  const double _t56 = _t11*_t55;
  const double _t57 = _hc0[5] + _hc1[5];
  const double _t58 = _t24*_t29;
  const double _t59 = _t58*_t9;
  const double _t60 = _t25*_t30;
  const double _t61 = 1.6000000000000001*_t2;
  const double _t62 = -_t25;
  const double _t63 = _t29*_t9;
  const double _t64 = _t62*_t63;
  const double _t65 = -_hc0[2] + _hc1[2];
  const double _t66 = (0.1e1 / (_t1 * _t1 * _t1));
  const double _t67 = _t4*_t66;
  const double _t68 = _t65*_t67;
  const double _t69 = _t44*_t68;
#endif
#if _KMAX >= 4
  const double _t70 = 4.8000000000000007*t;
  const double _t71 = _t34*_t6;
  const double _t72 = _t16*_t37;
  const double _t73 = _t41*_t5;
  const double _t74 = _t38*_t63;
  const double _t75 = _t28*_t9;
  const double _t76 = _t41*_t6*_t75;
  const double _t77 = _t44*_t65;
  const double _t78 = pow(_t1, _t3 - 0.4e1);
  const double _t79 = _t46*_t78;
  const double _t80 = _t49*_t51*_t78;
  const double _t81 = _t51*_t53;
  const double _t82 = -0.3e1 / 0.2e1*_hc0[2] + (0.3e1 / 0.2e1)*_hc1[2];
  const double _t83 = _t24*_t65;
  const double _t84 = 2.4000000000000004*_t2;
  const double _t85 = _t25*_t84;
  const double _t86 = 1.2800000000000002*_t23;
  const double _t87 = _t68*_t9;
  const double _t88 = _t44*_t67;
#endif

  const double f = _t4;
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = _t6*_t8;
  out[1] = df_dt;
  const double df_dz = _t12*_t3;
  out[2] = df_dz;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _t13*t + 5.7600000000000016*_t14*_t16;
  out[3] = d2f_dt2;
  const double d2f_dz_dt = _t12*_t8 + _t18*_t20;
  out[4] = d2f_dz_dt;
  const double d2f_dz2 = _t22*_t24 + _t26*_t3 + _t3*_t31;
  out[5] = d2f_dz2;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _t13 + 34.560000000000009*_t16*_t2 + 13.824000000000005*_t23*_t32;
  out[6] = d3f_dt3;
  const double d3f_dz_dt2 = _t18*_t34 + _t33*t + _t35*_t37;
  out[7] = d3f_dz_dt2;
  const double d3f_dz2_dt = _t22*_t38 + _t26*_t8 + _t31*_t8 + _t39*_t41 + _t42*_t43 + _t43*_t45;
  out[8] = d3f_dz2_dt;
  const double d3f_dz3 = _t24*_t48 + _t25*_t59 + _t3*_t56 + _t3*_t64 + _t3*_t69 + _t50*_t52 + _t53*_t54 + _t57*_t59 + _t60*_t61;
  out[9] = d3f_dz3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = 115.20000000000005*_t16*_t7 + 165.88800000000006*_t19*_t32 + 33.17760000000002*_t4*_t40*(_t5 * _t5 * _t5 * _t5);
  out[10] = d4f_dt4;
  const double d4f_dz_dt3 = 11.059200000000006*_t17*_t32*_t51 + 72.960000000000008*_t18*_t2 + 69.120000000000019*_t23*_t35 + _t33;
  out[11] = d4f_dz_dt3;
  const double d4f_dz2_dt2 = 19.200000000000003*_t14*_t22 + 3.6864000000000017*_t15*_t22*xc_powi(t, 10) + _t26*_t70 + _t31*_t70 + 21.504000000000005*_t36*_t39 + _t42*_t71 + _t42*_t72 + _t45*_t71 + _t45*_t72;
  out[12] = d4f_dz2_dt2;
  const double d4f_dz3_dt = _t10*_t43*_t55 + _t19*_t53*(-3.8400000000000007*_hc0[2] + 3.8400000000000007*_hc1[2]) + _t25*_t27*_t28*_t38*_t6 + _t25*_t74 + _t25*_t76 + _t38*_t48 + 4.6080000000000014*_t40*_t50 + _t43*_t62*_t75 + _t43*_t66*_t77 + _t48*_t73 + 1.2288000000000006*_t5*_t50*xc_powi(t, 11) + _t53*_t65*_t73 + _t56*_t8 + _t57*_t74 + _t57*_t76 + 4.8000000000000007*_t60*_t7 + _t64*_t8 + _t69*_t8;
  out[13] = d4f_dz3_dt;
  const double d4f_dz4 = _t11*_t3*((0.1e1 / 0.2e1)*_hc0[14] + (0.1e1 / 0.2e1)*_hc1[14]) + _t21*_t78*_t82*_t83 + 0.2e1*_t23*_t53*(-0.64000000000000012*_hc0[5] - 0.64000000000000012*_hc1[5]) + _t23*_t79*(-0.96000000000000019*_hc0[2] + 0.96000000000000019*_hc1[2]) + _t24*_t57*_t88 + (_t25 * _t25)*_t58 + _t25*_t57*_t58 + _t25*_t67*_t83*_t9 + _t25*_t86*_t88 - (_t27 * _t27 * _t27 * _t27)*_t52*_t78 + _t27*_t68*_t85 + _t29*_t62*_t85 - _t3*_t55*_t63 - _t3*_t57*_t88 + _t30*_t55*_t84 + _t54*_t79 + _t55*_t63*_t86 + _t57*_t86*_t87 + _t59*(_hc0[9] - _hc1[9]) + _t61*_t62*_t87 + 0.40960000000000013*_t78*(_t9 * _t9 * _t9 * _t9)*xc_powi(t, 12) + _t80*(-0.76800000000000024*_hc0[2] + 0.76800000000000024*_hc1[2]) + _t80*(-0.51200000000000012*_hc0[2] + 0.51200000000000012*_hc1[2]) + _t81*(0.25600000000000006*_hc0[5] + 0.25600000000000006*_hc1[5]) + _t81*(0.51200000000000012*_hc0[5] + 0.51200000000000012*_hc1[5]) + _t81*(0.76800000000000024*_hc0[5] + 0.76800000000000024*_hc1[5]) + _t3*_t4*_t77*_t82/(_t1 * _t1 * _t1 * _t1);
  out[14] = d4f_dz4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(A_z0_k, _KMAX)(const xc_func_type *p, double rs, double t, double *out) {
  ...
  const double _t10 = _hc1[0]*_t8;
  const double _t11 = _hc0[1]*_t8;
  const double _t12 = 0.2e1*_t11;
  const double _t13 = _hc1[0]*_t7;
  const double _t14 = ((_hc0[1]) * (_hc0[1]));
  const double _t15 = xc_powi(M_PI, 6)/(_t1 * _t1 * _t1);
  const double _t16 = _t14*_t15;
  const double _t17 = (_t6 * _t6)/(_t3 * _t3 * _t3);
  const double _t18 = _hc1[0]*_t17;
  const double _t19 = 0.2e1*_t16;
#endif
#if _KMAX >= 3
  const double _t20 = _hc1[1]*_t7;
  const double _t21 = _hc1[1]*_t17;
  const double _t22 = 0.3e1*_t11;
  const double _t23 = 0.3e1*_hc1[2];
  const double _t24 = _hc0[2]*_t8;
  const double _t25 = xc_powi(M_PI, 8)/(_t1 * _t1 * _t1 * _t1);
  const double _t26 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_t25;
  const double _t27 = _hc0[2]*_t15;
  const double _t28 = _t27*_t5;
  const double _t29 = _t16*_t7;
  const double _t30 = _hc1[2]*_t17;
  const double _t31 = 0.6e1*_t16;
  const double _t32 = 0.6e1*_t26;
  const double _t33 = (_t6 * _t6 * _t6)/(_t3 * _t3 * _t3 * _t3);
  const double _t34 = _t32*_t33;
#endif
#if _KMAX >= 4
  const double _t35 = 0.3e1*_hc1[4];
  const double _t36 = _hc0[1]*_t27;
  const double _t37 = 0.6e1*_hc1[5];
  const double _t38 = 0.4e1*_hc1[2];
  const double _t39 = _hc0[3]*_t15*_t5;
  const double _t40 = ((_hc0[2]) * (_hc0[2]))*_t15;
  const double _t41 = xc_powi(M_PI, 10)*((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]))/xc_powi(_t1, 5);
  const double _t42 = _hc0[2]*_t14*_t25;
  const double _t43 = 0.24e2*_t26;
  const double _t44 = _hc1[0]*_t41;
  const double _t45 = 0.36e2*_t33;
#endif
  ...
  const double d2f_dt2 = 0;
  out[3] = d2f_dt2;
  const double d2f_drs_dt = _hc0[1]*_t9 + _hc1[4]*_t4;
  out[4] = d2f_drs_dt;
  const double d2f_drs2 = _hc0[2]*_t10 + _hc1[2]*_t12 + _hc1[5]*_t4 - _t13*_t16 + _t18*_t19;
  out[5] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = 0;
  ...
  const double d3f_drs_dt2 = 0;
  out[7] = d3f_drs_dt2;
  const double d3f_drs2_dt = _hc0[2]*_t9 + _hc1[4]*_t12 + _hc1[8]*_t4 - _t16*_t20 + _t19*_t21;
  out[8] = d3f_drs2_dt;
  const double d3f_drs3 = _hc0[3]*_t10 + _hc1[0]*_t34 + _hc1[5]*_t22 + _hc1[9]*_t4 + _t13*_t26 + 0.6e1*_t17*_t28 - _t18*_t32 + _t23*_t24 - _t23*_t29 - 0.3e1*_t28*_t7 + _t30*_t31;
  out[9] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = 0;
  ...
  const double d4f_drs2_dt2 = 0;
  out[12] = d4f_drs2_dt2;
  const double d4f_drs3_dt = _hc0[3]*_t9 + _hc1[1]*_t34 + _hc1[13]*_t4 + _hc1[4]*_t17*_t31 + _hc1[8]*_t22 + _t20*_t26 - 0.3e1*_t20*_t36 - _t21*_t32 + 0.6e1*_t21*_t36 + _t24*_t35 - _t29*_t35;
  out[13] = d4f_drs3_dt;
  const double d4f_drs4 = _hc0[3]*_t38*_t8 + _hc0[4]*_t10 + _hc1[0]*_t42*_t45 + _hc1[14]*_t4 + _hc1[2]*_t33*_t43 - 0.12e2*_hc1[2]*_t36*_t7 + 0.12e2*_hc1[5]*_t16*_t17 + 0.4e1*_hc1[9]*_t11 - 0.3e1*_t13*_t40 - _t13*_t41 + 0.6e1*_t13*_t42 + 0.8e1*_t17*_t39 + 0.6e1*_t18*_t40 + 0.14e2*_t18*_t41 - 0.36e2*_t18*_t42 + _t24*_t37 + _t26*_t38*_t7 - _t29*_t37 + 0.24e2*_t30*_t36 - _t30*_t43 - 0.4e1*_t39*_t7 - _t44*_t45 + 0.24e2*_t44*(_t6 * _t6 * _t6 * _t6)/xc_powi(_t3, 5);
  out[14] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f2_z0_k, _KMAX)(const xc_func_type *p, double rs, double t, double *out) {
  ...
  const double _t30 = _hc2[2]*_t7;
  const double _t31 = _hc2[0]*_t6;
  const double _t32 = _hc1[1]*_t14;
  const double _t33 = _hc0[0]*_hc1[4];
  const double _t34 = _hc0[1]*_hc1[2];
  const double _t35 = _hc0[2]*_hc1[1];
  const double _t36 = _hc0[4]*_hc1[0];
  const double _t37 = -_t33 - _t34 - _t35 - _t36;
  const double _t38 = _t26*_t27;
  const double _t39 = _hc2[0]*_t14;
  const double _t40 = 0.2e1*_hc1[2];
  const double _t41 = 0.2e1*_t30;
  const double _t42 = _t14*_t31;
  const double _t43 = _hc0[0]*_hc1[5];
  const double _t44 = _hc0[5]*_hc1[0];
  const double _t45 = 0.2e1*_hc0[2];
  const double _t46 = -_hc1[2]*_t45 - _t43 - _t44;
  const double _t47 = -0.2e1*_t12 - 0.2e1*_t13;
  const double _t48 = _t26*_t39;
#endif
#if _KMAX >= 3
  const double _t49 = 0.3e1*_hc1[3];
  const double _t50 = 0.6e1*_hc1[1];
  const double _t51 = _hc2[1]*_t6;
  const double _t52 = _t10*_t51;
  const double _t53 = 0.3e1*_t18;
  const double _t54 = 0.3e1*_hc1[1];
  const double _t55 = _t24*_t31;
  const double _t56 = _hc0[0]*_hc1[6];
  const double _t57 = _hc0[6]*_hc1[0];
  const double _t58 = _hc0[1]*_hc1[3];
  const double _t59 = _hc0[3]*_hc1[1];
  const double _t60 = -_t56 - _t57 - 0.3e1*_t58 - 0.3e1*_t59;
  const double _t61 = _t10*_t38;
  const double _t62 = 0.3e1*_t61;
  const double _t63 = _t25*_t28;
  const double _t64 = -0.2e1*_t21 - 0.2e1*_t22 - 0.4e1*_t23;
  const double _t65 = _t11*_t26;
  const double _t66 = _hc2[0]*_t38;
  const double _t67 = 0.2e1*_t24;
  const double _t68 = -0.3e1*_t8 - 0.3e1*_t9;
  const double _t69 = _t2/(_t1 * _t1 * _t1 * _t1);
  const double _t70 = _hc1[0]*_t69;
  const double _t71 = _t68*_t70;
  const double _t72 = _hc2[4]*_t3;
  const double _t73 = 0.2e1*_hc1[4];
  const double _t74 = _t10*_t7;
  const double _t75 = 0.2e1*_hc2[4];
  const double _t76 = _t14*_t16;
  const double _t77 = _hc2[2]*_t10;
  const double _t78 = _t6*_t77;
  const double _t79 = _hc1[2]*_t31;
  const double _t80 = _t31*_t37;
  const double _t81 = _hc1[2]*_t25;
  const double _t82 = _hc2[1]*_t14;
  const double _t83 = 0.2e1*_t38;
  const double _t84 = _t27*_t39;
  const double _t85 = _t25*_t84;
  const double _t86 = _hc0[0]*_hc1[7];
  const double _t87 = _hc0[2]*_hc1[3];
  const double _t88 = _hc0[3]*_hc1[2];
  const double _t89 = _hc0[7]*_hc1[0];
  const double _t90 = 0.2e1*_hc0[1];
  const double _t91 = 0.2e1*_hc0[4];
  const double _t92 = -_hc1[1]*_t91 - _hc1[4]*_t90 - _t86 - _t87 - _t88 - _t89;
  const double _t93 = _hc2[0]*_t37;
  const double _t94 = _hc2[5]*_t3;
  const double _t95 = _hc2[5]*_t7;
  const double _t96 = _t14*_t7;
  const double _t97 = _hc2[2]*_t6;
  const double _t98 = _t14*_t51;
  const double _t99 = _t31*_t46;
  const double _t100 = _t26*_t47;
  const double _t101 = _t25*_t47;
  const double _t102 = _hc2[0]*_t32;
  const double _t103 = _hc2[2]*_t14;
  const double _t104 = _hc2[0]*_t46;
  const double _t105 = _hc0[0]*_hc1[8];
  const double _t106 = _hc0[1]*_hc1[5];
  const double _t107 = _hc0[5]*_hc1[1];
  const double _t108 = _hc0[8]*_hc1[0];
  const double _t109 = -_hc1[2]*_t91 - _hc1[4]*_t45 - _t105 - _t106 - _t107 - _t108;
  const double _t110 = -0.2e1*_t33 - 0.2e1*_t34 - 0.2e1*_t35 - 0.2e1*_t36;
  const double _t111 = _t39*_t47;
  const double _t112 = 0.3e1*_hc1[2];
  const double _t113 = 0.3e1*_hc1[5];
  const double _t114 = 0.3e1*_t95;
  const double _t115 = 0.6e1*_hc1[2];
  const double _t116 = _t14*_t97;
  const double _t117 = 0.3e1*_t30;
  const double _t118 = _hc0[0]*_hc1[9];
  const double _t119 = _hc0[9]*_hc1[0];
  const double _t120 = 0.3e1*_hc0[2];
  const double _t121 = 0.3e1*_hc0[5];
  const double _t122 = -_hc1[2]*_t121 - _hc1[5]*_t120 - _t118 - _t119;
  const double _t123 = 0.3e1*_t103;
  const double _t124 = _t101*_t39;
  const double _t125 = 0.4e1*_hc0[2];
  const double _t126 = -_hc1[2]*_t125 - 0.2e1*_t43 - 0.2e1*_t44;
  const double _t127 = 0.2e1*_t100;
  const double _t128 = -0.3e1*_t12 - 0.3e1*_t13;
  const double _t129 = _t111*_t70;
#endif
#if _KMAX >= 4
  const double _t130 = 0.4e1*_hc1[6];
  const double _t131 = _t24*_t51;
  const double _t132 = 0.12e2*_hc1[1];
  const double _t133 = 0.6e1*_hc1[3];
  const double _t134 = 0.4e1*_hc1[1];
  const double _t135 = _hc2[1]*_t10;
  const double _t136 = _t25*_t27;
  const double _t137 = _t135*_t136;
  const double _t138 = 0.4e1*_hc0[1];
  const double _t139 = 0.8e1*_t24;
  const double _t140 = _hc2[1]*_t38;
  const double _t141 = _t26*_t64;
  const double _t142 = 0.4e1*_t135;
  const double _t143 = _hc2[0]*_t136;
  const double _t144 = _t11*_t64;
  const double _t145 = _t134*_t25;
  const double _t146 = -0.2e1*_t56 - 0.2e1*_t57 - 0.6e1*_t58 - 0.6e1*_t59;
  const double _t147 = 0.3e1*_t24;
  const double _t148 = _hc2[0]*_t147;
  const double _t149 = _t27*_t71;
  const double _t150 = _t28*_t68;
  const double _t151 = _t150*_t69;
  const double _t152 = -0.3e1*_t21 - 0.3e1*_t22 - 0.6e1*_t23;
  const double _t153 = _t152*_t70;
  const double _t154 = 0.2e1*_t71;
  const double _t155 = _hc1[0]*_t2/xc_powi(_t1, 5);
  const double _t156 = _t155*(-0.4e1*_t8 - 0.4e1*_t9);
  const double _t157 = 0.3e1*_hc1[7];
  const double _t158 = _t10*_t6;
  const double _t159 = _hc2[4]*_t158;
  const double _t160 = 0.6e1*_hc1[4];
  const double _t161 = _hc2[4]*_t7;
  const double _t162 = _t24*_t97;
  const double _t163 = 0.3e1*_hc1[4];
  const double _t164 = _t37*_t51;
  const double _t165 = _t136*_t77;
  const double _t166 = 0.3e1*_t141;
  const double _t167 = _hc2[2]*_t38;
  const double _t168 = _t25*_t39;
  const double _t169 = _t168*_t64;
  const double _t170 = _t31*_t92;
  const double _t171 = _t136*_t93;
  const double _t172 = 0.3e1*_t149;
  const double _t173 = _t68*_t84;
  const double _t174 = _t173*_t69;
  const double _t175 = _t39*_t71;
  const double _t176 = 0.2e1*_t175;
  const double _t177 = 0.3e1*_hc0[4];
  const double _t178 = _hc2[0]*_t92;
  const double _t179 = 0.3e1*_t38;
  const double _t180 = _hc2[8]*_t3;
  const double _t181 = 0.4e1*_hc1[4];
  const double _t182 = 0.2e1*_hc1[7];
  const double _t183 = 0.2e1*_hc1[8];
  const double _t184 = _t14*_t6;
  const double _t185 = _hc2[4]*_t184;
  const double _t186 = _hc2[5]*_t158;
  const double _t187 = 0.4e1*_hc1[2];
  const double _t188 = _t46*_t51;
  const double _t189 = 0.4e1*_t37;
  const double _t190 = _t37*_t97;
  const double _t191 = _hc2[4]*_t14;
  const double _t192 = _hc2[1]*_t46;
  const double _t193 = 0.2e1*_t103;
  const double _t194 = _t104*_t16;
  const double _t195 = _t109*_t31;
  const double _t196 = _t110*_t26;
  const double _t197 = 0.2e1*_t196;
  const double _t198 = _t101*_t93;
  const double _t199 = _t110*_t168;
  const double _t200 = _t154*_t47;
  const double _t201 = _t111*_t68;
  const double _t202 = _t201*_t69;
  const double _t203 = 0.2e1*_t93;
  const double _t204 = _t47*_t71;
  const double _t205 = 0.4e1*_hc0[4];
  const double _t206 = _hc2[9]*_t3;
  const double _t207 = 0.3e1*_hc1[8];
  const double _t208 = _hc2[5]*_t184;
  const double _t209 = 0.3e1*_t46;
  const double _t210 = _t46*_t97;
  const double _t211 = _t122*_t31;
  const double _t212 = 0.3e1*_t100;
  const double _t213 = _hc2[5]*_t14;
  const double _t214 = _t126*_t26;
  const double _t215 = _t126*_t25;
  const double _t216 = _t128*_t70;
  const double _t217 = _t216*_t47;
  const double _t218 = _t128*_t69;
  const double _t219 = _t216*_t39;
  const double _t220 = _t111*_t128;
  const double _t221 = 0.6e1*_hc1[5];
  const double _t222 = 0.4e1*_hc1[9];
  const double _t223 = 0.12e2*_hc1[2];
  const double _t224 = _t47*_t81;
  const double _t225 = 0.4e1*_t103;
  const double _t226 = 0.3e1*_t104;
#endif
...
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _hc1[3]*_t5 + _t10*_t19 + _t15*_t24 + _t16*_t17 + _t16*_t20 + _t26*_t28;
  out[3] = d2f_dt2;
  const double d2f_drs_dt = _hc1[1]*_t29 + _hc1[2]*_t17 + _hc1[2]*_t20 + _hc1[4]*_t5 + _hc2[4]*_t4 + _t10*_t30 + _t14*_t18 + _t15*_t37 + _t31*_t32 + _t38*_t39;
  out[4] = d2f_drs_dt;
  const double d2f_drs2 = _hc1[5]*_t5 + _hc2[5]*_t4 + _t14*_t41 + _t15*_t46 + _t29*_t40 + _t40*_t42 + _t47*_t48;
  out[5] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _hc1[6]*_t5 + _hc2[1]*_t62 + _t15*_t60 + _t17*_t49 + _t20*_t49 + _t24*_t53 + _t28*_t71 + _t50*_t52 + _t54*_t55 + _t54*_t63 + _t64*_t65 + _t66*_t67;
  out[6] = d3f_dt3;
  const double d3f_drs_dt2 = _hc1[3]*_t29 + _hc1[3]*_t42 + _hc1[7]*_t5 + _t15*_t92 + _t16*_t72 + _t16*_t78 + _t16*_t80 + _t16*_t85 + _t17*_t73 + _t19*_t37 + _t20*_t73 + _t24*_t30 + _t24*_t79 + _t28*_t81 + _t38*_t77 + _t40*_t52 + _t48*_t64 + _t51*_t76 + _t71*_t84 + _t74*_t75 + _t82*_t83 + _t83*_t93;
  out[7] = d3f_drs_dt2;
  const double d3f_drs2_dt = _hc1[1]*_t94 + _hc1[1]*_t99 + _hc1[5]*_t17 + _hc1[5]*_t20 + _hc1[8]*_t5 + _hc2[8]*_t4 + _t10*_t95 + _t100*_t82 + _t100*_t93 + _t101*_t102 + _t103*_t83 + _t104*_t38 + _t109*_t15 + _t110*_t48 + _t111*_t71 + _t18*_t46 + _t29*_t73 + _t37*_t41 + _t40*_t72 + _t40*_t78 + _t40*_t80 + _t40*_t85 + _t40*_t98 + _t42*_t73 + _t75*_t96 + _t76*_t97;
  out[8] = d3f_drs2_dt;
  const double d3f_drs3 = _hc1[9]*_t5 + _hc2[9]*_t4 + _t100*_t123 + _t104*_t127 + _t112*_t124 + _t112*_t94 + _t112*_t99 + _t113*_t29 + _t113*_t42 + _t114*_t14 + _t115*_t116 + _t117*_t46 + _t122*_t15 + _t126*_t48 + _t128*_t129;
  out[9] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = _hc1[1]*_t139*_t143 + _hc1[10]*_t5 + 0.12e2*_hc1[3]*_t52 + _t130*_t17 + _t130*_t20 + _t131*_t132 + _t132*_t137 + _t133*_t55 + _t133*_t63 + _t134*_t151 + _t134*_t31*_t60 + _t139*_t140 + _t141*_t142 + _t141*_t148 + _t142*_t149 + _t144*_t145 + _t144*_t154 + _t146*_t65 + _t148*_t149 + _t15*(-_hc0[0]*_hc1[10] - _hc0[10]*_hc1[0] - _hc0[3]*_t133 - _hc0[6]*_t134 - _hc1[6]*_t138) + _t150*_t156 + _t153*_t28 + 0.4e1*_t18*_t60 + 0.3e1*_t60*_t66;
  out[10] = d4f_dt4;
  const double d4f_drs_dt3 = _hc1[11]*_t5 + _hc1[2]*_t151 + _hc1[6]*_t29 + _hc1[6]*_t42 + 0.6e1*_hc2[1]*_t136*_t32 + _hc2[4]*_t62 + _t112*_t131 + _t112*_t137 + 0.6e1*_t140*_t37 + _t141*_t77 + _t143*_t24*_t40 + _t144*_t81 + _t146*_t48 + _t147*_t161 + _t149*_t77 + _t15*(-_hc0[0]*_hc1[11] - _hc0[1]*_t157 - _hc0[11]*_hc1[0] - _hc0[2]*_hc1[6] - _hc0[3]*_t163 - _hc0[6]*_hc1[2] - _hc0[7]*_t54 - _hc1[3]*_t177) + _t153*_t84 + _t156*_t173 + _t157*_t17 + _t157*_t20 + _t159*_t50 + _t160*_t52 + _t162*_t54 + _t163*_t55 + _t163*_t63 + _t164*_t50 + _t165*_t54 + _t166*_t82 + _t166*_t93 + _t167*_t67 + _t169*_t54 + _t170*_t54 + _t171*_t50 + _t172*_t82 + _t172*_t93 + _t174*_t54 + _t176*_t64 + _t178*_t179 + _t30*_t60 + _t49*_t72 + _t49*_t78 + _t49*_t80 + _t49*_t85 + _t49*_t98 + _t53*_t92 + _t60*_t79;
  out[11] = d4f_drs_dt3;
  const double d4f_drs2_dt2 = _hc1[12]*_t5 + 0.2e1*_hc1[3]*_t116 + _hc1[3]*_t124 + _hc1[3]*_t94 + _hc1[3]*_t99 + 0.2e1*_hc1[5]*_t52 + _hc1[5]*_t55 + _hc1[5]*_t63 + _hc2[1]*_t101*_t76 + _hc2[1]*_t127*_t37 + _hc2[5]*_t61 + 0.2e1*_hc2[8]*_t74 + _t100*_t178 + _t103*_t145*_t27 + _t104*_t141 + _t104*_t149 + _t109*_t19 + 0.2e1*_t109*_t66 + _t110*_t176 + _t129*_t152 + _t134*_t185 + _t134*_t190 + _t136*_t187*_t82 + _t136*_t194 + _t141*_t193 + _t149*_t193 + _t15*(-_hc0[0]*_hc1[12] - _hc0[12]*_hc1[0] - _hc0[3]*_hc1[5] - _hc0[5]*_hc1[3] - _hc0[7]*_t40 - _hc0[8]*_t16 - _hc1[4]*_t205 - _hc1[7]*_t45 - _hc1[8]*_t90) + _t156*_t201 + _t159*_t187 + _t16*_t180 + _t16*_t186 + _t16*_t188 + _t16*_t195 + _t16*_t198 + _t16*_t199 + _t16*_t202 + _t161*_t189 + _t162*_t40 + _t164*_t187 + _t165*_t40 + _t167*_t189 + _t169*_t40 + _t17*_t183 + _t170*_t40 + _t171*_t187 + _t174*_t40 + _t181*_t72 + _t181*_t78 + _t181*_t80 + _t181*_t85 + _t181*_t98 + _t182*_t29 + _t182*_t42 + _t183*_t20 + 0.4e1*_t191*_t38 + _t192*_t83 + _t196*_t203 + _t197*_t82 + _t200*_t82 + _t203*_t204 + _t24*_t95 + _t41*_t92 + _t48*(-_hc0[4]*_t134 - _hc1[4]*_t138 - 0.2e1*_t86 - 0.2e1*_t87 - 0.2e1*_t88 - 0.2e1*_t89);
  out[12] = d4f_drs2_dt2;
  const double d4f_drs3_dt = _hc1[1]*_t206 + _hc1[1]*_t211 + _hc1[13]*_t5 + _hc1[9]*_t17 + _hc1[9]*_t20 + _hc2[0]*_t109*_t127 + _hc2[13]*_t4 + _hc2[2]*_t212*_t37 + 0.3e1*_hc2[8]*_t96 + _hc2[9]*_t74 + _t101*_t103*_t54 + _t101*_t112*_t82 + _t101*_t194 + _t102*_t215 + _t102*_t218*_t47 + _t103*_t115*_t136 + _t104*_t112*_t136 + _t104*_t197 + _t104*_t200 + _t109*_t117 + _t110*_t219 + _t112*_t180 + _t112*_t186 + _t112*_t188 + _t112*_t195 + _t112*_t198 + _t112*_t199 + _t112*_t202 + _t113*_t72 + _t113*_t78 + _t113*_t80 + _t113*_t85 + _t113*_t98 + _t114*_t37 + _t115*_t185 + _t115*_t190 + _t116*_t160 + _t122*_t18 + _t122*_t66 + _t123*_t196 + _t123*_t204 + _t124*_t163 + _t126*_t175 + _t127*_t192 + _t129*(-0.3e1*_t33 - 0.3e1*_t34 - 0.3e1*_t35 - 0.3e1*_t36) + _t15*(-_hc0[0]*_hc1[13] - _hc0[1]*_hc1[9] - _hc0[13]*_hc1[0] - _hc0[8]*_t112 - _hc0[9]*_hc1[1] - _hc1[4]*_t121 - _hc1[5]*_t177 - _hc1[8]*_t120) + _t156*_t220 + _t161*_t209 + _t163*_t94 + _t163*_t99 + _t167*_t209 + _t179*_t213 + _t191*_t212 + _t207*_t29 + _t207*_t42 + _t208*_t54 + _t210*_t54 + _t214*_t82 + _t214*_t93 + _t217*_t82 + _t217*_t93 + _t48*(-_hc1[2]*_t205 - _hc1[4]*_t125 - 0.2e1*_t105 - 0.2e1*_t106 - 0.2e1*_t107 - 0.2e1*_t108);
  out[13] = d4f_drs3_dt;
  const double d4f_drs4 = _hc1[14]*_t5 + 0.12e2*_hc1[5]*_t116 + _hc2[0]*_t122*_t212 + _hc2[14]*_t4 + 0.8e1*_hc2[2]*_t100*_t46 + 0.4e1*_hc2[9]*_t96 + 0.6e1*_t100*_t213 + 0.12e2*_t103*_t224 + 0.8e1*_t104*_t224 + _t111*_t187*_t218 + 0.4e1*_t122*_t30 + _t124*_t221 + 0.2e1*_t126*_t219 + _t129*(-_hc0[2]*_t115 - 0.3e1*_t43 - 0.3e1*_t44) + _t15*(-_hc0[0]*_hc1[14] - _hc0[14]*_hc1[0] - _hc0[5]*_t221 - _hc0[9]*_t187 - _hc1[9]*_t125) + _t155*_t220*(-0.4e1*_t12 - 0.4e1*_t13) + _t187*_t206 + _t187*_t211 + _t187*_t215*_t39 + _t208*_t223 + _t210*_t223 + _t214*_t225 + _t214*_t226 + _t217*_t225 + _t217*_t226 + _t221*_t94 + _t221*_t99 + _t222*_t29 + _t222*_t42 + 0.6e1*_t46*_t95 + _t48*(-_hc0[2]*_t221 - _hc0[5]*_t115 - 0.2e1*_t118 - 0.2e1*_t119);
  out[14] = d4f_drs4;
#endif
}
