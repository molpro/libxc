/*
  Generated from python/gga_exc/gga_x_2d_b86.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_x_2d_b86
*/

#ifndef _GGA_X_2D_B86_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_X_2D_B86_KERNEL_BODY
#define _KMAX 0
#define _GGA_X_2D_B86_HELPER_BODIES
#include "gga_x_2d_b86.c"
#undef _GGA_X_2D_B86_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_X_2D_B86_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_X_2D_B86_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(_2d_b86_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double *out) {

  const double _t1 = 0.0021050000000000001*x2 + 0.1e1;
  const double _t2 = 0.00011900000000000001*x2 + 0.1e1;
  ...
  out[0] = f;
#if _KMAX >= 1
  const double df_dx2 = -0.00011900000000000001*_t1*_t4 + 0.0021050000000000001*_t3;
  out[1] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dx22 = 2.8322000000000004e-8*_t1*_t5 - 5.0099000000000009e-7*_t4;
  out[2] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dx23 = -1.0110954000000001e-11*_t1*_t6 + 1.7885343000000004e-10*_t5;
  out[3] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dx24 = 4.8128141040000007e-15*_t1/xc_powi(_t2, 5) - 8.5134232680000026e-14*_t6;
  out[4] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double *out) {
  ...
  XC_CAT(_2d_b86_f_pf_k, _KMAX)(p, sigma_ss/(n_s * n_s * n_s), _hc1);
