/*
  Generated from python/gga_exc/gga_k_thakkar.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_k_thakkar
*/

#ifndef _GGA_K_THAKKAR_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_K_THAKKAR_KERNEL_BODY
#define _KMAX 0
#define _GGA_K_THAKKAR_HELPER_BODIES
#include "gga_k_thakkar.c"
#undef _GGA_K_THAKKAR_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_K_THAKKAR_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_K_THAKKAR_HELPER_BODIES)

/* ---- helpers (one graded body -> <name>_k<order>) ---- */

GPU_DEVICE_FUNCTION static inline void XC_CAT(thakkar_f0_k, _KMAX)(const xc_func_type *p, double x, double *out) {

  const double _t1 = xc_asinh(x);
  const double _t2 = 0.0253*_t1;
  const double _t3 = _t2*x + 0.1e1;
  const double _t4 = (0.1e1 / _t3);
  const double _t5 = (x * x);
  const double _t6 = 0.0054999999999999997*_t5;
#if _KMAX >= 1
  const double _t7 = 0.010999999999999999*_t4;
  const double _t8 = (0.1e1 / (_t3 * _t3));
  const double _t9 = _t5 + 0.1e1;
  const double _t10 = xc_powr(_t9, -1, 2);
  const double _t11 = _t10*x;
  const double _t12 = -0.0253*_t11 - _t2;
  const double _t13 = _t12*_t8;
#endif
#if _KMAX >= 2
  const double _t14 = 0.050599999999999999*_t10;
  const double _t15 = xc_powr(_t9, -3, 2);
  const double _t16 = _t15*_t5;
  const double _t17 = -_t14 + 0.0253*_t16;
  const double _t18 = _t17*_t8;
  const double _t19 = -0.050599999999999999*_t1 - _t14*x;
  const double _t20 = (0.1e1 / (_t3 * _t3 * _t3));
  const double _t21 = _t12*_t20;
  const double _t22 = _t19*_t21;
#endif
#if _KMAX >= 3
  const double _t23 = 0.033000000000000002*x;
  const double _t24 = xc_powr(_t9, -5, 2);
  const double _t25 = _t24*(x * x * x);
  const double _t26 = 0.1012*_t15*x - 0.075899999999999995*_t25;
  const double _t27 = _t6*_t8;
  const double _t28 = 0.010999999999999999*_t5;
  const double _t29 = _t17*_t20;
  const double _t30 = _t19*_t29;
  const double _t31 = 0.1012*_t10;
  const double _t32 = 0.050599999999999999*_t16 - _t31;
  const double _t33 = _t21*_t6;
  const double _t34 = (0.1e1 / (_t3 * _t3 * _t3 * _t3));
  const double _t35 = -0.075899999999999995*_t1 - 0.075899999999999995*_t11;
  const double _t36 = _t34*_t35;
  const double _t37 = _t12*_t36;
  const double _t38 = _t19*_t6;
#endif
#if _KMAX >= 4
  const double _t39 = 0.043999999999999997*x;
  const double _t40 = 0.016500000000000001*_t5;
  const double _t41 = _t19*_t40;
  const double _t42 = _t12*_t38;
#endif

  const double f = _t4*_t6 + 0.1e1;
  out[0] = f;
#if _KMAX >= 1
  const double df_dx = _t13*_t6 + _t7*x;
  out[1] = df_dx;
#endif
#if _KMAX >= 2
  const double d2f_dx2 = 0.021999999999999999*_t13*x + _t18*_t6 + _t22*_t6 + _t7;
  out[2] = d2f_dx2;
#endif
#if _KMAX >= 3
  const double d3f_dx3 = 0.033000000000000002*_t13 + _t18*_t23 + _t22*_t23 + _t26*_t27 + _t28*_t30 + _t32*_t33 + _t37*_t38;
  out[3] = d3f_dx3;
#endif
#if _KMAX >= 4
  const double d4f_dx4 = _t17*_t36*_t41 + 0.066000000000000003*_t18 + _t19*_t37*_t39 + _t20*_t26*_t41 + _t21*_t32*_t39 + 0.066000000000000003*_t22 + _t26*_t39*_t8 + _t27*(0.1012*_t15 - 0.53129999999999999*_t24*_t5 + 0.37949999999999995*(x * x * x * x)/xc_powr(_t9, 7, 2)) + _t28*_t32*_t37 + _t29*_t32*_t40 + 0.087999999999999995*_t30*x + _t33*(0.2024*_t15*x - 0.15179999999999999*_t25) + _t34*_t42*(-0.15179999999999999*_t10 + 0.075899999999999995*_t16) + _t35*_t42*(-0.1012*_t1 - _t31*x)/xc_powi(_t3, 5);
  out[4] = d4f_dx4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(thakkar_f1_k, _KMAX)(const xc_func_type *p, double x, double *out) {

  const double _t1 = xc_powr(0.2e1, 2, 3);
  const double _t2 = _t1*x;
  const double _t3 = 0.2e1*_t2 + 0.1e1;
  const double _t4 = 0.071999999999999995/_t3;
#if _KMAX >= 1
  const double _t5 = (0.1e1 / (_t3 * _t3));
#endif
#if _KMAX >= 2
  const double _t6 = M_CBRT2/(_t3 * _t3 * _t3);
#endif
#if _KMAX >= 3
  const double _t7 = (0.1e1 / (_t3 * _t3 * _t3 * _t3));
#endif

  const double f = -_t4*x;
  out[0] = f;
#if _KMAX >= 1
  const double df_dx = 0.14399999999999999*_t2*_t5 - _t4;
  out[1] = df_dx;
#endif
#if _KMAX >= 2
  const double d2f_dx2 = 0.28799999999999998*_t1*_t5 - 1.1519999999999999*_t6*x;
  out[2] = d2f_dx2;
#endif
#if _KMAX >= 3
  const double d3f_dx3 = -3.4559999999999995*_t6 + 13.823999999999998*_t7*x;
  out[3] = d3f_dx3;
#endif
#if _KMAX >= 4
  const double d4f_dx4 = -110.59199999999998*_t2/xc_powi(_t3, 5) + 55.295999999999992*_t7;
  out[4] = d4f_dx4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(thakkar_f_k, _KMAX)(const xc_func_type *p, double x, double *out) {

  double _hc0[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(thakkar_f0_k, _KMAX)(p, x, _hc0);
  double _hc1[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(thakkar_f1_k, _KMAX)(p, x, _hc1);
...
#endif
#if _KMAX >= 2
  const double d2f_dx2 = _hc0[2] + _hc1[2];
  out[2] = d2f_dx2;
#endif
#if _KMAX >= 3
  const double d3f_dx3 = _hc0[3] + _hc1[3];
  out[3] = d3f_dx3;
#endif
#if _KMAX >= 4
  const double d4f_dx4 = _hc0[4] + _hc1[4];
  out[4] = d4f_dx4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double *out) {
  ...
  if(!(_t3)) XC_CAT(thakkar_f_k, _KMAX)(p, _t1*_t2, _hc1);
