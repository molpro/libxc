/*
  Generated from python/gga_exc/gga_c_chachiyo.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_c_chachiyo
*/

#ifndef _GGA_C_CHACHIYO_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_C_CHACHIYO_KERNEL_BODY
#define _KMAX 0
#define _GGA_C_CHACHIYO_HELPER_BODIES
#include "gga_c_chachiyo.c"
#undef _GGA_C_CHACHIYO_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_C_CHACHIYO_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_C_CHACHIYO_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(e0_k, _KMAX)(const xc_func_type *p, double rs, double *out) {
  const gga_c_chachiyo_params *params = (const gga_c_chachiyo_params *)(p->params);
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(cha_t_k, _KMAX)(const xc_func_type *p, double rs, double xt, double *out) {
...
#endif
#if _KMAX >= 3
  const double _t6 = (0.15e2 / 0.64e2)*_t1*_t2;
#endif
  ...
  const double d4f_drs3_dxt = -_t6;
  out[13] = d4f_drs3_dxt;
  const double d4f_drs4 = (0.105e3 / 0.128e3)*_t2*xt/(rs * rs * rs * rs);
  out[14] = d4f_drs4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(f_chachiyo_gga_k, _KMAX)(const xc_func_type *p, double rs, double z, double xt, double xs0, double xs1, double *out) {
  const gga_c_chachiyo_params *params = (const gga_c_chachiyo_params *)(p->params);

  double _hc0[(_KMAX) >= 4 ? 15 : (_KMAX) >= 3 ? 10 : (_KMAX) >= 2 ? 6 : (_KMAX) >= 1 ? 3 : 1];
  XC_CAT(cha_t_k, _KMAX)(p, rs, xt, _hc0);
  double _hc1[(_KMAX) >= 4 ? 15 : (_KMAX) >= 3 ? 10 : (_KMAX) >= 2 ? 6 : (_KMAX) >= 1 ? 3 : 1];
  XC_CAT(f_chachiyo_k, _KMAX)(p, rs, z, _hc1);
  const double _t1 = ((_hc0[0]) * (_hc0[0]));
  const double _t2 = _t1 + 0.1e1;
  const double _t3 = (0.1e1 / (_hc1[0]));
  const double _t4 = _t3*params->h;
  const double _t5 = pow(_t2, _t4);
  const double _t6 = _hc1[0]*_t5;
#if _KMAX >= 1
  const double _t7 = _t5*params->h;
  const double _t8 = (0.1e1 / _t2);
  const double _t9 = 0.2e1*_t8;
  const double _t10 = _hc0[0]*_t9;
  const double _t11 = _hc0[1]*_t10;
  const double _t12 = _t11*_t7;
  const double _t13 = _hc1[1]*_t5;
  const double _t14 = log(_t2);
  const double _t15 = _t14*_t4;
  const double _t16 = _hc1[2]*_t5;
  const double _t17 = (0.1e1 / ((_hc1[0]) * (_hc1[0])));
  const double _t18 = _t14*params->h;
  const double _t19 = _t17*_t18;
  const double _t20 = _hc1[2]*_t19;
  const double _t21 = _t10*_t4;
  const double _t22 = _hc0[2]*_t21 - _t20;
  ...
  const double _t27 = (0.1e1 / (_t2 * _t2));
  const double _t28 = _t1*_t27;
  const double _t29 = 0.4e1*_t28;
  const double _t30 = _t25*_t29;
  const double _t31 = ((params->h) * (params->h));
  const double _t32 = _t31*_t5;
  const double _t33 = _t3*_t32;
  const double _t34 = _t24*_t29;
  const double _t35 = _t33*_t34;
  const double _t36 = 0.2e1*_t13;
  const double _t37 = _t36*_t8;
  const double _t38 = _t14*_t37;
  const double _t39 = _hc0[0]*_hc0[1];
  const double _t40 = _t17*_t31;
  const double _t41 = _t39*_t40;
  const double _t42 = _hc1[3]*_t5;
  const double _t43 = (0.1e1 / ((_hc1[0]) * (_hc1[0]) * (_hc1[0])));
  const double _t44 = ((_hc1[1]) * (_hc1[1]));
  const double _t45 = _t43*_t44;
  const double _t46 = (_t14 * _t14);
  const double _t47 = _t32*_t46;
  const double _t48 = _t45*_t47;
  const double _t49 = 0.2e1*_t16;
  const double _t50 = _t4*_t8;
  const double _t51 = _t39*_t50;
  const double _t52 = 0.2e1*_t22;
  const double _t53 = _t52*_t8;
  const double _t54 = _t39*_t7;
  const double _t55 = _t53*_t54;
  const double _t56 = _hc1[2]*_t17;
  const double _t57 = _t56*params->h;
  const double _t58 = _hc0[1]*_hc0[2];
  const double _t59 = _t29*_t4;
  const double _t60 = 0.2e1*_hc0[0]*_hc0[4]*_t3*_t8*params->h + 0.2e1*_hc0[1]*_hc0[2]*_t3*_t8*params->h - _t11*_t57 - _t58*_t59;
  const double _t61 = _t6*_t60;
  const double _t62 = _hc1[4]*_t5;
  const double _t63 = _t13*_t20;
  const double _t64 = _t13*_t22;
  const double _t65 = _hc1[4]*_t19;
  const double _t66 = _hc0[2]*params->h;
  const double _t67 = _hc1[1]*_t17;
  const double _t68 = _t10*_t67;
  const double _t69 = 0.2e1*_hc1[1]*_hc1[2]*_t14*_t43*params->h - _t65 - _t66*_t68;
  const double _t70 = _t6*_t69;
  const double _t71 = _hc1[5]*_t5;
  const double _t72 = _t22*_t49;
  const double _t73 = (_t22 * _t22);
  const double _t74 = _t6*_t73;
  const double _t75 = _hc1[5]*_t19;
  const double _t76 = ((_hc1[2]) * (_hc1[2]));
  const double _t77 = ((_hc0[2]) * (_hc0[2]));
  const double _t78 = 0.4e1*_t8;
  const double _t79 = _hc0[0]*_t78;
  const double _t80 = _hc0[2]*_t57;
  const double _t81 = _t4*_t77;
  const double _t82 = 0.2e1*_hc0[0]*_hc0[5]*_t3*_t8*params->h + 0.2e1*_t14*_t43*_t76*params->h - _t29*_t81 + 0.2e1*_t3*_t77*_t8*params->h - _t75 - _t79*_t80;
  const double _t83 = _t6*_t82;
#endif
#if _KMAX >= 3
  const double _t84 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t85 = _t7*_t84;
  const double _t86 = 0.12e2*_t27;
  const double _t87 = _hc0[0]*_t86;
  const double _t88 = _t85*_t87;
  const double _t89 = ((_hc0[0]) * (_hc0[0]) * (_hc0[0]));
  const double _t90 = (0.1e1 / (_t2 * _t2 * _t2));
  const double _t91 = _t89*_t90;
  const double _t92 = 0.16e2*_t91;
  const double _t93 = _t85*_t92;
  const double _t94 = _t84*_t87;
  const double _t95 = _t33*_t94;
  const double _t96 = ((params->h) * (params->h) * (params->h));
  const double _t97 = _t5*_t96;
  const double _t98 = _t17*_t97;
  const double _t99 = _t84*_t91;
  const double _t100 = 0.8e1*_t99;
  const double _t101 = _t100*_t98;
  const double _t102 = 0.24e2*_t99;
  const double _t103 = _t102*_t33;
  const double _t104 = _t13*_t34;
  const double _t105 = _t24*_t31;
  const double _t106 = _t105*_t17;
  const double _t107 = _t43*_t96;
  const double _t108 = _t107*_t14;
  const double _t109 = _t14*_t42;
  const double _t110 = _t11*_t40;
  const double _t111 = _t45*_t78;
  const double _t112 = _t111*_t14;
  const double _t113 = _t32*_t39;
  const double _t114 = (0.1e1 / ((_hc1[0]) * (_hc1[0]) * (_hc1[0]) * (_hc1[0])));
  const double _t115 = _t114*_t44;
  const double _t116 = _t46*_t97;
  const double _t117 = _t115*_t116;
  const double _t118 = _hc1[6]*_t5;
  const double _t119 = xc_powi((_hc1[0]), -5);
  const double _t120 = ((_hc1[1]) * (_hc1[1]) * (_hc1[1]));
  const double _t121 = _t119*_t120;
  const double _t122 = (_t14 * _t14 * _t14);
  const double _t123 = _t122*_t97;
  const double _t124 = _t121*_t123;
  const double _t125 = 0.3e1*_t47;
  const double _t126 = _t114*_t120;
  const double _t127 = _t24*_t50;
  const double _t128 = _t24*_t4;
  const double _t129 = 0.4e1*_t16;
  const double _t130 = _t129*_t28;
  const double _t131 = 0.4e1*_t22;
  const double _t132 = _t25*_t28;
  const double _t133 = _t24*_t33;
  const double _t134 = _t54*_t78;
  const double _t135 = _t4*_t78;
  const double _t136 = _hc0[4]*_t135;
  const double _t137 = _t24*params->h;
  const double _t138 = _t17*_t9;
  const double _t139 = _t137*_t138;
  const double _t140 = _t4*_t86;
  const double _t141 = _hc0[2]*_t140;
  const double _t142 = 0.8e1*_t28;
  const double _t143 = _t142*_t4;
  const double _t144 = _hc0[1]*_hc0[4];
  const double _t145 = _hc0[2]*_t4;
  const double _t146 = -_hc0[0]*_t141*_t24 + _hc0[1]*_t136 - _hc1[2]*_t139 + _t137*_t29*_t56 - _t143*_t144 + _t145*_t24*_t92;
  const double _t147 = 0.2e1*_t62;
  const double _t148 = _t39*params->h;
  const double _t149 = _t148*_t56;
  const double _t150 = _hc1[2]*_t39;
  const double _t151 = _t31*_t43;
  const double _t152 = _t151*_t38;
  const double _t153 = _t110*_t14;
  const double _t154 = _t13*_t60;
  const double _t155 = _hc1[4]*_t17;
  const double _t156 = _t11*params->h;
  const double _t157 = _t68*params->h;
  const double _t158 = _t58*params->h;
  const double _t159 = _t138*_t158;
  const double _t160 = 0.4e1*_hc0[0]*_hc0[1]*_hc1[1]*_hc1[2]*_t43*_t8*params->h + 0.4e1*_hc0[1]*_hc0[2]*_hc1[1]*_t1*_t17*_t27*params->h - _hc0[4]*_t157 - _hc1[1]*_t159 - _t155*_t156;
  const double _t161 = _hc1[7]*_t5;
  const double _t162 = _t16*_t19;
  const double _t163 = _t18*_t45;
  const double _t164 = _t31*_t46;
  const double _t165 = _t16*_t164;
  const double _t166 = _t22*_t42;
  const double _t167 = _t36*_t69;
  const double _t168 = _hc1[7]*_t19;
  const double _t169 = _t114*_t18;
  const double _t170 = 0.6e1*_t169;
  const double _t171 = _hc1[2]*_t44;
  const double _t172 = _t17*_t66;
  const double _t173 = _hc1[3]*_t10;
  const double _t174 = 0.4e1*_hc0[0]*_hc0[2]*_t43*_t44*_t8*params->h + 0.4e1*_hc1[1]*_hc1[4]*_t14*_t43*params->h + 0.2e1*_hc1[2]*_hc1[3]*_t14*_t43*params->h - _t168 - _t170*_t171 - _t172*_t173;
  const double _t175 = _t11*_t4;
  const double _t176 = -_t3*params->h;
  const double _t177 = pow(_t2, -_t176 - 0.1e1);
  const double _t178 = _t177*_t73;
  const double _t179 = 0.2e1*_t178;
  const double _t180 = _t129*_t22;
  const double _t181 = _t148*_t78;
  const double _t182 = _t181*_t56;
  const double _t183 = 0.4e1*_hc0[0]*_hc0[4]*_t3*_t8*params->h + 0.4e1*_hc0[1]*_hc0[2]*_t3*_t8*params->h - _t143*_t58 - _t182;
  const double _t184 = _t4*_t9;
  const double _t185 = _t156*_t17;
  const double _t186 = _hc0[4]*_t79;
  const double _t187 = _t57*_t58;
  const double _t188 = _hc0[1]*_t81;
  const double _t189 = _t43*_t76;
  const double _t190 = _hc0[1]*_hc0[5];
  const double _t191 = _hc0[1]*_hc0[5]*_t184 - _hc0[2]*_hc0[4]*_t143 + _hc0[2]*_t136 + _hc0[8]*_t21 - _hc1[5]*_t185 + _t142*_t187 + _t181*_t189 - _t186*_t57 - _t187*_t78 - _t188*_t87 + _t188*_t92 - _t190*_t59;
  const double _t192 = _hc1[8]*_t5;
  const double _t193 = _t13*_t73;
  const double _t194 = 0.2e1*_t64;
  const double _t195 = _t66*_t79;
  const double _t196 = 0.4e1*_hc1[1]*_hc1[2]*_t14*_t43*params->h - _t195*_t67 - 0.2e1*_t65;
  const double _t197 = _t13*_t82;
  const double _t198 = _hc1[8]*_t19;
  const double _t199 = _t170*_t76;
  const double _t200 = _t77*params->h;
  const double _t201 = _t138*_t200;
  const double _t202 = 0.8e1*_hc0[0]*_hc0[2]*_hc1[1]*_hc1[2]*_t43*_t8*params->h - _hc0[5]*_t157 + 0.2e1*_hc1[1]*_hc1[5]*_t14*_t43*params->h + 0.4e1*_hc1[1]*_t1*_t17*_t27*_t77*params->h - _hc1[1]*_t199 - _hc1[1]*_t201 + 0.4e1*_hc1[2]*_hc1[4]*_t14*_t43*params->h - _t155*_t195 - _t198;
  const double _t203 = _hc1[9]*_t5;
  const double _t204 = 0.3e1*_t71;
  const double _t205 = (_t22 * _t22 * _t22);
  const double _t206 = 0.3e1*_t16;
  const double _t207 = _hc0[0]*_t8;
  const double _t208 = 0.8e1*_t207;
  const double _t209 = 0.4e1*_hc0[0]*_hc0[5]*_t3*_t8*params->h + 0.4e1*_t14*_t43*_t76*params->h - _t142*_t81 - _t208*_t80 + 0.4e1*_t3*_t77*_t8*params->h - 0.2e1*_t75;
  const double _t210 = _hc1[9]*_t19;
  const double _t211 = ((_hc1[2]) * (_hc1[2]) * (_hc1[2]));
  const double _t212 = _t169*_t211;
  const double _t213 = 0.6e1*_t8;
  const double _t214 = _hc0[0]*_t213;
  const double _t215 = _hc1[5]*_t214;
  const double _t216 = _hc0[0]*_hc0[5];
  const double _t217 = _t213*_t57;
  const double _t218 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t219 = _t140*_t218;
  const double _t220 = _t200*_t213;
  const double _t221 = _t1*_t141;
  const double _t222 = 0.12e2*_hc0[0]*_hc0[2]*_t43*_t76*_t8*params->h + 0.2e1*_hc0[0]*_hc0[9]*_t3*_t8*params->h - _hc0[0]*_t219 + 0.6e1*_hc0[2]*_hc0[5]*_t3*_t8*params->h - _hc0[5]*_t221 + 0.6e1*_hc1[2]*_hc1[5]*_t14*_t43*params->h + 0.12e2*_hc1[2]*_t1*_t17*_t27*_t77*params->h - _t172*_t215 - _t210 - 0.6e1*_t212 - _t216*_t217 + 0.16e2*_t218*_t3*_t89*_t90*params->h - _t220*_t56;
#endif
#if _KMAX >= 4
  const double _t223 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t224 = _t223*_t7;
  const double _t225 = 0.96e2*_t224;
  const double _t226 = _t1*_t90;
  const double _t227 = ((_hc0[0]) * (_hc0[0]) * (_hc0[0]) * (_hc0[0]))/(_t2 * _t2 * _t2 * _t2);
  const double _t228 = _t223*_t33;
  const double _t229 = _t223*_t98;
  const double _t230 = ((params->h) * (params->h) * (params->h) * (params->h));
  const double _t231 = _t230*_t5;
  const double _t232 = 0.16e2*_t43;
  const double _t233 = 0.96e2*_t227;
  const double _t234 = _t13*_t40;
  const double _t235 = _t84*_t92;
  const double _t236 = _t13*_t235;
  const double _t237 = _t13*_t14;
  const double _t238 = _t34*_t40;
  const double _t239 = _t238*_t42;
  const double _t240 = _t24*_t32;
  const double _t241 = _t142*_t45;
  const double _t242 = _t240*_t241;
  const double _t243 = _t105*_t138;
  const double _t244 = 0.16e2*_t28;
  const double _t245 = _t115*_t14;
  const double _t246 = _t119*_t44;
  const double _t247 = _t246*_t46;
  const double _t248 = 0.12e2*_t8;
  const double _t249 = _t113*_t14;
  const double _t250 = xc_powi((_hc1[0]), -6);
  const double _t251 = _hc1[10]*_t5;
  const double _t252 = ((_hc1[1]) * (_hc1[1]) * (_hc1[1]) * (_hc1[1]));
  const double _t253 = _t164*_t43;
  const double _t254 = _t122*_t96;
  const double _t255 = _t115*_t164;
  const double _t256 = _t16*_t40;
  const double _t257 = _t25*_t60;
  const double _t258 = _t1*_t86;
  const double _t259 = _hc0[0]*_t27;
  const double _t260 = 0.36e2*_t259;
  const double _t261 = _t34*_t4;
  const double _t262 = _hc1[2]*_t105*_t43;
  const double _t263 = _hc1[2]*_t114;
  const double _t264 = _t14*_t64;
  const double _t265 = 0.4e1*_t69;
  const double _t266 = _t67*_t78;
  const double _t267 = _t266*params->h;
  const double _t268 = _hc1[1]*_hc1[2];
  const double _t269 = _t268*_t43;
  const double _t270 = _t137*_t142;
  const double _t271 = _t67*_t92;
  const double _t272 = _hc0[2]*_t137;
  const double _t273 = _t155*_t181;
  const double _t274 = _hc1[3]*_t17;
  const double _t275 = _t148*_t8;
  const double _t276 = _t151*_t78;
  const double _t277 = _hc1[3]*_t43;
  const double _t278 = _t14*_t31*_t39;
  const double _t279 = _t49*_t8;
  const double _t280 = 0.8e1*_t8;
  const double _t281 = _t16*_t39;
  const double _t282 = _t131*_t8;
  const double _t283 = _t42*_t60;
  const double _t284 = _t160*_t36;
  const double _t285 = _t17*_t173*params->h;
  const double _t286 = _hc1[1]*_hc1[4];
  const double _t287 = _t148*_t280;
  const double _t288 = _hc1[2]*_t277;
  const double _t289 = _t186*params->h;
  const double _t290 = _t158*_t78;
  const double _t291 = _t148*_t248;
  const double _t292 = _t114*_t291;
  const double _t293 = 0.3e1*_t13;
  const double _t294 = 0.3e1*_t42;
  const double _t295 = _t18*_t43;
  const double _t296 = _t120*_t16;
  const double _t297 = 0.3e1*_t62;
  const double _t298 = _t118*_t22;
  const double _t299 = _t294*_t69;
  const double _t300 = 0.3e1*_t22;
  const double _t301 = _t174*_t293;
  const double _t302 = 0.18e2*_t169;
  const double _t303 = _t268*_t302;
  const double _t304 = _hc1[4]*_t302;
  const double _t305 = 0.4e1*_t1*pow(_t2, -_t176 - 0.2e1)*_t73;
  const double _t306 = _t16*_t22;
  const double _t307 = 0.8e1*_t50;
  const double _t308 = 0.24e2*_t259;
  const double _t309 = _t145*_t24;
  const double _t310 = 0.32e2*_t91;
  const double _t311 = ((_hc0[4]) * (_hc0[4]));
  const double _t312 = _t4*_t58;
  const double _t313 = _t81*_t86;
  const double _t314 = _hc1[5]*_t17;
  const double _t315 = _t183*_t64;
  const double _t316 = _t13*_t191;
  const double _t317 = _hc0[4]*_t66;
  const double _t318 = _hc1[1]*_t76;
  const double _t319 = _t158*_t28;
  const double _t320 = _t42*_t73;
  const double _t321 = _t194*_t196;
  const double _t322 = _t42*_t82;
  const double _t323 = 0.12e2*_t169;
  const double _t324 = _t172*_t79;
  const double _t325 = _t202*_t36;
  const double _t326 = 0.4e1*_t295;
  const double _t327 = _t207*_t66;
  const double _t328 = _t208*_t66;
  const double _t329 = _t216*params->h;
  const double _t330 = _t200*_t78;
  const double _t331 = _t114*_t327;
  const double _t332 = 0.6e1*_t71;
  const double _t333 = _t206*_t22;
  const double _t334 = _t1*_t140;
  const double _t335 = _t208*_t57;
  const double _t336 = _t27*_t81;
  const double _t337 = _t145*_t244;
  const double _t338 = 0.12e2*_t56;
  const double _t339 = _t338*_t8;
  const double _t340 = _t114*_t211;
  const double _t341 = _t218*_t4;
  const double _t342 = _t13*_t205;
  const double _t343 = 0.3e1*_t75;
  const double _t344 = 0.3e1*_t20;
  const double _t345 = _t66*_t67;
  const double _t346 = _t209*_t64;
  const double _t347 = _t64*_t82;
  const double _t348 = _t13*_t222;
  const double _t349 = _t200*_t28;
  const double _t350 = 0.12e2*_hc1[5]*_t17;
  const double _t351 = _t200*_t8;
  const double _t352 = 0.24e2*_hc0[5];
  const double _t353 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t354 = ((_hc0[5]) * (_hc0[5]));
#endif
  ...
  out[2] = df_dxs0;
  const double df_dxt = _t12;
  out[3] = df_dxt;
  const double df_dz = -_t13*_t15 + _t13;
  out[4] = df_dz;
  const double df_drs = _t16 + _t23;
  out[5] = df_drs;
#endif
#if _KMAX >= 2
  ...
  out[10] = d2f_dxt_dxs0;
  const double d2f_dxt2 = _t26 - _t30 + _t35;
  out[11] = d2f_dxt2;
  const double d2f_dz_dxs1 = 0;
  out[12] = d2f_dz_dxs1;
  const double d2f_dz_dxs0 = 0;
  out[13] = d2f_dz_dxs0;
  const double d2f_dz_dxt = -_t38*_t41;
  out[14] = d2f_dz_dxt;
  const double d2f_dz2 = -_t15*_t42 + _t42 + _t48;
  out[15] = d2f_dz2;
  const double d2f_drs_dxs1 = 0;
  out[16] = d2f_drs_dxs1;
  const double d2f_drs_dxs0 = 0;
  out[17] = d2f_drs_dxs0;
  const double d2f_drs_dxt = _t49*_t51 + _t55 + _t61;
  out[18] = d2f_drs_dxt;
  const double d2f_drs_dz = -_t15*_t64 + _t62 - _t63 + _t64 + _t70;
  out[19] = d2f_drs_dz;
  const double d2f_drs2 = _t71 + _t72 + _t74 + _t83;
  out[20] = d2f_drs2;
#endif
#if _KMAX >= 3
  ...
  const double d3f_dxt3 = _t101 - _t103 - _t88 + _t93 + _t95;
  out[30] = d3f_dxt3;
  ...
  const double d3f_dz_dxt2 = 0.4e1*_hc1[1]*_t1*_t14*_t17*_t24*_t27*_t31*_t5 - _t104*_t108 - _t104*_t40 - _t106*_t38;
  out[36] = d3f_dz_dxt2;
  const double d3f_dz2_dxs1 = 0;
  out[37] = d3f_dz2_dxs1;
  const double d3f_dz2_dxs0 = 0;
  out[38] = d3f_dz2_dxs0;
  const double d3f_dz2_dxt = -_t109*_t110 + _t11*_t117 + _t112*_t113;
  out[39] = d3f_dz2_dxt;
  const double d3f_dz3 = 0.3e1*_hc1[1]*_hc1[3]*_t31*_t43*_t46*_t5 + _hc1[6]*_t5 - _t118*_t15 - _t124 - _t125*_t126;
  out[40] = d3f_dz3;
  ...
  const double d3f_drs_dxt2 = _t106*_t130 + _t127*_t49 - _t128*_t130 - _t131*_t132 + _t131*_t133*_t28 + _t134*_t60 + _t146*_t6 + _t25*_t53;
  out[46] = d3f_drs_dxt2;
  const double d3f_drs_dz_dxs1 = 0;
  out[47] = d3f_drs_dz_dxs1;
  const double d3f_drs_dz_dxs0 = 0;
  out[48] = d3f_drs_dz_dxs0;
  const double d3f_drs_dz_dxt = _t12*_t69 + _t147*_t51 - _t149*_t37 - _t15*_t154 - _t150*_t152 - _t153*_t64 + _t154 + _t160*_t6;
  out[49] = d3f_drs_dz_dxt;
  const double d3f_drs_dz2 = -_hc1[3]*_t162 + _t115*_t165 - _t15*_t166 - _t15*_t167 + _t161 + _t163*_t49 + _t166 + _t167 + _t174*_t6 + _t22*_t48 - _t36*_t65;
  out[50] = d3f_drs_dz2;
  const double d3f_drs2_dxs1 = 0;
  out[51] = d3f_drs2_dxs1;
  const double d3f_drs2_dxs0 = 0;
  out[52] = d3f_drs2_dxs0;
  const double d3f_drs2_dxt = _t12*_t82 + _t148*_t179 + _t175*_t71 + _t180*_t51 + _t183*_t23 + _t191*_t6 + _t49*_t60;
  out[53] = d3f_drs2_dxt;
  const double d3f_drs2_dz = -_t13*_t75 + _t147*_t22 - _t15*_t193 - _t15*_t197 + _t192 + _t193 - _t194*_t20 + _t196*_t23 + _t197 + _t202*_t6 + _t49*_t69;
  out[54] = d3f_drs2_dz;
  const double d3f_drs3 = _t203 + _t204*_t22 + _t205*_t6 + _t206*_t73 + _t206*_t82 + _t209*_t23 + _t222*_t6 + _t23*_t82;
  out[55] = d3f_drs3;
#endif
#if _KMAX >= 4
  ...
  const double d4f_dxt4 = _t223*_t227*_t231*_t232 - _t224*_t86 + _t225*_t226 - _t225*_t227 - 0.144e3*_t226*_t228 + 0.48e2*_t226*_t229 + 0.176e3*_t227*_t228 + _t228*_t86 - _t229*_t233;
  out[70] = d4f_dxt4;
  ...
  const double d4f_dz_dxt3 = 0.12e2*_hc0[0]*_hc1[1]*_t14*_t17*_t27*_t31*_t5*_t84 + 0.24e2*_hc1[1]*_t14*_t43*_t5*_t84*_t89*_t90*_t96 + 0.24e2*_hc1[1]*_t17*_t31*_t5*_t84*_t89*_t90 - _t100*_t114*_t230*_t237 - _t107*_t236 - _t108*_t13*_t94 - _t14*_t236*_t40 - _t234*_t94;
  out[80] = d4f_dz_dxt3;
  ...
  const double d4f_dz2_dxt2 = -_t107*_t109*_t34 - _t109*_t243 + _t112*_t240 + _t117*_t24*_t9 - _t117*_t34 + _t14*_t239 - _t14*_t242 + _t231*_t247*_t34 - _t239 + _t24*_t244*_t245*_t97 + _t242;
  out[86] = d4f_dz2_dxt2;
  const double d4f_dz3_dxs1 = 0;
  out[87] = d4f_dz3_dxs1;
  const double d4f_dz3_dxs0 = 0;
  out[88] = d4f_dz3_dxs0;
  const double d4f_dz3_dxt = 0.6e1*_hc0[0]*_hc0[1]*_hc1[1]*_hc1[3]*_t114*_t46*_t5*_t8*_t96 + 0.12e2*_hc0[0]*_hc0[1]*_hc1[1]*_hc1[3]*_t14*_t31*_t43*_t5*_t8 - _t11*_t120*_t122*_t231*_t250 - _t116*_t121*_t248*_t39 - _t118*_t153 - _t126*_t248*_t249;
  out[89] = d4f_dz3_dxt;
  const double d4f_dz4 = ((_hc1[3]) * (_hc1[3]))*_t125*_t43 + 0.4e1*_hc1[6]*_t13*_t253 + 0.12e2*_t119*_t252*_t47 + 0.8e1*_t123*_t250*_t252 - _t15*_t251 - 0.6e1*_t246*_t254*_t42 + _t251 - 0.18e2*_t255*_t42 + (_t14 * _t14 * _t14 * _t14)*_t231*_t252/xc_powi((_hc1[0]), 7);
  out[90] = d4f_dz4;
  ...
  const double d4f_drs_dxt3 = -_hc0[0]*_t140*_t16*_t84 + _t100*_t107*_t16 + _t101*_t22 - _t102*_t256 - _t103*_t22 + _t133*_t258*_t60 + _t146*_t213*_t54 + _t16*_t235*_t4 + _t213*_t257 - _t22*_t88 + _t22*_t93 + _t22*_t95 + _t256*_t94 - _t257*_t258 + _t6*(0.12e2*_hc0[0]*_hc1[2]*_t17*_t27*_t84*params->h + 0.96e2*_hc0[2]*_t1*_t3*_t84*_t90*params->h - _hc0[4]*_t128*_t260 + 0.48e2*_hc0[4]*_t24*_t3*_t89*_t90*params->h - _t141*_t84 - _t145*_t233*_t84 - _t235*_t57);
  ...
  const double d4f_drs_dz_dxt2 = 0.4e1*_hc0[0]*_hc0[1]*_t160*_t5*_t8*params->h + _hc1[0]*_t5*(0.12e2*_hc0[0]*_hc0[2]*_hc1[1]*_t17*_t24*_t27*params->h + 0.8e1*_hc0[1]*_hc0[4]*_hc1[1]*_t1*_t17*_t27*params->h + 0.4e1*_hc1[1]*_hc1[2]*_t24*_t43*_t8*params->h + 0.4e1*_hc1[4]*_t1*_t17*_t24*_t27*params->h - _hc1[4]*_t139 - _t144*_t267 - _t269*_t270 - _t271*_t272) + 0.4e1*_hc1[1]*_hc1[2]*_t1*_t14*_t24*_t27*_t31*_t43*_t5 + 0.4e1*_hc1[1]*_hc1[2]*_t1*_t17*_t24*_t27*_t5*params->h + 0.4e1*_hc1[1]*_t1*_t14*_t17*_t22*_t24*_t27*_t31*_t5 + _hc1[1]*_t146*_t5 + 0.4e1*_hc1[4]*_t1*_t17*_t24*_t27*_t31*_t5 + 0.2e1*_hc1[4]*_t24*_t3*_t5*_t8*params->h + 0.4e1*_t1*_t24*_t27*_t3*_t31*_t5*_t69 - _t104*_t14*_t263*_t96 - _t108*_t34*_t64 - _t13*_t142*_t262 - _t13*_t146*_t15 - _t132*_t265 - _t137*_t37*_t56 - _t14*_t154*_t41*_t78 - _t238*_t64 + 0.2e1*_t24*_t5*_t69*_t8*params->h - _t243*_t264 - _t261*_t62 - _t262*_t38;
  ...
  const double d4f_drs_dz2_dxt = -_hc1[4]*_t237*_t276*_t39 + _t117*_t39*_t53 + _t12*_t174 + _t129*_t275*_t45 - _t13*_t273 - _t14*_t234*_t265*_t39*_t8 - _t15*_t283 - _t15*_t284 - _t153*_t166 + _t161*_t175 + _t245*_t280*_t281*_t31 + _t247*_t279*_t39*_t96 + _t249*_t282*_t45 - _t274*_t275*_t49 - _t277*_t278*_t279 + _t283 + _t284 + _t48*_t60 + _t6*(-_hc0[4]*_t285 - _hc1[3]*_t159 - _hc1[7]*_t185 - _t158*_t241 + _t158*_t274*_t29 - _t171*_t292 + _t181*_t288 + _t286*_t287*_t43 + _t289*_t45 + _t290*_t45);
  out[109] = d4f_drs_dz2_dxt;
  const double d4f_drs_dz3 = _hc1[11]*_t5 + 0.6e1*_hc1[2]*_hc1[3]*_t13*_t295 + _hc1[3]*_t164*_t263*_t293 + 0.3e1*_hc1[3]*_t253*_t64 - _hc1[6]*_t162 - 0.6e1*_t121*_t165 - _t124*_t22 - _t126*_t300*_t47 - _t15*_t298 - _t15*_t299 - _t15*_t301 + 0.6e1*_t163*_t62 - _t168*_t293 - _t170*_t296 - _t250*_t254*_t296 + _t255*_t297 - _t294*_t65 + _t298 + _t299 + _t301 + 0.3e1*_t48*_t69 + _t6*(0.12e2*_hc0[0]*_hc0[2]*_hc1[1]*_hc1[3]*_t43*_t8*params->h - 0.12e2*_hc0[2]*_t126*_t207*params->h + 0.6e1*_hc1[1]*_hc1[7]*_t14*_t43*params->h - _hc1[11]*_t19 + 0.2e1*_hc1[2]*_hc1[6]*_t14*_t43*params->h + 0.24e2*_hc1[2]*_t119*_t120*_t14*params->h + 0.6e1*_hc1[3]*_hc1[4]*_t14*_t43*params->h - _hc1[3]*_t303 - _hc1[6]*_t10*_t172 - _t304*_t44);
  out[110] = d4f_drs_dz3;
  ...
  const double d4f_drs2_dxt2 = _t105*_t3*_t305 + _t106*_t142*_t306 + _t127*_t180 + _t134*_t191 + _t137*_t179 - _t137*_t305 - _t143*_t24*_t306 + _t146*_t49 + _t183*_t282*_t54 + _t183*_t61 + _t184*_t24*_t71 + _t23*(-_t137*_t56*_t78 - _t144*_t244*_t4 + _t144*_t307 + _t270*_t56 - _t308*_t309 + _t309*_t310) + _t238*_t71 + _t26*_t82 - _t261*_t71 + _t281*_t307*_t60 - _t30*_t82 + _t35*_t82 + _t6*(0.24e2*_hc0[0]*_hc0[2]*_hc1[2]*_t17*_t24*_t27*params->h + 0.64e2*_hc0[1]*_hc0[2]*_hc0[4]*_t3*_t89*_t90*params->h + 0.16e2*_hc0[1]*_hc0[4]*_hc1[2]*_t1*_t17*_t27*params->h - _hc0[1]*_hc0[8]*_t143 + 0.4e1*_hc0[1]*_hc0[8]*_t3*_t8*params->h - 0.48e2*_hc0[4]*_t259*_t312 + 0.16e2*_hc0[5]*_t24*_t3*_t89*_t90*params->h + 0.4e1*_hc1[5]*_t1*_t17*_t24*_t27*params->h - _hc1[5]*_t139 + 0.96e2*_t1*_t24*_t3*_t77*_t90*params->h - _t140*_t216*_t24 - _t143*_t311 - _t144*_t280*_t57 - _t189*_t270 - _t233*_t24*_t81 - _t24*_t313 + 0.4e1*_t24*_t43*_t76*_t8*params->h - _t272*_t310*_t56 + 0.4e1*_t3*_t311*_t8*params->h);
  ...
  const double d4f_drs2_dz_dxt = -_hc1[5]*_t152*_t39 + _t12*_t202 + _t131*_t51*_t62 + _t147*_t60 - _t148*_t314*_t37 - _t15*_t315 - _t15*_t316 - _t150*_t264*_t276 - _t153*_t197 - 0.2e1*_t154*_t20 + _t16*_t265*_t51 + _t160*_t49 + _t175*_t192 - _t179*_t278*_t67 - _t182*_t64 + _t196*_t55 + _t196*_t61 + _t23*(0.8e1*_hc0[0]*_hc0[1]*_hc1[1]*_hc1[2]*_t43*_t8*params->h + 0.8e1*_hc0[1]*_hc0[2]*_hc1[1]*_t1*_t17*_t27*params->h - _t158*_t266 - _t273 - _t289*_t67) + _t315 + _t316 + _t6*(0.4e1*_hc0[0]*_hc0[1]*_hc1[1]*_hc1[5]*_t43*_t8*params->h + 0.12e2*_hc0[0]*_hc0[1]*_hc1[1]*_t17*_t27*_t77*params->h + 0.8e1*_hc0[0]*_hc0[1]*_hc1[2]*_hc1[4]*_t43*_t8*params->h + 0.8e1*_hc0[0]*_hc0[4]*_hc1[1]*_hc1[2]*_t43*_t8*params->h + 0.8e1*_hc0[1]*_hc0[2]*_hc1[1]*_hc1[2]*_t43*_t8*params->h + 0.8e1*_hc0[1]*_hc0[2]*_hc1[4]*_t1*_t17*_t27*params->h + 0.4e1*_hc0[1]*_hc0[5]*_hc1[1]*_t1*_t17*_t27*params->h - _hc0[1]*_t200*_t271 + 0.8e1*_hc0[2]*_hc0[4]*_hc1[1]*_t1*_t17*_t27*params->h - _hc0[8]*_t157 - _hc1[1]*_t138*_t190*params->h - _hc1[8]*_t185 - _t155*_t289 - _t155*_t290 - _t232*_t268*_t319 - _t266*_t317 - _t292*_t318);
  out[119] = d4f_drs2_dz_dxt;
  const double d4f_drs2_dz2 = _hc1[12]*_t5 - _hc1[3]*_t19*_t72 - _t15*_t320 - _t15*_t321 - _t15*_t322 - _t15*_t325 + _t161*_t52 + _t163*_t180 + 0.2e1*_t163*_t71 + _t174*_t49 + _t196*_t70 - _t198*_t36 + _t23*(0.8e1*_hc0[0]*_hc0[2]*_t43*_t44*_t8*params->h + 0.8e1*_hc1[1]*_hc1[4]*_t14*_t43*params->h + 0.4e1*_hc1[2]*_hc1[3]*_t14*_t43*params->h - _hc1[3]*_t324 - 0.2e1*_t168 - _t171*_t323) + _t255*_t71 + _t255*_t72 + _t265*_t62 - _t265*_t63 + _t320 + _t321 + _t322 + _t325 - _t42*_t75 + _t48*_t73 + _t48*_t82 + _t6*(-_hc0[5]*_t285 + _hc1[1]*_hc1[8]*_t326 - _hc1[12]*_t19 + _hc1[2]*_hc1[7]*_t326 + 0.2e1*_hc1[3]*_hc1[5]*_t295 - _hc1[3]*_t199 - _hc1[3]*_t201 + ((_hc1[4]) * (_hc1[4]))*_t326 - 0.24e2*_hc1[4]*_t169*_t268 - _hc1[5]*_t170*_t44 - _hc1[7]*_t324 + _t111*_t329 + 0.24e2*_t119*_t18*_t44*_t76 - _t142*_t200*_t45 - 0.24e2*_t171*_t331 + _t200*_t274*_t29 + _t232*_t286*_t327 + _t288*_t328 + _t330*_t45) - 0.4e1*_t64*_t65;
  out[120] = d4f_drs2_dz2;
  const double d4f_drs3_dxs1 = 0;
  out[121] = d4f_drs3_dxs1;
  const double d4f_drs3_dxs0 = 0;
  out[122] = d4f_drs3_dxs0;
  const double d4f_drs3_dxt = _t12*_t222 + 0.2e1*_t148*_t177*_t205 + 0.6e1*_t150*_t178*_t4 + _t175*_t203 + _t183*_t333 + _t191*_t206 + _t191*_t23 + _t204*_t60 + _t209*_t55 + _t209*_t61 + _t213*_t281*_t4*_t82 + _t22*_t332*_t51 + _t23*(_hc0[0]*_hc0[8]*_t135 + _hc0[1]*_hc0[5]*_t135 + _hc0[2]*_hc0[4]*_t307 - _hc0[4]*_t335 - _hc0[4]*_t337 - _t143*_t190 - _t181*_t314 + _t187*_t244 - _t187*_t280 + _t188*_t310 + _t189*_t287 - 0.24e2*_t336*_t39) + _t55*_t82 + _t6*(0.12e2*_hc0[0]*_hc0[1]*_hc1[2]*_hc1[5]*_t43*_t8*params->h + 0.36e2*_hc0[0]*_hc0[1]*_hc1[2]*_t17*_t27*_t77*params->h + 0.2e1*_hc0[0]*_hc0[13]*_t3*_t8*params->h + 0.12e2*_hc0[0]*_hc0[4]*_t43*_t76*_t8*params->h + 0.48e2*_hc0[1]*_hc0[2]*_hc0[5]*_t3*_t89*_t90*params->h + 0.12e2*_hc0[1]*_hc0[2]*_hc1[5]*_t1*_t17*_t27*params->h + 0.12e2*_hc0[1]*_hc0[2]*_t43*_t76*_t8*params->h + 0.12e2*_hc0[1]*_hc0[5]*_hc1[2]*_t1*_t17*_t27*params->h + 0.2e1*_hc0[1]*_hc0[9]*_t3*_t8*params->h - _hc0[1]*_hc0[9]*_t59 + 0.96e2*_hc0[1]*_t1*_t218*_t3*_t90*params->h - 0.48e2*_hc0[1]*_t200*_t56*_t91 - _hc0[1]*_t219 - _hc0[1]*_t233*_t341 + 0.24e2*_hc0[2]*_hc0[4]*_hc1[2]*_t1*_t17*_t27*params->h + 0.6e1*_hc0[2]*_hc0[8]*_t3*_t8*params->h + 0.6e1*_hc0[4]*_hc0[5]*_t3*_t8*params->h - _hc0[4]*_hc0[5]*_t334 - _hc0[4]*_t17*_t215*params->h - _hc0[4]*_t260*_t81 + 0.48e2*_hc0[4]*_t3*_t77*_t89*_t90*params->h - _hc0[8]*_t214*_t57 - _hc0[8]*_t221 - _hc1[9]*_t185 - _t158*_t213*_t314 - 0.24e2*_t189*_t319 - _t190*_t217 - 0.36e2*_t216*_t27*_t312 - _t291*_t340 - _t317*_t339) + _t61*_t82 + _t74*(0.6e1*_hc0[0]*_hc0[4]*_t3*_t8*params->h + 0.6e1*_hc0[1]*_hc0[2]*_t3*_t8*params->h - _t149*_t213 - _t334*_t58);
  out[123] = d4f_drs3_dxt;
  const double d4f_drs3_dz = _hc1[13]*_t5 - _t13*_t210 - _t15*_t342 - _t15*_t346 - _t15*_t347 - _t15*_t348 + _t192*_t300 - _t193*_t344 + _t196*_t333 - _t197*_t344 + _t202*_t206 + _t202*_t23 + _t204*_t69 + _t209*_t70 + _t23*(0.16e2*_hc0[0]*_hc0[2]*_hc1[1]*_hc1[2]*_t43*_t8*params->h + 0.4e1*_hc1[1]*_hc1[5]*_t14*_t43*params->h + 0.8e1*_hc1[1]*_t1*_t17*_t27*_t77*params->h + 0.8e1*_hc1[2]*_hc1[4]*_t14*_t43*params->h - _t155*_t328 - 0.2e1*_t198 - _t216*_t267 - _t318*_t323 - _t330*_t67) + _t297*_t73 + _t297*_t82 + _t342 - _t343*_t64 + _t346 + _t347 + _t348 + _t6*(0.12e2*_hc0[0]*_hc0[2]*_hc1[1]*_hc1[5]*_t43*_t8*params->h + 0.24e2*_hc0[0]*_hc0[2]*_hc1[2]*_hc1[4]*_t43*_t8*params->h + 0.12e2*_hc0[0]*_hc0[5]*_hc1[1]*_hc1[2]*_t43*_t8*params->h + 0.12e2*_hc0[0]*_hc1[1]*_t17*_t218*_t27*params->h + 0.12e2*_hc0[2]*_hc0[5]*_hc1[1]*_t1*_t17*_t27*params->h - _hc0[5]*_t213*_t345 - _hc0[9]*_t157 + 0.12e2*_hc1[1]*_hc1[2]*_t43*_t77*_t8*params->h + 0.2e1*_hc1[1]*_hc1[9]*_t14*_t43*params->h + 0.24e2*_hc1[1]*_t119*_t14*_t211*params->h - _hc1[13]*_t19 + 0.6e1*_hc1[2]*_hc1[8]*_t14*_t43*params->h + 0.6e1*_hc1[4]*_hc1[5]*_t14*_t43*params->h + 0.12e2*_hc1[4]*_t1*_t17*_t27*_t77*params->h - _hc1[5]*_t303 - _hc1[8]*_t172*_t214 - _t155*_t213*_t329 - _t155*_t220 - _t218*_t271*params->h - 0.24e2*_t269*_t349 - _t304*_t76 - 0.36e2*_t318*_t331) + _t70*_t82 + _t74*(0.6e1*_hc1[1]*_hc1[2]*_t14*_t43*params->h - _t214*_t345 - 0.3e1*_t65);
  out[124] = d4f_drs3_dz;
  const double d4f_drs4 = _hc1[14]*_t5 + _t129*_t205 + _t129*_t222 + _t131*_t203 + _t180*_t209 + _t180*_t82 + _t209*_t74 + _t209*_t83 + (_t22 * _t22 * _t22 * _t22)*_t6 + 0.2e1*_t222*_t23 + _t23*(0.24e2*_hc0[0]*_hc0[2]*_t43*_t76*_t8*params->h + 0.4e1*_hc0[0]*_hc0[9]*_t3*_t8*params->h + 0.12e2*_hc0[2]*_hc0[5]*_t3*_t8*params->h + 0.12e2*_hc1[2]*_hc1[5]*_t14*_t43*params->h + 0.24e2*_hc1[2]*_t1*_t17*_t27*_t77*params->h - _t145*_t28*_t352 - 0.2e1*_t210 - 0.12e2*_t212 + 0.32e2*_t218*_t3*_t89*_t90*params->h - _t308*_t341 - _t327*_t350 - _t329*_t339 - _t338*_t351) + _t332*_t73 + _t332*_t82 + _t6*(_t82 * _t82) + _t6*(0.2e1*_hc0[0]*_hc0[14]*_t3*_t8*params->h + 0.48e2*_hc0[0]*_hc0[2]*_hc1[2]*_hc1[5]*_t43*_t8*params->h + 0.24e2*_hc0[0]*_hc0[5]*_t43*_t76*_t8*params->h + 0.48e2*_hc0[0]*_hc1[2]*_t17*_t218*_t27*params->h + 0.48e2*_hc0[2]*_hc0[5]*_hc1[2]*_t1*_t17*_t27*params->h + 0.8e1*_hc0[2]*_hc0[9]*_t3*_t8*params->h + 0.96e2*_hc0[5]*_t3*_t77*_t89*_t90*params->h - _hc0[9]*_t335 - _hc0[9]*_t337 - _hc1[14]*_t19 + 0.24e2*((_hc1[2]) * (_hc1[2]) * (_hc1[2]) * (_hc1[2]))*_t119*_t14*params->h + 0.8e1*_hc1[2]*_hc1[9]*_t14*_t43*params->h + 0.6e1*((_hc1[5]) * (_hc1[5]))*_t14*_t43*params->h + 0.24e2*_hc1[5]*_t1*_t17*_t27*_t77*params->h - 0.36e2*_hc1[5]*_t169*_t76 - _hc1[9]*_t172*_t208 + 0.96e2*_t1*_t3*_t353*_t90*params->h - _t140*_t353 - 0.48e2*_t189*_t349 - 0.72e2*_t216*_t336 - 0.64e2*_t218*_t57*_t91 - _t233*_t353*_t4 + 0.6e1*_t3*_t354*_t8*params->h - 0.48e2*_t327*_t340 - _t329*_t350*_t8 - _t334*_t354 - _t350*_t351 - _t352*_t8*_t80 + 0.24e2*_t43*_t76*_t77*_t8*params->h) + _t74*_t82 + _t74*(0.6e1*_hc0[0]*_hc0[5]*_t3*_t8*params->h - _t1*_t313 + 0.6e1*_t14*_t43*_t76*params->h + 0.6e1*_t3*_t77*_t8*params->h - _t327*_t338 - _t343);
  out[125] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f_chachiyo_gga_z0_k, _KMAX)(const xc_func_type *p, double rs, double xt, double xs0, double xs1, double *out) {
  const gga_c_chachiyo_params *params = (const gga_c_chachiyo_params *)(p->params);

  double _hc0[(_KMAX) >= 4 ? 15 : (_KMAX) >= 3 ? 10 : (_KMAX) >= 2 ? 6 : (_KMAX) >= 1 ? 3 : 1];
  XC_CAT(cha_t_k, _KMAX)(p, rs, xt, _hc0);
  double _hc1[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(f_chachiyo_zeta0_k, _KMAX)(p, rs, _hc1);
  const double _t1 = ((_hc0[0]) * (_hc0[0]));
  const double _t2 = _t1 + 0.1e1;
  const double _t3 = (0.1e1 / (_hc1[0]));
  const double _t4 = _t3*params->h;
  ...
  const double _t15 = log(_t2);
  const double _t16 = _t15*params->h;
  const double _t17 = _t14*_t16;
  const double _t18 = _t10*_t4;
  const double _t19 = _hc0[2]*_t18 - _hc1[1]*_t17;
  ...
  const double _t28 = ((params->h) * (params->h));
  const double _t29 = _t28*_t3;
  const double _t30 = _t29*_t5;
  const double _t31 = _t21*_t26;
  const double _t32 = _t30*_t31;
  const double _t33 = 0.2e1*_t13;
  const double _t34 = _t4*_t8;
  const double _t35 = _t33*_t34;
  const double _t36 = _hc0[0]*_hc0[1];
  const double _t37 = _t12*_t19;
  const double _t38 = _hc1[1]*_t14;
  const double _t39 = _t38*params->h;
  const double _t40 = _hc0[1]*_hc0[2];
  const double _t41 = _t26*_t4;
  const double _t42 = 0.2e1*_hc0[0]*_hc0[4]*_t3*_t8*params->h + 0.2e1*_hc0[1]*_hc0[2]*_t3*_t8*params->h - _t11*_t39 - _t40*_t41;
  const double _t43 = _t42*_t6;
  const double _t44 = _hc1[2]*_t5;
  const double _t45 = (_t19 * _t19);
  const double _t46 = _t45*_t6;
  const double _t47 = _hc1[2]*_t17;
  const double _t48 = (0.1e1 / ((_hc1[0]) * (_hc1[0]) * (_hc1[0])));
  const double _t49 = ((_hc1[1]) * (_hc1[1]));
  const double _t50 = ((_hc0[2]) * (_hc0[2]));
  const double _t51 = 0.4e1*_t8;
  const double _t52 = _t38*_t51;
  const double _t53 = _hc0[0]*params->h;
  const double _t54 = _hc0[2]*_t53;
  const double _t55 = _t4*_t50;
  const double _t56 = 0.2e1*_hc0[0]*_hc0[5]*_t3*_t8*params->h + 0.2e1*_t15*_t48*_t49*params->h - _t26*_t55 + 0.2e1*_t3*_t50*_t8*params->h - _t47 - _t52*_t54;
  const double _t57 = _t56*_t6;
#endif
#if _KMAX >= 3
  const double _t58 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t59 = _t58*_t7;
  const double _t60 = 0.12e2*_t24;
  const double _t61 = _hc0[0]*_t60;
  const double _t62 = _t59*_t61;
  const double _t63 = ((_hc0[0]) * (_hc0[0]) * (_hc0[0]));
  const double _t64 = (0.1e1 / (_t2 * _t2 * _t2));
  const double _t65 = _t63*_t64;
  const double _t66 = 0.16e2*_t65;
  const double _t67 = _t59*_t66;
  const double _t68 = _t58*_t61;
  const double _t69 = _t30*_t68;
  const double _t70 = ((params->h) * (params->h) * (params->h));
  const double _t71 = _t14*_t70;
  const double _t72 = _t58*_t65;
  const double _t73 = 0.8e1*_t72;
  const double _t74 = _t5*_t71*_t73;
  const double _t75 = 0.24e2*_t72;
  const double _t76 = _t30*_t75;
  const double _t77 = _t21*_t4;
  const double _t78 = 0.4e1*_t13;
  const double _t79 = _t25*_t78;
  const double _t80 = _t14*_t28;
  const double _t81 = _t21*_t80;
  const double _t82 = 0.4e1*_t19;
  const double _t83 = _t25*_t82;
  const double _t84 = _t21*_t30;
  const double _t85 = _t36*_t7;
  const double _t86 = _t51*_t85;
  const double _t87 = _t4*_t51;
  const double _t88 = _hc0[4]*_t87;
  const double _t89 = _t21*params->h;
  const double _t90 = _t89*_t9;
  const double _t91 = _t4*_t60;
  const double _t92 = _hc0[2]*_t91;
  const double _t93 = 0.8e1*_t25;
  const double _t94 = _t4*_t93;
  const double _t95 = _hc0[1]*_hc0[4];
  const double _t96 = _hc0[2]*_t4;
  const double _t97 = -_hc0[0]*_t21*_t92 + _hc0[1]*_t88 + _t21*_t66*_t96 + _t26*_t38*_t89 - _t38*_t90 - _t94*_t95;
  const double _t98 = _t4*_t44;
  const double _t99 = -_t3*params->h;
  const double _t100 = pow(_t2, -_t99 - 0.1e1);
  const double _t101 = _t100*_t45;
  const double _t102 = 0.2e1*_t101;
  const double _t103 = _hc0[1]*_t53;
  const double _t104 = _t19*_t78;
  const double _t105 = _t104*_t34;
  const double _t106 = 0.4e1*_hc0[0]*_hc0[4]*_t3*_t8*params->h + 0.4e1*_hc0[1]*_hc0[2]*_t3*_t8*params->h - _t103*_t52 - _t40*_t94;
  const double _t107 = _t4*_t9;
  const double _t108 = _hc1[2]*_t14;
  const double _t109 = _t108*params->h;
  const double _t110 = _hc0[4]*_t53;
  const double _t111 = _t39*_t40;
  const double _t112 = _hc0[1]*_t55;
  const double _t113 = _t48*_t49;
  const double _t114 = _t103*_t51;
  const double _t115 = _hc0[1]*_hc0[5];
  const double _t116 = _hc0[1]*_hc0[5]*_t107 - _hc0[2]*_hc0[4]*_t94 + _hc0[2]*_t88 + _hc0[8]*_t18 - _t109*_t11 - _t110*_t52 - _t111*_t51 + _t111*_t93 - _t112*_t61 + _t112*_t66 + _t113*_t114 - _t115*_t41;
  const double _t117 = _hc1[3]*_t5;
  const double _t118 = 0.3e1*_t44;
  const double _t119 = (_t19 * _t19 * _t19);
  const double _t120 = 0.3e1*_t13;
  const double _t121 = 0.8e1*_t8;
  const double _t122 = _t121*_t38;
  const double _t123 = 0.4e1*_hc0[0]*_hc0[5]*_t3*_t8*params->h - _t122*_t54 + 0.4e1*_t15*_t48*_t49*params->h + 0.4e1*_t3*_t50*_t8*params->h - 0.2e1*_t47 - _t55*_t93;
  const double _t124 = _hc1[3]*_t17;
  const double _t125 = ((_hc1[1]) * (_hc1[1]) * (_hc1[1]));
  const double _t126 = (0.1e1 / ((_hc1[0]) * (_hc1[0]) * (_hc1[0]) * (_hc1[0])));
  const double _t127 = _t126*_t16;
  const double _t128 = _t125*_t127;
  const double _t129 = 0.6e1*_t8;
  const double _t130 = _t108*_t129;
  const double _t131 = _t129*_t38;
  const double _t132 = _t131*_t53;
  const double _t133 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t134 = _t133*_t91;
  const double _t135 = _t50*params->h;
  const double _t136 = _t1*_t92;
  const double _t137 = 0.12e2*_hc0[0]*_hc0[2]*_t48*_t49*_t8*params->h + 0.2e1*_hc0[0]*_hc0[9]*_t3*_t8*params->h - _hc0[0]*_t134 + 0.6e1*_hc0[2]*_hc0[5]*_t3*_t8*params->h - _hc0[5]*_t132 - _hc0[5]*_t136 + 0.6e1*_hc1[1]*_hc1[2]*_t15*_t48*params->h + 0.12e2*_hc1[1]*_t1*_t14*_t24*_t50*params->h - _t124 - 0.6e1*_t128 - _t130*_t54 - _t131*_t135 + 0.16e2*_t133*_t3*_t63*_t64*params->h;
#endif
#if _KMAX >= 4
  const double _t138 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t139 = _t138*_t7;
  const double _t140 = 0.96e2*_t139;
  const double _t141 = _t1*_t64;
  const double _t142 = ((_hc0[0]) * (_hc0[0]) * (_hc0[0]) * (_hc0[0]))/(_t2 * _t2 * _t2 * _t2);
  const double _t143 = _t138*_t5;
  const double _t144 = _t143*_t29;
  const double _t145 = _t143*_t71;
  const double _t146 = 0.96e2*_t142;
  const double _t147 = _t13*_t80;
  const double _t148 = _t58*_t66;
  const double _t149 = _t22*_t42;
  const double _t150 = _t1*_t60;
  const double _t151 = _hc0[0]*_t24;
  const double _t152 = 0.36e2*_t151;
  const double _t153 = 0.4e1*_t1*pow(_t2, -_t99 - 0.2e1)*_t45;
  const double _t154 = _t13*_t19;
  const double _t155 = 0.8e1*_t34;
  const double _t156 = _t13*_t36;
  const double _t157 = 0.24e2*_t151;
  const double _t158 = _t21*_t96;
  const double _t159 = 0.16e2*_t25;
  const double _t160 = _t89*_t93;
  const double _t161 = 0.32e2*_t65;
  const double _t162 = ((_hc0[4]) * (_hc0[4]));
  const double _t163 = _t4*_t40;
  const double _t164 = _hc0[0]*_hc0[5];
  const double _t165 = _t55*_t60;
  const double _t166 = 0.6e1*_t44;
  const double _t167 = _t1*_t91;
  const double _t168 = _t159*_t96;
  const double _t169 = 0.12e2*_hc0[2]*_t8;
  const double _t170 = _t164*_t24;
  const double _t171 = 0.12e2*_t8;
  const double _t172 = _t125*_t126;
  const double _t173 = _t133*_t4;
  const double _t174 = _t169*_t53;
  const double _t175 = _hc0[5]*_t171*_t53;
  const double _t176 = 0.12e2*_t135*_t8;
  const double _t177 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t178 = ((_hc0[5]) * (_hc0[5]));
  const double _t179 = _t54*_t8;
#endif
  ...
  const double d2f_dxt_dxs0 = 0;
  out[9] = d2f_dxt_dxs0;
  const double d2f_dxt2 = _t23 - _t27 + _t32;
  out[10] = d2f_dxt2;
  const double d2f_drs_dxs1 = 0;
  out[11] = d2f_drs_dxs1;
  const double d2f_drs_dxs0 = 0;
  out[12] = d2f_drs_dxs0;
  const double d2f_drs_dxt = _t35*_t36 + _t37 + _t43;
  out[13] = d2f_drs_dxt;
  const double d2f_drs2 = _t19*_t33 + _t44 + _t46 + _t57;
  out[14] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dxs13 = 0;
  ...
  const double d3f_dxt3 = -_t62 + _t67 + _t69 + _t74 - _t76;
  out[24] = d3f_dxt3;
  const double d3f_drs_dxs12 = 0;
  ...
  const double d3f_drs_dxt2 = _t19*_t23 + _t21*_t35 - _t22*_t83 + _t42*_t86 + _t6*_t97 - _t77*_t79 + _t79*_t81 + _t83*_t84;
  out[30] = d3f_drs_dxt2;
  const double d3f_drs2_dxs1 = 0;
  out[31] = d3f_drs2_dxs1;
  const double d3f_drs2_dxs0 = 0;
  out[32] = d3f_drs2_dxs0;
  const double d3f_drs2_dxt = _t102*_t103 + _t105*_t36 + _t106*_t20 + _t11*_t98 + _t116*_t6 + _t12*_t56 + _t33*_t42;
  out[33] = d3f_drs2_dxt;
  const double d3f_drs3 = _t117 + _t118*_t19 + _t119*_t6 + _t120*_t45 + _t120*_t56 + _t123*_t20 + _t137*_t6 + _t20*_t56;
  out[34] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dxs14 = 0;
  ...
  const double d4f_dxt4 = -_t139*_t60 + _t140*_t141 - _t140*_t142 - 0.144e3*_t141*_t144 + 0.48e2*_t141*_t145 + 0.16e2*_t142*_t143*_t48*((params->h) * (params->h) * (params->h) * (params->h)) + 0.176e3*_t142*_t144 + _t144*_t60 - _t145*_t146;
  out[49] = d4f_dxt4;
  const double d4f_drs_dxs13 = 0;
  ...
  const double d4f_drs_dxt3 = -_hc0[0]*_t13*_t58*_t91 + _t129*_t149 + _t129*_t85*_t97 + _t13*_t148*_t4 + _t13*_t48*_t70*_t73 + _t147*_t68 - _t147*_t75 - _t149*_t150 + _t150*_t42*_t84 - _t19*_t62 + _t19*_t67 + _t19*_t69 + _t19*_t74 - _t19*_t76 + _t6*(0.12e2*_hc0[0]*_hc1[1]*_t14*_t24*_t58*params->h + 0.96e2*_hc0[2]*_t1*_t3*_t58*_t64*params->h - _hc0[4]*_t152*_t77 + 0.48e2*_hc0[4]*_t21*_t3*_t63*_t64*params->h - _t146*_t58*_t96 - _t148*_t39 - _t58*_t92);
  out[59] = d4f_drs_dxt3;
  const double d4f_drs2_dxs12 = 0;
  ...
  const double d4f_drs2_dxt2 = _t102*_t89 + _t105*_t21 + _t106*_t43 + _t106*_t8*_t82*_t85 + _t107*_t21*_t44 + _t116*_t86 + _t153*_t21*_t29 - _t153*_t89 - _t154*_t21*_t94 + _t154*_t81*_t93 + _t155*_t156*_t42 + _t20*(_t155*_t95 - _t157*_t158 + _t158*_t161 - _t159*_t4*_t95 + _t160*_t38 - _t38*_t51*_t89) + _t23*_t56 - _t27*_t56 + _t31*_t44*_t80 - _t31*_t98 + _t32*_t56 + _t33*_t97 + _t6*(0.24e2*_hc0[0]*_hc0[2]*_hc1[1]*_t14*_t21*_t24*params->h + 0.64e2*_hc0[1]*_hc0[2]*_hc0[4]*_t3*_t63*_t64*params->h + 0.16e2*_hc0[1]*_hc0[4]*_hc1[1]*_t1*_t14*_t24*params->h + 0.4e1*_hc0[1]*_hc0[8]*_t3*_t8*params->h - _hc0[1]*_hc0[8]*_t94 - _hc0[2]*_t161*_t38*_t89 - 0.48e2*_hc0[4]*_t151*_t163 + 0.16e2*_hc0[5]*_t21*_t3*_t63*_t64*params->h + 0.4e1*_hc1[2]*_t1*_t14*_t21*_t24*params->h + 0.96e2*_t1*_t21*_t3*_t50*_t64*params->h - _t108*_t90 - _t113*_t160 - _t121*_t39*_t95 - _t146*_t21*_t55 + 0.4e1*_t162*_t3*_t8*params->h - _t162*_t94 - _t164*_t21*_t91 - _t165*_t21 + 0.4e1*_t21*_t48*_t49*_t8*params->h);
  out[65] = d4f_drs2_dxt2;
  const double d4f_drs3_dxs1 = 0;
  out[66] = d4f_drs3_dxs1;
  const double d4f_drs3_dxs0 = 0;
  out[67] = d4f_drs3_dxs0;
  const double d4f_drs3_dxt = 0.6e1*_hc1[1]*_t101*_t36*_t4 + 0.2e1*_t100*_t103*_t119 + _t106*_t120*_t19 + _t11*_t117*_t4 + _t116*_t120 + _t116*_t20 + _t118*_t42 + _t12*_t137 + _t123*_t37 + _t123*_t43 + _t129*_t156*_t4*_t56 + _t166*_t19*_t34*_t36 + _t20*(_hc0[0]*_hc0[8]*_t87 + _hc0[1]*_hc0[5]*_t87 + _hc0[2]*_hc0[4]*_t155 - _hc0[4]*_t168 + _t103*_t113*_t121 - _t108*_t114 - _t110*_t122 - _t111*_t121 + _t111*_t159 - _t112*_t157 + _t112*_t161 - _t115*_t94) + _t37*_t56 + _t43*_t56 + _t46*(0.6e1*_hc0[0]*_hc0[4]*_t3*_t8*params->h + 0.6e1*_hc0[1]*_hc0[2]*_t3*_t8*params->h - _t103*_t131 - _t167*_t40) + _t6*(0.12e2*_hc0[0]*_hc0[1]*_hc1[1]*_hc1[2]*_t48*_t8*params->h + 0.36e2*_hc0[0]*_hc0[1]*_hc1[1]*_t14*_t24*_t50*params->h + 0.2e1*_hc0[0]*_hc0[13]*_t3*_t8*params->h + 0.12e2*_hc0[0]*_hc0[4]*_t48*_t49*_t8*params->h + 0.48e2*_hc0[1]*_hc0[2]*_hc0[5]*_t3*_t63*_t64*params->h + 0.12e2*_hc0[1]*_hc0[2]*_hc1[2]*_t1*_t14*_t24*params->h + 0.12e2*_hc0[1]*_hc0[2]*_t48*_t49*_t8*params->h + 0.12e2*_hc0[1]*_hc0[5]*_hc1[1]*_t1*_t14*_t24*params->h + 0.2e1*_hc0[1]*_hc0[9]*_t3*_t8*params->h - _hc0[1]*_hc0[9]*_t41 + 0.96e2*_hc0[1]*_t1*_t133*_t3*_t64*params->h - _hc0[1]*_t134 - 0.48e2*_hc0[1]*_t135*_t38*_t65 - _hc0[1]*_t146*_t173 + 0.24e2*_hc0[2]*_hc0[4]*_hc1[1]*_t1*_t14*_t24*params->h + 0.6e1*_hc0[2]*_hc0[8]*_t3*_t8*params->h - _hc0[4]*_hc0[5]*_t167 + 0.6e1*_hc0[4]*_hc0[5]*_t3*_t8*params->h - _hc0[4]*_t152*_t55 - _hc0[4]*_t169*_t39 + 0.48e2*_hc0[4]*_t3*_t50*_t63*_t64*params->h - _hc0[8]*_t132 - _hc0[8]*_t136 - _hc1[3]*_t11*_t14*params->h - _t103*_t171*_t172 - _t109*_t129*_t40 - _t110*_t130 - 0.24e2*_t113*_t25*_t40*params->h - _t115*_t131*params->h - 0.36e2*_t163*_t170);
  out[68] = d4f_drs3_dxt;
  const double d4f_drs4 = _hc1[4]*_t5 + _t104*_t123 + _t104*_t56 + _t117*_t82 + _t119*_t78 + _t123*_t46 + _t123*_t57 + 0.2e1*_t137*_t20 + _t137*_t78 + _t166*_t45 + _t166*_t56 + (_t19 * _t19 * _t19 * _t19)*_t6 + _t20*(0.24e2*_hc0[0]*_hc0[2]*_t48*_t49*_t8*params->h + 0.4e1*_hc0[0]*_hc0[9]*_t3*_t8*params->h + 0.12e2*_hc0[2]*_hc0[5]*_t3*_t8*params->h - 0.24e2*_hc0[5]*_t25*_t96 + 0.12e2*_hc1[1]*_hc1[2]*_t15*_t48*params->h + 0.24e2*_hc1[1]*_t1*_t14*_t24*_t50*params->h - _t108*_t174 - 0.2e1*_t124 - 0.12e2*_t128 + 0.32e2*_t133*_t3*_t63*_t64*params->h - _t157*_t173 - _t175*_t38 - _t176*_t38) + _t46*_t56 + _t46*(0.6e1*_hc0[0]*_hc0[5]*_t3*_t8*params->h - _t1*_t165 + 0.6e1*_t15*_t48*_t49*params->h - _t174*_t38 + 0.6e1*_t3*_t50*_t8*params->h - 0.3e1*_t47) + (_t56 * _t56)*_t6 + _t6*(0.2e1*_hc0[0]*_hc0[14]*_t3*_t8*params->h + 0.48e2*_hc0[0]*_hc0[2]*_hc1[1]*_hc1[2]*_t48*_t8*params->h + 0.24e2*_hc0[0]*_hc0[5]*_t48*_t49*_t8*params->h + 0.48e2*_hc0[0]*_hc1[1]*_t133*_t14*_t24*params->h + 0.48e2*_hc0[2]*_hc0[5]*_hc1[1]*_t1*_t14*_t24*params->h - 0.24e2*_hc0[2]*_hc0[5]*_t39*_t8 + 0.8e1*_hc0[2]*_hc0[9]*_t3*_t8*params->h + 0.96e2*_hc0[5]*_t3*_t50*_t63*_t64*params->h - _hc0[9]*_t122*_t53 - _hc0[9]*_t168 + 0.8e1*_hc1[1]*_hc1[3]*_t15*_t48*params->h + 0.6e1*((_hc1[2]) * (_hc1[2]))*_t15*_t48*params->h + 0.24e2*_hc1[2]*_t1*_t14*_t24*_t50*params->h - 0.36e2*_hc1[2]*_t127*_t49 - 0.8e1*_hc1[3]*_t14*_t179 - _hc1[4]*_t17 + 0.96e2*_t1*_t177*_t3*_t64*params->h - _t108*_t175 - _t108*_t176 - 0.48e2*_t113*_t135*_t25 - 0.64e2*_t133*_t39*_t65 - _t146*_t177*_t4 - _t167*_t178 - 0.72e2*_t170*_t55 - 0.48e2*_t172*_t179 - _t177*_t91 + 0.6e1*_t178*_t3*_t8*params->h + 0.24e2*_t48*_t49*_t50*_t8*params->h + 0.24e2*((_hc1[1]) * (_hc1[1]) * (_hc1[1]) * (_hc1[1]))*_t15*params->h/xc_powi((_hc1[0]), 5));
  out[69] = d4f_drs4;
#endif
}
...
FUNC_NAME(const xc_func_type *p, size_t ip, const double *rho, const double *sigma, xc_gga_out_params *out)
{
  ...
  XC_CAT(f_chachiyo_gga_z0_k, _KMAX)(p, _t1*_t4, _t5*_t6, 0, 0, _hc0);
  ...
  XC_CAT(f_chachiyo_gga_k, _KMAX)(p, _t2*_t6, _t7*_t8, _t11*_t9, 0, 0, _hc0);
  const double zk = _hc0[0];
  if(out->zk != NULL) out->zk[ip*p->dim.zk + 0] += zk;
#if _KMAX >= 1
