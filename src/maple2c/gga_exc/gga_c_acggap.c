/*
  Generated from python/gga_exc/gga_c_acggap.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_c_acggap
*/

#ifndef _GGA_C_ACGGAP_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_C_ACGGAP_KERNEL_BODY
#define _KMAX 0
#define _GGA_C_ACGGAP_HELPER_BODIES
#include "gga_c_acggap.c"
#undef _GGA_C_ACGGAP_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_C_ACGGAP_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_C_ACGGAP_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(bcgp_pt_k, _KMAX)(const xc_func_type *p, double t, double *out) {

  const double _t1 = t + 4.5;
  const double _t2 = 1.4670000000000001*t;
  const double _t3 = _t2 + 4.5;
  const double _t4 = (0.1e1 / _t3);
  const double _t5 = xc_powr(_t1*_t4, 1, 2);
  ...
  const double _t11 = -0.73350000000000004*_t1*_t10 + (0.1e1 / 0.2e1)*_t4;
  const double _t12 = _t11*_t3;
#endif
#if _KMAX >= 2
  const double _t13 = _t5*_t7;
  const double _t14 = _t11*_t13;
  const double _t15 = 1.4670000000000001*_t10;
  const double _t16 = (_t3 * _t3 * _t3);
  const double _t17 = (0.1e1 / _t16);
  const double _t18 = _t1*_t17;
  const double _t19 = -_t15 + 2.1520890000000001*_t18;
  const double _t20 = _t19*_t8;
  const double _t21 = 0.2e1*_t3;
  const double _t22 = (0.1e1 / (_t1 * _t1));
  const double _t23 = _t22*_t6;
  const double _t24 = _t12*_t23;
  const double _t25 = (_t11 * _t11);
  const double _t26 = _t25*_t9;
#endif
#if _KMAX >= 3
  const double _t27 = _t11*_t23;
  const double _t28 = _t13*_t19;
  const double _t29 = 0.3e1*_t3;
  const double _t30 = (_t3 * _t3 * _t3 * _t3);
  const double _t31 = (0.1e1 / _t30);
  const double _t32 = _t1*_t31;
  const double _t33 = 6.4562670000000004*_t17 - 9.4713436889999993*_t32;
  const double _t34 = _t3*_t33;
  const double _t35 = _t22*_t5;
  const double _t36 = _t11*_t35;
  const double _t37 = _t19*_t23;
  const double _t38 = (0.1e1 / (_t1 * _t1 * _t1));
  const double _t39 = _t38*_t6;
  const double _t40 = 4.3041780000000003*t;
  const double _t41 = _t40 + 13.203000000000001;
  const double _t42 = _t23*_t25;
  const double _t43 = _t25*_t35;
  const double _t44 = _t2*_t3;
  const double _t45 = (_t11 * _t11 * _t11);
  const double _t46 = _t16*_t45;
  const double _t47 = _t27*_t9;
  const double _t48 = 2.9340000000000002*_t10;
  const double _t49 = 4.3041780000000003*_t18 - _t48;
#endif
#if _KMAX >= 4
  const double _t50 = _t11*_t39;
  const double _t51 = _t19*_t3;
  const double _t52 = _t38*_t5;
  const double _t53 = _t6/(_t1 * _t1 * _t1 * _t1);
  const double _t54 = 0.6e1*_t53;
  const double _t55 = _t25*_t39;
  const double _t56 = _t39*_t45;
  const double _t57 = _t27*_t41;
  const double _t58 = _t49*_t9;
  const double _t59 = 0.4e1*_t36*_t9;
  const double _t60 = _t16*_t55;
#endif

  const double f = _t6;
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = _t12*_t8 + _t5;
  out[1] = df_dt;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _t14*_t2 + _t14*_t21 + _t20*_t3 + _t23*_t26 - _t24;
  out[2] = d2f_dt2;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = 0.2e1*_t12*_t39 + 4.4009999999999998*_t14 + _t19*_t47 + 2.9340000000000002*_t20 - _t21*_t37 - 0.3e1*_t26*_t39 - 2.9340000000000002*_t27 + _t28*_t29 - _t29*_t36 + _t34*_t8 + _t39*_t46 + _t41*_t42 + _t43*_t44 + 0.3e1*_t43*_t9 + _t47*_t49;
  out[3] = d3f_dt3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = (_t11 * _t11 * _t11 * _t11)*_t30*_t53 + 0.8e1*_t12*_t52 - _t12*_t54 + 0.4e1*_t13*_t34 + (_t19 * _t19)*_t23*_t9 + 2.9340000000000002*_t19*_t24 - 0.4e1*_t19*_t50*_t9 + _t19*_t57 + _t19*_t59 - _t23*_t29*_t33 - 0.12e2*_t26*_t52 + 0.11e2*_t26*_t53 + 11.736000000000001*_t28 + _t3*_t41*_t56 - 5.8680000000000003*_t3*_t55 + _t3*_t8*(55.577844767051999*_t1/xc_powi(_t3, 5) - 37.885374755999997*_t31) + 0.2e1*_t33*_t47 + 4.4009999999999998*_t33*_t8 - 0.8e1*_t35*_t51 + _t36*_t44*_t49 - 11.736000000000001*_t36 + _t37*_t58 - 8.8019999999999996*_t37 + 0.6e1*_t39*_t51 - 0.5e1*_t41*_t55 + 6.4562670000000004*_t42 + _t43*(8.6083560000000006*t + 26.406000000000002) + _t43*(17.216712000000001*t + 52.812000000000005) + 0.4e1*_t46*_t52 - _t46*_t54 + _t47*(12.912534000000001*_t17 - 18.942687377999999*_t32) + 0.2e1*_t49*_t57 + _t49*_t59 - 0.5e1*_t50*_t58 + 8.8019999999999996*_t50 + 5.8680000000000003*_t56*_t9 + _t60*(-4.4009999999999998*_t10 + _t17*(6.4562670000000004*t + 29.0532015)) + _t60*(-_t15 + _t17*(2.1520890000000001*t + 9.6844005000000006)) + _t60*(_t17*(_t40 + 19.368801000000001) - _t48);
  out[4] = d4f_dt4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(fbeta_modRasoltGeldart_k, _KMAX)(const xc_func_type *p, double rs, double *out) {

  const double _t1 = 0.16667000000000001*rs;
  const double _t2 = 0.5*rs;
  const double _t3 = _t2*(_t1 + 0.1e1) + 1.0;
  const double _t4 = 0.29632999999999998*rs;
  const double _t5 = _t2*(_t4 + 0.1e1) + 1.0;
  const double _t6 = (0.1e1 / _t5);
#if _KMAX >= 1
  const double _t7 = _t1 + 0.5;
  const double _t8 = -_t4 - 0.5;
  const double _t9 = (0.1e1 / (_t5 * _t5));
  const double _t10 = _t3*_t9;
#endif
#if _KMAX >= 2
  const double _t11 = _t8*_t9;
  const double _t12 = -0.59265999999999996*rs - 1.0;
  const double _t13 = (0.1e1 / (_t5 * _t5 * _t5));
  const double _t14 = _t13*_t3;
  const double _t15 = _t14*_t8;
#endif
#if _KMAX >= 3
  const double _t16 = _t13*_t8;
  const double _t17 = (0.1e1 / (_t5 * _t5 * _t5 * _t5));
  const double _t18 = -0.88898999999999995*rs - 1.5;
  const double _t19 = _t17*_t18*_t3*_t8;
#endif
#if _KMAX >= 4
  const double _t20 = 2.3706399999999999*_t7;
  const double _t21 = 0.88898999999999995*_t3;
#endif

  const double f = _t3*_t6;
  out[0] = f;
#if _KMAX >= 1
  const double df_drs = _t10*_t8 + _t6*_t7;
  out[1] = df_drs;
#endif
#if _KMAX >= 2
  const double d2f_drs2 = -0.29632999999999998*_t10 + 0.2e1*_t11*_t7 + _t12*_t15 + 0.16667000000000001*_t6;
  out[2] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_drs3 = 0.50001000000000007*_t11 - 0.59265999999999996*_t12*_t14 + 0.3e1*_t12*_t16*_t7 + _t12*_t19 - 0.59265999999999996*_t15 - 0.88898999999999995*_t7*_t9;
  out[3] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_drs4 = -_t12*_t13*_t20 + 1.0000200000000001*_t12*_t13*_t8 - _t12*_t17*_t18*_t21 + 0.4e1*_t12*_t17*_t18*_t7*_t8 - _t12*_t17*_t21*_t8 + _t12*_t18*_t3*_t8*(-1.1853199999999999*rs - 2.0)/xc_powi(_t5, 5) + 0.52686881339999991*_t13*_t3 - _t16*_t20 - 1.1853199999999999*_t19 - 0.29633592660000002*_t9;
  out[4] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(mbeta_k, _KMAX)(const xc_func_type *p, double rs, double t, double *out) {
  ...
  double _hc0[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(fbeta_modRasoltGeldart_k, _KMAX)(p, rs, _hc0);

  const double f = 0.06672455060314922*_hc0[0];
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = 0;
  out[1] = df_dt;
  const double df_drs = 0.06672455060314922*_hc0[1];
  out[2] = df_drs;
#endif
#if _KMAX >= 2
  ...
  out[4] = d2f_drs_dt;
  const double d2f_drs2 = 0.06672455060314922*_hc0[2];
  out[5] = d2f_drs2;
#endif
#if _KMAX >= 3
  ...
  out[8] = d3f_drs2_dt;
  const double d3f_drs3 = 0.06672455060314922*_hc0[3];
  out[9] = d3f_drs3;
#endif
#if _KMAX >= 4
  ...
  out[13] = d4f_drs3_dt;
  const double d4f_drs4 = 0.06672455060314922*_hc0[4];
  out[14] = d4f_drs4;
#endif
}
...
#if _KMAX >= 1
  const double _t8 = -0.1e1 / 0.2e1*_hc0[2] + (0.1e1 / 0.2e1)*_hc1[2];
  const double _t9 = (0.1e1 / (_t2 * _t2));
  const double _t14 = xc_powr(rs, -3, 2);
  const double _t15 = (0.1e1 / 0.16e2)*_t14;
#endif
#if _KMAX >= 2
  const double _t17 = (0.1e1 / rs);
  const double _t21 = (0.1e1 / (_t2 * _t2 * _t2));
  const double _t22 = _t21*_t8;
  const double _t24 = (0.1e1 / 0.32e2)*xt;
  const double _t26 = -0.1e1 / 0.2e1*_hc0[5] - 0.1e1 / 0.2e1*_hc1[5];
  const double _t28 = (_t8 * _t8);
  const double _t29 = (xt * xt);
  const double _t30 = (0.1e1 / (_t2 * _t2 * _t2 * _t2));
  const double _t31 = _t29*_t30;
  const double _t32 = _t28*_t31;
  const double _t34 = -_hc0[2] + _hc1[2];
  const double _t36 = _t22*_t6;
  const double _t39 = (0.1e1 / (rs * rs));
  const double _t40 = (0.1e1 / 0.64e2)*_t39;
  const double _t44 = _t29*_t40;
  const double _t45 = xc_powr(rs, -5, 2);
  const double _t46 = (0.3e1 / 0.32e2)*_t45;
  const double _t47 = (0.1e1 / (rs * rs * rs));
  const double _t49 = (0.1e1 / 0.128e3)*_t29;
#endif
#if _KMAX >= 3
  const double _t51 = (0.1e1 / 0.128e3)*_t14;
  const double _t52 = _t30*xt;
  const double _t56 = _t21*_t26;
  const double _t57 = xc_powi(_t2, -5);
  const double _t58 = _t28*_t57;
  const double _t59 = _t29*_t58;
  const double _t61 = _t52*_t8;
  const double _t63 = -0.1e1 / 0.2e1*_hc0[9] + (0.1e1 / 0.2e1)*_hc1[9];
  const double _t65 = (xt * xt * xt);
  const double _t66 = (_t8 * _t8 * _t8);
  const double _t67 = xc_powi(_t2, -6);
  const double _t68 = _t66*_t67;
  const double _t69 = _t65*_t68;
  const double _t72 = -_hc0[5] - _hc1[5];
  const double _t75 = _t31*_t8;
  const double _t77 = -0.2e1*_hc0[2] + 0.2e1*_hc1[2];
  const double _t79 = -0.3e1 / 0.2e1*_hc0[2] + (0.3e1 / 0.2e1)*_hc1[2];
  const double _t80 = _t6*_t79;
  const double _t86 = (0.3e1 / 0.64e2)*xt;
  const double _t88 = _t58*_t65;
  const double _t90 = _t30*_t39;
  const double _t91 = _t28*_t90;
  const double _t94 = _t15*_t22;
  const double _t96 = _t8*_t90;
  const double _t97 = _t79*_t96;
  const double _t98 = xc_powr(rs, -7, 2);
  const double _t100 = (0.1e1 / 0.512e3)*_t29;
  const double _t103 = _t30*_t65;
  const double _t104 = (0.1e1 / 0.512e3)*_t103;
  const double _t105 = _t21*_t47;
  const double _t110 = (0.3e1 / 0.128e3)*_t8;
  const double _t111 = xc_powr(rs, -9, 2);
  const double _t113 = (0.1e1 / 0.1024e4)*_t65;
  const double _t114 = (0.15e2 / 0.64e2)*_t98;
  const double _t116 = (0.1e1 / (rs * rs * rs * rs));
  const double _t117 = (0.9e1 / 0.256e3)*_t116;
#endif
#if _KMAX >= 4
  const double _t121 = _t110*_t30;
  const double _t123 = _t57*xt;
  const double _t124 = _t123*_t8;
  const double _t126 = _t30*_t34;
  const double _t127 = _t126*_t8;
  const double _t128 = _t28*_t67;
  const double _t129 = _t128*_t29;
  const double _t130 = _t21*_t63;
  const double _t131 = (0.3e1 / 0.128e3)*_t29;
  const double _t132 = _t66/xc_powi(_t2, 7);
  const double _t136 = _t29*_t57;
  const double _t138 = _t58*xt;
  const double _t139 = _t61*_t72;
  const double _t141 = _t57*_t8;
  const double _t142 = _t141*_t79;
  const double _t144 = (xt * xt * xt * xt);
  const double _t145 = (0.3e1 / 0.8e1)*xt;
  const double _t146 = -_hc0[9] + _hc1[9];
  const double _t147 = _t34*_t65;
  const double _t151 = -0.3e1 / 0.2e1*_hc0[5] - 0.3e1 / 0.2e1*_hc1[5];
  const double _t152 = _t128*_t65;
  const double _t154 = _t136*_t8;
  const double _t155 = _t154*_t72;
  const double _t156 = -0.5e1 / 0.2e1*_hc0[2] + (0.5e1 / 0.2e1)*_hc1[2];
  const double _t162 = (0.1e1 / 0.64e2)*xt;
  const double _t166 = _t57*_t65;
  const double _t167 = _t72*_t8;
  const double _t168 = _t166*_t8;
  const double _t170 = _t40*_t59;
  const double _t173 = (0.3e1 / 0.256e3)*_t29;
  const double _t176 = xc_powi(rs, -5);
  const double _t179 = (0.9e1 / 0.1024e4)*_t65;
#endif
  double _hc2[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(bcgp_pt_k, _KMAX)(p, _t4*_t6, _hc2);
#if _KMAX >= 1
  const double _t7 = _hc2[1]*_t3;
  const double _t10 = _hc2[1]*_t1;
...
#endif
#if _KMAX >= 2
  const double _t18 = M_CBRT2*_hc2[2];
  const double _t19 = _t18*_t9;
  const double _t20 = (0.1e1 / 0.32e2)*_t19;
  const double _t23 = _t17*_t18;
  const double _t25 = _t23*_t24;
  const double _t27 = _t12*_t26;
  const double _t33 = (0.1e1 / 0.32e2)*_t23;
  const double _t35 = _t10*_t34;
  const double _t37 = _t35*_t36;
  const double _t38 = _t19*xt;
  const double _t41 = _t11*_t15;
  const double _t42 = _t41*_t8;
  const double _t43 = _t18*_t22;
  const double _t48 = _t19*_t47;
#endif
#if _KMAX >= 3
  const double _t50 = _hc2[3]*_t21;
  const double _t53 = _hc2[3]*_t51;
  const double _t54 = _t53*_t8;
  const double _t55 = (0.1e1 / 0.16e2)*_t23;
  const double _t60 = _t28*_t55;
  const double _t62 = _t33*_t34;
  const double _t64 = _t12*_t63;
  const double _t70 = _t35*_t5;
  const double _t71 = (0.1e1 / 0.4e1)*_t56*_t70;
  const double _t73 = _t10*_t36;
  const double _t74 = _t72*_t73;
  const double _t76 = _t33*_t75;
  const double _t78 = _t33*_t59;
  const double _t81 = _t35*_t61;
  const double _t82 = _t45*_t50;
  const double _t83 = _hc2[3]*_t45;
  const double _t84 = (0.1e1 / 0.256e3)*_t83;
  const double _t85 = _t39*_t43;
  const double _t87 = _t26*_t41;
  const double _t89 = _t18*_t56;
  const double _t92 = _t18*_t29;
  const double _t93 = (0.1e1 / 0.64e2)*_t92;
  const double _t95 = _t35*_t94;
  const double _t99 = _t50*_t98;
  const double _t101 = _hc2[3]*_t98;
  const double _t102 = _t101*_t8;
  const double _t106 = _t18*_t34;
  const double _t107 = _t105*_t106;
  const double _t108 = _t11*_t46;
  const double _t109 = _t108*_t8;
  const double _t112 = _t111*_t50;
  const double _t115 = _t19*_t29;
#endif
#if _KMAX >= 4
  const double _t118 = _hc2[4]*_t1;
  const double _t119 = (0.1e1 / 0.1024e4)*_t118;
  const double _t120 = _hc2[3]*_t14;
  const double _t122 = _t119*_t39;
  const double _t125 = _t26*_t53;
  const double _t133 = _t34*_t55;
  const double _t134 = _t133*_t26;
  const double _t135 = _t129*_t53;
  const double _t137 = _t136*_t54;
  const double _t140 = _t55*_t77;
  const double _t143 = _t31*_t33;
  const double _t148 = _t132*_t53;
  const double _t149 = _t10*_t72;
  const double _t150 = _t148*_t65;
  const double _t153 = _t152*_t53;
  const double _t157 = _t129*_t62;
  const double _t158 = _t33*_t77;
  const double _t159 = (0.1e1 / 0.2048e4)*_t118*_t47;
  const double _t160 = _t26*_t84;
  const double _t161 = _t18*_t24;
  const double _t163 = _t79*_t84;
  const double _t164 = _t18*_t44;
  const double _t165 = _t35*xt;
  const double _t169 = _t79*_t92;
  const double _t171 = _t93*_t96;
  const double _t172 = (0.1e1 / 0.4096e4)*_t116*_t118;
  const double _t174 = _t18*_t49;
  const double _t175 = (0.1e1 / 0.512e3)*_t102;
  const double _t177 = (0.1e1 / 0.8192e4)*_t118*_t176;
  const double _t178 = _hc2[3]*_t111*_t30;
#endif

  const double f = _hc2[0];
  out[0] = f;
#if _KMAX >= 1
  const double df_dxt = _t6*_t7;
  out[1] = df_dxt;
  const double df_dz = _t13*xt;
  out[2] = df_dz;
  const double df_drs = -_t15*_t16;
  out[3] = df_drs;
#endif
#if _KMAX >= 2
  const double d2f_dxt2 = _t17*_t20;
  out[4] = d2f_dxt2;
  const double d2f_dz_dxt = _t13 + _t22*_t25;
  out[5] = d2f_dz_dxt;
  const double d2f_dz2 = _t27*xt + _t32*_t33 + _t37*xt;
  out[6] = d2f_dz2;
  const double d2f_drs_dxt = -_t15*_t7 - _t38*_t40;
  out[7] = d2f_drs_dxt;
  const double d2f_drs_dz = -_t42*xt - _t43*_t44;
  out[8] = d2f_drs_dz;
  const double d2f_drs2 = _t16*_t46 + _t48*_t49;
  out[9] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dxt3 = _t50*_t51;
  out[10] = d3f_dxt3;
  const double d3f_dz_dxt2 = _t22*_t55 + _t52*_t54;
  out[11] = d3f_dz_dxt2;
  const double d3f_dz2_dxt = _t25*_t56 + _t27 + _t37 + _t52*_t60 + _t53*_t59 + _t61*_t62;
  out[12] = d3f_dz2_dxt;
  const double d3f_dz3 = _t26*_t76 + _t53*_t69 + _t59*_t62 + _t64*xt + _t71*xt + _t72*_t76 + _t74*xt + _t77*_t78 + _t80*_t81;
  out[13] = d3f_dz3;
  const double d3f_drs_dxt2 = -_t20*_t39 - 0.1e1 / 0.256e3*_t82*xt;
  out[14] = d3f_drs_dxt2;
  const double d3f_drs_dz_dxt = -_t42 - _t75*_t84 - _t85*_t86;
  out[15] = d3f_drs_dz_dxt;
  const double d3f_drs_dz2 = -_t44*_t89 - _t84*_t88 - _t87*xt - _t91*_t93 - _t93*_t97 - _t95*xt;
  out[16] = d3f_drs_dz2;
  const double d3f_drs2_dxt = _t100*_t99 + _t46*_t7 + (0.5e1 / 0.128e3)*_t48*xt;
  out[17] = d3f_drs2_dxt;
  const double d3f_drs2_dz = _t102*_t104 + _t105*_t110*_t92 + _t107*_t49 + _t109*xt;
  out[18] = d3f_drs2_dz;
  const double d3f_drs3 = -_t112*_t113 - _t114*_t16 - _t115*_t117;
  out[19] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dxt4 = _t119*_t90;
  out[20] = d4f_dxt4;
  const double d4f_dz_dxt3 = _t120*_t121 + _t122*_t124;
  out[21] = d4f_dz_dxt3;
  const double d4f_dz2_dxt2 = _t120*_t24*_t58 + _t122*_t129 + _t123*_t34*_t54 + _t125*_t52 + _t127*_t55 + _t30*_t60 + _t55*_t56;
  out[22] = d4f_dz2_dxt2;
  const double d4f_dz3_dxt = _t10*_t127*_t80 + _t113*_t118*_t132*_t39 + _t120*_t131*_t68 + _t130*_t25 + _t133*_t138 + _t134*_t52 + _t135*_t34 + _t135*_t77 + _t137*_t26 + _t137*_t72 + _t138*_t140 + (0.3e1 / 0.32e2)*_t139*_t23 + _t142*_t25*_t34 + _t26*_t55*_t61 + _t64 + _t71 + _t74;
  out[23] = d4f_dz3_dxt;
  const double d4f_dz4 = (0.1e1 / 0.4e1)*_t10*_t139*_t5*_t79 + _t12*xt*(-0.1e1 / 0.2e1*_hc0[14] - 0.1e1 / 0.2e1*_hc1[14]) + _t122*_t144*(_t8 * _t8 * _t8 * _t8)/xc_powi(_t2, 8) + _t124*_t35*_t77*_t80 + _t125*_t152 + _t129*_t156*_t158 + _t130*_t145*_t70 + _t134*_t154 + _t140*_t155 + _t143*(_t26 * _t26) + _t143*_t26*_t72 + _t145*_t149*_t5*_t56 + _t146*_t73*xt + _t146*_t76 + _t147*_t148 + _t150*_t77 + _t150*(-0.3e1*_hc0[2] + 0.3e1*_hc1[2]) + _t151*_t153 + _t151*_t6*_t81 + _t153*_t72 + _t154*_t158*_t26 + _t155*_t62 + _t156*_t157 + _t157*_t79 + (0.3e1 / 0.8e1)*_t26*_t52*_t70*_t79 + _t55*_t59*_t72 + _t55*_t63*_t75 + _t78*(-0.2e1*_hc0[5] - 0.2e1*_hc1[5]);
  out[24] = d4f_dz4;
  const double d4f_drs_dxt3 = -_t159*_t52 - 0.3e1 / 0.256e3*_t82;
  out[25] = d4f_drs_dxt3;
  const double d4f_drs_dz_dxt2 = -_t154*_t159 - 0.5e1 / 0.256e3*_t61*_t83 - 0.1e1 / 0.16e2*_t85;
  out[26] = d4f_drs_dz_dxt2;
  const double d4f_drs_dz2_dxt = -_t106*_t162*_t96 - _t152*_t159 - _t154*_t163 - _t160*_t31 - _t161*_t91 - _t161*_t97 - _t39*_t86*_t89 - 0.1e1 / 0.64e2*_t59*_t83 - _t87 - _t95;
  out[27] = d4f_drs_dz2_dxt;
  const double d4f_drs_dz3 = -_t106*_t170 - _t130*_t164 - _t132*_t144*_t159 - 0.1e1 / 0.8e1*_t14*_t165*_t56 - _t142*_t164*_t77 - _t149*_t94*xt - _t15*_t79*_t81 - _t151*_t171 - _t152*_t156*_t84 - _t152*_t163 - _t160*_t168 - _t166*_t167*_t84 - _t167*_t90*_t93 - 0.1e1 / 0.32e2*_t169*_t26*_t90 - _t170*_t18*_t77 - _t171*_t26 - _t41*_t63*xt - _t69*_t84;
  out[28] = d4f_drs_dz3;
  const double d4f_drs2_dxt2 = _t172*_t31 + (0.1e1 / 0.16e2)*_t48 + (0.7e1 / 0.512e3)*_t99*xt;
  out[29] = d4f_drs2_dxt2;
  const double d4f_drs2_dz_dxt = _t100*_t101*_t126 + _t102*_t173*_t30 + _t107*_t162 + _t109 + _t168*_t172 + (0.9e1 / 0.128e3)*_t43*_t47*xt;
  out[30] = d4f_drs2_dz_dxt;
  const double d4f_drs2_dz2 = _t101*_t104*_t26 + (0.3e1 / 0.512e3)*_t101*_t88 + _t105*_t174*_t72 + _t108*_t26*xt + _t121*_t169*_t47 + _t126*_t174*_t47*_t79 + _t128*_t144*_t172 + _t131*_t47*_t89 + _t147*_t175*_t57 + _t165*_t22*_t46 + _t166*_t175*_t77 + (0.3e1 / 0.128e3)*_t18*_t32*_t47;
  out[31] = d4f_drs2_dz2;
  const double d4f_drs3_dxt = -_t103*_t177 - _t112*_t173 - _t114*_t7 - 0.33e2 / 0.256e3*_t116*_t38;
  out[32] = d4f_drs3_dxt;
  const double d4f_drs3_dz = -_t11*_t114*_t8*xt - _t113*_t178*_t79 - 0.15e2 / 0.256e3*_t116*_t29*_t43 - _t117*_t21*_t34*_t92 - _t141*_t144*_t177 - _t178*_t179*_t8;
  out[33] = d4f_drs3_dz;
  const double d4f_drs4 = (0.105e3 / 0.128e3)*_t111*_t16 + (0.87e2 / 0.512e3)*_t115*_t176 + (0.1e1 / 0.16384e5)*_t118*_t144*_t30/xc_powi(rs, 6) + _t179*_t50/xc_powr(rs, 11, 2);
  out[34] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f2_k, _KMAX)(const xc_func_type *p, double rs, double z, double t, double *out) {
  ...
  const double _t27 = -0.2e1*_t7 - 0.2e1*_t8;
  const double _t28 = _t10*_t27;
  const double _t29 = _hc1[1]*_t6;
  ...
  const double _t38 = _t13*_t6;
  const double _t39 = _hc0[0]*_hc1[6];
  const double _t40 = _hc0[6]*_hc1[0];
  const double _t41 = 0.2e1*_hc0[2];
  const double _t42 = -_hc1[2]*_t41 - _t39 - _t40;
  const double _t43 = -0.2e1*_t11 - 0.2e1*_t12;
  ...
  const double _t50 = _t26*_t27;
  const double _t51 = _hc1[0]*_t18;
  const double _t52 = _hc1[0]*_t44;
  const double _t53 = _hc1[2]*_t6;
  const double _t54 = _hc0[0]*_hc1[8];
  const double _t55 = _hc0[2]*_hc1[3];
  const double _t56 = _hc0[3]*_hc1[2];
  const double _t57 = _hc0[8]*_hc1[0];
  const double _t58 = -_t54 - _t55 - _t56 - _t57;
  const double _t59 = _t26*_t51;
  const double _t60 = _hc2[5]*_t3;
  const double _t61 = 0.2e1*_hc1[3];
  const double _t62 = 0.2e1*_t52;
  const double _t63 = _t18*_t6;
  const double _t64 = _hc0[0]*_hc1[9];
  const double _t65 = _hc0[9]*_hc1[0];
  const double _t66 = 0.2e1*_hc0[3];
  const double _t67 = -_hc1[3]*_t66 - _t64 - _t65;
  const double _t68 = -0.2e1*_t16 - 0.2e1*_t17;
#endif
#if _KMAX >= 3
  const double _t69 = 0.3e1*_t20;
  const double _t70 = 0.3e1*_hc1[1];
  const double _t71 = _t24*_t6;
  const double _t72 = _hc0[0]*_hc1[10];
  const double _t73 = _hc0[10]*_hc1[0];
  const double _t74 = _hc0[1]*_hc1[4];
  const double _t75 = _hc0[4]*_hc1[1];
  const double _t76 = -_t72 - _t73 - 0.3e1*_t74 - 0.3e1*_t75;
  const double _t77 = _t50*_t9;
  const double _t78 = -0.2e1*_t21 - 0.2e1*_t22 - 0.4e1*_t23;
  const double _t79 = _t10*_t26;
  const double _t80 = _hc1[0]*_t50;
  const double _t81 = 0.2e1*_t80;
  const double _t82 = -0.3e1*_t7 - 0.3e1*_t8;
  const double _t83 = _t2/(_t1 * _t1 * _t1 * _t1);
  const double _t84 = _hc2[0]*_t83;
  const double _t85 = _t82*_t84;
  const double _t86 = 0.2e1*_hc1[5];
  const double _t87 = _t34*_t6;
  const double _t88 = _hc1[2]*_t9;
  const double _t89 = _t13*_t50;
  const double _t90 = _hc0[0]*_hc1[11];
  const double _t91 = _hc0[11]*_hc1[0];
  const double _t92 = _hc0[2]*_hc1[4];
  const double _t93 = _hc0[4]*_hc1[2];
  const double _t94 = 0.2e1*_hc0[1];
  const double _t95 = 0.2e1*_hc0[5];
  const double _t96 = -_hc1[1]*_t95 - _hc1[5]*_t94 - _t90 - _t91 - _t92 - _t93;
  const double _t97 = _t35*_t85;
  const double _t98 = _hc1[1]*_t13;
  const double _t99 = _t26*_t43;
  const double _t100 = _hc0[0]*_hc1[12];
  const double _t101 = _hc0[1]*_hc1[6];
  const double _t102 = _hc0[12]*_hc1[0];
  const double _t103 = _hc0[6]*_hc1[1];
  const double _t104 = -_hc1[2]*_t95 - _hc1[5]*_t41 - _t100 - _t101 - _t102 - _t103;
  const double _t105 = _hc1[0]*_t34;
  const double _t106 = -0.2e1*_t30 - 0.2e1*_t31 - 0.2e1*_t32 - 0.2e1*_t33;
  const double _t107 = 0.3e1*_t38;
  const double _t108 = 0.3e1*_hc1[2];
  const double _t109 = _t42*_t6;
  const double _t110 = _hc0[0]*_hc1[13];
  const double _t111 = _hc0[13]*_hc1[0];
  const double _t112 = 0.3e1*_hc0[2];
  const double _t113 = -_hc0[6]*_t108 - _hc1[6]*_t112 - _t110 - _t111;
  const double _t114 = _t13*_t99;
  const double _t115 = 0.4e1*_hc0[2];
  const double _t116 = -_hc1[2]*_t115 - 0.2e1*_t39 - 0.2e1*_t40;
  const double _t117 = _hc1[0]*_t99;
  const double _t118 = 0.2e1*_t117;
  const double _t119 = -0.3e1*_t11 - 0.3e1*_t12;
  const double _t120 = _t119*_t84;
  const double _t121 = _t35*_t43;
  const double _t122 = _t44*_t9;
  const double _t123 = 0.2e1*_hc1[7];
  const double _t124 = _hc1[3]*_t6;
  const double _t125 = _t49*_t6;
  const double _t126 = _hc2[2]*_t25;
  const double _t127 = _hc1[3]*_t50;
  const double _t128 = _t18*_t50;
  const double _t129 = _hc0[0]*_hc1[14];
  const double _t130 = _hc0[14]*_hc1[0];
  const double _t131 = _hc0[3]*_hc1[4];
  const double _t132 = _hc0[4]*_hc1[3];
  const double _t133 = 0.2e1*_hc0[7];
  const double _t134 = -_hc1[1]*_t133 - _hc1[7]*_t94 - _t129 - _t130 - _t131 - _t132;
  const double _t135 = _t51*_t85;
  const double _t136 = _t13*_t44;
  const double _t137 = _hc1[2]*_t44;
  const double _t138 = _t126*_t35;
  const double _t139 = _hc1[1]*_t18;
  const double _t140 = _hc1[2]*_t18;
  const double _t141 = _hc1[0]*_t49;
  const double _t142 = _hc0[0]*_hc1[15];
  const double _t143 = _hc0[1]*_hc1[8];
  const double _t144 = _hc0[15]*_hc1[0];
  const double _t145 = _hc0[2]*_hc1[7];
  const double _t146 = _hc0[3]*_hc1[5];
  const double _t147 = _hc0[5]*_hc1[3];
  const double _t148 = _hc0[7]*_hc1[2];
  const double _t149 = _hc0[8]*_hc1[1];
  const double _t150 = -_t142 - _t143 - _t144 - _t145 - _t146 - _t147 - _t148 - _t149;
  const double _t151 = 0.2e1*_hc1[8];
  const double _t152 = _t58*_t6;
  const double _t153 = _t18*_t99;
  const double _t154 = _hc0[0]*_hc1[16];
  const double _t155 = _hc0[16]*_hc1[0];
  const double _t156 = _hc0[3]*_hc1[6];
  const double _t157 = _hc0[6]*_hc1[3];
  const double _t158 = 0.2e1*_hc0[8];
  const double _t159 = -_hc1[2]*_t158 - _hc1[8]*_t41 - _t154 - _t155 - _t156 - _t157;
  const double _t160 = _t120*_t51;
  const double _t161 = 0.2e1*_t15;
  const double _t162 = _hc2[5]*_t5;
  const double _t163 = _t18*_t44;
  const double _t164 = _t26*_t68;
  const double _t165 = _t126*_t27;
  const double _t166 = 0.2e1*_t51;
  const double _t167 = _hc0[0]*_hc1[17];
  const double _t168 = _hc0[1]*_hc1[9];
  const double _t169 = _hc0[17]*_hc1[0];
  const double _t170 = _hc0[9]*_hc1[1];
  const double _t171 = -_hc1[3]*_t133 - _hc1[7]*_t66 - _t167 - _t168 - _t169 - _t170;
  const double _t172 = -0.2e1*_t45 - 0.2e1*_t46 - 0.2e1*_t47 - 0.2e1*_t48;
  const double _t173 = _hc1[0]*_t162;
  const double _t174 = _t126*_t43;
  const double _t175 = _hc0[0]*_hc1[18];
  const double _t176 = _hc0[18]*_hc1[0];
  const double _t177 = _hc0[2]*_hc1[9];
  const double _t178 = _hc0[9]*_hc1[2];
  const double _t179 = -_hc1[3]*_t158 - _hc1[8]*_t66 - _t175 - _t176 - _t177 - _t178;
  const double _t180 = _hc1[0]*_t58;
  const double _t181 = -0.2e1*_t54 - 0.2e1*_t55 - 0.2e1*_t56 - 0.2e1*_t57;
  const double _t182 = _hc2[9]*_t3;
  const double _t183 = 0.3e1*_hc1[3];
  const double _t184 = 0.3e1*_t15;
  const double _t185 = 0.3e1*_t173;
  const double _t186 = 0.6e1*_hc1[3];
  const double _t187 = 0.3e1*_t63;
  const double _t188 = 0.3e1*_t52;
  const double _t189 = _t6*_t67;
  const double _t190 = _hc0[0]*_hc1[19];
  const double _t191 = _hc0[19]*_hc1[0];
  const double _t192 = 0.3e1*_hc0[3];
  const double _t193 = -_hc0[9]*_t183 - _hc1[9]*_t192 - _t190 - _t191;
  const double _t194 = _t51*_t68;
  const double _t195 = 0.3e1*_t126;
  const double _t196 = _t164*_t18;
  const double _t197 = 0.4e1*_hc0[3];
  const double _t198 = -_hc1[3]*_t197 - 0.2e1*_t64 - 0.2e1*_t65;
  const double _t199 = _hc1[0]*_t164;
  const double _t200 = 0.2e1*_t199;
  const double _t201 = -0.3e1*_t16 - 0.3e1*_t17;
  const double _t202 = _t194*_t84;
#endif
#if _KMAX >= 4
  const double _t203 = 0.6e1*_hc1[4];
  const double _t204 = 0.4e1*_hc1[1];
  const double _t205 = 0.4e1*_hc0[1];
  const double _t206 = _t24*_t50;
  const double _t207 = _t26*_t78;
  const double _t208 = _t204*_t9;
  const double _t209 = -0.2e1*_t72 - 0.2e1*_t73 - 0.6e1*_t74 - 0.6e1*_t75;
  const double _t210 = 0.3e1*_t80;
  const double _t211 = 0.3e1*_t207;
  const double _t212 = _hc1[0]*_t24;
  const double _t213 = _t27*_t85;
  const double _t214 = -0.3e1*_t21 - 0.3e1*_t22 - 0.6e1*_t23;
  const double _t215 = _t214*_t84;
  const double _t216 = 0.3e1*_t213;
  const double _t217 = 0.2e1*_t78;
  const double _t218 = _t28*_t82;
  const double _t219 = _hc2[0]*_t2/xc_powi(_t1, 5);
  const double _t220 = _t219*(-0.4e1*_t7 - 0.4e1*_t8);
  const double _t221 = 0.3e1*_hc1[5];
  const double _t222 = _hc1[4]*_t6;
  const double _t223 = 0.3e1*_t34;
  const double _t224 = 0.3e1*_t89;
  const double _t225 = _t13*_t207;
  const double _t226 = _t6*_t96;
  const double _t227 = _t34*_t50;
  const double _t228 = 0.6e1*_hc1[1];
  const double _t229 = _t13*_t213;
  const double _t230 = _t215*_t27;
  const double _t231 = 0.3e1*_hc0[1];
  const double _t232 = 0.3e1*_hc0[5];
  const double _t233 = _t27*_t35;
  const double _t234 = _t220*_t82;
  const double _t235 = 0.2e1*_t38;
  const double _t236 = 0.2e1*_t20;
  const double _t237 = 0.4e1*_hc1[5];
  const double _t238 = _t19*_t42;
  const double _t239 = _t104*_t6;
  const double _t240 = _hc1[0]*_t42;
  const double _t241 = _t34*_t99;
  const double _t242 = _t106*_t26;
  const double _t243 = _t13*_t242;
  const double _t244 = 0.4e1*_hc1[2];
  const double _t245 = _t43*_t85;
  const double _t246 = _t13*_t245;
  const double _t247 = -_hc0[5]*_t204 - _hc1[5]*_t205 - 0.2e1*_t90 - 0.2e1*_t91 - 0.2e1*_t92 - 0.2e1*_t93;
  const double _t248 = 0.2e1*_t242;
  const double _t249 = 0.2e1*_t245;
  const double _t250 = 0.2e1*_t106;
  const double _t251 = 0.4e1*_hc0[5];
  const double _t252 = _hc1[6]*_t6;
  const double _t253 = _t116*_t26;
  const double _t254 = _t120*_t43;
  const double _t255 = -_hc1[2]*_t251 - _hc1[5]*_t115 - 0.2e1*_t100 - 0.2e1*_t101 - 0.2e1*_t102 - 0.2e1*_t103;
  const double _t256 = _t120*_t35;
  const double _t257 = -0.3e1*_t30 - 0.3e1*_t31 - 0.3e1*_t32 - 0.3e1*_t33;
  const double _t258 = _t121*_t84;
  const double _t259 = _t119*_t121;
  const double _t260 = 0.6e1*_hc1[6];
  const double _t261 = _t42*_t99;
  const double _t262 = _t13*_t244;
  const double _t263 = 0.6e1*_hc1[2];
  const double _t264 = -_hc0[2]*_t260 - _hc0[6]*_t263 - 0.2e1*_t110 - 0.2e1*_t111;
  const double _t265 = 0.3e1*_t117;
  const double _t266 = 0.3e1*_t253;
  const double _t267 = -_hc0[2]*_t263 - 0.3e1*_t39 - 0.3e1*_t40;
  const double _t268 = 0.3e1*_t254;
  const double _t269 = 0.2e1*_t116;
  const double _t270 = _t219*(-0.4e1*_t11 - 0.4e1*_t12);
  const double _t271 = 0.3e1*_t122;
  const double _t272 = _t24*_t44;
  const double _t273 = 0.3e1*_hc1[7];
  const double _t274 = _t165*_t9;
  const double _t275 = _hc1[4]*_t18;
  const double _t276 = _t126*_t78;
  const double _t277 = _hc1[3]*_t207;
  const double _t278 = 0.2e1*_t165;
  const double _t279 = _t18*_t207;
  const double _t280 = _t134*_t6;
  const double _t281 = _t49*_t50;
  const double _t282 = _hc2[2]*_t83;
  const double _t283 = _t18*_t70;
  const double _t284 = 0.3e1*_hc0[7];
  const double _t285 = _t27*_t51;
  const double _t286 = _t34*_t44;
  const double _t287 = _t13*_t165;
  const double _t288 = _t19*_t58;
  const double _t289 = _t49*_t99;
  const double _t290 = _t18*_t242;
  const double _t291 = _t282*_t82;
  const double _t292 = _hc1[3]*_t13;
  const double _t293 = _t18*_t19;
  const double _t294 = _t43*_t51;
  const double _t295 = _t150*_t6;
  const double _t296 = _t42*_t44;
  const double _t297 = _hc1[6]*_t18;
  const double _t298 = _t50*_t58;
  const double _t299 = _t18*_t245;
  const double _t300 = _t294*_t84;
  const double _t301 = _t119*_t294;
  const double _t302 = 0.3e1*_t136;
  const double _t303 = 0.3e1*_hc1[8];
  const double _t304 = _t13*_t174;
  const double _t305 = 0.2e1*_t174;
  const double _t306 = _t18*_t253;
  const double _t307 = _t159*_t6;
  const double _t308 = _t58*_t99;
  const double _t309 = _t18*_t254;
  const double _t310 = 0.3e1*_hc0[8];
  const double _t311 = _t162*_t9;
  const double _t312 = 0.2e1*_t63;
  const double _t313 = 0.2e1*_t163;
  const double _t314 = 0.4e1*_hc1[7];
  const double _t315 = _t44*_t49;
  const double _t316 = _hc2[5]*_t25;
  const double _t317 = _t165*_t18;
  const double _t318 = _t50*_t67;
  const double _t319 = _t171*_t6;
  const double _t320 = _hc1[0]*_t67;
  const double _t321 = _t164*_t49;
  const double _t322 = _t172*_t26;
  const double _t323 = 0.4e1*_hc1[3];
  const double _t324 = _t166*_t291;
  const double _t325 = _t68*_t85;
  const double _t326 = 0.2e1*_t322;
  const double _t327 = 0.2e1*_t325;
  const double _t328 = 0.4e1*_hc0[7];
  const double _t329 = _t44*_t58;
  const double _t330 = _t316*_t35;
  const double _t331 = _t67*_t99;
  const double _t332 = _t164*_t58;
  const double _t333 = _t181*_t26;
  const double _t334 = _t126*_t166;
  const double _t335 = _t120*_t68;
  const double _t336 = _t119*_t194;
  const double _t337 = _t13*_t162;
  const double _t338 = 0.4e1*_hc1[8];
  const double _t339 = _t174*_t18;
  const double _t340 = _t179*_t6;
  const double _t341 = _t18*_t333;
  const double _t342 = 0.2e1*_t333;
  const double _t343 = 0.2e1*_t335;
  const double _t344 = 0.4e1*_hc0[8];
  const double _t345 = _hc2[9]*_t5;
  const double _t346 = _t162*_t18;
  const double _t347 = 0.6e1*_t163;
  const double _t348 = _t44*_t67;
  const double _t349 = 0.3e1*_hc1[9];
  const double _t350 = 0.3e1*_t316;
  const double _t351 = _t126*_t68;
  const double _t352 = _t198*_t26;
  const double _t353 = 0.3e1*_t320;
  const double _t354 = _t164*_t67;
  const double _t355 = _t141*_t68;
  const double _t356 = _t172*_t51;
  const double _t357 = _t18*_t183;
  const double _t358 = _t201*_t84;
  const double _t359 = _t358*_t68;
  const double _t360 = _t194*_t201;
  const double _t361 = _t18*_t351;
  const double _t362 = _t181*_t51;
  const double _t363 = 0.4e1*_hc1[19];
  const double _t364 = 0.6e1*_hc1[9];
  const double _t365 = 0.4e1*_t51;
  const double _t366 = 0.12e2*_hc1[3];
  const double _t367 = _t18*_t323;
#endif
...
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _hc1[4]*_t4 + _t14*_t24 + _t19*_t20 + _t26*_t28;
  out[4] = d2f_dt2;
  const double d2f_dz_dt = _hc1[2]*_t20 + _hc1[5]*_t4 + _t13*_t29 + _t14*_t34 + _t27*_t36;
  out[5] = d2f_dz_dt;
  const double d2f_dz2 = _hc1[6]*_t4 + _t14*_t42 + _t36*_t43 + _t37*_t38;
  out[6] = d2f_dz2;
  const double d2f_drs_dt = _hc1[1]*_t15 + _hc1[3]*_t20 + _hc1[7]*_t4 + _t10*_t44 + _t14*_t49 + _t18*_t29 + _t50*_t51;
  out[7] = d2f_drs_dt;
  const double d2f_drs_dz = _hc1[2]*_t15 + _hc1[3]*_t38 + _hc1[8]*_t4 + _t13*_t52 + _t14*_t58 + _t18*_t53 + _t43*_t59;
  out[8] = d2f_drs_dz;
  const double d2f_drs2 = _hc1[0]*_t60 + _hc1[9]*_t4 + _t14*_t67 + _t15*_t61 + _t18*_t62 + _t59*_t68 + _t61*_t63;
  out[9] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _hc1[10]*_t4 + _hc1[4]*_t69 + _t14*_t76 + _t24*_t81 + _t28*_t85 + _t70*_t71 + _t70*_t77 + _t78*_t79;
  out[10] = d3f_dt3;
  const double d3f_dz_dt2 = _hc1[11]*_t4 + _hc1[4]*_t38 + _t14*_t96 + _t19*_t87 + _t19*_t89 + _t20*_t86 + _t24*_t53 + _t27*_t97 + _t34*_t81 + _t36*_t78 + _t50*_t88;
  out[11] = d3f_dz_dt2;
  const double d3f_dz2_dt = _hc1[12]*_t4 + _hc1[6]*_t20 + _t104*_t14 + _t105*_t99 + _t106*_t36 + _t29*_t42 + _t37*_t87 + _t37*_t89 + _t38*_t86 + _t42*_t80 + _t43*_t97 + _t98*_t99;
  out[12] = d3f_dz2_dt;
  const double d3f_dz3 = _hc1[13]*_t4 + _hc1[6]*_t107 + _t108*_t109 + _t108*_t114 + _t113*_t14 + _t116*_t36 + _t118*_t42 + _t120*_t121;
  out[13] = d3f_dz3;
  const double d3f_drs_dt2 = _hc1[14]*_t4 + _hc1[4]*_t15 + _hc1[4]*_t63 + _t122*_t19 + _t123*_t20 + _t124*_t24 + _t125*_t19 + _t126*_t28 + _t127*_t9 + _t128*_t19 + _t134*_t14 + _t135*_t27 + _t24*_t52 + _t49*_t81 + _t59*_t78;
  out[14] = d3f_drs_dt2;
  const double d3f_drs_dz_dt = _hc1[1]*_t136 + _hc1[15]*_t4 + _hc1[5]*_t15 + _hc1[5]*_t63 + _hc1[7]*_t38 + _hc1[8]*_t20 + _t106*_t59 + _t124*_t34 + _t127*_t13 + _t135*_t43 + _t137*_t9 + _t138*_t27 + _t139*_t99 + _t14*_t150 + _t140*_t50 + _t141*_t99 + _t29*_t58 + _t34*_t52 + _t49*_t53 + _t58*_t80;
  out[15] = d3f_drs_dz_dt;
  const double d3f_drs_dz2 = _hc1[16]*_t4 + _hc1[3]*_t114 + _hc1[6]*_t15 + _hc1[6]*_t63 + _t116*_t59 + _t118*_t58 + _t124*_t42 + _t136*_t37 + _t138*_t43 + _t14*_t159 + _t151*_t38 + _t152*_t37 + _t153*_t37 + _t160*_t43 + _t42*_t52;
  out[16] = d3f_drs_dz2;
  const double d3f_drs2_dt = _hc1[1]*_t60 + _hc1[17]*_t4 + _hc1[7]*_t161 + _hc1[9]*_t20 + _t10*_t162 + _t122*_t61 + _t123*_t63 + _t125*_t61 + _t128*_t61 + _t135*_t68 + _t139*_t164 + _t14*_t171 + _t141*_t164 + _t163*_t19 + _t165*_t166 + _t172*_t59 + _t29*_t67 + _t49*_t62 + _t67*_t80;
  out[17] = d3f_drs2_dt;
  const double d3f_drs2_dz = _hc1[18]*_t4 + _hc1[2]*_t60 + _hc1[8]*_t161 + _hc1[9]*_t38 + _t117*_t67 + _t13*_t173 + _t136*_t61 + _t14*_t179 + _t140*_t164 + _t151*_t63 + _t152*_t61 + _t153*_t61 + _t160*_t68 + _t163*_t37 + _t164*_t180 + _t166*_t174 + _t181*_t59 + _t53*_t67 + _t58*_t62;
  out[18] = d3f_drs2_dz;
  const double d3f_drs3 = _hc1[0]*_t182 + _hc1[19]*_t4 + _hc1[9]*_t184 + _hc1[9]*_t187 + _t14*_t193 + _t163*_t186 + _t18*_t185 + _t183*_t189 + _t183*_t196 + _t183*_t60 + _t188*_t67 + _t194*_t195 + _t198*_t59 + _t200*_t67 + _t201*_t202;
  out[19] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = 0.8e1*_hc1[1]*_t206 + 0.4e1*_hc1[10]*_t20 + _hc1[20]*_t4 + _t10*_t217*_t85 + _t14*(-_hc0[0]*_hc1[20] - _hc0[10]*_t204 - _hc0[20]*_hc1[0] - _hc0[4]*_t203 - _hc1[10]*_t205) + _t203*_t71 + _t203*_t77 + _t204*_t6*_t76 + _t207*_t208 + _t208*_t213 + _t209*_t79 + _t210*_t76 + _t211*_t212 + _t212*_t216 + _t215*_t28 + _t218*_t220;
  out[20] = d4f_dt4;
  const double d4f_dz_dt3 = _hc1[10]*_t38 + _hc1[11]*_t69 + _hc1[21]*_t4 + _hc1[4]*_t224 + _t105*_t211 + _t105*_t216 + _t14*(-_hc0[0]*_hc1[21] - _hc0[10]*_hc1[2] - _hc0[11]*_t70 - _hc0[2]*_hc1[10] - _hc0[21]*_hc1[0] - _hc0[4]*_t221 - _hc1[11]*_t231 - _hc1[4]*_t232) + _t206*_t37 + _t207*_t88 + _t209*_t36 + _t210*_t96 + _t213*_t88 + _t217*_t97 + _t221*_t71 + _t221*_t77 + _t222*_t223 + _t225*_t70 + _t226*_t70 + _t227*_t228 + _t229*_t70 + _t230*_t35 + _t233*_t234 + _t53*_t76;
  out[21] = d4f_dz_dt3;
  const double d4f_dz2_dt2 = _hc1[11]*_t235 + _hc1[12]*_t236 + _hc1[22]*_t4 + _hc1[4]*_t114 + _hc1[6]*_t71 + _hc1[6]*_t77 + _t104*_t81 + _t105*_t248 + _t105*_t249 + _t117*_t96 + _t121*_t215 + _t121*_t234 + _t14*(-_hc0[0]*_hc1[22] - _hc0[11]*_t37 - _hc0[12]*_t19 - _hc0[22]*_hc1[0] - _hc0[4]*_hc1[6] - _hc0[6]*_hc1[4] - _hc1[11]*_t41 - _hc1[12]*_t94 - _hc1[5]*_t251) + _t19*_t239 + _t19*_t241 + _t19*_t243 + _t19*_t246 + _t207*_t240 + _t213*_t240 + _t222*_t42 + _t225*_t37 + _t226*_t37 + _t227*_t244 + _t229*_t37 + _t237*_t87 + _t237*_t89 + _t238*_t50 + _t247*_t36 + _t250*_t97;
  out[22] = d4f_dz2_dt2;
  const double d4f_dz3_dt = _hc1[12]*_t107 + _hc1[13]*_t20 + _hc1[23]*_t4 + _hc1[6]*_t224 + _t104*_t118 + _t105*_t253 + _t105*_t254 + _t106*_t256 + _t108*_t239 + _t108*_t241 + _t108*_t243 + _t108*_t246 + _t108*_t42*_t50 + _t109*_t221 + _t113*_t29 + _t113*_t80 + _t114*_t221 + _t116*_t97 + _t14*(-_hc0[0]*_hc1[23] - _hc0[1]*_hc1[13] - _hc0[12]*_t108 - _hc0[13]*_hc1[1] - _hc0[23]*_hc1[0] - _hc0[6]*_t221 - _hc1[12]*_t112 - _hc1[6]*_t232) + _t220*_t259 + _t223*_t252 + _t238*_t99 + _t240*_t248 + _t240*_t249 + _t253*_t98 + _t254*_t98 + _t255*_t36 + _t257*_t258;
  out[23] = d4f_dz3_dt;
  const double d4f_dz4 = 0.4e1*_hc1[13]*_t38 + 0.8e1*_hc1[2]*_t261 + _hc1[24]*_t4 + _t109*_t260 + _t113*_t244*_t6 + _t113*_t265 + _t114*_t260 + _t14*(-_hc0[0]*_hc1[24] - _hc0[13]*_t244 - _hc0[24]*_hc1[0] - _hc0[6]*_t260 - _hc1[13]*_t115) + _t240*_t266 + _t240*_t268 + _t253*_t262 + _t254*_t262 + _t256*_t269 + _t258*_t267 + _t259*_t270 + _t264*_t36;
  out[24] = d4f_dz4;
  const double d4f_drs_dt3 = _hc1[10]*_t15 + _hc1[10]*_t63 + _hc1[14]*_t69 + _hc1[25]*_t4 + _hc1[3]*_t213*_t9 + _hc1[4]*_t271 + _t10*_t276 + _t124*_t76 + _t134*_t210 + _t135*_t217 + _t14*(-_hc0[0]*_hc1[25] - _hc0[10]*_hc1[3] - _hc0[14]*_t70 - _hc0[25]*_hc1[0] - _hc0[3]*_hc1[10] - _hc0[4]*_t273 - _hc1[14]*_t231 - _hc1[4]*_t284) + _t141*_t211 + _t141*_t216 + _t206*_t61 + _t209*_t59 + _t212*_t278 + _t213*_t283 + _t218*_t282 + 0.3e1*_t222*_t49 + _t228*_t281 + _t230*_t51 + _t234*_t285 + _t272*_t70 + _t273*_t71 + _t273*_t77 + _t274*_t70 + 0.3e1*_t275*_t50 + _t277*_t9 + _t279*_t70 + _t280*_t70 + _t52*_t76;
  out[25] = d4f_drs_dt3;
  const double d4f_drs_dz_dt2 = _hc1[11]*_t15 + _hc1[11]*_t63 + _hc1[14]*_t38 + _hc1[15]*_t236 + _hc1[26]*_t4 + _hc1[4]*_t136 + _hc1[8]*_t71 + _hc1[8]*_t77 + _t105*_t278 + _t117*_t134 + _t122*_t86 + _t123*_t87 + _t123*_t89 + _t124*_t96 + _t125*_t86 + _t128*_t86 + _t13*_t277 + _t134*_t53 + _t135*_t250 + _t137*_t24 + _t138*_t78 + _t14*(-_hc0[0]*_hc1[26] - _hc0[11]*_hc1[3] - _hc0[14]*_hc1[2] - _hc0[15]*_t19 - _hc0[2]*_hc1[14] - _hc0[26]*_hc1[0] - _hc0[3]*_hc1[11] - _hc0[4]*_hc1[8] - _hc0[8]*_hc1[4] - _hc1[15]*_t94 - _hc1[5]*_t133 - _hc1[7]*_t95) + _t140*_t207 + _t140*_t213 + _t141*_t248 + _t141*_t249 + _t150*_t81 + _t165*_t88 + _t180*_t207 + _t180*_t213 + _t19*_t286 + _t19*_t287 + _t19*_t289 + _t19*_t290 + _t19*_t295 + _t213*_t292 + _t215*_t294 + _t222*_t58 + _t227*_t61 + _t233*_t291 + _t234*_t294 + _t245*_t293 + _t247*_t59 + _t275*_t99 + _t281*_t37 + _t288*_t50 + _t52*_t96;
  out[26] = d4f_drs_dz_dt2;
  const double d4f_drs_dz2_dt = _hc1[1]*_t296 + _hc1[12]*_t15 + _hc1[12]*_t63 + _hc1[15]*_t235 + _hc1[16]*_t20 + _hc1[27]*_t4 + _hc1[3]*_t241 + _hc1[6]*_t122 + _hc1[7]*_t109 + _hc1[7]*_t114 + _t104*_t124 + _t104*_t52 + _t105*_t174 + _t106*_t138 + _t106*_t160 + _t116*_t135 + _t118*_t150 + _t121*_t291 + _t127*_t42 + _t136*_t86 + _t139*_t253 + _t139*_t254 + _t14*(-_hc0[0]*_hc1[27] - _hc0[1]*_hc1[16] - _hc0[12]*_hc1[3] - _hc0[15]*_t37 - _hc0[16]*_hc1[1] - _hc0[27]*_hc1[0] - _hc0[3]*_hc1[12] - _hc0[6]*_hc1[7] - _hc0[7]*_hc1[6] - _hc1[15]*_t41 - _hc1[5]*_t158 - _hc1[8]*_t95) + _t141*_t253 + _t141*_t254 + _t151*_t87 + _t151*_t89 + _t152*_t86 + _t153*_t86 + _t159*_t29 + _t159*_t80 + _t165*_t240 + _t174*_t98 + _t180*_t248 + _t180*_t249 + _t220*_t301 + _t242*_t292 + _t245*_t292 + _t252*_t49 + _t255*_t59 + _t257*_t300 + _t286*_t37 + _t287*_t37 + _t288*_t99 + _t289*_t37 + _t290*_t37 + _t295*_t37 + _t297*_t50 + _t298*_t37 + _t299*_t37;
  out[27] = d4f_drs_dz2_dt;
  const double d4f_drs_dz3 = _hc1[13]*_t15 + _hc1[13]*_t63 + _hc1[16]*_t107 + _hc1[28]*_t4 + _hc1[6]*_t302 + _t108*_t296 + _t108*_t304 + _t108*_t306 + _t108*_t307 + _t108*_t309 + _t109*_t303 + _t113*_t124 + _t113*_t52 + _t114*_t303 + _t116*_t138 + _t14*(-_hc0[0]*_hc1[28] - _hc0[13]*_hc1[3] - _hc0[16]*_t108 - _hc0[28]*_hc1[0] - _hc0[3]*_hc1[13] - _hc0[6]*_t303 - _hc1[16]*_t112 - _hc1[6]*_t310) + _t159*_t265 + _t160*_t269 + _t180*_t266 + _t180*_t268 + _t240*_t305 + 0.3e1*_t252*_t58 + _t253*_t292 + _t254*_t292 + _t259*_t282 + _t261*_t61 + _t263*_t308 + _t264*_t59 + _t267*_t300 + _t270*_t301 + 0.3e1*_t297*_t99;
  out[28] = d4f_drs_dz3;
  const double d4f_drs2_dt2 = _hc1[14]*_t161 + _hc1[14]*_t312 + _hc1[17]*_t236 + _hc1[29]*_t4 + _hc1[4]*_t313 + _hc1[4]*_t60 + _hc1[9]*_t71 + _hc1[9]*_t77 + _t122*_t314 + _t125*_t314 + _t128*_t314 + _t134*_t199 + _t134*_t62 + 0.2e1*_t135*_t172 + _t14*(-_hc0[0]*_hc1[29] - _hc0[14]*_t61 - _hc0[17]*_t19 - _hc0[29]*_hc1[0] - _hc0[4]*_hc1[9] - _hc0[9]*_hc1[4] - _hc1[14]*_t66 - _hc1[17]*_t94 - _hc1[7]*_t328) + 0.4e1*_t141*_t165 + _t141*_t326 + _t141*_t327 + _t164*_t275 + _t166*_t276 + _t171*_t81 + _t173*_t24 + _t18*_t213*_t61 + _t19*_t311 + _t19*_t318 + _t19*_t319 + _t19*_t321 + _t194*_t234 + _t202*_t214 + _t204*_t315 + _t204*_t317 + _t207*_t320 + _t213*_t320 + _t222*_t67 + _t27*_t324 + _t272*_t61 + _t274*_t61 + _t279*_t61 + _t28*_t316 + _t280*_t61 + _t281*_t323 + _t293*_t322 + _t293*_t325 + _t59*(-_hc0[7]*_t204 - _hc1[7]*_t205 - 0.2e1*_t129 - 0.2e1*_t130 - 0.2e1*_t131 - 0.2e1*_t132);
  out[29] = d4f_drs2_dt2;
  const double d4f_drs2_dz_dt = _hc1[1]*_t331 + _hc1[1]*_t332 + _hc1[15]*_t161 + _hc1[15]*_t312 + _hc1[17]*_t38 + _hc1[18]*_t20 + _hc1[2]*_t318 + _hc1[2]*_t321 + _hc1[30]*_t4 + _hc1[5]*_t189 + _hc1[5]*_t196 + _hc1[5]*_t60 + _hc1[9]*_t87 + _hc1[9]*_t89 + _t106*_t334 + _t117*_t171 + _t122*_t151 + _t123*_t136 + _t123*_t152 + _t123*_t153 + _t125*_t151 + _t128*_t151 + _t135*_t181 + _t139*_t333 + _t139*_t335 + _t14*(-_hc0[0]*_hc1[30] - _hc0[1]*_hc1[18] - _hc0[15]*_t61 - _hc0[17]*_hc1[2] - _hc0[18]*_hc1[1] - _hc0[2]*_hc1[17] - _hc0[30]*_hc1[0] - _hc0[5]*_hc1[9] - _hc0[9]*_hc1[5] - _hc1[15]*_t66 - _hc1[7]*_t158 - _hc1[8]*_t133) + _t140*_t322 + _t140*_t325 + _t141*_t305 + _t141*_t333 + _t141*_t335 + _t150*_t199 + _t150*_t62 + _t160*_t172 + _t162*_t88 + _t162*_t98 + _t163*_t86 + _t171*_t53 + _t173*_t34 + _t174*_t293 + _t179*_t29 + _t179*_t80 + _t180*_t278 + _t180*_t322 + _t180*_t325 + _t19*_t329 + _t202*_t257 + _t220*_t336 + _t242*_t320 + _t245*_t320 + _t27*_t330 + _t286*_t61 + _t287*_t61 + _t289*_t61 + _t290*_t61 + _t295*_t61 + _t298*_t61 + _t299*_t61 + _t315*_t37 + _t317*_t37 + _t324*_t43 + _t59*(-0.2e1*_t142 - 0.2e1*_t143 - 0.2e1*_t144 - 0.2e1*_t145 - 0.2e1*_t146 - 0.2e1*_t147 - 0.2e1*_t148 - 0.2e1*_t149);
  out[30] = d4f_drs2_dz_dt;
  const double d4f_drs2_dz2 = _hc1[16]*_t161 + _hc1[16]*_t312 + _hc1[18]*_t235 + _hc1[31]*_t4 + _hc1[6]*_t313 + _hc1[6]*_t60 + _hc1[9]*_t109 + _hc1[9]*_t114 + _t116*_t334 + _t118*_t179 + _t119*_t166*_t282*_t43 + _t136*_t338 + _t14*(-_hc0[0]*_hc1[31] - _hc0[16]*_t61 - _hc0[18]*_t37 - _hc0[31]*_hc1[0] - _hc0[6]*_hc1[9] - _hc0[9]*_hc1[6] - _hc1[16]*_t66 - _hc1[18]*_t41 - _hc1[8]*_t344) + _t152*_t338 + _t153*_t338 + _t159*_t199 + _t159*_t62 + 0.2e1*_t160*_t181 + _t164*_t297 + _t173*_t42 + 0.4e1*_t174*_t180 + _t18*_t335*_t37 + _t180*_t342 + _t180*_t343 + _t202*_t267 + _t244*_t329 + _t244*_t339 + _t252*_t67 + _t253*_t320 + _t254*_t320 + _t270*_t336 + _t296*_t61 + _t304*_t61 + _t306*_t61 + _t307*_t61 + _t308*_t323 + _t309*_t61 + _t330*_t43 + _t331*_t37 + _t332*_t37 + _t337*_t37 + _t340*_t37 + _t341*_t37 + _t59*(-_hc0[8]*_t244 - _hc1[8]*_t115 - 0.2e1*_t154 - 0.2e1*_t155 - 0.2e1*_t156 - 0.2e1*_t157);
  out[31] = d4f_drs2_dz2;
  const double d4f_drs3_dt = _hc1[1]*_t182 + _hc1[17]*_t184 + _hc1[17]*_t187 + _hc1[19]*_t20 + _hc1[32]*_t4 + _hc1[7]*_t347 + _hc1[9]*_t271 + _t10*_t345 + _t125*_t349 + _t128*_t349 + _t135*_t198 + _t139*_t352 + _t139*_t359 + _t14*(-_hc0[0]*_hc1[32] - _hc0[1]*_hc1[19] - _hc0[17]*_t183 - _hc0[19]*_hc1[1] - _hc0[32]*_hc1[0] - _hc0[9]*_t273 - _hc1[17]*_t192 - _hc1[9]*_t284) + _t141*_t352 + _t165*_t353 + _t171*_t188 + _t171*_t200 + _t183*_t311 + _t183*_t318 + _t183*_t319 + _t183*_t321 + _t185*_t49 + _t186*_t315 + _t186*_t317 + _t189*_t273 + _t19*_t354 + _t193*_t29 + _t193*_t80 + 0.3e1*_t194*_t291 + _t195*_t355 + _t195*_t356 + _t196*_t273 + _t202*(-0.3e1*_t45 - 0.3e1*_t46 - 0.3e1*_t47 - 0.3e1*_t48) + _t220*_t360 + _t273*_t60 + _t283*_t351 + _t285*_t350 + _t320*_t326 + _t320*_t327 + _t322*_t357 + _t325*_t357 + _t346*_t70 + _t348*_t70 + _t355*_t358 + _t356*_t358 + _t59*(-_hc1[3]*_t328 - _hc1[7]*_t197 - 0.2e1*_t167 - 0.2e1*_t168 - 0.2e1*_t169 - 0.2e1*_t170);
  out[32] = d4f_drs3_dt;
  const double d4f_drs3_dz = _hc1[18]*_t184 + _hc1[18]*_t187 + _hc1[19]*_t38 + _hc1[2]*_t182 + _hc1[33]*_t4 + _hc1[8]*_t347 + _hc1[9]*_t302 + _t108*_t346 + _t108*_t348 + _t108*_t361 + _t117*_t193 + _t14*(-_hc0[0]*_hc1[33] - _hc0[18]*_t183 - _hc0[19]*_hc1[2] - _hc0[2]*_hc1[19] - _hc0[33]*_hc1[0] - _hc0[9]*_t303 - _hc1[18]*_t192 - _hc1[9]*_t310) + _t140*_t352 + _t140*_t359 + _t152*_t349 + _t153*_t349 + _t160*_t198 + _t174*_t353 + _t179*_t188 + _t179*_t200 + _t180*_t195*_t68 + _t180*_t352 + _t180*_t359 + _t183*_t331 + _t183*_t332 + _t183*_t337 + _t183*_t340 + _t183*_t341 + _t185*_t58 + _t186*_t329 + _t186*_t339 + _t189*_t303 + _t193*_t53 + _t195*_t362 + _t196*_t303 + _t202*(-0.3e1*_t54 - 0.3e1*_t55 - 0.3e1*_t56 - 0.3e1*_t57) + _t270*_t360 + 0.3e1*_t282*_t336 + _t294*_t350 + _t303*_t60 + _t320*_t342 + _t320*_t343 + _t335*_t357 + _t345*_t35 + _t354*_t37 + _t358*_t362 + _t59*(-_hc1[3]*_t344 - _hc1[8]*_t197 - 0.2e1*_t175 - 0.2e1*_t176 - 0.2e1*_t177 - 0.2e1*_t178);
  out[33] = d4f_drs3_dz;
  const double d4f_drs4 = _hc1[0]*_hc2[14]*_t3 + 0.8e1*_hc1[3]*_t354 + _hc1[34]*_t4 + 0.12e2*_hc1[9]*_t163 + _t126*_t198*_t365 + _t14*(-_hc0[0]*_hc1[34] - _hc0[19]*_t323 - _hc0[34]*_hc1[0] - _hc0[9]*_t364 - _hc1[19]*_t197) + _t15*_t363 + _t166*_t198*_t358 + 0.6e1*_t173*_t67 + _t182*_t323 + _t189*_t364 + 0.3e1*_t193*_t199 + _t193*_t323*_t6 + 0.4e1*_t193*_t52 + 0.6e1*_t194*_t316 + _t196*_t364 + _t201*_t282*_t365*_t68 + _t202*(-_hc0[3]*_t186 - 0.3e1*_t64 - 0.3e1*_t65) + _t219*_t360*(-0.4e1*_t16 - 0.4e1*_t17) + 0.8e1*_t320*_t351 + _t345*_t365 + _t346*_t366 + _t348*_t366 + _t352*_t353 + _t352*_t367 + _t353*_t359 + _t359*_t367 + _t361*_t366 + _t363*_t63 + _t364*_t60 + _t59*(-_hc0[3]*_t364 - _hc0[9]*_t186 - 0.2e1*_t190 - 0.2e1*_t191);
  out[34] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f_pbe_grad_k, _KMAX)(const xc_func_type *p, double rs, double z, double xt, double xs0, double xs1, double *out) {
  ...
  const double _t7 = 0.3e1*_hc1[4];
  const double _t8 = _hc0[5]*_hc1[4];
  const double _t9 = 0.2e1*_hc0[1];
  const double _t10 = _hc0[2]*_hc1[10];
  const double _t11 = _hc0[1]*_hc1[11];
  const double _t12 = _hc0[6]*_hc1[4];
  const double _t13 = _hc0[1]*_t10;
  const double _t14 = _t11 + _t13 + _t8;
  const double _t15 = _hc0[2]*_hc1[11];
  const double _t16 = _hc1[12] + _t15;
  const double _t17 = 0.2e1*_t3;
  const double _t18 = _hc1[11] + _t10;
  const double _t19 = _hc0[2]*_t18 + _t12 + _t16;
  const double _t20 = _hc0[7]*_hc1[4];
  const double _t21 = _hc0[3]*_hc1[10];
  const double _t22 = _hc0[2]*_hc1[14];
  const double _t23 = _hc0[8]*_hc1[4];
  const double _t24 = _hc1[15] + _t22;
  const double _t25 = _hc0[1]*_hc1[14];
  const double _t26 = _hc0[9]*_hc1[4];
  const double _t27 = _hc0[1]*_t21;
  const double _t28 = _t20 + _t25 + _t27;
  const double _t29 = _hc0[3]*_t18 + _t23 + _t24;
  const double _t30 = _hc0[3]*_hc1[14];
  const double _t31 = _hc1[17] + _t30;
  const double _t32 = 0.2e1*_t5;
  const double _t33 = _hc1[14] + _t21;
  const double _t34 = _hc0[3]*_t33 + _t26 + _t31;
#endif
#if _KMAX >= 4
  const double _t35 = _hc0[11]*_hc1[4];
  const double _t36 = 0.3e1*_hc0[1];
  const double _t37 = 0.3e1*_hc0[4];
  const double _t38 = _hc0[2]*_hc1[20];
  const double _t39 = _hc0[5]*_hc1[10];
  const double _t40 = 0.3e1*_t1;
  const double _t41 = _hc0[12]*_hc1[4];
  const double _t42 = 0.2e1*_hc0[5];
  const double _t43 = _hc1[21]*_t1;
  const double _t44 = _hc0[6]*_hc1[10];
  const double _t45 = 0.2e1*_t14;
  const double _t46 = _hc0[4]*_hc1[11] + _hc0[4]*_t10 + _t1*_t38 + _t35 + _t39*_t9 + _t43;
  const double _t47 = _hc0[13]*_hc1[4];
  const double _t48 = _hc0[1]*_hc1[22];
  const double _t49 = _hc0[1]*_hc1[21];
  const double _t50 = _hc0[2]*_t49 + _hc0[5]*_hc1[11] + _t48;
  const double _t51 = _hc0[1]*_t38 + _t39 + _t49;
  const double _t52 = _hc0[1]*_t44 + _hc0[2]*_t51 + _hc0[5]*_t18 + _t41 + _t50;
  const double _t53 = _hc0[2]*_hc1[22] + _hc1[23];
  const double _t54 = 0.3e1*_t3;
  const double _t55 = 0.2e1*_hc0[6];
  const double _t56 = _hc0[2]*_hc1[21] + _hc1[22];
  const double _t57 = _hc0[2]*_t56 + _hc0[6]*_hc1[11] + _t53;
  const double _t58 = 0.3e1*_t19;
  const double _t59 = _hc1[21] + _t38;
  const double _t60 = _hc0[2]*_t59 + _t44 + _t56;
  const double _t61 = _hc0[2]*_t60 + _t18*_t55 + _t47 + _t57;
  const double _t62 = _hc0[14]*_hc1[4];
  const double _t63 = _hc0[3]*_hc1[20];
  const double _t64 = _hc0[7]*_hc1[10];
  const double _t65 = _hc0[15]*_hc1[4];
  const double _t66 = _hc0[2]*_hc1[25];
  const double _t67 = _hc0[8]*_hc1[10];
  const double _t68 = _hc0[16]*_hc1[4];
  const double _t69 = _hc0[1]*_hc1[26];
  const double _t70 = _hc0[1]*_t66 + _hc0[5]*_hc1[14] + _t69;
  const double _t71 = _hc0[2]*_hc1[26] + _hc1[27];
  const double _t72 = _hc1[26] + _t66;
  const double _t73 = _hc0[2]*_t72 + _hc0[6]*_hc1[14] + _t71;
  const double _t74 = _hc0[17]*_hc1[4];
  const double _t75 = _hc1[25]*_t1;
  const double _t76 = _hc0[9]*_hc1[10];
  const double _t77 = 0.2e1*_t28;
  const double _t78 = _hc0[18]*_hc1[4];
  const double _t79 = _hc0[2]*_hc1[29];
  const double _t80 = _hc1[30] + _t79;
  const double _t81 = 0.2e1*_hc0[8];
  const double _t82 = _hc0[19]*_hc1[4];
  const double _t83 = _hc0[1]*_hc1[29];
  const double _t84 = _hc0[1]*_hc1[25];
  const double _t85 = _hc0[3]*_t84 + _hc0[7]*_hc1[14] + _t83;
  const double _t86 = _hc0[3]*_t72 + _hc0[8]*_hc1[14] + _t80;
  const double _t87 = 0.2e1*_hc0[9];
  const double _t88 = _hc0[3]*_hc1[29] + _hc1[32];
  const double _t89 = _hc0[3]*_hc1[25] + _hc1[29];
  const double _t90 = _hc0[3]*_t89 + _hc0[9]*_hc1[14] + _t88;
#endif
  ...
  out[10] = d2f_dxt_dxs0;
  const double d2f_dxt2 = _hc0[4]*_hc1[1] + _hc1[4]*_t1;
  out[11] = d2f_dxt2;
  ...
  const double d3f_dxt3 = _hc0[1]*_hc0[4]*_t7 + _hc0[10]*_hc1[1] + _hc1[10]*_t6;
  out[30] = d3f_dxt3;
  ...
  const double d3f_dz_dxt2 = _hc0[11]*_hc1[1] + _hc0[4]*_hc1[5] + _hc0[4]*_t2 + _hc1[11]*_t1 + _t1*_t10 + _t8*_t9;
  out[36] = d3f_dz_dxt2;
  const double d3f_dz2_dxs1 = 0;
  out[37] = d3f_dz2_dxs1;
  const double d3f_dz2_dxs0 = 0;
  out[38] = d3f_dz2_dxs0;
  const double d3f_dz2_dxt = _hc0[1]*_hc1[12] + _hc0[1]*_t12 + _hc0[12]*_hc1[1] + _hc0[2]*_t11 + _hc0[2]*_t14 + _hc0[5]*_hc1[5] + _hc0[5]*_t3;
  out[39] = d3f_dz2_dxt;
  const double d3f_dz3 = _hc0[13]*_hc1[1] + _hc0[2]*_hc1[12] + _hc0[2]*_t16 + _hc0[2]*_t19 + _hc0[6]*_hc1[5] + _hc0[6]*_t17 + _hc1[13];
  out[40] = d3f_dz3;
  ...
  const double d3f_drs_dxt2 = _hc0[14]*_hc1[1] + _hc0[4]*_hc1[7] + _hc0[4]*_t4 + _hc1[14]*_t1 + _t1*_t21 + _t20*_t9;
  out[46] = d3f_drs_dxt2;
  const double d3f_drs_dz_dxs1 = 0;
  out[47] = d3f_drs_dz_dxs1;
  const double d3f_drs_dz_dxs0 = 0;
  out[48] = d3f_drs_dz_dxs0;
  const double d3f_drs_dz_dxt = _hc0[1]*_hc1[15] + _hc0[1]*_t22 + _hc0[1]*_t23 + _hc0[15]*_hc1[1] + _hc0[3]*_t14 + _hc0[5]*_hc1[7] + _hc0[7]*_t3;
  out[49] = d3f_drs_dz_dxt;
  const double d3f_drs_dz2 = _hc0[16]*_hc1[1] + _hc0[2]*_hc1[15] + _hc0[2]*_t24 + _hc0[3]*_t19 + _hc0[6]*_hc1[7] + _hc0[8]*_t17 + _hc1[16];
  out[50] = d3f_drs_dz2;
  const double d3f_drs2_dxs1 = 0;
  out[51] = d3f_drs2_dxs1;
  const double d3f_drs2_dxs0 = 0;
  out[52] = d3f_drs2_dxs0;
  const double d3f_drs2_dxt = _hc0[1]*_hc1[17] + _hc0[1]*_t26 + _hc0[17]*_hc1[1] + _hc0[3]*_t25 + _hc0[3]*_t28 + _hc0[7]*_hc1[7] + _hc0[7]*_t5;
  out[53] = d3f_drs2_dxt;
  const double d3f_drs2_dz = _hc0[18]*_hc1[1] + _hc0[2]*_hc1[17] + _hc0[3]*_t24 + _hc0[3]*_t29 + _hc0[8]*_hc1[7] + _hc0[8]*_t5 + _hc0[9]*_t3 + _hc1[18];
  out[54] = d3f_drs2_dz;
  const double d3f_drs3 = _hc0[19]*_hc1[1] + _hc0[3]*_hc1[17] + _hc0[3]*_t31 + _hc0[3]*_t34 + _hc0[9]*_hc1[7] + _hc0[9]*_t32 + _hc1[19];
  out[55] = d3f_drs3;
#endif
#if _KMAX >= 4
  ...
  const double d4f_dxt4 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_hc1[20] + 0.4e1*_hc0[1]*_hc0[10]*_hc1[4] + _hc0[20]*_hc1[1] + ((_hc0[4]) * (_hc0[4]))*_t7 + 0.6e1*_hc0[4]*_hc1[10]*_t1;
  out[70] = d4f_dxt4;
  ...
  const double d4f_dz_dxt3 = _hc0[10]*_hc1[5] + _hc0[10]*_t2 + _hc0[21]*_hc1[1] + _hc1[21]*_t6 + _t11*_t37 + _t13*_t37 + _t35*_t36 + _t37*_t8 + _t38*_t6 + _t39*_t40;
  out[80] = d4f_dz_dxt3;
  ...
  const double d4f_dz2_dxt2 = _hc0[11]*_hc1[5] + _hc0[11]*_t3 + _hc0[2]*_t43 + _hc0[2]*_t46 + _hc0[22]*_hc1[1] + _hc0[4]*_hc1[12] + _hc0[4]*_t12 + _hc0[4]*_t15 + _hc0[5]*_t45 + _hc1[22]*_t1 + _t1*_t44 + _t11*_t42 + _t41*_t9;
  out[86] = d4f_dz2_dxt2;
  const double d4f_dz3_dxs1 = 0;
  out[87] = d4f_dz3_dxs1;
  const double d4f_dz3_dxs0 = 0;
  out[88] = d4f_dz3_dxs0;
  const double d4f_dz3_dxt = _hc0[1]*_hc1[23] + _hc0[1]*_t47 + _hc0[12]*_hc1[5] + _hc0[12]*_t17 + _hc0[2]*_t48 + _hc0[2]*_t50 + _hc0[2]*_t52 + _hc0[23]*_hc1[1] + _hc0[5]*_hc1[12] + _hc0[5]*_t16 + _hc0[5]*_t19 + _hc0[6]*_t11 + _hc0[6]*_t45;
  out[89] = d4f_dz3_dxt;
  const double d4f_dz4 = _hc0[13]*_hc1[5] + _hc0[13]*_t54 + _hc0[2]*_hc1[23] + _hc0[2]*_t53 + _hc0[2]*_t57 + _hc0[2]*_t61 + _hc0[24]*_hc1[1] + _hc0[6]*_hc1[12] + _hc0[6]*_t58 + _hc1[24] + _t16*_t55;
  out[90] = d4f_dz4;
  ...
  const double d4f_drs_dxt3 = _hc0[10]*_hc1[7] + _hc0[10]*_t4 + _hc0[25]*_hc1[1] + _hc1[25]*_t6 + _t20*_t37 + _t25*_t37 + _t27*_t37 + _t36*_t62 + _t40*_t64 + _t6*_t63;
  ...
  const double d4f_drs_dz_dxt2 = _hc0[11]*_hc1[7] + _hc0[14]*_t3 + _hc0[26]*_hc1[1] + _hc0[3]*_t46 + _hc0[4]*_hc1[15] + _hc0[4]*_t22 + _hc0[4]*_t23 + _hc0[7]*_t45 + _hc1[26]*_t1 + _t1*_t66 + _t1*_t67 + _t25*_t42 + _t65*_t9;
  ...
  const double d4f_drs_dz2_dxt = _hc0[1]*_hc1[27] + _hc0[1]*_t68 + _hc0[12]*_hc1[7] + _hc0[15]*_t17 + _hc0[2]*_t69 + _hc0[2]*_t70 + _hc0[27]*_hc1[1] + _hc0[3]*_t52 + _hc0[5]*_hc1[15] + _hc0[5]*_t24 + _hc0[6]*_t25 + _hc0[7]*_t19 + _hc0[8]*_t45;
  out[109] = d4f_drs_dz2_dxt;
  const double d4f_drs_dz3 = _hc0[13]*_hc1[7] + _hc0[16]*_t54 + _hc0[2]*_hc1[27] + _hc0[2]*_t71 + _hc0[2]*_t73 + _hc0[28]*_hc1[1] + _hc0[3]*_t61 + _hc0[6]*_hc1[15] + _hc0[8]*_t58 + _hc1[28] + _t24*_t55;
  out[110] = d4f_drs_dz3;
  ...
  const double d4f_drs2_dxt2 = _hc0[14]*_hc1[7] + _hc0[14]*_t5 + _hc0[29]*_hc1[1] + _hc0[3]*_t75 + _hc0[3]*(_hc0[4]*_hc1[14] + _hc0[4]*_t21 + _t1*_t63 + _t62 + _t64*_t9 + _t75) + _hc0[4]*_hc1[17] + _hc0[4]*_t26 + _hc0[4]*_t30 + 0.2e1*_hc0[7]*_t25 + _hc0[7]*_t77 + _hc1[29]*_t1 + _t1*_t76 + _t74*_t9;
  ...
  const double d4f_drs2_dz_dxt = _hc0[1]*_hc1[30] + _hc0[1]*_t78 + _hc0[1]*_t79 + _hc0[15]*_hc1[7] + _hc0[15]*_t5 + _hc0[17]*_t3 + _hc0[3]*_t70 + _hc0[3]*(_hc0[1]*_t67 + _hc0[3]*_t51 + _hc0[7]*_t18 + _t65 + _t70) + _hc0[30]*_hc1[1] + _hc0[5]*_hc1[17] + _hc0[7]*_t24 + _hc0[7]*_t29 + _hc0[8]*_t25 + _hc0[8]*_t28 + _hc0[9]*_t14;
  out[119] = d4f_drs2_dz_dxt;
  const double d4f_drs2_dz2 = _hc0[16]*_hc1[7] + _hc0[16]*_t5 + _hc0[18]*_t17 + _hc0[2]*_hc1[30] + _hc0[2]*_t80 + _hc0[3]*_t73 + _hc0[3]*(_hc0[3]*_t60 + _t18*_t81 + _t68 + _t73) + _hc0[31]*_hc1[1] + _hc0[6]*_hc1[17] + _hc0[9]*_t19 + _hc1[31] + _t24*_t81 + _t29*_t81;
  out[120] = d4f_drs2_dz2;
  const double d4f_drs3_dxs1 = 0;
  out[121] = d4f_drs3_dxs1;
  const double d4f_drs3_dxs0 = 0;
  out[122] = d4f_drs3_dxs0;
  const double d4f_drs3_dxt = _hc0[1]*_hc1[32] + _hc0[1]*_t82 + _hc0[17]*_hc1[7] + _hc0[17]*_t32 + _hc0[3]*_t83 + _hc0[3]*_t85 + _hc0[3]*(_hc0[1]*_t76 + _hc0[3]*(_hc0[1]*_t63 + _t64 + _t84) + _hc0[7]*_t33 + _t74 + _t85) + _hc0[32]*_hc1[1] + _hc0[7]*_hc1[17] + _hc0[7]*_t31 + _hc0[7]*_t34 + _hc0[9]*_t25 + _hc0[9]*_t77;
  out[123] = d4f_drs3_dxt;
  const double d4f_drs3_dz = _hc0[18]*_hc1[7] + _hc0[18]*_t32 + _hc0[19]*_t3 + _hc0[2]*_hc1[32] + _hc0[3]*_t80 + _hc0[3]*_t86 + _hc0[3]*(_hc0[3]*(_hc0[3]*_t59 + _t67 + _t72) + _hc0[8]*_t33 + _hc0[9]*_t18 + _t78 + _t86) + _hc0[33]*_hc1[1] + _hc0[8]*_hc1[17] + _hc0[8]*_t31 + _hc0[8]*_t34 + _hc0[9]*_t24 + _hc1[33] + _t29*_t87;
  out[124] = d4f_drs3_dz;
  const double d4f_drs4 = _hc0[19]*_hc1[7] + 0.3e1*_hc0[19]*_t5 + _hc0[3]*_hc1[32] + _hc0[3]*_t88 + _hc0[3]*_t90 + _hc0[3]*(_hc0[3]*(_hc0[3]*(_hc1[25] + _t63) + _t76 + _t89) + _t33*_t87 + _t82 + _t90) + _hc0[34]*_hc1[1] + _hc0[9]*_hc1[17] + 0.3e1*_hc0[9]*_t34 + _hc1[34] + _t31*_t87;
  out[125] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(tp_z0_k, _KMAX)(const xc_func_type *p, double rs, double xt, double *out) {
  ...
  const double _t3 = (0.1e1 / 0.8e1)/xc_powr(rs, 1, 2);
#if _KMAX >= 1
  const double _t5 = xc_powr(rs, -3, 2);
  const double _t6 = (0.1e1 / 0.16e2)*_t5;
#endif
#if _KMAX >= 2
  const double _t10 = (0.1e1 / (rs * rs));
  const double _t12 = xc_powr(rs, -5, 2);
  const double _t13 = (0.3e1 / 0.32e2)*_t12;
  const double _t14 = (xt * xt);
  const double _t15 = (0.1e1 / (rs * rs * rs));
#endif
#if _KMAX >= 3
  const double _t18 = xc_powr(rs, -7, 2);
  const double _t20 = (xt * xt * xt);
  const double _t21 = xc_powr(rs, -9, 2);
  const double _t23 = (0.15e2 / 0.64e2)*_t18;
  const double _t24 = (0.1e1 / (rs * rs * rs * rs));
  const double _t25 = _t14*_t24;
#endif
#if _KMAX >= 4
  const double _t27 = xc_powi(rs, -5);
#endif
  double _hc0[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(bcgp_pt_k, _KMAX)(p, _t2*_t3, _hc0);
#if _KMAX >= 1
  const double _t4 = _hc0[1]*_t1;
  const double _t7 = _hc0[1]*_t2;
#endif
#if _KMAX >= 2
  const double _t8 = M_CBRT2*_hc0[2];
  const double _t9 = (0.1e1 / 0.32e2)*_t8;
  const double _t11 = _t8*xt;
  const double _t16 = _t15*_t8;
#endif
#if _KMAX >= 3
  const double _t17 = _hc0[3]*_t12;
  const double _t19 = _hc0[3]*_t18;
  const double _t22 = _hc0[3]*_t21;
#endif
#if _KMAX >= 4
  const double _t26 = _hc0[4]*_t1;
#endif

  const double f = _hc0[0];
  out[0] = f;
#if _KMAX >= 1
  const double df_dxt = _t3*_t4;
  out[1] = df_dxt;
  const double df_drs = -_t6*_t7;
  out[2] = df_drs;
#endif
#if _KMAX >= 2
  const double d2f_dxt2 = _t9/rs;
  out[3] = d2f_dxt2;
  const double d2f_drs_dxt = -0.1e1 / 0.64e2*_t10*_t11 - _t4*_t6;
  out[4] = d2f_drs_dxt;
  const double d2f_drs2 = _t13*_t7 + (0.1e1 / 0.128e3)*_t14*_t16;
  out[5] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dxt3 = (0.1e1 / 0.128e3)*_hc0[3]*_t5;
  out[6] = d3f_dxt3;
  const double d3f_drs_dxt2 = -_t10*_t9 - 0.1e1 / 0.256e3*_t17*xt;
  out[7] = d3f_drs_dxt2;
  const double d3f_drs2_dxt = _t13*_t4 + (0.1e1 / 0.512e3)*_t14*_t19 + (0.5e1 / 0.128e3)*_t16*xt;
  out[8] = d3f_drs2_dxt;
  const double d3f_drs3 = -0.1e1 / 0.1024e4*_t20*_t22 - _t23*_t7 - 0.9e1 / 0.256e3*_t25*_t8;
  out[9] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dxt4 = (0.1e1 / 0.1024e4)*_t10*_t26;
  out[10] = d4f_dxt4;
  const double d4f_drs_dxt3 = -0.1e1 / 0.2048e4*_hc0[4]*_t15*_t2 - 0.3e1 / 0.256e3*_t17;
  out[11] = d4f_drs_dxt3;
  const double d4f_drs2_dxt2 = (0.1e1 / 0.16e2)*_t16 + (0.7e1 / 0.512e3)*_t19*xt + (0.1e1 / 0.4096e4)*_t25*_t26;
  out[12] = d4f_drs2_dxt2;
  const double d4f_drs3_dxt = -0.33e2 / 0.256e3*_t11*_t24 - 0.3e1 / 0.256e3*_t14*_t22 - 0.1e1 / 0.8192e4*_t20*_t26*_t27 - _t23*_t4;
  out[13] = d4f_drs3_dxt;
  const double d4f_drs4 = (0.9e1 / 0.1024e4)*_hc0[3]*_t20/xc_powr(rs, 11, 2) + (0.87e2 / 0.512e3)*_t14*_t27*_t8 + (0.105e3 / 0.128e3)*_t21*_t7 + (0.1e1 / 0.16384e5)*_t26*(xt * xt * xt * xt)/xc_powi(rs, 6);
  out[14] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f2_z0_k, _KMAX)(const xc_func_type *p, double rs, double t, double *out) {
  ...
  const double _t34 = -_t30 - _t31 - _t32 - _t33;
  const double _t35 = _t24*_t25;
  const double _t36 = _hc1[0]*_t14;
  const double _t37 = _hc2[5]*_t3;
  const double _t38 = 0.2e1*_hc1[2];
  const double _t39 = _hc1[0]*_t27;
  const double _t40 = 0.2e1*_t39;
  const double _t41 = _hc0[0]*_hc1[5];
  const double _t42 = _hc0[5]*_hc1[0];
  const double _t43 = 0.2e1*_hc0[2];
  const double _t44 = -_hc1[2]*_t43 - _t41 - _t42;
  const double _t45 = -0.2e1*_t12 - 0.2e1*_t13;
  const double _t46 = _t24*_t36;
#endif
#if _KMAX >= 3
  const double _t47 = 0.3e1*_hc1[3];
  const double _t48 = 0.3e1*_hc1[1];
  const double _t49 = _t21*_t6;
  const double _t50 = _hc0[0]*_hc1[6];
  const double _t51 = _hc0[6]*_hc1[0];
  const double _t52 = _hc0[1]*_hc1[3];
  const double _t53 = _hc0[3]*_hc1[1];
  const double _t54 = -_t50 - _t51 - 0.3e1*_t52 - 0.3e1*_t53;
  const double _t55 = _t35*_t9;
  const double _t56 = -0.2e1*_t18 - 0.2e1*_t19 - 0.4e1*_t20;
  const double _t57 = _t10*_t24;
  const double _t58 = _hc1[0]*_t35;
  const double _t59 = 0.2e1*_t21;
  const double _t60 = -0.3e1*_t7 - 0.3e1*_t8;
  const double _t61 = (0.1e1 / (_t1 * _t1 * _t1 * _t1));
  const double _t62 = _t23*_t61;
  const double _t63 = _t60*_t62;
  const double _t64 = _t16*_t27;
  const double _t65 = 0.2e1*_hc1[4];
  const double _t66 = _t34*_t6;
  const double _t67 = _t2*_t22;
  const double _t68 = _hc2[2]*_t67;
  const double _t69 = _hc1[2]*_t9;
  const double _t70 = _t14*_t35;
  const double _t71 = _hc0[0]*_hc1[7];
  const double _t72 = _hc0[2]*_hc1[3];
  const double _t73 = _hc0[3]*_hc1[2];
  const double _t74 = _hc0[7]*_hc1[0];
  const double _t75 = 0.2e1*_hc0[1];
  const double _t76 = 0.2e1*_hc0[4];
  const double _t77 = -_hc1[1]*_t76 - _hc1[4]*_t75 - _t71 - _t72 - _t73 - _t74;
  const double _t78 = _hc1[0]*_t34;
  const double _t79 = 0.2e1*_t78;
  const double _t80 = _t25*_t36;
  const double _t81 = 0.2e1*_t11;
  const double _t82 = _hc2[5]*_t5;
  const double _t83 = _hc1[5]*_t6;
  const double _t84 = _t27*_t9;
  const double _t85 = _t44*_t6;
  const double _t86 = _t24*_t45;
  const double _t87 = _t14*_t86;
  const double _t88 = 0.2e1*_t80;
  const double _t89 = _hc1[0]*_t44;
  const double _t90 = _hc0[0]*_hc1[8];
  const double _t91 = _hc0[1]*_hc1[5];
  const double _t92 = _hc0[5]*_hc1[1];
  const double _t93 = _hc0[8]*_hc1[0];
  const double _t94 = -_hc1[2]*_t76 - _hc1[4]*_t43 - _t90 - _t91 - _t92 - _t93;
  const double _t95 = -0.2e1*_t30 - 0.2e1*_t31 - 0.2e1*_t32 - 0.2e1*_t33;
  const double _t96 = _t36*_t45;
  const double _t97 = _hc2[9]*_t3;
  const double _t98 = 0.3e1*_hc1[2];
  const double _t99 = 0.3e1*_t11;
  const double _t100 = _hc1[0]*_t82;
  const double _t101 = 0.3e1*_t100;
  const double _t102 = 0.6e1*_hc1[2];
  const double _t103 = _t14*_t27;
  const double _t104 = 0.3e1*_hc1[5];
  const double _t105 = 0.3e1*_t39;
  const double _t106 = _hc0[0]*_hc1[9];
  const double _t107 = _hc0[9]*_hc1[0];
  const double _t108 = 0.3e1*_hc0[2];
  const double _t109 = 0.3e1*_hc0[5];
  const double _t110 = -_hc1[2]*_t109 - _hc1[5]*_t108 - _t106 - _t107;
  const double _t111 = 0.3e1*_t68;
  const double _t112 = 0.4e1*_hc0[2];
  const double _t113 = -_hc1[2]*_t112 - 0.2e1*_t41 - 0.2e1*_t42;
  const double _t114 = 0.2e1*_t86;
  const double _t115 = -0.3e1*_t12 - 0.3e1*_t13;
  const double _t116 = _t62*_t96;
#endif
#if _KMAX >= 4
  const double _t117 = 0.6e1*_hc1[3];
  const double _t118 = 0.4e1*_hc1[1];
  const double _t119 = 0.4e1*_hc0[1];
  const double _t120 = _t21*_t35;
  const double _t121 = _t24*_t56;
  const double _t122 = _t118*_t9;
  const double _t123 = -0.2e1*_t50 - 0.2e1*_t51 - 0.6e1*_t52 - 0.6e1*_t53;
  const double _t124 = 0.3e1*_t121;
  const double _t125 = _hc1[0]*_t21;
  const double _t126 = _t25*_t63;
  const double _t127 = -0.3e1*_t18 - 0.3e1*_t19 - 0.6e1*_t20;
  const double _t128 = _t127*_t62;
  const double _t129 = 0.3e1*_t126;
  const double _t130 = _t56*_t63;
  const double _t131 = _t26*_t60;
  const double _t132 = _t23/xc_powi(_t1, 5);
  const double _t133 = _t132*(-0.4e1*_t7 - 0.4e1*_t8);
  const double _t134 = 0.3e1*_hc1[7];
  const double _t135 = _t21*_t27;
  const double _t136 = 0.3e1*_hc1[4];
  const double _t137 = _t25*_t68;
  const double _t138 = _t137*_t9;
  const double _t139 = _t56*_t68;
  const double _t140 = _t121*_t14;
  const double _t141 = _t6*_t77;
  const double _t142 = _t34*_t35;
  const double _t143 = _hc2[2]*_t2*_t61;
  const double _t144 = _t14*_t48;
  const double _t145 = 0.2e1*_t36;
  const double _t146 = 0.3e1*_hc0[4];
  const double _t147 = _hc1[0]*_t77;
  const double _t148 = _t133*_t60;
  const double _t149 = _t82*_t9;
  const double _t150 = 0.4e1*_hc1[4];
  const double _t151 = _t27*_t34;
  const double _t152 = _hc2[5]*_t67;
  const double _t153 = _t137*_t14;
  const double _t154 = _t16*_t44;
  const double _t155 = _t6*_t94;
  const double _t156 = _t34*_t86;
  const double _t157 = _t24*_t95;
  const double _t158 = _t14*_t157;
  const double _t159 = 0.4e1*_hc1[2];
  const double _t160 = _t143*_t60;
  const double _t161 = _t45*_t63;
  const double _t162 = _t14*_t161;
  const double _t163 = 0.4e1*_hc0[4];
  const double _t164 = _hc2[9]*_t5;
  const double _t165 = _t14*_t82;
  const double _t166 = _t27*_t44;
  const double _t167 = _t110*_t6;
  const double _t168 = _t45*_t68;
  const double _t169 = _t113*_t24;
  const double _t170 = _hc1[1]*_t14;
  const double _t171 = _t45*_t78;
  const double _t172 = _t36*_t95;
  const double _t173 = _t115*_t62;
  const double _t174 = _t173*_t45;
  const double _t175 = 0.2e1*_t89;
  const double _t176 = _t115*_t96;
  const double _t177 = 0.6e1*_hc1[5];
  const double _t178 = 0.4e1*_hc1[9];
  const double _t179 = 0.4e1*_t36;
  const double _t180 = 0.12e2*_hc1[2];
  const double _t181 = _t14*_t159;
  const double _t182 = 0.3e1*_t89;
#endif
...
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _hc1[3]*_t4 + _t15*_t21 + _t16*_t17 + _t24*_t26;
  out[3] = d2f_dt2;
  const double d2f_drs_dt = _hc1[1]*_t11 + _hc1[1]*_t28 + _hc1[4]*_t4 + _t10*_t27 + _t15*_t34 + _t29*_t9 + _t35*_t36;
  out[4] = d2f_drs_dt;
  const double d2f_drs2 = _hc1[0]*_t37 + _hc1[5]*_t4 + _t11*_t38 + _t14*_t40 + _t15*_t44 + _t28*_t38 + _t45*_t46;
  out[5] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _hc1[6]*_t4 + _t15*_t54 + _t17*_t47 + _t26*_t63 + _t48*_t49 + _t48*_t55 + _t56*_t57 + _t58*_t59;
  out[6] = d3f_dt3;
  const double d3f_drs_dt2 = _hc1[3]*_t11 + _hc1[3]*_t28 + _hc1[7]*_t4 + _t15*_t77 + _t16*_t66 + _t16*_t70 + _t17*_t65 + _t21*_t29 + _t21*_t39 + _t26*_t68 + _t35*_t69 + _t35*_t79 + _t46*_t56 + _t63*_t80 + _t64*_t9;
  out[7] = d3f_drs_dt2;
  const double d3f_drs2_dt = _hc1[1]*_t37 + _hc1[1]*_t85 + _hc1[1]*_t87 + _hc1[4]*_t81 + _hc1[8]*_t4 + _t10*_t82 + _t14*_t64 + _t15*_t94 + _t28*_t65 + _t34*_t40 + _t35*_t89 + _t38*_t66 + _t38*_t70 + _t38*_t84 + _t46*_t95 + _t63*_t96 + _t68*_t88 + _t78*_t86 + _t83*_t9;
  out[8] = d3f_drs2_dt;
  const double d3f_drs3 = _hc1[0]*_t97 + _hc1[5]*_t99 + _hc1[9]*_t4 + _t101*_t14 + _t102*_t103 + _t104*_t28 + _t105*_t44 + _t110*_t15 + _t111*_t96 + _t113*_t46 + _t114*_t89 + _t115*_t116 + _t37*_t98 + _t85*_t98 + _t87*_t98;
  out[9] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = 0.8e1*_hc1[1]*_t120 + _hc1[10]*_t4 + 0.4e1*_hc1[6]*_t17 + 0.2e1*_t10*_t130 + _t117*_t49 + _t117*_t55 + _t118*_t54*_t6 + _t121*_t122 + _t122*_t126 + _t123*_t57 + _t124*_t125 + _t125*_t129 + _t128*_t26 + _t131*_t133 + _t15*(-_hc0[0]*_hc1[10] - _hc0[10]*_hc1[0] - _hc0[3]*_t117 - _hc0[6]*_t118 - _hc1[6]*_t119) + 0.3e1*_t54*_t58;
  out[10] = d4f_dt4;
  const double d4f_drs_dt3 = _hc1[0]*_t137*_t59 + 0.6e1*_hc1[1]*_t142 + _hc1[11]*_t4 + _hc1[6]*_t11 + _hc1[6]*_t28 + _t10*_t139 + _t120*_t38 + _t121*_t69 + _t123*_t46 + _t124*_t78 + _t126*_t144 + _t126*_t69 + _t128*_t80 + _t129*_t78 + _t130*_t145 + _t131*_t143 + _t134*_t17 + _t135*_t48 + _t136*_t49 + _t136*_t55 + _t138*_t48 + _t140*_t48 + _t141*_t48 + 0.3e1*_t147*_t35 + _t148*_t80 + _t15*(-_hc0[0]*_hc1[11] - _hc0[1]*_t134 - _hc0[11]*_hc1[0] - _hc0[2]*_hc1[6] - _hc0[3]*_t136 - _hc0[6]*_hc1[2] - _hc0[7]*_t48 - _hc1[3]*_t146) + _t29*_t54 + _t39*_t54 + _t47*_t66 + _t47*_t70 + _t47*_t84;
  out[11] = d4f_drs_dt3;
  const double d4f_drs2_dt2 = _hc1[12]*_t4 + 0.2e1*_hc1[3]*_t103 + _hc1[3]*_t37 + _hc1[3]*_t85 + _hc1[3]*_t87 + _hc1[5]*_t55 + 0.2e1*_hc1[7]*_t28 + _hc1[7]*_t81 + 0.2e1*_hc1[8]*_t17 + _t100*_t21 + _t116*_t127 + _t118*_t151 + _t118*_t153 + _t121*_t89 + _t126*_t14*_t38 + _t126*_t89 + _t135*_t38 + 0.4e1*_t137*_t78 + _t138*_t38 + _t139*_t145 + _t140*_t38 + _t141*_t38 + _t142*_t159 + _t145*_t63*_t95 + _t147*_t86 + _t148*_t96 + _t149*_t16 + _t15*(-_hc0[0]*_hc1[12] - _hc0[12]*_hc1[0] - _hc0[3]*_hc1[5] - _hc0[5]*_hc1[3] - _hc0[7]*_t38 - _hc0[8]*_t16 - _hc1[4]*_t163 - _hc1[7]*_t43 - _hc1[8]*_t75) + _t150*_t66 + _t150*_t70 + _t150*_t84 + _t152*_t26 + _t154*_t35 + _t155*_t16 + _t156*_t16 + _t157*_t79 + _t158*_t16 + _t16*_t162 + _t160*_t88 + _t161*_t79 + _t21*_t83 + _t40*_t77 + _t46*(-_hc0[4]*_t118 - _hc1[4]*_t119 - 0.2e1*_t71 - 0.2e1*_t72 - 0.2e1*_t73 - 0.2e1*_t74) + 0.2e1*_t58*_t94;
  out[12] = d4f_drs2_dt2;
  const double d4f_drs3_dt = _hc1[0]*_t114*_t94 + _hc1[1]*_t167 + _hc1[1]*_t97 + _hc1[13]*_t4 + 0.6e1*_hc1[4]*_t103 + 0.3e1*_hc1[8]*_t28 + _hc1[8]*_t99 + _hc1[9]*_t17 + _t10*_t164 + _t101*_t34 + _t102*_t151 + _t102*_t153 + _t104*_t70 + _t104*_t84 + _t105*_t94 + _t110*_t58 + _t111*_t171 + _t111*_t172 + _t111*_t25*_t89 + _t113*_t36*_t63 + _t116*(-0.3e1*_t30 - 0.3e1*_t31 - 0.3e1*_t32 - 0.3e1*_t33) + _t133*_t176 + _t136*_t37 + _t136*_t85 + _t136*_t87 + _t144*_t168 + _t149*_t98 + _t15*(-_hc0[0]*_hc1[13] - _hc0[1]*_hc1[9] - _hc0[13]*_hc1[0] - _hc0[8]*_t98 - _hc0[9]*_hc1[1] - _hc1[4]*_t109 - _hc1[5]*_t146 - _hc1[8]*_t108) + 0.3e1*_t152*_t80 + _t154*_t86 + _t155*_t98 + _t156*_t98 + _t157*_t175 + _t158*_t98 + 0.3e1*_t160*_t96 + _t161*_t175 + _t162*_t98 + _t165*_t48 + _t166*_t48 + _t169*_t170 + _t169*_t78 + _t170*_t174 + _t171*_t173 + _t172*_t173 + 0.3e1*_t34*_t83 + _t35*_t44*_t98 + _t46*(-_hc1[2]*_t163 - _hc1[4]*_t112 - 0.2e1*_t90 - 0.2e1*_t91 - 0.2e1*_t92 - 0.2e1*_t93);
  out[13] = d4f_drs3_dt;
  const double d4f_drs4 = _hc1[0]*_hc2[14]*_t3 + 0.3e1*_hc1[0]*_t110*_t86 + _hc1[14]*_t4 + 0.8e1*_hc1[2]*_t44*_t86 + 0.12e2*_hc1[5]*_t103 + 0.6e1*_t100*_t44 + _t11*_t178 + 0.4e1*_t110*_t39 + _t113*_t145*_t173 + _t113*_t179*_t68 + _t115*_t143*_t179*_t45 + _t116*(-_hc0[2]*_t102 - 0.3e1*_t41 - 0.3e1*_t42) + _t132*_t176*(-0.4e1*_t12 - 0.4e1*_t13) + _t14*_t168*_t180 + _t15*(-_hc0[0]*_hc1[14] - _hc0[14]*_hc1[0] - _hc0[5]*_t177 - _hc0[9]*_t159 - _hc1[9]*_t112) + 0.6e1*_t152*_t96 + _t159*_t167 + _t159*_t97 + _t164*_t179 + _t165*_t180 + _t166*_t180 + 0.8e1*_t168*_t89 + _t169*_t181 + _t169*_t182 + _t174*_t181 + _t174*_t182 + _t177*_t37 + _t177*_t85 + _t177*_t87 + _t178*_t28 + _t46*(-_hc0[2]*_t177 - _hc0[5]*_t102 - 0.2e1*_t106 - 0.2e1*_t107);
  out[14] = d4f_drs4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f_pbe_grad_z0_k, _KMAX)(const xc_func_type *p, double rs, double xt, double xs0, double xs1, double *out) {
  ...
  const double d2f_dxt_dxs0 = 0;
  out[9] = d2f_dxt_dxs0;
  const double d2f_dxt2 = _hc0[3]*_hc1[1] + _hc1[3]*_t1;
  out[10] = d2f_dxt2;
  const double d2f_drs_dxs1 = 0;
  out[11] = d2f_drs_dxs1;
  const double d2f_drs_dxs0 = 0;
  ...
  const double d3f_dxt3 = _hc0[1]*_hc0[3]*_t5 + _hc0[6]*_hc1[1] + _hc1[6]*_t4;
  out[24] = d3f_dxt3;
  const double d3f_drs_dxs12 = 0;
  ...
  const double d3f_drs_dxt2 = _hc0[3]*_hc1[4] + _hc0[3]*_t2 + _hc0[7]*_hc1[1] + _hc1[7]*_t1 + _t1*_t8 + _t6*_t7;
  out[30] = d3f_drs_dxt2;
  const double d3f_drs2_dxs1 = 0;
  out[31] = d3f_drs2_dxs1;
  const double d3f_drs2_dxs0 = 0;
  out[32] = d3f_drs2_dxs0;
  const double d3f_drs2_dxt = _hc0[1]*_hc1[8] + _hc0[1]*_t10 + _hc0[2]*_t12 + _hc0[2]*_t9 + _hc0[4]*_hc1[4] + _hc0[4]*_t3 + _hc0[8]*_hc1[1];
  out[33] = d3f_drs2_dxt;
  const double d3f_drs3 = _hc0[2]*_hc1[8] + _hc0[2]*_t14 + _hc0[2]*_t17 + _hc0[5]*_hc1[4] + _hc0[9]*_hc1[1] + _hc1[9] + _t15*_t3;
  out[34] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dxs14 = 0;
  ...
  const double d4f_dxt4 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_hc1[10] + 0.4e1*_hc0[1]*_hc0[6]*_hc1[3] + _hc0[10]*_hc1[1] + ((_hc0[3]) * (_hc0[3]))*_t5 + 0.6e1*_hc0[3]*_hc1[6]*_t1;
  out[49] = d4f_dxt4;
  const double d4f_drs_dxs13 = 0;
  ...
  const double d4f_drs_dxt3 = 0.3e1*_hc0[1]*_t19 + _hc0[11]*_hc1[1] + _hc0[6]*_hc1[4] + _hc0[6]*_t2 + _hc1[11]*_t4 + 0.3e1*_t1*_t21 + _t11*_t18 + _t18*_t6 + _t18*_t9 + _t20*_t4;
  out[59] = d4f_drs_dxt3;
  const double d4f_drs2_dxs12 = 0;
  ...
  const double d4f_drs2_dxt2 = _hc0[12]*_hc1[1] + _hc0[2]*_t24 + _hc0[2]*(_hc0[3]*_hc1[7] + _hc0[3]*_t8 + _t1*_t20 + _t19 + _t21*_t7 + _t24) + _hc0[3]*_hc1[8] + _hc0[3]*_t10 + _hc0[3]*_t13 + _hc0[7]*_hc1[4] + _hc0[7]*_t3 + _hc1[12]*_t1 + _t1*_t25 + _t12*_t22 + _t22*_t9 + _t23*_t7;
  out[65] = d4f_drs2_dxt2;
  const double d4f_drs3_dxs1 = 0;
  out[66] = d4f_drs3_dxs1;
  const double d4f_drs3_dxs0 = 0;
  out[67] = d4f_drs3_dxs0;
  const double d4f_drs3_dxt = _hc0[1]*_hc1[13] + _hc0[1]*_t27 + _hc0[13]*_hc1[1] + _hc0[2]*_t26 + _hc0[2]*_t29 + _hc0[2]*(_hc0[1]*_t25 + _hc0[2]*(_hc0[1]*_t20 + _t21 + _t28) + _hc0[4]*_t16 + _t23 + _t29) + _hc0[4]*_hc1[8] + _hc0[4]*_t14 + _hc0[4]*_t17 + _hc0[5]*_t9 + _hc0[8]*_hc1[4] + 0.2e1*_hc0[8]*_t3 + _t12*_t15;
  out[68] = d4f_drs3_dxt;
  const double d4f_drs4 = _hc0[14]*_hc1[1] + _hc0[2]*_hc1[13] + _hc0[2]*_t30 + _hc0[2]*_t32 + _hc0[2]*(_hc0[2]*(_hc0[2]*(_hc1[11] + _t20) + _t25 + _t31) + _t15*_t16 + _t27 + _t32) + _hc0[5]*_hc1[8] + 0.3e1*_hc0[5]*_t17 + _hc0[9]*_hc1[4] + 0.3e1*_hc0[9]*_t3 + _hc1[14] + _t14*_t15;
  out[69] = d4f_drs4;
#endif
}
