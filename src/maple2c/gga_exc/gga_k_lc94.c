/*
  Generated from python/gga_exc/gga_k_lc94.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_k_lc94
*/

#ifndef _GGA_K_LC94_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_K_LC94_KERNEL_BODY
#define _KMAX 0
#define _GGA_K_LC94_HELPER_BODIES
#include "gga_k_lc94.c"
#undef _GGA_K_LC94_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_K_LC94_HELPER_BODIES
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double *out) {
  ...
  if(!(_t3)) XC_CAT(pw91_f_k, _KMAX)(p, _t1*_t2, _hc1);
