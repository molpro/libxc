/*
  Generated from python/gga_exc/gga_x_chachiyo.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_x_chachiyo
*/

#ifndef _GGA_X_CHACHIYO_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_X_CHACHIYO_KERNEL_BODY
#define _KMAX 0
#define _GGA_X_CHACHIYO_HELPER_BODIES
#include "gga_x_chachiyo.c"
#undef _GGA_X_CHACHIYO_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_X_CHACHIYO_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_X_CHACHIYO_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(chachiyo_x_k, _KMAX)(const xc_func_type *p, double x, double *out) {

  const double _t1 = (0.1e1 / 0.27e2)*xc_powr(0.6e1, 2, 3)*M_CBRTPI;

  const double f = _t1*x;
  out[0] = f;
#if _KMAX >= 1
  const double df_dx = _t1;
  out[1] = df_dx;
#endif
#if _KMAX >= 2
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(chachiyo_f0_k, _KMAX)(const xc_func_type *p, double x, double *out) {

  const double _t1 = xc_log1p(x);
  const double _t2 = (M_PI * M_PI);
  const double _t3 = _t1*_t2 + 0.3e1*(x * x);
  const double _t4 = _t2 + 0.3e1*x;
  ...
  const double _t10 = x + 0.1e1;
  const double _t11 = (0.1e1 / _t10);
  const double _t12 = _t11*_t2 + 0.6e1*x;
  const double _t13 = _t3*_t5;
  const double _t14 = (0.1e1 / (_t1 * _t1));
  const double _t15 = _t11*_t14;
#endif
#if _KMAX >= 2
  const double _t16 = (0.1e1 / (_t10 * _t10));
  const double _t17 = -_t16*_t2 + 0.6e1;
  ...
  const double _t22 = _t15*_t3;
  const double _t23 = _t15*_t5;
#endif
#if _KMAX >= 3
  const double _t24 = (0.1e1 / (_t10 * _t10 * _t10));
  const double _t25 = (0.1e1 / (_t4 * _t4 * _t4 * _t4));
  const double _t26 = (0.1e1 / (_t1 * _t1 * _t1 * _t1));
  const double _t27 = _t13*_t24;
  const double _t28 = 0.6e1*_t27;
  const double _t29 = _t16*_t21;
  const double _t30 = _t29*_t3;
  const double _t31 = _t14*_t16;
  const double _t32 = _t3*_t8;
#endif
#if _KMAX >= 4
  const double _t33 = 0.8e1*_t14;
  const double _t34 = (0.1e1 / (_t10 * _t10 * _t10 * _t10));
  const double _t35 = _t2*_t34;
  const double _t36 = 0.108e3*_t18;
  const double _t37 = 0.648e3*_t25;
  const double _t38 = 0.36e2*_t8;
  const double _t39 = _t13*_t34;
  const double _t40 = 0.72e2*_t24*_t32;
  const double _t41 = 0.24e2*_t24;
  const double _t42 = 0.216e3*_t18;
  const double _t43 = _t12*_t5;
  ...
  out[0] = f;
#if _KMAX >= 1
  const double df_dx = _t12*_t5*_t6 - _t13*_t15 - 0.3e1*_t3*_t9;
  out[1] = df_dx;
#endif
#if _KMAX >= 2
  const double d2f_dx2 = -0.2e1*_t12*_t23 - 0.6e1*_t12*_t9 + _t14*_t20 + _t17*_t7 + 0.18e2*_t18*_t19 + 0.2e1*_t20*_t21 + 0.6e1*_t22*_t8;
  out[2] = d2f_dx2;
#endif
#if _KMAX >= 3
  const double d3f_dx3 = 0.18e2*_t11*_t12*_t14*_t8 + 0.3e1*_t12*_t14*_t16*_t5 + 0.6e1*_t12*_t16*_t21*_t5 + 0.54e2*_t12*_t18*_t6 - 0.2e1*_t14*_t27 - 0.3e1*_t17*_t23 - 0.9e1*_t17*_t9 - 0.54e2*_t18*_t22 - 0.162e3*_t19*_t25 + 0.2e1*_t2*_t24*_t5*_t6 - _t21*_t28 - _t26*_t28 - 0.18e2*_t30*_t8 - 0.9e1*_t31*_t32;
  out[3] = d3f_dx3;
#endif
#if _KMAX >= 4
  const double d4f_dx4 = -_t12*_t15*_t42 - 0.72e2*_t12*_t29*_t8 - _t12*_t31*_t38 - _t12*_t37*_t6 + _t14*_t32*_t41 + 0.6e1*_t14*_t39 + _t15*_t17*_t38 + 0.12e2*_t17*_t29*_t5 + 0.6e1*_t17*_t31*_t5 + _t17*_t36*_t6 + 0.1944e4*_t19/xc_powi(_t4, 5) - 0.24e2*_t2*_t24*_t9 + 0.22e2*_t21*_t39 + _t21*_t40 - _t21*_t44 + _t22*_t37 - _t24*_t33*_t43 + 0.36e2*_t26*_t39 + _t26*_t40 - _t26*_t44 + _t3*_t31*_t36 + _t30*_t42 - _t33*_t35*_t5 - 0.6e1*_t35*_t7 + 0.24e2*_t39/xc_powi(_t1, 5);
  out[4] = d4f_dx4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(chachiyo_f_k, _KMAX)(const xc_func_type *p, double x, double *out) {

  double _hc0[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(chachiyo_x_k, _KMAX)(p, x, _hc0);
  double _hc1[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(chachiyo_f0_k, _KMAX)(p, _hc0[0], _hc1);
...
#endif
#if _KMAX >= 2
  const double d2f_dx2 = ((_hc0[1]) * (_hc0[1]))*_hc1[2];
  out[2] = d2f_dx2;
#endif
#if _KMAX >= 3
  const double d3f_dx3 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_hc1[3];
  out[3] = d3f_dx3;
#endif
#if _KMAX >= 4
  const double d4f_dx4 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_hc1[4];
  out[4] = d4f_dx4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double *out) {
  ...
  if(!(_t6)) XC_CAT(chachiyo_f_k, _KMAX)(p, _t1*_t2, _hc0);
