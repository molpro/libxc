/*
  Generated from python/gga_exc/gga_x_s12.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_x_s12
*/

#ifndef _GGA_X_S12_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_X_S12_KERNEL_BODY
#define _KMAX 0
#define _GGA_X_S12_HELPER_BODIES
#include "gga_x_s12.c"
#undef _GGA_X_S12_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_X_S12_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_X_S12_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(s12g_f_inner_pf_k, _KMAX)(const xc_func_type *p, double x2, double *out) {
  const gga_x_s12_params *params = (const gga_x_s12_params *)(p->params);

  const double _t1 = params->E*x2;
  const double _t2 = params->C*x2 + params->D*(x2 * x2);
  const double _t3 = _t1 + 0.1e1;
  const double _t4 = (0.1e1 / _t3);
  const double _t5 = _t2 + 0.1e1;
  const double _t6 = (0.1e1 / _t5);
  const double _t7 = _t6*params->B;
  const double _t8 = _t4*_t7;
  const double _t9 = _t2*_t8;
#if _KMAX >= 1
  const double _t10 = params->D*x2;
  const double _t11 = 0.2e1*_t10 + params->C;
  const double _t12 = _t11*_t8;
  const double _t13 = (0.1e1 / (_t3 * _t3));
  const double _t14 = ((params->E) * (params->E));
  const double _t15 = _t13*_t14;
  const double _t16 = _t2*_t7;
  const double _t17 = _t16*x2;
  const double _t18 = -_t11;
  const double _t19 = _t18*_t2;
  const double _t20 = (0.1e1 / (_t5 * _t5));
  const double _t21 = _t20*params->B;
  const double _t22 = _t21*_t4;
  const double _t23 = _t1*_t22;
#endif
#if _KMAX >= 2
  const double _t24 = _t8*params->D;
  const double _t25 = 0.2e1*params->E;
  const double _t26 = 0.2e1*_t15;
  const double _t27 = _t11*_t7*x2;
  const double _t28 = _t2*params->D;
  const double _t29 = 0.2e1*_t23;
  const double _t30 = (0.1e1 / (_t3 * _t3 * _t3));
  const double _t31 = ((params->E) * (params->E) * (params->E));
  const double _t32 = _t30*_t31;
  const double _t33 = _t11*_t18;
  const double _t34 = _t19*_t21*x2;
  const double _t35 = (0.1e1 / (_t5 * _t5 * _t5));
  const double _t36 = -0.4e1*_t10 - 0.2e1*params->C;
  const double _t37 = _t35*_t36*params->B;
  const double _t38 = _t19*_t4;
  const double _t39 = _t1*_t38;
#endif
#if _KMAX >= 3
  const double _t40 = 0.6e1*params->E;
  const double _t41 = 0.6e1*_t10;
  const double _t42 = _t15*_t7;
  const double _t43 = 0.6e1*_t11;
  const double _t44 = _t23*params->D;
  const double _t45 = _t43*x2;
  const double _t46 = 0.6e1*_t32;
  const double _t47 = ((params->E) * (params->E) * (params->E) * (params->E))/(_t3 * _t3 * _t3 * _t3);
  const double _t48 = _t15*_t21;
  const double _t49 = _t22*params->E;
  const double _t50 = 0.6e1*_t19;
  const double _t51 = _t37*_t4;
  const double _t52 = _t1*_t51;
  const double _t53 = _t35*params->B;
  const double _t54 = _t39*params->D;
  const double _t55 = 0.3e1*_t37;
  const double _t56 = _t1*_t4;
  const double _t57 = _t33*_t56;
  const double _t58 = _t38*params->E;
  const double _t59 = _t15*_t19;
  const double _t60 = _t59*x2;
  const double _t61 = (0.1e1 / (_t5 * _t5 * _t5 * _t5));
  const double _t62 = -_t41 - 0.3e1*params->C;
  const double _t63 = _t61*_t62*params->B;
  const double _t64 = _t36*_t63;
#endif
#if _KMAX >= 4
  const double _t65 = 0.24e2*params->D;
  const double _t66 = ((params->D) * (params->D));
  const double _t67 = 0.24e2*_t47;
  const double _t68 = 0.24e2*_t48;
  const double _t69 = 0.16e2*params->D;
  const double _t70 = _t53*_t69;
  const double _t71 = 0.12e2*_t37;
#endif

  const double f = _t1*_t9 + params->A;
  out[0] = f;
#if _KMAX >= 1
  const double df_dx2 = _t1*_t12 - _t15*_t17 + _t19*_t23 + _t9*params->E;
  out[1] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dx22 = 0.2e1*_t1*_t24 + _t12*_t25 - _t16*_t26 + 0.2e1*_t17*_t32 + _t19*_t22*_t25 - _t26*_t27 - _t26*_t34 - _t28*_t29 + _t29*_t33 + _t37*_t39;
  out[2] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dx23 = _t16*_t46 - 0.6e1*_t17*_t47 + _t18*_t43*_t49 + 0.6e1*_t18*_t44 - _t18*_t45*_t48 + _t2*_t41*_t48 - _t22*_t28*_t40 + _t24*_t40 - 0.4e1*_t28*_t52 + _t32*_t45*_t7 + _t34*_t46 + _t39*_t64 - _t41*_t42 - _t42*_t43 - _t43*_t44 - _t48*_t50 - 0.4e1*_t53*_t54 + _t55*_t57 + _t55*_t58 - _t55*_t60;
  out[3] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dx24 = -_t10*_t18*_t68 - 0.24e2*_t10*_t2*_t21*_t32 + 0.24e2*_t11*_t13*_t14*_t20*params->B*params->D*x2 + 0.24e2*_t11*_t18*_t20*_t30*_t31*params->B*x2 + 0.12e2*_t11*_t18*_t35*_t36*_t4*params->B*params->E + 0.4e1*_t11*_t18*_t36*_t4*_t61*_t62*params->B*params->E*x2 + 0.24e2*_t11*_t30*_t31*_t6*params->B - _t11*_t49*_t65 - _t11*_t52*_t69 + 0.16e2*_t13*_t14*_t18*_t2*_t35*params->B*params->D*x2 + 0.24e2*_t13*_t14*_t2*_t20*params->B*params->D + 0.16e2*_t13*_t14*_t2*_t35*_t36*params->B*params->D*x2 - _t15*_t33*_t71*x2 - _t16*_t67 + 0.24e2*_t18*_t2*_t20*_t30*_t31*params->B + 0.12e2*_t18*_t2*_t30*_t31*_t35*_t36*params->B*x2 + 0.4e1*_t18*_t2*_t36*_t4*_t61*_t62*params->B*params->E + _t18*_t2*_t36*_t4*_t62*params->B*params->E*x2*(-0.8e1*_t10 - 0.4e1*params->C)/xc_powi(_t5, 5) + 0.24e2*_t18*_t20*_t4*params->B*params->D*params->E + 0.12e2*_t18*_t35*_t36*_t4*params->B*params->D*params->E*x2 + 0.24e2*_t2*_t35*_t4*_t66*params->B*params->E*x2 + 0.24e2*_t2*_t6*params->B*xc_powi((params->E), 5)*x2/xc_powi(_t3, 5) - 0.24e2*_t23*_t66 - _t27*_t67 - 0.16e2*_t28*_t51*params->E - 0.6e1*_t28*_t56*_t64 + 0.24e2*_t30*_t31*_t6*params->B*params->D*x2 - _t33*_t68 - _t34*_t67 - _t36*_t50*_t56*_t61*params->B*params->D - _t42*_t65 - 0.8e1*_t54*_t63 - _t57*_t70 - _t58*_t70 - _t59*_t71 - 0.4e1*_t60*_t64;
  out[4] = d4f_dx24;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(s12g_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double *out) {
  const gga_x_s12_params *params = (const gga_x_s12_params *)(p->params);

  double _hc0[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(s12g_f_inner_pf_k, _KMAX)(p, x2, _hc0);

  const double f = _hc0[0]*params->bx;
  out[0] = f;
#if _KMAX >= 1
  const double df_dx2 = _hc0[1]*params->bx;
  out[1] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dx22 = _hc0[2]*params->bx;
  out[2] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dx23 = _hc0[3]*params->bx;
  out[3] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dx24 = _hc0[4]*params->bx;
  out[4] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double *out) {
  ...
  if(!(_t4)) XC_CAT(s12g_f_pf_k, _KMAX)(p, _t3*sigma_ss, _hc1);
