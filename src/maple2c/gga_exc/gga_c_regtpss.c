/*
  Generated from python/gga_exc/gga_c_regtpss.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py gga_c_regtpss
*/

#ifndef _GGA_C_REGTPSS_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _GGA_C_REGTPSS_KERNEL_BODY
#define _KMAX 0
#define _GGA_C_REGTPSS_HELPER_BODIES
#include "gga_c_regtpss.c"
#undef _GGA_C_REGTPSS_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _GGA_C_REGTPSS_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_GGA_C_REGTPSS_HELPER_BODIES)
