/*
  Generated from python/lda_exc/lda_c_vwn_1.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py lda_c_vwn_1
*/

#ifndef _LDA_C_VWN_1_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _LDA_C_VWN_1_KERNEL_BODY
#define _KMAX 0
#define _LDA_C_VWN_1_HELPER_BODIES
#include "lda_c_vwn_1.c"
#undef _LDA_C_VWN_1_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _LDA_C_VWN_1_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_LDA_C_VWN_1_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(f_vwn_k, _KMAX)(const xc_func_type *p, double rs, double z, double *out) {
  ...
  XC_CAT(f_aux_k, _KMAX)(p, 0.015545349999999999, 7.0604199999999997, 18.0578, -0.32500000000000001, rs, _hc0);
  ...
  XC_CAT(f_aux_k, _KMAX)(p, 0.031090699999999999, 3.7274400000000001, 12.9352, -0.10498, rs, _hc2);
