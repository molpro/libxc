/*
  Generated from python/lda_exc/lda_c_chachiyo.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py lda_c_chachiyo
*/

#ifndef _LDA_C_CHACHIYO_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _LDA_C_CHACHIYO_KERNEL_BODY
#define _KMAX 0
#define _LDA_C_CHACHIYO_HELPER_BODIES
#include "lda_c_chachiyo.c"
#undef _LDA_C_CHACHIYO_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _LDA_C_CHACHIYO_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_LDA_C_CHACHIYO_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(e0_k, _KMAX)(const xc_func_type *p, double rs, double *out) {
  const lda_c_chachiyo_params *params = (const lda_c_chachiyo_params *)(p->params);
