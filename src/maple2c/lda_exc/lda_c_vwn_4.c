/*
  Generated from python/lda_exc/lda_c_vwn_4.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py lda_c_vwn_4
*/

#ifndef _LDA_C_VWN_4_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _LDA_C_VWN_4_KERNEL_BODY
#define _KMAX 0
#define _LDA_C_VWN_4_HELPER_BODIES
#include "lda_c_vwn_4.c"
#undef _LDA_C_VWN_4_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _LDA_C_VWN_4_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_LDA_C_VWN_4_HELPER_BODIES)
...
FUNC_NAME(const xc_func_type *p, size_t ip, const double *rho, xc_lda_out_params *out)
{
  ...
  XC_CAT(f_aux_k, _KMAX)(p, -(0.1e1 / 0.6e1)/(M_PI * M_PI), 1.0683499999999999, 11.481299999999999, -0.22834399999999999, _t6, _hc2);
