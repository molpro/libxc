/*
  Generated from python/mgga_exc/mgga_x_tm.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_x_tm
*/

#ifndef _MGGA_X_TM_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_X_TM_KERNEL_BODY
#define _KMAX 0
#define _MGGA_X_TM_HELPER_BODIES
#include "mgga_x_tm.c"
#undef _MGGA_X_TM_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_X_TM_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_X_TM_HELPER_BODIES)
