/*
  Generated from python/mgga_exc/mgga_x_gx.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_x_gx
*/

#ifndef _MGGA_X_GX_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_X_GX_KERNEL_BODY
#define _KMAX 0
#define _MGGA_X_GX_HELPER_BODIES
#include "mgga_x_gx.c"
#undef _MGGA_X_GX_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_X_GX_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_X_GX_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(gx_gx0_k, _KMAX)(const xc_func_type *p, double a, double *out) {
  const mgga_x_gx_params *params = (const mgga_x_gx_params *)(p->params);

  const double _t1 = (0.16e2 / 0.9e1)*M_CBRTPI/(M_CBRTPI*M_CBRT3);
  const double _t2 = a*params->c1;
  const double _t3 = _t2 + params->c0;
  const double _t4 = params->c0 + params->c1 - 0.1e1;
  const double _t5 = _t4*a + 1.0;
  const double _t6 = 0.1e1 - _t1;
  const double _t7 = _t6/_t5;
  const double _t8 = _t3*_t7;
#if _KMAX >= 1
  const double _t9 = -_t4*_t6;
  const double _t10 = _t9/(_t5 * _t5);
  const double _t11 = _t10*_t3;
#endif
#if _KMAX >= 2
  const double _t12 = 0.2e1*params->c1;
  const double _t13 = _t9*(-_t12 - 0.2e1*params->c0 + 0.2e1);
  const double _t14 = _t13/(_t5 * _t5 * _t5);
  const double _t15 = _t14*_t3;
#endif
#if _KMAX >= 3
  const double _t16 = -0.3e1*params->c0 - 0.3e1*params->c1 + 0.3e1;
  const double _t17 = _t13*_t16/(_t5 * _t5 * _t5 * _t5);
  const double _t18 = _t17*_t3;
#endif

  const double f = _t1 + _t8*a;
  out[0] = f;
#if _KMAX >= 1
  const double df_da = _t11*a + _t2*_t7 + _t8;
  out[1] = df_da;
#endif
#if _KMAX >= 2
  const double d2f_da2 = 0.2e1*_t10*_t2 + 0.2e1*_t11 + _t12*_t7 + _t15*a;
  out[2] = d2f_da2;
#endif
#if _KMAX >= 3
  const double d3f_da3 = 0.6e1*_t10*params->c1 + 0.3e1*_t14*_t2 + 0.3e1*_t15 + _t18*a;
  out[3] = d3f_da3;
#endif
#if _KMAX >= 4
  const double d4f_da4 = _t13*_t16*_t3*a*(-0.4e1*params->c0 - 0.4e1*params->c1 + 0.4e1)/xc_powi(_t5, 5) + 0.12e2*_t14*params->c1 + 0.4e1*_t17*_t2 + 0.4e1*_t18;
  out[4] = d4f_da4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(gx_gx1_k, _KMAX)(const xc_func_type *p, double a, double *out) {
  const mgga_x_gx_params *params = (const mgga_x_gx_params *)(p->params);

  const double _t1 = 0.1e1 - a;
  const double _t2 = 0.1e1 - params->alphainf;
  const double _t3 = a + 0.1e1;
  const double _t4 = _t2/_t3;
#if _KMAX >= 1
  const double _t5 = _t2/(_t3 * _t3);
#endif
#if _KMAX >= 2
  const double _t6 = _t2/(_t3 * _t3 * _t3);
#endif
#if _KMAX >= 3
  const double _t7 = _t2/(_t3 * _t3 * _t3 * _t3);
#endif

  const double f = _t1*_t4 + 0.1e1;
  out[0] = f;
#if _KMAX >= 1
  const double df_da = -_t1*_t5 - _t4;
  out[1] = df_da;
#endif
#if _KMAX >= 2
  const double d2f_da2 = 0.2e1*_t1*_t6 + 0.2e1*_t5;
  out[2] = d2f_da2;
#endif
#if _KMAX >= 3
  const double d3f_da3 = -0.6e1*_t1*_t7 - 0.6e1*_t6;
  out[3] = d3f_da3;
#endif
#if _KMAX >= 4
  const double d4f_da4 = 0.24e2*_t1*_t2/xc_powi(_t3, 5) + 0.24e2*_t7;
  out[4] = d4f_da4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(gx_f_a_k, _KMAX)(const xc_func_type *p, double a, double *out) {

  double _hc0[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(gx_gx0_k, _KMAX)(p, a, _hc0);
  double _hc1[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(gx_gx1_k, _KMAX)(p, a, _hc1);
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(gx_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double u, double t, double *out) {

  double _hc0[(_KMAX) >= 4 ? 15 : (_KMAX) >= 3 ? 10 : (_KMAX) >= 2 ? 6 : (_KMAX) >= 1 ? 3 : 1];
  XC_CAT(mgga_alpha_pf_k, _KMAX)(p, x2, t, _hc0);
  double _hc1[(_KMAX) >= 4 ? 5 : (_KMAX) >= 3 ? 4 : (_KMAX) >= 2 ? 3 : (_KMAX) >= 1 ? 2 : 1];
  XC_CAT(gx_f_a_k, _KMAX)(p, _hc0[0], _hc1);
#if _KMAX >= 2
  const double _t1 = ((_hc0[1]) * (_hc0[1]));
  const double _t2 = ((_hc0[2]) * (_hc0[2]));
#endif
#if _KMAX >= 3
  const double _t3 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]));
...
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _hc1[2]*_t1;
  out[4] = d2f_dt2;
  const double d2f_du_dt = 0;
  out[5] = d2f_du_dt;
  const double d2f_du2 = 0;
  out[6] = d2f_du2;
  const double d2f_dx2_dt = _hc0[1]*_hc0[2]*_hc1[2];
  out[7] = d2f_dx2_dt;
  const double d2f_dx2_du = 0;
  out[8] = d2f_dx2_du;
  const double d2f_dx22 = _hc1[2]*_t2;
  out[9] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _hc1[3]*_t3;
  out[10] = d3f_dt3;
  ...
  out[13] = d3f_du3;
  const double d3f_dx2_dt2 = _hc0[2]*_hc1[3]*_t1;
  out[14] = d3f_dx2_dt2;
  const double d3f_dx2_du_dt = 0;
  out[15] = d3f_dx2_du_dt;
  const double d3f_dx2_du2 = 0;
  out[16] = d3f_dx2_du2;
  const double d3f_dx22_dt = _hc0[1]*_hc1[3]*_t2;
  out[17] = d3f_dx22_dt;
  const double d3f_dx22_du = 0;
  out[18] = d3f_dx22_du;
  const double d3f_dx23 = _hc1[3]*_t4;
  out[19] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_hc1[4];
  out[20] = d4f_dt4;
  ...
  out[24] = d4f_du4;
  const double d4f_dx2_dt3 = _hc0[2]*_hc1[4]*_t3;
  out[25] = d4f_dx2_dt3;
  ...
  out[28] = d4f_dx2_du3;
  const double d4f_dx22_dt2 = _hc1[4]*_t1*_t2;
  out[29] = d4f_dx22_dt2;
  const double d4f_dx22_du_dt = 0;
  out[30] = d4f_dx22_du_dt;
  const double d4f_dx22_du2 = 0;
  out[31] = d4f_dx22_du2;
  const double d4f_dx23_dt = _hc0[1]*_hc1[4]*_t4;
  out[32] = d4f_dx23_dt;
  const double d4f_dx23_du = 0;
  out[33] = d4f_dx23_du;
  const double d4f_dx24 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]) * (_hc0[2]))*_hc1[4];
  out[34] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double lapl_s, double tau_s, double *out) {
  ...
  if(!(_t7)) XC_CAT(gx_f_pf_k, _KMAX)(p, _t1*sigma_ss, 0, _t2*tau_s, _hc0);
