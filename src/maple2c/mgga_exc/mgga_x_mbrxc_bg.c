/*
  Generated from python/mgga_exc/mgga_x_mbrxc_bg.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_x_mbrxc_bg
*/

#ifndef _MGGA_X_MBRXC_BG_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_X_MBRXC_BG_KERNEL_BODY
#define _KMAX 0
#define _MGGA_X_MBRXC_BG_HELPER_BODIES
#include "mgga_x_mbrxc_bg.c"
#undef _MGGA_X_MBRXC_BG_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_X_MBRXC_BG_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_X_MBRXC_BG_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(mbrxc_Q_pf_k, _KMAX)(const xc_func_type *p, double x2, double t, double *out) {
  ...
  const double f = 0.14949200000000001*t + 0.0032000000000000002*(x2 * x2) + 0.14699999999999999*x2 - 0.3e1 / 0.10e2*xc_powr(0.6e1, 2, 3)*(M_PI * M_CBRTPI);
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = 0.14949200000000001;
  out[1] = df_dt;
  const double df_dx2 = 0.0064000000000000003*x2 + 0.14699999999999999;
  out[2] = df_dx2;
#endif
#if _KMAX >= 2
  ...
  out[4] = d2f_dx2_dt;
  const double d2f_dx22 = 0.0064000000000000003;
  out[5] = d2f_dx22;
#endif
#if _KMAX >= 3
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(mbrxc_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double u, double t, double *out) {
  ...
  const double _t9 = (0.2e1 / 0.3e1)/((_hc0[0]) * (_hc0[0]));
#endif
#if _KMAX >= 2
  ...
  const double _t20 = (M_PI * M_CBRTPI);
  const double _t21 = _t19*_t20;
  const double _t23 = (0.1e1 / ((_hc0[0]) * (_hc0[0]) * (_hc0[0]) * (_hc0[0])));
  const double _t24 = _t15*_t23;
  const double _t31 = ((_hc0[2]) * (_hc0[2]));
#endif
#if _KMAX >= 3
  const double _t35 = (M_PI * M_PI);
  const double _t36 = xc_powi((_hc0[0]), -6);
  const double _t37 = _t35*_t36;
  const double _t38 = (0.64e2 / 0.27e2)*_t37;
  const double _t39 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t45 = (0.64e2 / 0.9e1)*_t37;
  const double _t48 = xc_powi((_hc0[0]), -5);
  const double _t49 = (0.16e2 / 0.3e1)*_t48;
  const double _t57 = _hc0[2]*_t15;
  const double _t71 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t74 = _hc0[2]*_hc0[5];
#endif
#if _KMAX >= 4
  const double _t75 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t76 = xc_powi((_hc0[0]), -7);
  const double _t77 = _t35*_t76;
  const double _t78 = _t75*_t77;
  const double _t80 = 0.16e2*_t48;
  const double _t82 = (M_PI * M_PI * M_CBRTPI * M_CBRTPI);
  const double _t83 = xc_powi((_hc0[0]), -8);
  const double _t84 = _t82*_t83;
  const double _t85 = _t2*_t84;
  const double _t86 = _t75*_t85;
  const double _t88 = 0.32e2*_t36;
  const double _t98 = (0.256e3 / 0.81e2)*_t85;
  const double _t101 = _hc0[5]*_t15;
  const double _t104 = _t15*_t31;
  const double _t105 = _t104*_t77;
  const double _t106 = (0.256e3 / 0.3e1)*_t105;
  const double _t109 = _t104*_t85;
  const double _t114 = _hc0[1]*_t71;
  const double _t116 = _hc0[1]*_t74;
  const double _t117 = (0.64e2 / 0.3e1)*_t37;
  const double _t123 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t124 = _t31*_t37;
  const double _t125 = ((_hc0[5]) * (_hc0[5]));
  const double _t126 = _t123*_t85;
#endif
  ...
  const double _t6 = (0.1e1 / (_hc2[0]));
  const double _t7 = _t5*_t6;
  const double _t8 = _t4*_t7;
  const double _t10 = _hc0[2]*_hc1[1];
  const double _t11 = _t2*_t7;
  const double _t12 = _t11*_t9;
#endif
#if _KMAX >= 2
  const double _t16 = _hc1[1]*_t11;
  const double _t17 = _t15*_t16;
  const double _t18 = (0.1e1 / ((_hc2[0]) * (_hc2[0])));
  const double _t22 = _hc1[2]*_t18*_t21;
  const double _t25 = (0.1e1 / ((_hc2[0]) * (_hc2[0]) * (_hc2[0])));
  const double _t26 = _t14*_t8;
  const double _t27 = _t22*_t23;
  const double _t28 = (0.8e1 / 0.9e1)*_t27;
  const double _t29 = _hc0[1]*_t28;
  const double _t30 = _hc0[5]*_hc1[1];
  const double _t32 = _hc2[1]*_t21;
  const double _t33 = _hc1[1]*_t32;
  const double _t34 = _t25*_t33;
#endif
#if _KMAX >= 3
  const double _t40 = _t25*_t39;
  const double _t41 = _hc1[3]*_t40;
  const double _t42 = (0.1e1 / ((_hc2[0]) * (_hc2[0]) * (_hc2[0]) * (_hc2[0])));
  const double _t43 = _t39*_t42;
  const double _t44 = _hc1[1]*_hc2[2];
  const double _t46 = _hc1[2]*_hc2[1];
  const double _t47 = 0.4e1*_t16;
  const double _t50 = _t22*_t39;
  const double _t51 = ((_hc2[1]) * (_hc2[1]));
  const double _t52 = _t39*_t51;
  const double _t53 = xc_powi((_hc2[0]), -5);
  const double _t54 = _hc1[1]*_t53;
  const double _t55 = _hc1[3]*_t25;
  const double _t56 = _t38*_t55;
  const double _t58 = _t10*_t15;
  const double _t59 = _hc2[2]*_t42;
  const double _t60 = _t38*_t59;
  const double _t61 = _t42*_t46;
  const double _t62 = _t45*_t61;
  const double _t63 = _t10*_t11;
  const double _t64 = 0.4e1*_t63;
  const double _t65 = _t22*_t49;
  const double _t66 = _t51*_t53;
  const double _t67 = _t45*_t66;
  const double _t68 = _t25*_t32;
  const double _t69 = _t49*_t68;
  const double _t70 = _t3*_t31;
  const double _t72 = _t42*_t44;
  const double _t73 = (0.8e1 / 0.3e1)*_t27;
#endif
#if _KMAX >= 4
  const double _t79 = (0.256e3 / 0.9e1)*_t55;
  const double _t81 = _t16*_t80;
  const double _t87 = _hc1[4]*_t42;
  const double _t89 = _t22*_t88;
  const double _t90 = _t51*_t54;
  const double _t91 = xc_powi((_hc2[0]), -6);
  const double _t92 = (0.2560e4 / 0.81e2)*_t91;
  const double _t93 = _t44*_t92;
  const double _t94 = xc_powi((_hc2[0]), -7);
  const double _t95 = ((_hc2[1]) * (_hc2[1]) * (_hc2[1]));
  const double _t96 = (0.1280e4 / 0.27e2)*_t91;
  const double _t97 = _t51*_t96;
  const double _t99 = (0.256e3 / 0.3e1)*_t53;
  const double _t100 = _hc2[1]*_hc2[2]*_t92;
  const double _t102 = _t15*_t30;
  const double _t103 = _t77*_t79;
  const double _t107 = _t87*_t98;
  const double _t108 = (0.1024e4 / 0.81e2)*_hc2[2]*_t53;
  const double _t110 = _hc1[2]*_t109;
  const double _t111 = (0.512e3 / 0.27e2)*_hc1[3]*_hc2[1]*_t53;
  const double _t112 = _hc2[1]*_t93;
  const double _t113 = (0.1280e4 / 0.27e2)*_t94*_t95;
  const double _t115 = _t3*_t74;
  const double _t118 = _t3*_t77;
  const double _t119 = _t51*_t71;
  const double _t120 = _t3*_t68;
  const double _t121 = _t4*_t71*_t84;
  const double _t122 = _hc1[2]*_t85;
#endif
  ...
  out[2] = df_du;
  const double df_dx2 = _t10*_t12;
  out[3] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = (0.8e1 / 0.9e1)*_hc1[1]*_hc2[1]*_t15*_t19*_t20*_t23*_t25 - _t14*_t17 - 0.8e1 / 0.9e1*_t22*_t24;
  out[4] = d2f_dt2;
  const double d2f_du_dt = 0;
  out[5] = d2f_du_dt;
  const double d2f_du2 = 0;
  out[6] = d2f_du2;
  const double d2f_dx2_dt = (0.8e1 / 0.9e1)*_hc0[1]*_hc0[2]*_hc1[1]*_hc2[1]*_t19*_t20*_t23*_t25 - _hc0[2]*_t26 - _hc0[2]*_t29;
  out[7] = d2f_dx2_dt;
  const double d2f_dx2_du = 0;
  out[8] = d2f_dx2_du;
  const double d2f_dx22 = _t12*_t30 - _t14*_t16*_t31 + (0.8e1 / 0.9e1)*_t23*_t31*_t34 - _t28*_t31;
  out[9] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _t23*_t39*_t47 - _t33*_t40*_t49 + _t38*_t41 - _t38*_t43*_t44 - _t43*_t45*_t46 + _t45*_t52*_t54 + _t49*_t50;
  out[10] = d3f_dt3;
  ...
  out[13] = d3f_du3;
  const double d3f_dx2_dt2 = _t24*_t64 + _t56*_t57 - _t57*_t62 + _t57*_t65 - _t58*_t60 + _t58*_t67 - _t58*_t69;
  out[14] = d3f_dx2_dt2;
  const double d3f_dx2_du_dt = 0;
  out[15] = d3f_dx2_du_dt;
  const double d3f_dx2_du2 = 0;
  out[16] = d3f_dx2_du2;
  const double d3f_dx22_dt = (0.8e1 / 0.9e1)*_hc0[1]*_hc0[5]*_hc1[1]*_hc2[1]*_t19*_t20*_t23*_t25 + 0.4e1*_hc0[1]*_hc1[1]*_t2*_t23*_t31*_t5*_t6 + (0.64e2 / 0.9e1)*_hc0[1]*_hc1[1]*_t31*_t35*_t36*_t51*_t53 + (0.16e2 / 0.3e1)*_hc0[1]*_hc1[2]*_t18*_t19*_t20*_t31*_t48 + (0.64e2 / 0.27e2)*_hc0[1]*_hc1[3]*_t25*_t31*_t35*_t36 - _hc0[1]*_t31*_t62 - _hc0[5]*_t26 - _hc0[5]*_t29 - _t60*_t70 - _t69*_t70;
  out[17] = d3f_dx22_dt;
  const double d3f_dx22_du = 0;
  out[18] = d3f_dx22_du;
  const double d3f_dx23 = (0.8e1 / 0.3e1)*_hc0[2]*_hc0[5]*_hc1[1]*_hc2[1]*_t19*_t20*_t23*_t25 - _hc0[5]*_t13*_t64 + 0.4e1*_hc1[1]*_t2*_t23*_t5*_t6*_t71 + (0.64e2 / 0.9e1)*_hc1[1]*_t35*_t36*_t51*_t53*_t71 + (0.16e2 / 0.3e1)*_hc1[2]*_t18*_t19*_t20*_t48*_t71 + (0.64e2 / 0.27e2)*_hc1[3]*_t25*_t35*_t36*_t71 - _t34*_t49*_t71 - _t38*_t71*_t72 - _t62*_t71 - _t73*_t74;
  out[19] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = 0.32e2*_hc1[1]*_hc2[1]*_t19*_t20*_t25*_t36*_t75 + (0.256e3 / 0.9e1)*_hc1[1]*_hc2[2]*_t35*_t42*_t75*_t76 + (0.256e3 / 0.81e2)*_hc1[1]*_hc2[3]*_t2*_t53*_t75*_t82*_t83 + (0.1280e4 / 0.27e2)*_hc1[1]*_t2*_t75*_t82*_t83*_t94*_t95 + (0.256e3 / 0.3e1)*_hc1[2]*_hc2[1]*_t35*_t42*_t75*_t76 + (0.1024e4 / 0.81e2)*_hc1[2]*_hc2[2]*_t2*_t53*_t75*_t82*_t83 - _hc1[2]*_t86*_t97 + (0.512e3 / 0.27e2)*_hc1[3]*_hc2[1]*_t2*_t53*_t75*_t82*_t83 - _hc2[1]*_t86*_t93 - _t75*_t81 - _t75*_t89 - _t78*_t79 - 0.256e3 / 0.3e1*_t78*_t90 - 0.256e3 / 0.81e2*_t86*_t87;
  out[20] = d4f_dt4;
  ...
  out[24] = d4f_du4;
  const double d4f_dx2_dt3 = 0.32e2*_hc0[2]*_hc1[1]*_hc2[1]*_t19*_t20*_t25*_t36*_t39 + (0.256e3 / 0.9e1)*_hc0[2]*_hc1[1]*_hc2[2]*_t35*_t39*_t42*_t76 + (0.256e3 / 0.81e2)*_hc0[2]*_hc1[1]*_hc2[3]*_t2*_t39*_t53*_t82*_t83 + (0.1280e4 / 0.27e2)*_hc0[2]*_hc1[1]*_t2*_t39*_t82*_t83*_t94*_t95 + (0.256e3 / 0.3e1)*_hc0[2]*_hc1[2]*_hc2[1]*_t35*_t39*_t42*_t76 + (0.1024e4 / 0.81e2)*_hc0[2]*_hc1[2]*_hc2[2]*_t2*_t39*_t53*_t82*_t83 - _hc0[2]*_hc1[2]*_t52*_t85*_t96 + (0.512e3 / 0.27e2)*_hc0[2]*_hc1[3]*_hc2[1]*_t2*_t39*_t53*_t82*_t83 - _hc0[2]*_hc1[4]*_t43*_t98 - 0.256e3 / 0.9e1*_hc0[2]*_t41*_t77 - _hc0[2]*_t50*_t88 - _t10*_t100*_t39*_t85 - _t10*_t52*_t77*_t99 - _t39*_t63*_t80;
  out[25] = d4f_dx2_dt3;
  ...
  out[28] = d4f_dx2_du3;
  const double d4f_dx22_dt2 = _hc0[5]*_t24*_t47 + _hc1[1]*_t109*_t113 + _hc2[3]*_t104*_t54*_t98 + _t101*_t56 - _t101*_t62 + _t101*_t65 - _t102*_t60 + _t102*_t67 - _t102*_t69 - _t103*_t104 - _t104*_t107 + _t104*_t34*_t88 - _t104*_t89 + (0.256e3 / 0.9e1)*_t105*_t72 + _t106*_t61 - _t106*_t90 + _t108*_t110 + _t109*_t111 - _t109*_t112 - _t110*_t97 - _t17*_t31*_t80;
  out[29] = d4f_dx22_dt2;
  const double d4f_dx22_du_dt = 0;
  out[30] = d4f_dx22_du_dt;
  const double d4f_dx22_du2 = 0;
  out[31] = d4f_dx22_du2;
  const double d4f_dx23_dt = _hc0[1]*_hc0[2]*_hc0[5]*_t45*_t55 - _hc0[1]*_t119*_t122*_t96 + (0.256e3 / 0.81e2)*_hc2[3]*_t121*_t53 - _t100*_t121 - _t103*_t114 - _t107*_t114 + _t108*_t114*_t122 + _t111*_t114*_t85 + _t113*_t121 + (0.256e3 / 0.3e1)*_t114*_t61*_t77 - _t114*_t89 + _t115*_t117*_t66 - _t115*_t45*_t59 - _t116*_t117*_t61 + _t116*_t22*_t80 - _t118*_t119*_t99 + (0.256e3 / 0.9e1)*_t118*_t59*_t71 + _t120*_t71*_t88 - _t120*_t74*_t80 + 0.12e2*_t23*_t74*_t8 - _t71*_t8*_t80;
  out[32] = d4f_dx23_dt;
  const double d4f_dx23_du = 0;
  out[33] = d4f_dx23_du;
  const double d4f_dx24 = 0.24e2*_hc0[5]*_hc1[1]*_t2*_t23*_t31*_t5*_t6 + (0.128e3 / 0.3e1)*_hc0[5]*_hc1[1]*_t31*_t35*_t36*_t51*_t53 + 0.32e2*_hc0[5]*_hc1[2]*_t18*_t19*_t20*_t31*_t48 + (0.128e3 / 0.9e1)*_hc0[5]*_hc1[3]*_t25*_t31*_t35*_t36 - 0.128e3 / 0.3e1*_hc0[5]*_t124*_t61 + 0.32e2*_hc1[1]*_hc2[1]*_t123*_t19*_t20*_t25*_t36 + (0.8e1 / 0.3e1)*_hc1[1]*_hc2[1]*_t125*_t19*_t20*_t23*_t25 + (0.256e3 / 0.9e1)*_hc1[1]*_hc2[2]*_t123*_t35*_t42*_t76 + (0.256e3 / 0.81e2)*_hc1[1]*_hc2[3]*_t123*_t2*_t53*_t82*_t83 + (0.1280e4 / 0.27e2)*_hc1[1]*_t123*_t2*_t82*_t83*_t94*_t95 + (0.256e3 / 0.3e1)*_hc1[2]*_hc2[1]*_t123*_t35*_t42*_t76 + (0.1024e4 / 0.81e2)*_hc1[2]*_hc2[2]*_t123*_t2*_t53*_t82*_t83 - _hc1[2]*_t126*_t97 + (0.512e3 / 0.27e2)*_hc1[3]*_hc2[1]*_t123*_t2*_t53*_t82*_t83 - _t103*_t123 - _t107*_t123 - _t112*_t126 - 0.256e3 / 0.3e1*_t123*_t77*_t90 - _t123*_t81 - _t123*_t89 - 0.128e3 / 0.9e1*_t124*_t30*_t59 - _t125*_t13*_t47 - _t125*_t73 - 0.32e2*_t30*_t31*_t48*_t68;
  out[34] = d4f_dx24;
#endif
}
