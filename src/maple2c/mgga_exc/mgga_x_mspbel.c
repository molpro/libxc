/*
  Generated from python/mgga_exc/mgga_x_mspbel.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_x_mspbel
*/

#ifndef _MGGA_X_MSPBEL_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_X_MSPBEL_KERNEL_BODY
#define _KMAX 0
#define _MGGA_X_MSPBEL_HELPER_BODIES
#include "mgga_x_mspbel.c"
#undef _MGGA_X_MSPBEL_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_X_MSPBEL_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_X_MSPBEL_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(ms_fa_raw_k, _KMAX)(const xc_func_type *p, double a, double *out) {
  const mgga_x_mspbel_params *params = (const mgga_x_mspbel_params *)(p->params);
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(mspbel_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double u, double t, double *out) {
  const mgga_x_mspbel_params *params = (const mgga_x_mspbel_params *)(p->params);
  ...
  XC_CAT(mgga_alpha_reg_pf_k, _KMAX)(p, x2, t, params->eta, _hc1);
...
#endif
#if _KMAX >= 2
  const double _t7 = ((_hc1[2]) * (_hc1[2]));
  const double _t8 = _hc0[0]*_hc2[2];
  const double _t9 = _hc1[2]*_t8;
  const double _t10 = _hc1[2]*_hc2[1];
  const double _t11 = ((_hc1[3]) * (_hc1[3]));
  const double _t14 = _hc0[5]*_t13;
  const double _t15 = _hc1[3]*_hc2[1];
  ...
  const double _t22 = _hc2[2]*_t7;
  const double _t23 = 0.2e1*_t8;
  const double _t24 = _hc1[3]*_hc1[8];
  const double _t25 = _t11*_t19;
  const double _t26 = _hc1[8]*_hc2[1];
  const double _t27 = _hc1[2]*_hc2[2];
  const double _t28 = _hc1[3]*_t17;
  const double _t31 = ((_hc1[3]) * (_hc1[3]) * (_hc1[3]));
  const double _t32 = 0.3e1*_t8;
  const double _t33 = _hc1[3]*_t32;
  const double _t34 = _hc0[9]*_t30;
  const double _t35 = (0.1e1 / 0.8e1)*_t16;
  const double _t36 = _hc1[9]*_hc2[1];
  const double _t37 = _hc0[5]*_t12;
  const double _t38 = (0.1e1 / 0.192e3)*_t37;
  const double _t39 = _hc2[2]*_t11;
#endif
#if _KMAX >= 4
  const double _t40 = _hc0[0]*_hc2[4];
  const double _t41 = 0.3e1*_hc1[8];
  const double _t42 = _hc1[2]*_t19;
  const double _t43 = (0.1e1 / 0.6e1)*_t16;
  const double _t44 = _hc1[3]*_hc1[9];
  const double _t45 = _hc2[2]*_t16;
  ...
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = _hc1[2]*_t5;
  out[1] = df_dt;
  const double df_du = 0;
  out[2] = df_du;
  const double df_dx2 = _hc1[3]*_t5 + _hc2[0]*_t6 + _hc3[2]*_t3;
  out[3] = df_dx2;
#endif
#if _KMAX >= 2
  ...
  out[6] = d2f_du2;
  const double d2f_dx2_dt = _hc1[3]*_t9 + _hc1[8]*_t5 + _t10*_t6;
  out[7] = d2f_dx2_dt;
  const double d2f_dx2_du = 0;
  out[8] = d2f_dx2_du;
  const double d2f_dx22 = _hc1[9]*_t5 + _hc2[0]*_t14 + _hc3[5]*_t13 + _t11*_t8 + _t15*_t17;
  out[9] = d2f_dx22;
#endif
#if _KMAX >= 3
  ...
  out[13] = d3f_du3;
  const double d3f_dx2_dt2 = _hc1[3]*_t21 + _hc1[8]*_t20 + _t22*_t6;
  out[14] = d3f_dx2_dt2;
  const double d3f_dx2_du_dt = 0;
  out[15] = d3f_dx2_du_dt;
  const double d3f_dx2_du2 = 0;
  out[16] = d3f_dx2_du2;
  const double d3f_dx22_dt = _hc1[18]*_t5 + _hc1[2]*_t25 + _hc1[9]*_t9 + _t10*_t14 + _t17*_t26 + _t23*_t24 + _t27*_t28;
  out[17] = d3f_dx22_dt;
  const double d3f_dx22_du = 0;
  out[18] = d3f_dx22_du;
  const double d3f_dx23 = _hc1[19]*_t5 + _hc1[9]*_t33 + _hc2[0]*_t34 + _hc3[9]*_t30 + _t15*_t38 + _t19*_t31 + _t35*_t36 + _t35*_t39;
  out[19] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = ((_hc1[2]) * (_hc1[2]) * (_hc1[2]) * (_hc1[2]))*_t40;
  out[20] = d4f_dt4;
  ...
  out[24] = d4f_du4;
  const double d4f_dx2_dt3 = _hc1[3]*_t18*_t40 + _hc2[3]*_t18*_t6 + _t21*_t41;
  out[25] = d4f_dx2_dt3;
  ...
  out[28] = d4f_dx2_du3;
  const double d4f_dx22_dt2 = _hc1[18]*_t20 + ((_hc1[8]) * (_hc1[8]))*_t23 + _hc1[8]*_t27*_t43 + _hc1[9]*_t21 + _hc2[3]*_t28*_t7 + _t11*_t40*_t7 + _t14*_t22 + 0.4e1*_t24*_t42;
  out[29] = d4f_dx22_dt2;
  const double d4f_dx22_du_dt = 0;
  out[30] = d4f_dx22_du_dt;
  const double d4f_dx22_du2 = 0;
  out[31] = d4f_dx22_du2;
  const double d4f_dx23_dt = _hc1[18]*_hc2[1]*_t35 + _hc1[18]*_t33 + _hc1[19]*_t9 + _hc1[2]*_hc2[3]*_t11*_t35 + _hc1[2]*_t31*_t40 + _hc1[3]*_t27*_t38 + _hc1[33]*_t5 + _hc1[8]*_hc1[9]*_t32 + _hc1[9]*_t27*_t35 + _t10*_t34 + (0.1e1 / 0.4e1)*_t24*_t45 + _t25*_t41 + _t26*_t38 + 0.3e1*_t42*_t44;
  out[32] = d4f_dx23_dt;
  const double d4f_dx23_du = 0;
  out[33] = d4f_dx23_du;
  const double d4f_dx24 = _hc0[14]*_hc2[0]*_t46 + (0.1e1 / 0.576e3)*_hc0[9]*_t15*_t29 + 0.4e1*_hc1[19]*_hc1[3]*_t8 + _hc1[19]*_hc2[1]*_t43 + ((_hc1[3]) * (_hc1[3]) * (_hc1[3]) * (_hc1[3]))*_t40 + _hc1[34]*_t5 + ((_hc1[9]) * (_hc1[9]))*_t32 + 0.6e1*_hc1[9]*_t25 + _hc2[3]*_t31*_t43 + _hc3[14]*_t46 + _t36*_t47 + _t39*_t47 + (0.1e1 / 0.2e1)*_t44*_t45;
  out[34] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double lapl_s, double tau_s, double *out) {
  ...
  if(!(_t7)) XC_CAT(mspbel_f_pf_k, _KMAX)(p, _t5*sigma_ss, 0, _t6*tau_s, _hc1);
