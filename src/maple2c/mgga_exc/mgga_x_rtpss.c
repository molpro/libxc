/*
  Generated from python/mgga_exc/mgga_x_rtpss.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_x_rtpss
*/

#ifndef _MGGA_X_RTPSS_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_X_RTPSS_KERNEL_BODY
#define _KMAX 0
#define _MGGA_X_RTPSS_HELPER_BODIES
#include "mgga_x_rtpss.c"
#undef _MGGA_X_RTPSS_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_X_RTPSS_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_X_RTPSS_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(tpss_kappa_pf_k, _KMAX)(const xc_func_type *p, double x2, double t, double *out) {
  const mgga_x_rtpss_params *params = (const mgga_x_rtpss_params *)(p->params);
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(tpss_fxnum_pf_k, _KMAX)(const xc_func_type *p, double x2, double t, double *out) {
  ...
  const double _t29 = (0.1e1 / (_t12 * _t12 * _t12));
  const double _t30 = _t15*_t29;
  const double _t31 = 0.4e1*_t30;
  const double _t32 = (0.1e1 / (_hc1[0]));
  const double _t33 = _t20*(_hc1[1]*_hc2[0]*_t13*_t14*_t32*params->c - _t25*_t31);
  const double _t34 = _hc1[0]*_hc1[2];
  const double _t35 = (0.25e2 / 0.472392e6)*_t7;
  const double _t36 = (0.9e1 / 0.50e2)*_hc1[0];
  const double _t37 = _hc1[2]*_t36 + _t8*x2;
  const double _t38 = (0.73e2 / 0.405e3)*_t37;
  const double _t39 = _t31*_t34;
  const double _t40 = _hc1[2]*_hc2[0]*_t13*_t14*_t32*params->c - _t39;
  const double _t41 = _t20*x2;
#endif
#if _KMAX >= 2
  const double _t42 = ((_hc1[1]) * (_hc1[1]));
  const double _t43 = _hc1[0]*_hc1[3];
  const double _t44 = _hc0[1]*_t26;
  const double _t45 = (0.73e2 / 0.1125e4)*_t25;
  const double _t46 = (0.73e2 / 0.2250e4)*_t42;
  const double _t47 = xc_powr(_t9, -3, 2);
  const double _t48 = _hc0[0]*_t47;
  const double _t49 = _t1*_t42;
  const double _t50 = (0.73e2 / 0.12500e5)*_t49;
  const double _t51 = 0.4e1*_t42;
  const double _t52 = 0.8e1*_t30;
  const double _t53 = _hc2[0]*_t52;
  const double _t54 = (0.1e1 / (_t12 * _t12 * _t12 * _t12));
  const double _t55 = _t15*_t54;
  const double _t56 = 0.24e2*_t55;
  const double _t57 = (0.1e1 / _t1);
  const double _t58 = ((_hc2[0]) * (_hc2[0]));
  const double _t59 = _t16*_t58;
  const double _t60 = _t57*_t59;
  const double _t61 = _t42*_t60;
  const double _t62 = _hc2[0]*_t32;
  const double _t63 = _hc1[3]*_t62;
  const double _t64 = _hc2[0]*_t57;
  const double _t65 = _t42*_t64;
  const double _t66 = _t63 - _t65;
  const double _t67 = _t16*_t66;
  const double _t68 = _t20*(-_t30*_t51 - _t31*_t43 - _t42*_t53 + _t49*_t56 + _t61 + _t67);
  const double _t69 = (0.292e3 / 0.2025e4)*_hc0[2];
  const double _t70 = _hc1[1]*_hc1[2];
  const double _t71 = _hc0[2]*_t26;
  const double _t72 = (0.73e2 / 0.2250e4)*_t71;
  const double _t73 = (0.9e1 / 0.50e2)*_hc1[2];
  const double _t74 = _hc1[1]*_t73 + _hc1[4]*_t36;
  const double _t75 = (0.73e2 / 0.405e3)*_t27;
  const double _t76 = (0.73e2 / 0.2250e4)*_t25;
  const double _t77 = _t37*_t48;
  const double _t78 = _hc1[0]*_t31;
  const double _t79 = _t31*_t70;
  const double _t80 = _t53*_t70;
  const double _t81 = _hc1[4]*_t62;
  const double _t82 = _t64*_t70;
  const double _t83 = _t81 - _t82;
  const double _t84 = _t16*_t83;
  const double _t85 = -_hc1[4]*_t78 + _t1*_t56*_t70 + _t60*_t70 - _t79 - _t80 + _t84;
  const double _t86 = ((_hc1[2]) * (_hc1[2]));
  const double _t87 = _t8 + (0.9e1 / 0.50e2)*_t86;
  const double _t88 = (0.146e3 / 0.405e3)*_t37;
  const double _t89 = (0.1e1 / 0.12e2)*_t19;
  const double _t90 = -_t37;
  const double _t91 = _t48*_t90;
  const double _t92 = 0.4e1*_t30*_t86;
  const double _t93 = _t53*_t86;
  const double _t94 = 0.24e2*_t1*_t14*_t54*_t86*params->c + _t13*_t14*_t57*_t58*_t86*params->c - _t16*_t64*_t86 - _t92 - _t93;
#endif
#if _KMAX >= 3
  const double _t95 = (0.292e3 / 0.675e3)*_hc0[1];
  const double _t96 = (0.8e1 / 0.15e2)*_t2;
  const double _t97 = _hc1[1]*_t96;
  const double _t98 = _hc1[0]*_hc1[6];
  const double _t99 = (0.73e2 / 0.750e3)*_t27;
  const double _t100 = _hc1[1]*_hc1[3];
  const double _t101 = (0.73e2 / 0.750e3)*_t43;
  const double _t102 = _hc0[3]*_t26;
  const double _t103 = (0.73e2 / 0.750e3)*_t25;
  const double _t104 = (0.73e2 / 0.750e3)*_t42;
  const double _t105 = (0.219e3 / 0.12500e5)*_t48;
  const double _t106 = ((_hc1[1]) * (_hc1[1]) * (_hc1[1]));
  const double _t107 = _hc1[0]*_t106;
  const double _t108 = _t1*_t105;
  const double _t109 = xc_powr(_t9, -5, 2);
  const double _t110 = _hc0[0]*_t109;
  const double _t111 = ((_hc1[0]) * (_hc1[0]) * (_hc1[0]));
  const double _t112 = _t106*_t111;
  const double _t113 = (0.1971e4 / 0.625000e6)*_t112;
  const double _t114 = _hc0[1]*_t47;
  const double _t115 = (0.219e3 / 0.12500e5)*_t49;
  const double _t116 = 0.12e2*_t30;
  const double _t117 = _t100*_t116;
  const double _t118 = _t15/xc_powi(_t12, 5);
  const double _t119 = 0.192e3*_t118;
  const double _t120 = _t106*_t116;
  const double _t121 = (0.1e1 / _t111);
  const double _t122 = ((_hc2[0]) * (_hc2[0]) * (_hc2[0]));
  const double _t123 = _t32*_t58;
  const double _t124 = _t116*_t25;
  const double _t125 = 0.2e1*_t63 - 0.2e1*_t65;
  const double _t126 = _hc1[6]*_t62;
  const double _t127 = 0.3e1*_t64;
  const double _t128 = _hc2[0]*_t121;
  const double _t129 = _t106*_t128;
  const double _t130 = -_t100*_t127 + _t126 + 0.2e1*_t129;
  const double _t131 = _t20*(0.72e2*_hc1[0]*_hc2[0]*_t106*_t14*_t54*params->c + 0.72e2*_hc1[0]*_t106*_t14*_t54*params->c + 0.72e2*_hc1[1]*_hc1[3]*_t1*_t14*_t54*params->c + _hc1[1]*_hc2[0]*_t125*_t13*_t14*_t32*params->c + _hc1[1]*_hc2[0]*_t13*_t14*_t32*_t66*params->c - _hc2[0]*_t117 + _t106*_t121*_t122*_t13*_t14*params->c - _t112*_t119 - _t117 - _t120*_t123 - _t120*_t62 - _t124*_t66 + _t13*_t130*_t14*params->c - _t31*_t98);
  const double _t132 = (0.584e3 / 0.2025e4)*_hc0[4];
  const double _t133 = _hc1[1]*_hc1[4];
  const double _t134 = (0.16e2 / 0.45e2)*_t2;
  const double _t135 = _hc1[2]*_hc1[3];
  const double _t136 = _hc0[4]*_t26;
  const double _t137 = _hc0[2]*_t47;
  const double _t138 = (0.146e3 / 0.405e3)*_t74;
  const double _t139 = _t48*_t74;
  const double _t140 = _hc1[3]*_t73 + _hc1[7]*_t36 + (0.9e1 / 0.25e2)*_t133;
  const double _t141 = (0.73e2 / 0.2250e4)*_t77;
  const double _t142 = _t114*_t37;
  const double _t143 = _t46*_t48;
  const double _t144 = _t110*_t37;
  const double _t145 = _t135*_t31;
  const double _t146 = _hc1[2]*_t42;
  const double _t147 = _t111*_t119;
  const double _t148 = _t116*_t123;
  const double _t149 = _t52*_t83;
  const double _t150 = _hc1[7]*_t62;
  const double _t151 = 0.2e1*_t64;
  const double _t152 = _t135*_t64;
  const double _t153 = 0.2e1*_t128;
  const double _t154 = -_t133*_t151 + _t146*_t153 + _t150 - _t152;
  const double _t155 = 0.72e2*_hc1[0]*_hc1[2]*_hc2[0]*_t14*_t42*_t54*params->c + 0.72e2*_hc1[0]*_hc1[2]*_t14*_t42*_t54*params->c + 0.48e2*_hc1[1]*_hc1[4]*_t1*_t14*_t54*params->c + 0.2e1*_hc1[1]*_hc2[0]*_t13*_t14*_t32*_t83*params->c + 0.24e2*_hc1[2]*_hc1[3]*_t1*_t14*_t54*params->c + _hc1[2]*_hc2[0]*_t13*_t14*_t32*_t66*params->c + _hc1[2]*_t121*_t122*_t13*_t14*_t42*params->c - _hc1[7]*_t78 - _hc2[0]*_t145 - _t116*_t146*_t62 + _t13*_t14*_t154*params->c - _t133*_t52 - _t133*_t53 - _t145 - _t146*_t147 - _t146*_t148 - _t149*_t25 - _t39*_t66;
  const double _t156 = (0.292e3 / 0.2025e4)*_hc0[5];
  const double _t157 = _hc1[2]*_hc1[4];
  const double _t158 = _hc0[5]*_t26;
  const double _t159 = (0.73e2 / 0.2250e4)*_t158;
  const double _t160 = (0.73e2 / 0.405e3)*_t87;
  const double _t161 = _t48*_t87;
  const double _t162 = _t137*_t37;
  const double _t163 = (0.73e2 / 0.405e3)*_t91;
  const double _t164 = -_t74;
  const double _t165 = _t38*_t48;
  const double _t166 = _t114*_t90;
  const double _t167 = _t37*_t90;
  const double _t168 = _t110*_t167;
  const double _t169 = _hc1[1]*_t86;
  const double _t170 = _t121*_t59;
  const double _t171 = 0.2e1*_hc1[1]*_hc2[0]*_t121*_t86 - _t151*_t157;
  const double _t172 = 0.2e1*_t81 - 0.2e1*_t82;
  const double _t173 = 0.72e2*_hc1[0]*_hc1[1]*_hc2[0]*_t14*_t54*_t86*params->c + 0.72e2*_hc1[0]*_hc1[1]*_t14*_t54*_t86*params->c + _hc1[1]*_t121*_t122*_t13*_t14*_t86*params->c + 0.48e2*_hc1[2]*_hc1[4]*_t1*_t14*_t54*params->c + _hc1[2]*_hc2[0]*_t13*_t14*_t172*_t32*params->c + _t13*_t14*_t171*params->c - _t147*_t169 - _t148*_t169 - _t149*_t34 - _t157*_t52 - _t157*_t53 - _t169*_t170 - _t169*_t52*_t62;
  const double _t174 = (0.73e2 / 0.135e3)*_t87;
  const double _t175 = (0.73e2 / 0.135e3)*_t37;
  const double _t176 = -_t87;
  const double _t177 = (0.146e3 / 0.405e3)*_t87;
  const double _t178 = _t137*_t90;
  const double _t179 = _t38*_t90;
  const double _t180 = (0.27e2 / 0.50e2)*_hc1[0];
  const double _t181 = (0.1e1 / 0.384e3)*_t6;
  const double _t182 = -_hc1[2]*_t180 - _t181*x2;
  const double _t183 = _t110*_t182;
  const double _t184 = ((_hc1[2]) * (_hc1[2]) * (_hc1[2]));
  const double _t185 = 0.72e2*_t55;
  const double _t186 = _hc1[0]*_t184*_t185;
  const double _t187 = _hc2[0]*_t186 + _t121*_t122*_t16*_t184 - _t147*_t184 - _t148*_t184 + _t153*_t16*_t184 - 0.3e1*_t170*_t184 + _t186;
#endif
#if _KMAX >= 4
  const double _t188 = _hc1[1]*_hc1[6];
  const double _t189 = ((_hc1[3]) * (_hc1[3]));
  const double _t190 = _hc1[0]*_hc1[10];
  const double _t191 = (0.146e3 / 0.1125e4)*_t44;
  const double _t192 = (0.73e2 / 0.375e3)*_t102;
  const double _t193 = _hc0[6]*_t26;
  const double _t194 = (0.146e3 / 0.1125e4)*_t25;
  const double _t195 = ((_hc1[1]) * (_hc1[1]) * (_hc1[1]) * (_hc1[1]));
  const double _t196 = (0.219e3 / 0.3125e4)*_t114;
  const double _t197 = _t42*_t43;
  const double _t198 = _t1*_t188;
  const double _t199 = (0.73e2 / 0.3125e4)*_t48;
  const double _t200 = _t1*_t100;
  const double _t201 = _t1*_t195;
  const double _t202 = (0.5913e4 / 0.312500e6)*_t110;
  const double _t203 = ((_hc1[0]) * (_hc1[0]) * (_hc1[0]) * (_hc1[0]));
  const double _t204 = _t195*_t203;
  const double _t205 = xc_powr(_t9, -7, 2);
  const double _t206 = _hc0[0]*_t205;
  const double _t207 = _hc0[1]*_t109;
  const double _t208 = _hc0[3]*_t47;
  const double _t209 = (0.219e3 / 0.6250e4)*_t49;
  const double _t210 = _t111*_t42;
  const double _t211 = _hc1[3]*_t210;
  const double _t212 = 0.16e2*_t30;
  const double _t213 = _t188*_t212;
  const double _t214 = _hc2[0]*_t195;
  const double _t215 = 0.288e3*_t55;
  const double _t216 = 0.1152e4*_t118;
  const double _t217 = _t1*_t185;
  const double _t218 = xc_powi(_t12, -6);
  const double _t219 = 0.1920e4*_t15*_t218;
  const double _t220 = 0.144e3*_t55;
  const double _t221 = _t195*_t58;
  const double _t222 = 0.768e3*_t118;
  const double _t223 = _t1*_t222;
  const double _t224 = ((_hc2[0]) * (_hc2[0]) * (_hc2[0]) * (_hc2[0]));
  const double _t225 = (0.1e1 / _t203);
  const double _t226 = _t16*_t225;
  const double _t227 = _t224*_t226;
  const double _t228 = 0.24e2*_t30;
  const double _t229 = _t228*_t57;
  const double _t230 = _t212*_t57;
  const double _t231 = _t122*_t230;
  const double _t232 = _t228*_t42;
  const double _t233 = _hc1[3]*_t123;
  const double _t234 = _t228*_t66;
  const double _t235 = _hc2[0]*_t42;
  const double _t236 = _t212*_t235;
  const double _t237 = _t16*_t62;
  const double _t238 = 0.4e1*_t64;
  const double _t239 = 0.6e1*_t225;
  const double _t240 = _hc1[2]*_hc1[6];
  const double _t241 = _hc1[3]*_hc1[4];
  const double _t242 = (0.73e2 / 0.750e3)*_t100;
  const double _t243 = _hc0[7]*_t26;
  const double _t244 = (0.219e3 / 0.12500e5)*_t137;
  const double _t245 = _hc0[2]*_t109;
  const double _t246 = _hc0[4]*_t47;
  const double _t247 = (0.73e2 / 0.135e3)*_t74;
  const double _t248 = (0.73e2 / 0.375e3)*_t25;
  const double _t249 = (0.657e3 / 0.12500e5)*_t49;
  const double _t250 = _t110*_t74;
  const double _t251 = (0.27e2 / 0.50e2)*_hc1[1];
  const double _t252 = (0.657e3 / 0.12500e5)*_t144;
  const double _t253 = _hc1[1]*_hc1[7];
  const double _t254 = _t116*_t253;
  const double _t255 = _t240*_t31;
  const double _t256 = 0.576e3*_t118;
  const double _t257 = _hc1[2]*_t106;
  const double _t258 = _t1*_t216;
  const double _t259 = _hc1[4]*_t256;
  const double _t260 = _hc2[0]*_t223;
  const double _t261 = _t30*_t70;
  const double _t262 = _t229*_t58;
  const double _t263 = _hc1[4]*_t148;
  const double _t264 = _t116*_t83;
  const double _t265 = _t116*_t66;
  const double _t266 = _hc1[0]*_hc1[4];
  const double _t267 = _hc2[0]*_t239;
  const double _t268 = _hc1[2]*_hc1[7];
  const double _t269 = ((_hc1[4]) * (_hc1[4]));
  const double _t270 = _hc0[8]*_t26;
  const double _t271 = _hc0[5]*_t47;
  const double _t272 = (0.73e2 / 0.1125e4)*_t162;
  const double _t273 = _t164*_t48;
  const double _t274 = _hc1[2]*_t133;
  const double _t275 = _t49*_t86;
  const double _t276 = _t42*_t86;
  const double _t277 = _t122*_t226;
  const double _t278 = _t212*_t83;
  const double _t279 = _t278*_t70;
  const double _t280 = _hc0[9]*_t26;
  const double _t281 = _t183*_t90;
  const double _t282 = _t110*_t179;
  const double _t283 = _t179*_t182;
  const double _t284 = _hc1[1]*_t184;
  const double _t285 = 0.216e3*_t55;
  const double _t286 = _hc2[0]*_t284;
  const double _t287 = _hc2[0]*_t86;
  const double _t288 = _t203*_t219;
  const double _t289 = _t225*_t59;
  const double _t290 = (0.292e3 / 0.405e3)*_t37;
  const double _t291 = ((_hc1[2]) * (_hc1[2]) * (_hc1[2]) * (_hc1[2]));
  const double _t292 = _t220*_t291;
  const double _t293 = _t16*_t291;
#endif
  ...
  out[0] = f;
#if _KMAX >= 1
  const double df_dt = -_hc0[1]*_t11 + _hc0[1]*_t22 + _hc1[1]*_t24 - _t25*_t28 + _t33*x2;
  out[1] = df_dt;
  const double df_dx2 = -_hc0[2]*_t11 + _hc0[2]*_t22 + _t21 + _t23*_t34 - _t27*_t38 + _t35*x2 + (0.1e1 / 0.768e3)*_t4*_t5 + _t40*_t41;
  out[2] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = (0.292e3 / 0.2025e4)*((_hc0[1]) * (_hc0[1])) - _hc0[3]*_t11 + _hc0[3]*_t22 + _hc1[3]*_t24 + _t23*_t42 - _t27*_t46 - _t28*_t43 - _t44*_t45 + _t48*_t50 + _t68*x2;
  out[3] = d2f_dt2;
  const double d2f_dx2_dt = _hc0[1]*_t69 - _hc0[4]*_t11 + _hc0[4]*_t22 + _hc1[4]*_t24 + _t23*_t70 - _t25*_t72 + _t33 - _t38*_t44 + _t41*_t85 - _t74*_t75 + _t76*_t77;
  out[4] = d2f_dx2_dt;
  const double d2f_dx22 = (0.292e3 / 0.2025e4)*((_hc0[2]) * (_hc0[2])) - _hc0[5]*_t11 + _hc0[5]*_t22 + _t23*_t86 + _t35 - _t38*_t91 + (0.1e1 / 0.384e3)*_t4*x2 + _t40*_t89 + _t41*_t94 - _t71*_t88 - _t75*_t87;
  out[5] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _hc0[3]*_t95 - _hc0[6]*_t11 + _hc0[6]*_t22 + _hc1[3]*_t97 + _hc1[6]*_t24 + _t100*_t108 - _t100*_t99 - _t101*_t44 - _t102*_t103 - _t104*_t44 + _t105*_t107 - _t110*_t113 + _t114*_t115 + _t131*x2 - _t28*_t98;
  out[6] = d3f_dt3;
  const double d3f_dx2_dt2 = _hc0[1]*_t132 + _hc0[3]*_t69 - _hc0[7]*_t11 + _hc0[7]*_t22 + _hc1[7]*_t24 - _t102*_t38 - _t115*_t144 + _t133*_t134 + _t135*_t23 - _t136*_t45 + _t137*_t50 - _t138*_t44 + _t139*_t45 - _t140*_t75 + _t141*_t43 + _t142*_t45 + _t143*_t37 + _t155*_t41 - _t43*_t72 - _t46*_t71 + _t68;
  out[7] = d3f_dx2_dt2;
  const double d3f_dx22_dt = _hc0[1]*_t156 + _hc0[2]*_t132 - _hc0[8]*_t11 + _hc0[8]*_t22 + _t103*_t168 + _t134*_t157 - _t136*_t88 - _t138*_t71 - 0.73e2 / 0.1125e4*_t157*_t27 - _t159*_t25 - _t160*_t44 + _t161*_t76 + _t162*_t45 - _t163*_t74 - _t164*_t165 - _t166*_t38 + _t173*_t41 + _t85*_t89;
  out[8] = d3f_dx22_dt;
  const double d3f_dx23 = (0.292e3 / 0.2025e4)*_hc0[0]*_hc0[9] + (0.292e3 / 0.675e3)*_hc0[2]*_hc0[5] - _hc0[9]*_t11 - _t158*_t175 - _t165*_t176 + (0.1e1 / 0.24e2)*_t17*_t18*_t187*x2 + (0.1e1 / 0.8e1)*_t17*_t18*_t94 - _t174*_t71 - _t175*_t178 - _t177*_t91 - _t179*_t183 + (0.1e1 / 0.384e3)*_t3*params->e*params->mu;
  out[9] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = (0.1168e4 / 0.2025e4)*_hc0[1]*_hc0[6] - _hc0[10]*_t11 + _hc0[10]*_t22 + (0.292e3 / 0.675e3)*((_hc0[3]) * (_hc0[3])) + _hc1[10]*_t24 - 0.146e3 / 0.375e3*_t100*_t44 + _t105*_t195 + _t107*_t196 + _t108*_t189 - 0.1971e4 / 0.156250e6*_t112*_t207 + (0.32e2 / 0.45e2)*_t188*_t2 - 0.146e3 / 0.1125e4*_t188*_t27 + _t189*_t96 - _t189*_t99 - _t190*_t28 - _t191*_t98 - _t192*_t42 - _t192*_t43 - _t193*_t194 + _t196*_t200 + (0.657e3 / 0.6250e4)*_t197*_t48 + _t198*_t199 - _t201*_t202 - _t202*_t211 + (0.17739e5 / 0.6250000e7)*_t204*_t206 + _t208*_t209 + _t41*(0.2e1*_hc1[1]*_t130*_t16*_t62 + _hc1[1]*_t237*(-0.6e1*_t100*_t64 + 0.2e1*_t126 + 0.4e1*_t129) + _hc2[0]*_t197*_t215 - _hc2[0]*_t213 - _t116*_t189 - _t125*_t236 + _t125*_t61 + _t125*_t67 - _t130*_t212*_t25 + _t16*(_t66 * _t66) + _t16*(_hc1[10]*_hc2[0]*_t32 + 0.12e2*_hc1[3]*_hc2[0]*_t121*_t42 - _t127*_t189 - _t188*_t238 - _t214*_t239) + _t185*_t195 + _t189*_t217 - _t190*_t31 + _t195*_t227 - _t195*_t231 + 0.432e3*_t197*_t55 + 0.96e2*_t198*_t55 - _t201*_t216 + _t204*_t219 - _t211*_t216 - _t213 + _t214*_t215 - _t214*_t223 + _t220*_t221 + _t220*_t49*_t66 - _t221*_t229 - _t232*_t233 - _t234*_t42 - _t234*_t43 - _t236*_t66 - 0.48e2*_t30*_t42*_t63 + _t42*_t57*_t58*_t67 + _t61*(0.3e1*_t63 - 0.3e1*_t65));
  out[10] = d4f_dt4;
  const double d4f_dx2_dt3 = -_hc0[11]*_t11 + _hc0[11]*_t22 + (0.292e3 / 0.675e3)*_hc0[3]*_hc0[4] + _hc0[6]*_t69 + _hc0[7]*_t95 + _hc1[11]*_t24 + _hc1[7]*_t97 - _t101*_t136 + _t101*_t139 + _t101*_t142 - _t102*_t247 + _t103*_t140*_t48 + _t103*_t208*_t37 - _t103*_t243 - _t104*_t136 + _t104*_t139 + _t104*_t142 + _t107*_t244 - _t107*_t252 + (0.1971e4 / 0.125000e6)*_t112*_t206*_t37 - _t113*_t245 + _t114*_t248*_t74 + _t115*_t246 + _t131 - 0.73e2 / 0.135e3*_t140*_t44 + _t141*_t98 - _t193*_t38 + _t200*_t244 - _t200*_t252 - _t207*_t249*_t37 + _t23*_t240 + _t241*_t96 - _t242*_t71 + _t242*_t77 - _t249*_t250 + _t41*(0.144e3*_hc1[0]*_hc1[1]*_hc1[2]*_hc1[3]*_hc2[0]*_t14*_t54*params->c + 0.216e3*_hc1[0]*_hc1[1]*_hc1[2]*_hc1[3]*_t14*_t54*params->c + 0.144e3*_hc1[0]*_hc1[4]*_hc2[0]*_t14*_t42*_t54*params->c + 0.216e3*_hc1[0]*_hc1[4]*_t14*_t42*_t54*params->c + 0.72e2*_hc1[1]*_hc1[2]*_t1*_t14*_t54*_t66*params->c + _hc1[1]*_hc1[2]*_t125*_t13*_t14*_t57*_t58*params->c + _hc1[1]*_hc1[2]*_t13*_t14*_t57*_t58*_t66*params->c + 0.72e2*_hc1[1]*_hc1[7]*_t1*_t14*_t54*params->c + 0.3e1*_hc1[1]*_hc2[0]*_t13*_t14*_t154*_t32*params->c - _hc1[11]*_t78 + 0.24e2*_hc1[2]*_hc1[6]*_t1*_t14*_t54*params->c + 0.288e3*_hc1[2]*_hc2[0]*_t106*_t14*_t54*params->c + _hc1[2]*_hc2[0]*_t13*_t130*_t14*_t32*params->c + _hc1[2]*_t106*_t13*_t14*_t224*_t225*params->c + 0.1920e4*_hc1[2]*_t106*_t14*_t203*_t218*params->c + 0.144e3*_hc1[2]*_t106*_t14*_t54*_t58*params->c + 0.72e2*_hc1[2]*_t106*_t14*_t54*params->c + 0.72e2*_hc1[3]*_hc1[4]*_t1*_t14*_t54*params->c - _hc1[3]*_t111*_t256*_t70 - 0.12e2*_hc1[3]*_t123*_t261 - _hc2[0]*_t125*_t79 - _hc2[0]*_t212*_t66*_t70 - _hc2[0]*_t254 - _hc2[0]*_t255 + 0.72e2*_t1*_t14*_t42*_t54*_t83*params->c - _t116*_t241 - _t124*_t154 + 0.3e1*_t13*_t14*_t42*_t57*_t58*_t83*params->c + 0.3e1*_t13*_t14*_t66*_t83*params->c + _t13*_t14*params->c*(0.6e1*_hc1[1]*_hc1[2]*_hc1[3]*_hc2[0]*_t121 + _hc1[11]*_hc2[0]*_t32 + 0.6e1*_hc1[4]*_hc2[0]*_t121*_t42 - _t127*_t241 - _t127*_t253 - _t240*_t64 - _t257*_t267) - _t130*_t39 - _t210*_t259 - _t228*_t235*_t83 - _t228*_t63*_t70 - _t231*_t257 - _t232*_t81 - _t254 - _t255 - _t257*_t258 - _t257*_t260 - _t257*_t262 - _t263*_t42 - _t264*_t42 - _t264*_t43 - _t265*_t266 - _t265*_t70) - _t72*_t98 - _t75*(_hc1[11]*_t36 + _hc1[6]*_t73 + _hc1[7]*_t251 + (0.27e2 / 0.50e2)*_t241);
  out[11] = d4f_dx2_dt3;
  const double d4f_dx22_dt2 = (0.584e3 / 0.2025e4)*_hc0[1]*_hc0[8] - _hc0[12]*_t11 + _hc0[12]*_t22 + (0.584e3 / 0.2025e4)*_hc0[2]*_hc0[7] + _hc0[3]*_t156 + (0.584e3 / 0.2025e4)*((_hc0[4]) * (_hc0[4])) + _t101*_t168 - _t102*_t160 + _t104*_t168 - _t110*_t115*_t87 - _t114*_t164*_t88 + _t114*_t45*_t87 + _t133*_t199*_t34 + _t134*_t268 + _t134*_t269 - 0.292e3 / 0.405e3*_t136*_t74 + _t137*_t194*_t74 - _t138*_t166 - _t138*_t273 - _t140*_t163 + _t140*_t165 - 0.146e3 / 0.405e3*_t140*_t71 + _t143*_t87 + _t144*_t164*_t248 + _t155*_t89 - _t157*_t191 - _t158*_t46 - _t159*_t43 + (0.73e2 / 0.2250e4)*_t161*_t43 - 0.219e3 / 0.2500e4*_t167*_t206*_t49 + _t167*_t207*_t248 - _t179*_t208 + _t194*_t246*_t37 - _t209*_t245*_t37 - _t243*_t88 + _t248*_t250*_t90 - _t270*_t45 + _t271*_t50 + _t272*_t42 + _t272*_t43 + _t41*(0.192e3*_hc1[0]*_hc1[1]*_hc1[2]*_hc1[4]*_hc2[0]*_t14*_t54*params->c + 0.288e3*_hc1[0]*_hc1[1]*_hc1[2]*_hc1[4]*_t14*_t54*params->c + 0.48e2*_hc1[0]*_hc1[3]*_hc2[0]*_t14*_t54*_t86*params->c + 0.72e2*_hc1[0]*_hc1[3]*_t14*_t54*_t86*params->c + 0.96e2*_hc1[1]*_hc1[2]*_t1*_t14*_t54*_t83*params->c + 0.2e1*_hc1[1]*_hc1[2]*_t13*_t14*_t172*_t57*_t58*params->c + 0.2e1*_hc1[1]*_hc2[0]*_t13*_t14*_t171*_t32*params->c + 0.48e2*_hc1[2]*_hc1[7]*_t1*_t14*_t54*params->c + _hc1[2]*_hc2[0]*_t13*_t14*_t32*params->c*(_hc1[2]*_t128*_t51 - _t133*_t238 + 0.2e1*_t150 - 0.2e1*_t152) - _hc1[3]*_t147*_t86 + 0.4e1*_hc2[0]*_t14*_t29*_t42*_t57*_t86*params->c + 0.264e3*_hc2[0]*_t14*_t42*_t54*_t86*params->c - _hc2[0]*_t222*_t275 - _hc2[0]*_t279 + 0.48e2*_t1*_t14*_t269*_t54*params->c + 0.24e2*_t1*_t14*_t54*_t66*_t86*params->c - _t111*_t222*_t274 - _t123*_t212*_t274 + _t13*_t14*_t172*_t83*params->c + _t13*_t14*_t224*_t225*_t42*_t86*params->c + _t13*_t14*_t57*_t58*_t66*_t86*params->c + _t13*_t14*params->c*(0.8e1*_hc1[1]*_hc1[2]*_hc1[4]*_hc2[0]*_t121 + 0.2e1*_hc1[3]*_hc2[0]*_t121*_t86 - _t151*_t268 - _t151*_t269 - _t267*_t276) + 0.1920e4*_t14*_t203*_t218*_t42*_t86*params->c + 0.144e3*_t14*_t42*_t54*_t58*_t86*params->c + 0.72e2*_t14*_t42*_t54*_t86*params->c - _t154*_t34*_t52 - _t171*_t25*_t52 - _t172*_t80 - _t216*_t275 - _t230*_t276*_t58 - _t231*_t276 - _t233*_t92 - 0.32e2*_t261*_t81 - _t266*_t278 - _t268*_t52 - _t268*_t53 - _t269*_t52 - _t276*_t277 - _t279 - _t63*_t92 - _t64*_t67*_t86 - _t66*_t92 - _t66*_t93) - _t75*((0.9e1 / 0.25e2)*_t268 + (0.9e1 / 0.25e2)*_t269);
  out[12] = d4f_dx22_dt2;
  const double d4f_dx23_dt = (0.292e3 / 0.2025e4)*_hc0[0]*_hc0[13] + (0.73e2 / 0.750e3)*_hc0[0]*_hc1[0]*_hc1[1]*_t109*_t176*_t37 + (0.73e2 / 0.375e3)*_hc0[0]*_hc1[0]*_hc1[1]*_t109*_t87*_t90 + (0.73e2 / 0.450e3)*_hc0[0]*_hc1[0]*_hc1[1]*_t182*_t205*_t37*_t90 + (0.73e2 / 0.1125e4)*_hc0[0]*_hc1[2]*_hc1[4]*_t37*_t47 + (0.292e3 / 0.2025e4)*_hc0[1]*_hc0[9] - _hc0[13]*_t11 + (0.292e3 / 0.675e3)*_hc0[2]*_hc0[8] + (0.73e2 / 0.250e3)*_hc0[2]*_hc1[0]*_hc1[1]*_t109*_t37*_t90 + (0.73e2 / 0.750e3)*_hc0[2]*_hc1[0]*_hc1[1]*_t47*_t87 + (0.292e3 / 0.675e3)*_hc0[4]*_hc0[5] + (0.73e2 / 0.750e3)*_hc0[5]*_hc1[0]*_hc1[1]*_t37*_t47 - _t114*_t176*_t38 - _t136*_t174 - _t137*_t164*_t175 - 0.73e2 / 0.405e3*_t139*_t176 - 0.73e2 / 0.375e3*_t157*_t71 - 0.146e3 / 0.1125e4*_t157*_t91 - _t158*_t247 - _t164*_t183*_t38 - _t166*_t177 + (0.1e1 / 0.8e1)*_t17*_t173*_t18 + (0.1e1 / 0.24e2)*_t17*_t18*x2*(_hc1[2]*_t16*_t171*_t62 + _hc1[2]*_t237*(0.4e1*_hc1[1]*_hc2[0]*_t121*_t86 - _t157*_t238) - _t111*_t259*_t86 - _t116*_t171*_t34 - _t116*_t172*_t287 - _t116*_t81*_t86 - _t127*_t84*_t86 + _t16*(0.6e1*_hc1[4]*_t128*_t86 - _t267*_t284) + _t185*_t284 + _t217*_t83*_t86 + _t220*_t266*_t287 + _t220*_t284*_t58 - _t223*_t286 + _t227*_t284 - _t231*_t284 + _t238*_t284*_t30 - _t258*_t284 - _t263*_t86 - _t264*_t86 + _t266*_t285*_t86 - 0.3e1*_t277*_t284 + _t284*_t288 + 0.2e1*_t284*_t289 + _t285*_t286 + _t60*_t86*(0.3e1*_t81 - 0.3e1*_t82)) - _t175*_t246*_t90 - _t175*_t270 - _t177*_t273 - _t178*_t247 - _t207*_t283 - _t280*_t76 - 0.73e2 / 0.405e3*_t281*_t74 - _t282*(-_hc1[2]*_t251 - _hc1[4]*_t180);
  out[13] = d4f_dx23_dt;
  const double d4f_dx24 = (0.292e3 / 0.2025e4)*_hc0[0]*_hc0[14] - _hc0[14]*_t11 + (0.1168e4 / 0.2025e4)*_hc0[2]*_hc0[9] + (0.292e3 / 0.675e3)*((_hc0[5]) * (_hc0[5])) - _t137*_t176*_t290 - 0.146e3 / 0.135e3*_t158*_t87 - 0.146e3 / 0.135e3*_t167*_t271 + (0.1e1 / 0.6e1)*_t17*_t18*_t187 + (0.1e1 / 0.24e2)*_t17*_t18*x2*(_hc2[0]*_t292 - _t122*_t239*_t293 + _t185*_t291 + _t227*_t291 - _t231*_t291 - _t258*_t291 - _t260*_t291 + _t262*_t291 - _t267*_t293 + _t288*_t291 + 0.11e2*_t289*_t291 - _t291*_t52*_t64 + _t292*_t58) - _t174*_t176*_t48 - _t174*_t281 - _t176*_t183*_t88 - 0.584e3 / 0.405e3*_t178*_t87 - _t182*_t245*_t290*_t90 - _t206*_t283*(-0.9e1 / 0.10e2*_t34 - 0.5e1 / 0.1152e4*_t6*x2) - _t280*_t290 - _t282*(-_t181 - 0.27e2 / 0.50e2*_t86);
  out[14] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(rtpss_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double u, double t, double *out) {

  double _hc0[(_KMAX) >= 4 ? 15 : (_KMAX) >= 3 ? 10 : (_KMAX) >= 2 ? 6 : (_KMAX) >= 1 ? 3 : 1];
  XC_CAT(tpss_kappa_pf_k, _KMAX)(p, 0, 0, _hc0);
  double _hc1[(_KMAX) >= 4 ? 15 : (_KMAX) >= 3 ? 10 : (_KMAX) >= 2 ? 6 : (_KMAX) >= 1 ? 3 : 1];
  XC_CAT(tpss_fx_pf_k, _KMAX)(p, x2, t, _hc1);
  const double _t1 = (0.1e1 / (_hc0[0]));
  const double _t2 = xc_expm1(-_hc1[0]*_t1);
#if _KMAX >= 1
  const double _t3 = _t2 + 0.1e1;
  const double _t4 = _hc1[1]*_t3;
  const double _t5 = _hc1[2]*_t3;
#endif
#if _KMAX >= 2
  const double _t6 = _hc1[3]*_t3;
  const double _t7 = ((_hc1[1]) * (_hc1[1]));
  const double _t8 = _t1*_t3;
  const double _t9 = _hc1[4]*_t3;
  const double _t10 = _t1*_t4;
  const double _t11 = ((_hc1[2]) * (_hc1[2]));
#endif
#if _KMAX >= 3
  const double _t12 = ((_hc1[1]) * (_hc1[1]) * (_hc1[1]));
  const double _t13 = (0.1e1 / ((_hc0[0]) * (_hc0[0])));
  const double _t14 = _t13*_t3;
  const double _t15 = 0.3e1*_t10;
  const double _t16 = 0.2e1*_hc1[4];
  const double _t17 = _t1*_t5;
  const double _t18 = ((_hc1[2]) * (_hc1[2]) * (_hc1[2]));
  const double _t19 = 0.3e1*_t17;
#endif
#if _KMAX >= 4
  const double _t20 = (0.1e1 / ((_hc0[0]) * (_hc0[0]) * (_hc0[0])));
  const double _t21 = _t20*_t3;
  const double _t22 = 0.3e1*_t8;
  const double _t23 = _t1*_t6;
#endif

  const double f = -_hc0[0]*_t2 + 0.1e1;
  out[0] = f;
#if _KMAX >= 1
  ...
  out[2] = df_du;
  const double df_dx2 = _t5;
  out[3] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _t6 - _t7*_t8;
  out[4] = d2f_dt2;
  const double d2f_du_dt = 0;
  out[5] = d2f_du_dt;
  const double d2f_du2 = 0;
  out[6] = d2f_du2;
  const double d2f_dx2_dt = -_hc1[2]*_t10 + _t9;
  out[7] = d2f_dx2_dt;
  const double d2f_dx2_du = 0;
  out[8] = d2f_dx2_du;
  const double d2f_dx22 = _hc1[5]*_t3 - _t11*_t8;
  out[9] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = -_hc1[3]*_t15 + _hc1[6]*_t3 + _t12*_t14;
  out[10] = d3f_dt3;
  ...
  out[13] = d3f_du3;
  const double d3f_dx2_dt2 = -_hc1[3]*_t17 + _hc1[7]*_t3 - _t10*_t16 + _t13*_t5*_t7;
  out[14] = d3f_dx2_dt2;
  const double d3f_dx2_du_dt = 0;
  out[15] = d3f_dx2_du_dt;
  const double d3f_dx2_du2 = 0;
  out[16] = d3f_dx2_du2;
  const double d3f_dx22_dt = -_hc1[5]*_t10 + _hc1[8]*_t3 + _t11*_t13*_t4 - _t16*_t17;
  out[17] = d3f_dx22_dt;
  const double d3f_dx22_du = 0;
  out[18] = d3f_dx22_du;
  const double d3f_dx23 = -_hc1[5]*_t19 + _hc1[9]*_t3 + _t14*_t18;
  out[19] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = -((_hc1[1]) * (_hc1[1]) * (_hc1[1]) * (_hc1[1]))*_t21 + _hc1[10]*_t3 - ((_hc1[3]) * (_hc1[3]))*_t22 + 0.6e1*_hc1[3]*_t13*_t3*_t7 - 0.4e1*_hc1[6]*_t10;
  out[20] = d4f_dt4;
  ...
  out[24] = d4f_du4;
  const double d4f_dx2_dt3 = 0.3e1*_hc1[1]*_hc1[2]*_hc1[3]*_t13*_t3 + _hc1[11]*_t3 + 0.3e1*_hc1[4]*_t13*_t3*_t7 - 0.3e1*_hc1[4]*_t23 - _hc1[6]*_t17 - _hc1[7]*_t15 - _t12*_t20*_t5;
  out[25] = d4f_dx2_dt3;
  ...
  out[28] = d4f_dx2_du3;
  const double d4f_dx22_dt2 = 0.4e1*_hc1[1]*_hc1[2]*_hc1[4]*_t13*_t3 + _hc1[12]*_t3 + _hc1[3]*_t11*_t13*_t3 - 0.2e1*((_hc1[4]) * (_hc1[4]))*_t8 + _hc1[5]*_t13*_t3*_t7 - _hc1[5]*_t23 - 0.2e1*_hc1[7]*_t17 - 0.2e1*_hc1[8]*_t10 - _t11*_t21*_t7;
  out[29] = d4f_dx22_dt2;
  const double d4f_dx22_du_dt = 0;
  out[30] = d4f_dx22_du_dt;
  const double d4f_dx22_du2 = 0;
  out[31] = d4f_dx22_du2;
  const double d4f_dx23_dt = 0.3e1*_hc1[1]*_hc1[2]*_hc1[5]*_t13*_t3 + _hc1[13]*_t3 + 0.3e1*_hc1[4]*_t11*_t13*_t3 - 0.3e1*_hc1[5]*_t1*_t9 - _hc1[8]*_t19 - _hc1[9]*_t10 - _t18*_t20*_t4;
  out[32] = d4f_dx23_dt;
  const double d4f_dx23_du = 0;
  out[33] = d4f_dx23_du;
  const double d4f_dx24 = _hc1[14]*_t3 - ((_hc1[2]) * (_hc1[2]) * (_hc1[2]) * (_hc1[2]))*_t21 - ((_hc1[5]) * (_hc1[5]))*_t22 + 0.6e1*_hc1[5]*_t11*_t13*_t3 - 0.4e1*_hc1[9]*_t17;
  out[34] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double lapl_s, double tau_s, double *out) {
  ...
  if(!(_t7)) XC_CAT(rtpss_f_pf_k, _KMAX)(p, _t5*sigma_ss, 0, _t6*tau_s, _hc1);
