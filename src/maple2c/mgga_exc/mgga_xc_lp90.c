/*
  Generated from python/mgga_exc/mgga_xc_lp90.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_xc_lp90
*/

#ifndef _MGGA_XC_LP90_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_XC_LP90_KERNEL_BODY
#define _KMAX 0
#define _MGGA_XC_LP90_HELPER_BODIES
#include "mgga_xc_lp90.c"
#undef _MGGA_XC_LP90_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_XC_LP90_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_XC_LP90_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(lp90_f_k, _KMAX)(const xc_func_type *p, double rs, double z, double xt2, double us0, double us1, double *out) {
  const mgga_xc_lp90_params *params = (const mgga_xc_lp90_params *)(p->params);
  ...
  const double _t4 = (0.1e1 / 0.3e1)*_t3;
  const double _t5 = _t4*rs + params->k;
  const double _t6 = (0.1e1 / _t5);
  const double _t7 = _hc0[0] + 0.1e1;
  const double _t8 = _hc1[0] + 0.1e1;
  const double _t9 = M_CBRT2;
  const double _t10 = (0.1e1 / 0.32e2)*_t9;
  const double _t11 = -params->c0 - params->d0*(-_t10*(_t7*us0 + _t8*us1) + (0.1e1 / 0.8e1)*xt2);
#if _KMAX >= 1
  const double _t12 = _t6*params->d0;
  const double _t13 = _t10*_t12;
  const double _t14 = _hc0[2]*us0 - _hc1[2]*us1;
  const double _t15 = (0.1e1 / (_t5 * _t5));
#endif
#if _KMAX >= 2
  const double _t16 = _hc0[5]*us0 + _hc1[5]*us1;
  const double _t17 = _t15*params->d0;
  const double _t18 = (0.1e1 / 0.48e2)*xc_powr(0.3e1, 2, 3)*_t17*_t2;
  const double _t19 = (M_CBRTPI * M_CBRTPI)/(_t5 * _t5 * _t5);
  const double _t20 = xc_powr(0.6e1, 1, 3)*_t19;
#endif
#if _KMAX >= 3
  const double _t21 = _hc0[9]*us0 - _hc1[9]*us1;
  const double _t22 = (0.1e1 / 0.24e2)*xc_powr(0.12e2, 1, 3)*_t19*params->d0;
  const double _t23 = M_PI/(_t5 * _t5 * _t5 * _t5);
#endif
#if _KMAX >= 4
  const double _t24 = _t23*params->d0;
  const double _t25 = (0.1e1 / 0.4e1)*_t24*_t9;
#endif

  const double f = _t11*_t6;
  out[0] = f;
#if _KMAX >= 1
  const double df_dus1 = _t13*_t8;
  out[1] = df_dus1;
  const double df_dus0 = _t13*_t7;
  out[2] = df_dus0;
  const double df_dxt2 = -0.1e1 / 0.8e1*_t12;
  out[3] = df_dxt2;
  const double df_dz = _t13*_t14;
  out[4] = df_dz;
  const double df_drs = -_t11*_t15*_t4;
  out[5] = df_drs;
#endif
#if _KMAX >= 2
  ...
  out[11] = d2f_dxt22;
  const double d2f_dz_dus1 = -_hc1[2]*_t13;
  out[12] = d2f_dz_dus1;
  const double d2f_dz_dus0 = _hc0[2]*_t13;
  out[13] = d2f_dz_dus0;
  const double d2f_dz_dxt2 = 0;
  out[14] = d2f_dz_dxt2;
  const double d2f_dz2 = _t13*_t16;
  out[15] = d2f_dz2;
  const double d2f_drs_dus1 = -_t18*_t8;
  out[16] = d2f_drs_dus1;
  const double d2f_drs_dus0 = -_t18*_t7;
  out[17] = d2f_drs_dus0;
  const double d2f_drs_dxt2 = (0.1e1 / 0.24e2)*_t17*_t3;
  out[18] = d2f_drs_dxt2;
  const double d2f_drs_dz = -_t14*_t18;
  out[19] = d2f_drs_dz;
  const double d2f_drs2 = (0.4e1 / 0.3e1)*_t11*_t20;
  out[20] = d2f_drs2;
#endif
#if _KMAX >= 3
  ...
  out[36] = d3f_dz_dxt22;
  const double d3f_dz2_dus1 = _hc1[5]*_t13;
  out[37] = d3f_dz2_dus1;
  const double d3f_dz2_dus0 = _hc0[5]*_t13;
  out[38] = d3f_dz2_dus0;
  const double d3f_dz2_dxt2 = 0;
  out[39] = d3f_dz2_dxt2;
  const double d3f_dz3 = _t13*_t21;
  out[40] = d3f_dz3;
  ...
  const double d3f_drs_dz_dus1 = _hc1[2]*_t18;
  out[47] = d3f_drs_dz_dus1;
  const double d3f_drs_dz_dus0 = -_hc0[2]*_t18;
  out[48] = d3f_drs_dz_dus0;
  const double d3f_drs_dz_dxt2 = 0;
  out[49] = d3f_drs_dz_dxt2;
  const double d3f_drs_dz2 = -_t16*_t18;
  out[50] = d3f_drs_dz2;
  const double d3f_drs2_dus1 = _t22*_t8;
  out[51] = d3f_drs2_dus1;
  const double d3f_drs2_dus0 = _t22*_t7;
  out[52] = d3f_drs2_dus0;
  const double d3f_drs2_dxt2 = -0.1e1 / 0.6e1*_t20*params->d0;
  out[53] = d3f_drs2_dxt2;
  const double d3f_drs2_dz = _t14*_t22;
  out[54] = d3f_drs2_dz;
  const double d3f_drs3 = -0.8e1*_t11*_t23;
  out[55] = d3f_drs3;
#endif
#if _KMAX >= 4
  ...
  const double d4f_dz3_dus1 = -_hc1[9]*_t13;
  out[87] = d4f_dz3_dus1;
  const double d4f_dz3_dus0 = _hc0[9]*_t13;
  out[88] = d4f_dz3_dus0;
  const double d4f_dz3_dxt2 = 0;
  out[89] = d4f_dz3_dxt2;
  const double d4f_dz4 = _t13*(_hc0[14]*us0 + _hc1[14]*us1);
  out[90] = d4f_dz4;
  ...
  const double d4f_drs_dz2_dus1 = -_hc1[5]*_t18;
  out[107] = d4f_drs_dz2_dus1;
  const double d4f_drs_dz2_dus0 = -_hc0[5]*_t18;
  out[108] = d4f_drs_dz2_dus0;
  const double d4f_drs_dz2_dxt2 = 0;
  out[109] = d4f_drs_dz2_dxt2;
  const double d4f_drs_dz3 = -_t18*_t21;
  out[110] = d4f_drs_dz3;
  ...
  const double d4f_drs2_dz_dus1 = -_hc1[2]*_t22;
  out[117] = d4f_drs2_dz_dus1;
  const double d4f_drs2_dz_dus0 = _hc0[2]*_t22;
  out[118] = d4f_drs2_dz_dus0;
  const double d4f_drs2_dz_dxt2 = 0;
  out[119] = d4f_drs2_dz_dxt2;
  const double d4f_drs2_dz2 = _t16*_t22;
  out[120] = d4f_drs2_dz2;
  const double d4f_drs3_dus1 = -_t25*_t8;
  out[121] = d4f_drs3_dus1;
  const double d4f_drs3_dus0 = -_t25*_t7;
  out[122] = d4f_drs3_dus0;
  const double d4f_drs3_dxt2 = _t24;
  out[123] = d4f_drs3_dxt2;
  const double d4f_drs3_dz = -_t14*_t25;
  out[124] = d4f_drs3_dz;
  const double d4f_drs4 = (0.32e2 / 0.3e1)*(M_PI * M_CBRTPI)*_t1*_t11/xc_powi(_t5, 5);
  out[125] = d4f_drs4;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(lp90_f_z0_k, _KMAX)(const xc_func_type *p, double rs, double xt2, double us0, double us1, double *out) {
  const mgga_xc_lp90_params *params = (const mgga_xc_lp90_params *)(p->params);
  ...
  const double _t8 = (0.1e1 / 0.32e2)*_t7;
  const double _t9 = -params->c0 - params->d0*(-_t8*(us0 + us1) + (0.1e1 / 0.8e1)*xt2);
#if _KMAX >= 1
  const double _t10 = _t6*params->d0;
  const double _t11 = _t10*_t8;
  const double _t12 = (0.1e1 / (_t5 * _t5));
#endif
#if _KMAX >= 2
  const double _t13 = _t12*params->d0;
  const double _t14 = -0.1e1 / 0.48e2*xc_powr(0.3e1, 2, 3)*_t13*_t2;
  const double _t15 = (M_CBRTPI * M_CBRTPI)/(_t5 * _t5 * _t5);
  const double _t16 = xc_powr(0.6e1, 1, 3)*_t15;
#endif
#if _KMAX >= 3
  const double _t17 = (0.1e1 / 0.24e2)*xc_powr(0.12e2, 1, 3)*_t15*params->d0;
  const double _t18 = M_PI/(_t5 * _t5 * _t5 * _t5);
#endif
#if _KMAX >= 4
  const double _t19 = _t18*params->d0;
  const double _t20 = -0.1e1 / 0.4e1*_t19*_t7;
#endif

  const double f = _t6*_t9;
  out[0] = f;
#if _KMAX >= 1
  const double df_dus1 = _t11;
  out[1] = df_dus1;
  const double df_dus0 = _t11;
  out[2] = df_dus0;
  const double df_dxt2 = -0.1e1 / 0.8e1*_t10;
  out[3] = df_dxt2;
  const double df_drs = -_t12*_t4*_t9;
  out[4] = df_drs;
#endif
#if _KMAX >= 2
  const double d2f_dus12 = 0;
  ...
  const double d2f_dxt22 = 0;
  out[10] = d2f_dxt22;
  const double d2f_drs_dus1 = _t14;
  out[11] = d2f_drs_dus1;
  const double d2f_drs_dus0 = _t14;
  out[12] = d2f_drs_dus0;
  const double d2f_drs_dxt2 = (0.1e1 / 0.24e2)*_t13*_t3;
  out[13] = d2f_drs_dxt2;
  const double d2f_drs2 = (0.4e1 / 0.3e1)*_t16*_t9;
  out[14] = d2f_drs2;
#endif
#if _KMAX >= 3
  const double d3f_dus13 = 0;
  ...
  const double d3f_drs2_dus1 = _t17;
  out[31] = d3f_drs2_dus1;
  const double d3f_drs2_dus0 = _t17;
  out[32] = d3f_drs2_dus0;
  const double d3f_drs2_dxt2 = -0.1e1 / 0.6e1*_t16*params->d0;
  out[33] = d3f_drs2_dxt2;
  const double d3f_drs3 = -0.8e1*_t18*_t9;
  out[34] = d3f_drs3;
#endif
#if _KMAX >= 4
  const double d4f_dus14 = 0;
  ...
  const double d4f_drs3_dus1 = _t20;
  out[66] = d4f_drs3_dus1;
  const double d4f_drs3_dus0 = _t20;
  out[67] = d4f_drs3_dus0;
  const double d4f_drs3_dxt2 = _t19;
  out[68] = d4f_drs3_dxt2;
  const double d4f_drs4 = (0.32e2 / 0.3e1)*(M_PI * M_CBRTPI)*_t1*_t9/xc_powi(_t5, 5);
  out[69] = d4f_drs4;
#endif
}
...
FUNC_NAME(const xc_func_type *p, size_t ip, const double *rho, const double *sigma, const double *lapl, const double *tau, xc_mgga_out_params *out)
{
  ...
  XC_CAT(lp90_f_z0_k, _KMAX)(p, _t5, _t6*gaa, _t10, _t10, _hc0);
  ...
  XC_CAT(lp90_f_z0_k, _KMAX)(p, _t5, 0, 0, 0, _hc1);
  ...
  XC_CAT(lp90_f_k, _KMAX)(p, _t6, _t9, _t10*_t11, _t13, _t15, _hc0);
  const double zk = _hc0[0];
  if(out->zk != NULL) out->zk[ip*p->dim.zk + 0] += zk;
#if _KMAX >= 1
  ...
  XC_CAT(lp90_f_k, _KMAX)(p, _t6, _t9, 0, _t13, _t15, _hc1);
  double _hc2[(_KMAX) >= 4 ? 126 : (_KMAX) >= 3 ? 56 : (_KMAX) >= 2 ? 21 : (_KMAX) >= 1 ? 6 : 1];
  XC_CAT(lp90_f_k, _KMAX)(p, _t6, 0, 0, 0, 0, _hc2);
  double _hc3[(_KMAX) >= 4 ? 126 : (_KMAX) >= 3 ? 56 : (_KMAX) >= 2 ? 21 : (_KMAX) >= 1 ? 6 : 1];
  XC_CAT(lp90_f_k, _KMAX)(p, _t6, _t9, 0, 0, 0, _hc3);
