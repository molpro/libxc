/*
  Generated from python/mgga_exc/mgga_x_pbe_gx.py via
  python/libxc_codegen.py with Python 3.9.25, SymPy 1.14.0.
  Do not edit -- regenerate via
  scripts/sympy2c/compile.py mgga_x_pbe_gx
*/

#ifndef _MGGA_X_PBE_GX_KERNEL_BODY
#define maple2c_order 4
#define MAPLE2C_FLAGS (XC_FLAGS_I_HAVE_EXC | XC_FLAGS_I_HAVE_VXC | XC_FLAGS_I_HAVE_FXC | XC_FLAGS_I_HAVE_KXC | XC_FLAGS_I_HAVE_LXC)

/* ---- top-level dispatch ---- */

#define _MGGA_X_PBE_GX_KERNEL_BODY
#define _KMAX 0
#define _MGGA_X_PBE_GX_HELPER_BODIES
#include "mgga_x_pbe_gx.c"
#undef _MGGA_X_PBE_GX_HELPER_BODIES
#undef _KMAX
#if XC_MAXORDER >= 1
#define _KMAX 1
#define _MGGA_X_PBE_GX_HELPER_BODIES
...
#undef FUNC_NAME
#endif
#elif defined(_MGGA_X_PBE_GX_HELPER_BODIES)
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(gx_gx0_k, _KMAX)(const xc_func_type *p, double a, double *out) {
  ...
  const double _t2 = (0.1e1 / M_CBRT3);
  const double _t3 = (0.16e2 / 0.9e1)*M_CBRTPI*_t1*_t2;
  const double _t4 = 0.64356000000000002*a;
  const double _t5 = 0.82741100000000001 - _t4;
  const double _t6 = 0.81614900000000001*a;
  const double _t7 = 1.0 - _t6;
  const double _t8 = (0.1e1 / _t7);
  const double _t9 = 0.1e1 - _t3;
  const double _t10 = _t8*_t9;
  const double _t11 = _t10*_t5;
#if _KMAX >= 1
  const double _t12 = (0.1e1 / (_t7 * _t7));
...
#endif
#if _KMAX >= 3
  const double _t18 = _t9/(_t7 * _t7 * _t7 * _t7);
  const double _t19 = _t18*_t5;
#endif

  const double f = _t11*a + _t3;
  out[0] = f;
#if _KMAX >= 1
  const double df_da = -_t10*_t4 + _t11 + _t14*_t6;
  out[1] = df_da;
#endif
#if _KMAX >= 2
  const double d2f_da2 = -1.05048170088*_t13*a + 1.632298*_t14 + 1.3321983804020001*_t17*a + _t8*(2.2882133333333332*M_CBRTPI*_t1*_t2 - 1.28712);
  out[2] = d2f_da2;
#endif
#if _KMAX >= 3
  const double d3f_da3 = _t12*(5.6025690713600005*M_CBRTPI*_t1*_t2 - 3.1514451026400003) - 2.5720487690745335*_t16*a + 3.9965951412060003*_t17 + 3.2618171279001356*_t19*a;
  out[3] = d3f_da3;
#endif
#if _KMAX >= 4
  const double d4f_da4 = _t15*(18.290124580085571*M_CBRTPI*_t1*_t2 - 10.288195076298134) - 8.3967001233256457*_t18*a + 13.047268511600542*_t19 + 10.648515148474271*_t5*_t9*a/xc_powi(_t7, 5);
  out[4] = d4f_da4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(gx_gx1_k, _KMAX)(const xc_func_type *p, double a, double *out) {
  ...
  const double _t1 = 0.14800000000000002 - 0.14800000000000002*a;
  const double _t2 = a + 0.1e1;
  ...
  const double f = _t1*_t3 + 0.1e1;
  out[0] = f;
#if _KMAX >= 1
  const double df_da = -_t1*_t4 - 0.14800000000000002*_t3;
  out[1] = df_da;
#endif
#if _KMAX >= 2
  const double d2f_da2 = 0.2e1*_t1*_t5 + 0.29600000000000004*_t4;
  out[2] = d2f_da2;
#endif
#if _KMAX >= 3
  const double d3f_da3 = -0.6e1*_t1*_t6 - 0.88800000000000012*_t5;
  out[3] = d3f_da3;
#endif
#if _KMAX >= 4
  const double d4f_da4 = 0.24e2*_t1/xc_powi(_t2, 5) + 3.5520000000000005*_t6;
  out[4] = d4f_da4;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(pbe_gx_pf_k, _KMAX)(const xc_func_type *p, double x2, double *out) {

  const double _t1 = 0.0010155489999999999*x2 + 0.1e1;

  const double f = (0.1e1 / _t1);
  out[0] = f;
#if _KMAX >= 1
  const double df_dx2 = -0.0010155489999999999/(_t1 * _t1);
  out[1] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dx22 = 2.0626795428019999e-6/(_t1 * _t1 * _t1);
  out[2] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dx23 = -6.2842564410390838e-9/(_t1 * _t1 * _t1 * _t1);
  out[3] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dx24 = 2.5527881377763201e-11/xc_powi(_t1, 5);
  out[4] = d4f_dx24;
#endif
}

GPU_DEVICE_FUNCTION static inline void XC_CAT(pbe_gx_f_pf_k, _KMAX)(const xc_func_type *p, double x2, double u, double t, double *out) {
  ...
  XC_CAT(pbe_gx_pf_k, _KMAX)(p, x2, _hc2);
#if _KMAX >= 1
  const double _t1 = _hc1[1]*_hc2[0];
#endif
#if _KMAX >= 2
  const double _t2 = ((_hc0[1]) * (_hc0[1]));
  const double _t3 = _hc1[2]*_hc2[0];
  const double _t4 = _hc0[1]*_hc1[1];
  const double _t5 = _hc0[1]*_hc0[2];
  const double _t6 = _hc0[2]*_hc1[1];
  const double _t7 = 0.2e1*_hc2[1];
  const double _t8 = ((_hc0[2]) * (_hc0[2]));
#endif
#if _KMAX >= 3
  const double _t9 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]));
  const double _t10 = _hc1[3]*_hc2[0];
  const double _t11 = _hc1[2]*_t2;
  const double _t12 = _hc0[2]*_t2;
  const double _t13 = _hc1[2]*_t5;
  const double _t14 = _hc0[1]*_t8;
  const double _t15 = 0.3e1*_hc2[2];
  const double _t16 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]));
  const double _t17 = _hc1[2]*_t8;
#endif
#if _KMAX >= 4
  const double _t18 = _hc1[4]*_hc2[0];
  const double _t19 = _hc1[3]*_hc2[1];
#endif

  const double f = _hc1[0]*_hc2[0];
  out[0] = f;
#if _KMAX >= 1
  ...
  out[2] = df_du;
  const double df_dx2 = _hc0[2]*_t1 + _hc1[0]*_hc2[1];
  out[3] = df_dx2;
#endif
#if _KMAX >= 2
  const double d2f_dt2 = _t2*_t3;
  out[4] = d2f_dt2;
  const double d2f_du_dt = 0;
  out[5] = d2f_du_dt;
  const double d2f_du2 = 0;
  out[6] = d2f_du2;
  const double d2f_dx2_dt = _hc2[1]*_t4 + _t3*_t5;
  out[7] = d2f_dx2_dt;
  const double d2f_dx2_du = 0;
  out[8] = d2f_dx2_du;
  const double d2f_dx22 = _hc1[0]*_hc2[2] + _t3*_t8 + _t6*_t7;
  out[9] = d2f_dx22;
#endif
#if _KMAX >= 3
  const double d3f_dt3 = _t10*_t9;
  out[10] = d3f_dt3;
  ...
  out[13] = d3f_du3;
  const double d3f_dx2_dt2 = _hc2[1]*_t11 + _t10*_t12;
  out[14] = d3f_dx2_dt2;
  const double d3f_dx2_du_dt = 0;
  out[15] = d3f_dx2_du_dt;
  const double d3f_dx2_du2 = 0;
  out[16] = d3f_dx2_du2;
  const double d3f_dx22_dt = _hc2[2]*_t4 + _t10*_t14 + _t13*_t7;
  out[17] = d3f_dx22_dt;
  const double d3f_dx22_du = 0;
  out[18] = d3f_dx22_du;
  const double d3f_dx23 = _hc1[0]*_hc2[3] + 0.3e1*_hc2[1]*_t17 + _t10*_t16 + _t15*_t6;
  out[19] = d3f_dx23;
#endif
#if _KMAX >= 4
  const double d4f_dt4 = ((_hc0[1]) * (_hc0[1]) * (_hc0[1]) * (_hc0[1]))*_t18;
  out[20] = d4f_dt4;
  ...
  out[24] = d4f_du4;
  const double d4f_dx2_dt3 = _hc0[2]*_t18*_t9 + _t19*_t9;
  out[25] = d4f_dx2_dt3;
  ...
  out[28] = d4f_dx2_du3;
  const double d4f_dx22_dt2 = _hc2[2]*_t11 + 0.2e1*_t12*_t19 + _t18*_t2*_t8;
  out[29] = d4f_dx22_dt2;
  const double d4f_dx22_du_dt = 0;
  out[30] = d4f_dx22_du_dt;
  const double d4f_dx22_du2 = 0;
  out[31] = d4f_dx22_du2;
  const double d4f_dx23_dt = _hc0[1]*_t16*_t18 + _hc2[3]*_t4 + _t13*_t15 + 0.3e1*_t14*_t19;
  out[32] = d4f_dx23_dt;
  const double d4f_dx23_du = 0;
  out[33] = d4f_dx23_du;
  const double d4f_dx24 = ((_hc0[2]) * (_hc0[2]) * (_hc0[2]) * (_hc0[2]))*_t18 + _hc1[0]*_hc2[4] + 0.6e1*_hc2[2]*_t17 + 0.4e1*_hc2[3]*_t6 + 0.4e1*_t16*_t19;
  out[34] = d4f_dx24;
#endif
}
...
GPU_DEVICE_FUNCTION static inline void XC_CAT(xchan_k, _KMAX)(const xc_func_type *p, double n_s, double sigma_ss, double lapl_s, double tau_s, double *out) {
  ...
  if(!(_t7)) XC_CAT(pbe_gx_f_pf_k, _KMAX)(p, _t5*sigma_ss, 0, _t6*tau_s, _hc1);
