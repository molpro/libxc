...
XC_FLAGS_ON_DEVICE = (1 << 18) # 262144
XC_FLAGS_ON_HOST = (1 << 19) # 524288

# Collection of all flags
XC_FLAGS = [XC_FLAGS_HAVE_EXC, XC_FLAGS_HAVE_VXC, XC_FLAGS_HAVE_FXC, XC_FLAGS_HAVE_KXC, XC_FLAGS_HAVE_LXC, XC_FLAGS_1D, XC_FLAGS_2D, XC_FLAGS_3D, XC_FLAGS_HYB_CAM, XC_FLAGS_HYB_CAMY, XC_FLAGS_VV10, XC_FLAGS_HYB_LC, XC_FLAGS_HYB_LCY, XC_FLAGS_STABLE, XC_FLAGS_DEVELOPMENT, XC_FLAGS_NEEDS_LAPLACIAN, XC_FLAGS_NEEDS_TAU, XC_FLAGS_ENFORCE_FHC, XC_FLAGS_ON_DEVICE, XC_FLAGS_ON_HOST]
